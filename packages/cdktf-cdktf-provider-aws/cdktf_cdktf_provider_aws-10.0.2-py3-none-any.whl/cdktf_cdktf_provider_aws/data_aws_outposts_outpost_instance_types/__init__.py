...
class DataAwsOutpostsOutpostInstanceTypes(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataAwsOutpostsOutpostInstanceTypes.__init__)
    ...
    def arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataAwsOutpostsOutpostInstanceTypes, "arn").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataAwsOutpostsOutpostInstanceTypes, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataAwsOutpostsOutpostInstanceTypesConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataAwsOutpostsOutpostInstanceTypesConfig.__init__)
