...
class Ec2TransitGatewayRouteTablePropagation(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayRouteTablePropagation.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayRouteTablePropagation, "id").fset)
    ...
    def transit_gateway_attachment_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayRouteTablePropagation, "transit_gateway_attachment_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_gateway_route_table_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayRouteTablePropagation, "transit_gateway_route_table_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2TransitGatewayRouteTablePropagationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayRouteTablePropagationConfig.__init__)
