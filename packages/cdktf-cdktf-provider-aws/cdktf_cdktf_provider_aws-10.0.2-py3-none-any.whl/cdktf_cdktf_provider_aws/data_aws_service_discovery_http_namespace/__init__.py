...
class DataAwsServiceDiscoveryHttpNamespace(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataAwsServiceDiscoveryHttpNamespace.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataAwsServiceDiscoveryHttpNamespace, "id").fset)
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataAwsServiceDiscoveryHttpNamespace, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataAwsServiceDiscoveryHttpNamespace, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataAwsServiceDiscoveryHttpNamespaceConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataAwsServiceDiscoveryHttpNamespaceConfig.__init__)
