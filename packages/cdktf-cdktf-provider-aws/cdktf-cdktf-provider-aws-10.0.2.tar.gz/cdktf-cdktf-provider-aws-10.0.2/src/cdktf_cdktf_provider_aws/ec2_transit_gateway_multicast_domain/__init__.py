...
class Ec2TransitGatewayMulticastDomain(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["Ec2TransitGatewayMulticastDomainTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayMulticastDomain.__init__)
    ...
    def auto_accept_shared_associations(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomain, "auto_accept_shared_associations").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomain, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def igmpv2_support(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomain, "igmpv2_support").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def static_sources_support(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomain, "static_sources_support").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomain, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags_all(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomain, "tags_all").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_gateway_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomain, "transit_gateway_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2TransitGatewayMulticastDomainConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayMulticastDomainConfig.__init__)
...
class Ec2TransitGatewayMulticastDomainTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayMulticastDomainTimeouts.__init__)
...
class Ec2TransitGatewayMulticastDomainTimeoutsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayMulticastDomainTimeoutsOutputReference.__init__)
    ...
    def create(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomainTimeoutsOutputReference, "create").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def delete(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomainTimeoutsOutputReference, "delete").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastDomainTimeoutsOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
