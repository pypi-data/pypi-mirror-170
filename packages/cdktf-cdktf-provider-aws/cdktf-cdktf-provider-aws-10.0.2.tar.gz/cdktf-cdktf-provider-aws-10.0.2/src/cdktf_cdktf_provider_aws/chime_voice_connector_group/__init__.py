...
class ChimeVoiceConnectorGroup(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        connector: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["ChimeVoiceConnectorGroupConnector", typing.Dict[str, typing.Any]]]]] = None,
        ...
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/chime_voice_connector_group#id ChimeVoiceConnectorGroup#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorGroup.__init__)
    ...
    def put_connector(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["ChimeVoiceConnectorGroupConnector", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorGroup.put_connector)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroup, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroup, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ChimeVoiceConnectorGroupConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorGroupConfig.__init__)
...
class ChimeVoiceConnectorGroupConnector:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorGroupConnector.__init__)
...
class ChimeVoiceConnectorGroupConnectorList(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorGroupConnectorList.__init__)
    ...
    def get(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorGroupConnectorList.get)
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroupConnectorList, "_terraform_attribute").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _terraform_resource(self, value: cdktf.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroupConnectorList, "_terraform_resource").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroupConnectorList, "_wraps_set").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[ChimeVoiceConnectorGroupConnector]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[ChimeVoiceConnectorGroupConnector]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroupConnectorList, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ChimeVoiceConnectorGroupConnectorOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorGroupConnectorOutputReference.__init__)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
    ...
    def priority(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroupConnectorOutputReference, "priority").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def voice_connector_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroupConnectorOutputReference, "voice_connector_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[ChimeVoiceConnectorGroupConnector, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[ChimeVoiceConnectorGroupConnector, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[ChimeVoiceConnectorGroupConnector, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorGroupConnectorOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
