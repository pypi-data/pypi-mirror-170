...
class SecurityhubFindingAggregator(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SecurityhubFindingAggregator.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityhubFindingAggregator, "id").fset)
    ...
    def linking_mode(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityhubFindingAggregator, "linking_mode").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def specified_regions(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityhubFindingAggregator, "specified_regions").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SecurityhubFindingAggregatorConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SecurityhubFindingAggregatorConfig.__init__)
