...
class Ec2TransitGatewayPrefixListReference(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayPrefixListReference.__init__)
    ...
    def blackhole(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayPrefixListReference, "blackhole").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayPrefixListReference, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def prefix_list_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayPrefixListReference, "prefix_list_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_gateway_attachment_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayPrefixListReference, "transit_gateway_attachment_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_gateway_route_table_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayPrefixListReference, "transit_gateway_route_table_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2TransitGatewayPrefixListReferenceConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayPrefixListReferenceConfig.__init__)
