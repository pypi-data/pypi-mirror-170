...
Refer to the Terraform Registory for docs: [`aws_s3control_object_lambda_access_point_policy`](https://www.terraform.io/docs/providers/aws/r/s3control_object_lambda_access_point_policy).
'''
import abc
import builtins
import datetime
