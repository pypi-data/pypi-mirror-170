...
class Ec2LocalGatewayRoute(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2LocalGatewayRoute.__init__)
    ...
    def destination_cidr_block(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRoute, "destination_cidr_block").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRoute, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def local_gateway_route_table_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRoute, "local_gateway_route_table_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def local_gateway_virtual_interface_group_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRoute, "local_gateway_virtual_interface_group_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2LocalGatewayRouteConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2LocalGatewayRouteConfig.__init__)
