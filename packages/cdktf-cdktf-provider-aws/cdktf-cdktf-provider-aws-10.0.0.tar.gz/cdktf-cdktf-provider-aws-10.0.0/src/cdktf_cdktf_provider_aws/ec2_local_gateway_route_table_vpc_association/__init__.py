...
class Ec2LocalGatewayRouteTableVpcAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2LocalGatewayRouteTableVpcAssociation.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRouteTableVpcAssociation, "id").fset)
    ...
    def local_gateway_route_table_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRouteTableVpcAssociation, "local_gateway_route_table_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRouteTableVpcAssociation, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags_all(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRouteTableVpcAssociation, "tags_all").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def vpc_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2LocalGatewayRouteTableVpcAssociation, "vpc_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2LocalGatewayRouteTableVpcAssociationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2LocalGatewayRouteTableVpcAssociationConfig.__init__)
