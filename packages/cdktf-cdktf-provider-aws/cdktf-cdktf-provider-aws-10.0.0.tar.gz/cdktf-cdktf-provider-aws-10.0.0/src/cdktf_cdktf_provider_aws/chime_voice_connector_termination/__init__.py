...
class ChimeVoiceConnectorTermination(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorTermination.__init__)
    ...
    def calling_regions(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorTermination, "calling_regions").fset)
    ...
    def cidr_allow_list(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorTermination, "cidr_allow_list").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def cps_limit(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorTermination, "cps_limit").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def default_phone_number(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorTermination, "default_phone_number").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def disabled(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorTermination, "disabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorTermination, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def voice_connector_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorTermination, "voice_connector_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ChimeVoiceConnectorTerminationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorTerminationConfig.__init__)
