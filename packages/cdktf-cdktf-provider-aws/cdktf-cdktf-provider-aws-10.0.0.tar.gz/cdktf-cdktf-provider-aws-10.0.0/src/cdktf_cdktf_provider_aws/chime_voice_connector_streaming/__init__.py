...
class ChimeVoiceConnectorStreaming(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorStreaming.__init__)
    ...
    def data_retention(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorStreaming, "data_retention").fset)
    ...
    def disabled(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorStreaming, "disabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorStreaming, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def streaming_notification_targets(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorStreaming, "streaming_notification_targets").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def voice_connector_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorStreaming, "voice_connector_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ChimeVoiceConnectorStreamingConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorStreamingConfig.__init__)
