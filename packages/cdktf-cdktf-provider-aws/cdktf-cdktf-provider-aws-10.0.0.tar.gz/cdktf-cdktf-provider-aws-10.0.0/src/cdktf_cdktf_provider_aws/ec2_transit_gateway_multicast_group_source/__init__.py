...
class Ec2TransitGatewayMulticastGroupSource(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayMulticastGroupSource.__init__)
    ...
    def group_ip_address(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastGroupSource, "group_ip_address").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastGroupSource, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def network_interface_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastGroupSource, "network_interface_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_gateway_multicast_domain_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayMulticastGroupSource, "transit_gateway_multicast_domain_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2TransitGatewayMulticastGroupSourceConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayMulticastGroupSourceConfig.__init__)
