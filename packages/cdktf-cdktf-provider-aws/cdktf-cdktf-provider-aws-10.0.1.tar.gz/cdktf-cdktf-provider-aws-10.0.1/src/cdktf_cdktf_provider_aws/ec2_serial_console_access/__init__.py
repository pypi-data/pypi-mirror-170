...
Refer to the Terraform Registory for docs: [`aws_ec2_serial_console_access`](https://www.terraform.io/docs/providers/aws/r/ec2_serial_console_access).
'''
import abc
import builtins
import datetime
...
class Ec2SerialConsoleAccess(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2SerialConsoleAccess.__init__)
    ...
    def enabled(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2SerialConsoleAccess, "enabled").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2SerialConsoleAccess, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2SerialConsoleAccessConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2SerialConsoleAccessConfig.__init__)
