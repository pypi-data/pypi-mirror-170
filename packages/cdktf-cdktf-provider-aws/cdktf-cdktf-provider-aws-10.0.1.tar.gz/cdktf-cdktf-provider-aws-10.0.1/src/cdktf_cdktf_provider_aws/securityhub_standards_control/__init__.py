...
class SecurityhubStandardsControl(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SecurityhubStandardsControl.__init__)
    ...
    def control_status(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityhubStandardsControl, "control_status").fset)
    ...
    def disabled_reason(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityhubStandardsControl, "disabled_reason").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityhubStandardsControl, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def standards_control_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SecurityhubStandardsControl, "standards_control_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SecurityhubStandardsControlConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SecurityhubStandardsControlConfig.__init__)
