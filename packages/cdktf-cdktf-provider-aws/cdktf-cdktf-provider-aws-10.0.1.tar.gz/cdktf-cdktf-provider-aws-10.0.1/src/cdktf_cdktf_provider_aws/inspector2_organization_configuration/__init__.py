...
class Inspector2OrganizationConfiguration(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        auto_enable: typing.Union["Inspector2OrganizationConfigurationAutoEnable", typing.Dict[str, typing.Any]],
        id: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional[typing.Union["Inspector2OrganizationConfigurationTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Inspector2OrganizationConfiguration.__init__)
    ...
    def put_auto_enable(
        self,
        *,
        ec2: typing.Union[builtins.bool, cdktf.IResolvable],
        ecr: typing.Union[builtins.bool, cdktf.IResolvable],
    ) -> None:
        '''
    ...
    def max_account_limit_reached(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "maxAccountLimitReached"))
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["Inspector2OrganizationConfigurationTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["Inspector2OrganizationConfigurationTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Inspector2OrganizationConfiguration, "id").fset)
...
class Inspector2OrganizationConfigurationAutoEnable:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Inspector2OrganizationConfigurationAutoEnable.__init__)
    ...
    @builtins.property
    def ec2(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
    ...
    @builtins.property
    def ecr(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
...
class Inspector2OrganizationConfigurationAutoEnableOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Inspector2OrganizationConfigurationAutoEnableOutputReference.__init__)
    ...
    def ec2_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "ec2Input"))
    ...
    def ecr_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "ecrInput"))

    @builtins.property
    @jsii.member(jsii_name="ec2")
    def ec2(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "ec2"))

    @ec2.setter
    def ec2(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Inspector2OrganizationConfigurationAutoEnableOutputReference, "ec2").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ecr(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "ecr"))

    @ecr.setter
    def ecr(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Inspector2OrganizationConfigurationAutoEnableOutputReference, "ecr").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Inspector2OrganizationConfigurationAutoEnableOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Inspector2OrganizationConfigurationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Inspector2OrganizationConfigurationConfig.__init__)
...
class Inspector2OrganizationConfigurationTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Inspector2OrganizationConfigurationTimeouts.__init__)
...
class Inspector2OrganizationConfigurationTimeoutsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Inspector2OrganizationConfigurationTimeoutsOutputReference.__init__)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def create(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Inspector2OrganizationConfigurationTimeoutsOutputReference, "create").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def delete(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Inspector2OrganizationConfigurationTimeoutsOutputReference, "delete").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def update(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Inspector2OrganizationConfigurationTimeoutsOutputReference, "update").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[Inspector2OrganizationConfigurationTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[Inspector2OrganizationConfigurationTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Inspector2OrganizationConfigurationTimeoutsOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
