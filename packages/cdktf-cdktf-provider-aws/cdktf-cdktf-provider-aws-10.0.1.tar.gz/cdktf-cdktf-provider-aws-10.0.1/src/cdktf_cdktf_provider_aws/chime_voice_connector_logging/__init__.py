...
class ChimeVoiceConnectorLogging(
    ...
    def __init__(
        ...
        *,
        ...
        enable_media_metric_logs: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorLogging.__init__)
    ...
    def enable_media_metric_logs_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "enableMediaMetricLogsInput"))
    ...
    def enable_media_metric_logs(
        ...
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "enableMediaMetricLogs"))
    ...
    def enable_media_metric_logs(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorLogging, "enable_media_metric_logs").fset)
    ...
    def enable_sip_logs(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorLogging, "enable_sip_logs").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorLogging, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def voice_connector_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ChimeVoiceConnectorLogging, "voice_connector_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ChimeVoiceConnectorLoggingConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ChimeVoiceConnectorLoggingConfig.__init__)
