...
class EbsDefaultKmsKey(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EbsDefaultKmsKey.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EbsDefaultKmsKey, "id").fset)
    ...
    def key_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EbsDefaultKmsKey, "key_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class EbsDefaultKmsKeyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EbsDefaultKmsKeyConfig.__init__)
