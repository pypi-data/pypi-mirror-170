...
class Ec2TransitGatewayVpcAttachmentAccepter(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayVpcAttachmentAccepter.__init__)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayVpcAttachmentAccepter, "id").fset)
    ...
    def tags(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayVpcAttachmentAccepter, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags_all(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayVpcAttachmentAccepter, "tags_all").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_gateway_attachment_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayVpcAttachmentAccepter, "transit_gateway_attachment_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_gateway_default_route_table_association(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayVpcAttachmentAccepter, "transit_gateway_default_route_table_association").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_gateway_default_route_table_propagation(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2TransitGatewayVpcAttachmentAccepter, "transit_gateway_default_route_table_propagation").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2TransitGatewayVpcAttachmentAccepterConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2TransitGatewayVpcAttachmentAccepterConfig.__init__)
