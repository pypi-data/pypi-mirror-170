...
class MacieMemberAccountAssociation(
    ...
    jsii_type="@cdktf/provider-aws.macieMemberAccountAssociation.MacieMemberAccountAssociation",
):
...
@jsii.data_type(
    jsii_type="@cdktf/provider-aws.macieMemberAccountAssociation.MacieMemberAccountAssociationConfig",
