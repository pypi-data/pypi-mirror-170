...
class EfsBackupPolicy(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        backup_policy: typing.Union["EfsBackupPolicyBackupPolicy", typing.Dict[str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EfsBackupPolicy.__init__)
    ...
    def file_system_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EfsBackupPolicy, "file_system_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EfsBackupPolicy, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class EfsBackupPolicyBackupPolicy:
    def __init__(self, *, status: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EfsBackupPolicyBackupPolicy.__init__)
...
class EfsBackupPolicyBackupPolicyOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EfsBackupPolicyBackupPolicyOutputReference.__init__)
    ...
    def status(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EfsBackupPolicyBackupPolicyOutputReference, "status").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EfsBackupPolicyBackupPolicyOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class EfsBackupPolicyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EfsBackupPolicyConfig.__init__)
