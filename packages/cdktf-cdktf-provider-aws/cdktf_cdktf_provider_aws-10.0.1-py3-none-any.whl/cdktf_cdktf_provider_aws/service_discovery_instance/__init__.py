...
Refer to the Terraform Registory for docs: [`aws_service_discovery_instance`](https://www.terraform.io/docs/providers/aws/r/service_discovery_instance).
'''
import abc
import builtins
import datetime
...
class ServiceDiscoveryInstance(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServiceDiscoveryInstance.__init__)
    ...
    def attributes(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ServiceDiscoveryInstance, "attributes").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ServiceDiscoveryInstance, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def instance_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ServiceDiscoveryInstance, "instance_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def service_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ServiceDiscoveryInstance, "service_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ServiceDiscoveryInstanceConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ServiceDiscoveryInstanceConfig.__init__)
