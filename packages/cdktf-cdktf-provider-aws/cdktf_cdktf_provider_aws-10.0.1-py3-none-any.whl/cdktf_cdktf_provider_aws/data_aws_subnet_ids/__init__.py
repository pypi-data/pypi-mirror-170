...
class DataAwsSubnetIds(
    ...
    jsii_type="@cdktf/provider-aws.dataAwsSubnetIds.DataAwsSubnetIds",
):
...
@jsii.data_type(
    jsii_type="@cdktf/provider-aws.dataAwsSubnetIds.DataAwsSubnetIdsConfig",
...
@jsii.data_type(
    jsii_type="@cdktf/provider-aws.dataAwsSubnetIds.DataAwsSubnetIdsFilter",
    jsii_struct_bases=[],
...
class DataAwsSubnetIdsFilterList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-aws.dataAwsSubnetIds.DataAwsSubnetIdsFilterList",
):
    def __init__(
        self,
...
class DataAwsSubnetIdsFilterOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-aws.dataAwsSubnetIds.DataAwsSubnetIdsFilterOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@cdktf/provider-aws.dataAwsSubnetIds.DataAwsSubnetIdsTimeouts",
    jsii_struct_bases=[],
...
class DataAwsSubnetIdsTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-aws.dataAwsSubnetIds.DataAwsSubnetIdsTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
