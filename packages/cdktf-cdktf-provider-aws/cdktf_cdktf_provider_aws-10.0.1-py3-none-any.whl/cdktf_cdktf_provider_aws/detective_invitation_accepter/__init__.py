...
class DetectiveInvitationAccepter(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DetectiveInvitationAccepter.__init__)
    ...
    def graph_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DetectiveInvitationAccepter, "graph_arn").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DetectiveInvitationAccepter, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DetectiveInvitationAccepterConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DetectiveInvitationAccepterConfig.__init__)
