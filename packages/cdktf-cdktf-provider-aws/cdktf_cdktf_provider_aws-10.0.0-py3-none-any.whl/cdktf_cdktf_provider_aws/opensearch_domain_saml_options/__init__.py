...
class OpensearchDomainSamlOptions(
    ...
    def __init__(
        ...
        *,
        ...
        saml_options: typing.Optional[typing.Union["OpensearchDomainSamlOptionsSamlOptions", typing.Dict[str, typing.Any]]] = None,
        timeouts: typing.Optional[typing.Union["OpensearchDomainSamlOptionsTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpensearchDomainSamlOptions.__init__)
    ...
    def put_saml_options(
        ...
        *,
        ...
        idp: typing.Optional[typing.Union["OpensearchDomainSamlOptionsSamlOptionsIdp", typing.Dict[str, typing.Any]]] = None,
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["OpensearchDomainSamlOptionsTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["OpensearchDomainSamlOptionsTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
    ...
    def domain_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptions, "domain_name").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptions, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class OpensearchDomainSamlOptionsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(OpensearchDomainSamlOptionsConfig.__init__)
...
class OpensearchDomainSamlOptionsSamlOptions:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(OpensearchDomainSamlOptionsSamlOptions.__init__)
...
class OpensearchDomainSamlOptionsSamlOptionsIdp:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpensearchDomainSamlOptionsSamlOptionsIdp.__init__)
...
class OpensearchDomainSamlOptionsSamlOptionsIdpOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpensearchDomainSamlOptionsSamlOptionsIdpOutputReference.__init__)
    ...
    def entity_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsIdpOutputReference, "entity_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def metadata_content(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsIdpOutputReference, "metadata_content").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsIdpOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class OpensearchDomainSamlOptionsSamlOptionsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpensearchDomainSamlOptionsSamlOptionsOutputReference.__init__)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def enabled(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsOutputReference, "enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def master_backend_role(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsOutputReference, "master_backend_role").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def master_user_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsOutputReference, "master_user_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def roles_key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsOutputReference, "roles_key").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def session_timeout_minutes(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsOutputReference, "session_timeout_minutes").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def subject_key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsOutputReference, "subject_key").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsSamlOptionsOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class OpensearchDomainSamlOptionsTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpensearchDomainSamlOptionsTimeouts.__init__)
...
class OpensearchDomainSamlOptionsTimeoutsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpensearchDomainSamlOptionsTimeoutsOutputReference.__init__)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def delete(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsTimeoutsOutputReference, "delete").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def update(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsTimeoutsOutputReference, "update").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[OpensearchDomainSamlOptionsTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[OpensearchDomainSamlOptionsTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(OpensearchDomainSamlOptionsTimeoutsOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
