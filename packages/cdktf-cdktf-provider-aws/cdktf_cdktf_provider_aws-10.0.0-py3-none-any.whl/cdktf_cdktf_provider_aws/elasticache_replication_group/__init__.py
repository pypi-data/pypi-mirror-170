...
@jsii.data_type(
    jsii_type="@cdktf/provider-aws.elasticacheReplicationGroup.ElasticacheReplicationGroupClusterMode",
    jsii_struct_bases=[],
    name_mapping={
...
class ElasticacheReplicationGroupClusterModeOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-aws.elasticacheReplicationGroup.ElasticacheReplicationGroupClusterModeOutputReference",
):
    def __init__(
        self,
