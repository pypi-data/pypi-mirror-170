...
class Ec2AvailabilityZoneGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Ec2AvailabilityZoneGroup.__init__)
    ...
    def group_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2AvailabilityZoneGroup, "group_name").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2AvailabilityZoneGroup, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def opt_in_status(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Ec2AvailabilityZoneGroup, "opt_in_status").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Ec2AvailabilityZoneGroupConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(Ec2AvailabilityZoneGroupConfig.__init__)
