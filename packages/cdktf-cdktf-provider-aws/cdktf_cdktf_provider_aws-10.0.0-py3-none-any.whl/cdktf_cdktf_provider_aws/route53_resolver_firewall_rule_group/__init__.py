...
Refer to the Terraform Registory for docs: [`aws_route53_resolver_firewall_rule_group`](https://www.terraform.io/docs/providers/aws/r/route53_resolver_firewall_rule_group).
'''
import abc
import builtins
import datetime
