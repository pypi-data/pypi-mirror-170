...
class LocationMap(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        configuration: typing.Union["LocationMapConfiguration", typing.Dict[str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LocationMap.__init__)
    ...
    def description(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LocationMap, "description").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LocationMap, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def map_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LocationMap, "map_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LocationMap, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags_all(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LocationMap, "tags_all").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class LocationMapConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(LocationMapConfig.__init__)
...
class LocationMapConfiguration:
    def __init__(self, *, style: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LocationMapConfiguration.__init__)
...
class LocationMapConfigurationOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LocationMapConfigurationOutputReference.__init__)
    ...
    def style(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LocationMapConfigurationOutputReference, "style").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(self, value: typing.Optional[LocationMapConfiguration]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LocationMapConfigurationOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
