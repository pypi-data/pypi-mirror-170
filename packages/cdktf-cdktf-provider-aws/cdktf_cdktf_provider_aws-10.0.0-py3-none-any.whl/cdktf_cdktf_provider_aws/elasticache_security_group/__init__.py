...
class ElasticacheSecurityGroup(
    ...
    jsii_type="@cdktf/provider-aws.elasticacheSecurityGroup.ElasticacheSecurityGroup",
):
...
@jsii.data_type(
    jsii_type="@cdktf/provider-aws.elasticacheSecurityGroup.ElasticacheSecurityGroupConfig",
