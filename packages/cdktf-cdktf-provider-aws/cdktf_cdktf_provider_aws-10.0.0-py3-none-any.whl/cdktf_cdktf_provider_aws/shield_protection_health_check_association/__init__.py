...
class ShieldProtectionHealthCheckAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ShieldProtectionHealthCheckAssociation.__init__)
    ...
    def health_check_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ShieldProtectionHealthCheckAssociation, "health_check_arn").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ShieldProtectionHealthCheckAssociation, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def shield_protection_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ShieldProtectionHealthCheckAssociation, "shield_protection_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ShieldProtectionHealthCheckAssociationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ShieldProtectionHealthCheckAssociationConfig.__init__)
