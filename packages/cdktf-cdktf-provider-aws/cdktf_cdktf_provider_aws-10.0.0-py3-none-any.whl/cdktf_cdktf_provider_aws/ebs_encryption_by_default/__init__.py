...
class EbsEncryptionByDefault(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EbsEncryptionByDefault.__init__)
    ...
    def enabled(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EbsEncryptionByDefault, "enabled").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EbsEncryptionByDefault, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class EbsEncryptionByDefaultConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EbsEncryptionByDefaultConfig.__init__)
