...
Refer to the Terraform Registory for docs: [`data_aws_location_route_calculator`](https://www.terraform.io/docs/providers/aws/d/location_route_calculator).
'''
import abc
import builtins
import datetime
...
class DataAwsLocationRouteCalculator(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataAwsLocationRouteCalculator.__init__)
    ...
    def calculator_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataAwsLocationRouteCalculator, "calculator_name").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataAwsLocationRouteCalculator, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataAwsLocationRouteCalculator, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataAwsLocationRouteCalculatorConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DataAwsLocationRouteCalculatorConfig.__init__)
