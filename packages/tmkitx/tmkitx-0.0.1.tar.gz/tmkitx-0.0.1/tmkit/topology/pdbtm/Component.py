                ...
                if chains.tag == '{http://pdbtm.enzim.hu}CHAIN':
                    for regions in chains.iter('{http://pdbtm.enzim.hu}REGION'):
                        if type == 'side1':
                            ...
                            if chains.get('CHAINID') == kwargs['seq_chain'] and regions.get('type') == 'B':
                                start_id.append(int(regions.get('pdb_beg')))
                                last_id.append(int(regions.get('pdb_end')))
                        elif type == 'coil':
                            if chains.get('CHAINID') == kwargs['seq_chain'] and regions.get('type') == 'C':
                                start_id.append(int(regions.get('pdb_beg')))
                                last_id.append(int(regions.get('pdb_end')))
                        elif type == 'membrane-inside':
                            if chains.get('CHAINID') == kwargs['seq_chain'] and regions.get('type') == 'I':
                                start_id.append(int(regions.get('pdb_beg')))
                                last_id.append(int(regions.get('pdb_end')))
                        elif type == 'membrane-loop':
                            if chains.get('CHAINID') == kwargs['seq_chain'] and regions.get('type') == 'L':
                                start_id.append(int(regions.get('pdb_beg')))
                                last_id.append(int(regions.get('pdb_end')))
                        elif type == 'interfacial-helix':
                            if chains.get('CHAINID') == kwargs['seq_chain'] and regions.get('type') == 'F':
                                start_id.append(int(regions.get('pdb_beg')))
                                last_id.append(int(regions.get('pdb_end')))
                        elif type == 'unknown':
                            if chains.get('CHAINID') == kwargs['seq_chain'] and regions.get('type') == 'U':
                                start_id.append(int(regions.get('pdb_beg')))
                                last_id.append(int(regions.get('pdb_end')))
                        else:
