...
class PoseDetector:
    """
    Detects Pose using Mediapipe Pose detection
    """
    ...
    def findPose(self, img, draw=True):
        ...
        :param draw: If True Draws on Image
    ...
    def findPosition(self, img, draw=True, bboxWithHands=False):
        """
        locates the position of the body
        """
        self.lmList = []
        self.bboxInfo = {}
        if self.results.pose_landmarks:
    ...
    def findAngle(self, img, p1, p2, p3, draw=True):
        ...
        x2, y2 = self.lmList[p2][1:-1]
        x3, y3 = self.lmList[p3][1:-1]
