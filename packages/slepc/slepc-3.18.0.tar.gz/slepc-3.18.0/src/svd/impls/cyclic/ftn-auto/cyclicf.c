...
extern "C" {
#endif
SLEPC_EXTERN void  svdcyclicsetexplicitmatrix_(SVD svd,PetscBool *explicitmat, int *__ierr)
{
*__ierr = SVDCyclicSetExplicitMatrix(
	(SVD)PetscToPointer((svd) ),*explicitmat);
}
SLEPC_EXTERN void  svdcyclicgetexplicitmatrix_(SVD svd,PetscBool *explicitmat, int *__ierr)
{
