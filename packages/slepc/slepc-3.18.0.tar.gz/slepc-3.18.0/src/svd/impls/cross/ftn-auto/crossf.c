...
extern "C" {
#endif
SLEPC_EXTERN void  svdcrosssetexplicitmatrix_(SVD svd,PetscBool *explicitmat, int *__ierr)
{
*__ierr = SVDCrossSetExplicitMatrix(
	(SVD)PetscToPointer((svd) ),*explicitmat);
}
SLEPC_EXTERN void  svdcrossgetexplicitmatrix_(SVD svd,PetscBool *explicitmat, int *__ierr)
{
