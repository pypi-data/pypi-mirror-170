...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AdministrationAuditLogApi()
        api_instance.generate_audit_log  # this is an instance of the class Endpoint
        api_instance.generate_audit_log()  # this invokes api_instance.generate_audit_log.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.generate_audit_log.callable or self.callable in this class
