# openapi_client.MonitoringBridgeMacApi

All URIs are relative to */dataservice*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_aggregation_data_by_query6**](MonitoringBridgeMacApi.md#get_aggregation_data_by_query6) | **GET** /statistics/bridgemac/aggregation | 
[**get_count8**](MonitoringBridgeMacApi.md#get_count8) | **GET** /statistics/bridgemac/doccount | 
[**get_count_post8**](MonitoringBridgeMacApi.md#get_count_post8) | **POST** /statistics/bridgemac/doccount | 
[**get_post_aggregation_app_data_by_query6**](MonitoringBridgeMacApi.md#get_post_aggregation_app_data_by_query6) | **POST** /statistics/bridgemac/app-agg/aggregation | 
[**get_post_aggregation_data_by_query6**](MonitoringBridgeMacApi.md#get_post_aggregation_data_by_query6) | **POST** /statistics/bridgemac/aggregation | 
[**get_post_stat_bulk_raw_data6**](MonitoringBridgeMacApi.md#get_post_stat_bulk_raw_data6) | **POST** /statistics/bridgemac/page | 
[**get_stat_bulk_raw_data6**](MonitoringBridgeMacApi.md#get_stat_bulk_raw_data6) | **GET** /statistics/bridgemac/page | 
[**get_stat_data_fields8**](MonitoringBridgeMacApi.md#get_stat_data_fields8) | **GET** /statistics/bridgemac/fields | 
[**get_stat_data_raw_data6**](MonitoringBridgeMacApi.md#get_stat_data_raw_data6) | **GET** /statistics/bridgemac | 
[**get_stat_data_raw_data_as_csv6**](MonitoringBridgeMacApi.md#get_stat_data_raw_data_as_csv6) | **GET** /statistics/bridgemac/csv | 
[**get_stat_query_fields8**](MonitoringBridgeMacApi.md#get_stat_query_fields8) | **GET** /statistics/bridgemac/query/fields | 
[**get_stats_raw_data6**](MonitoringBridgeMacApi.md#get_stats_raw_data6) | **POST** /statistics/bridgemac | 
...
from openapi_client.api import monitoring_bridge_mac_api
...
with openapi_client.ApiClient() as api_client:
    ...
    api_instance = monitoring_bridge_mac_api.MonitoringBridgeMacApi(api_client)
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_aggregation_data_by_query6: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_count8: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_count_post8: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_post_aggregation_app_data_by_query6: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_post_aggregation_data_by_query6: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_post_stat_bulk_raw_data6: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_stat_bulk_raw_data6: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_stat_data_fields8: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_stat_data_raw_data6: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_stat_data_raw_data_as_csv6: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_stat_query_fields8: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling MonitoringBridgeMacApi->get_stats_raw_data6: %s\n" % e)
```
