...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/1.0.31/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.dataservice_client_token_get  # this is an instance of the class Endpoint
        api_instance.dataservice_client_token_get()  # this invokes api_instance.dataservice_client_token_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.dataservice_client_token_get.callable or self.callable in this class
