...
class ServiceRoles(Enum):
    ...
    LOG: ServiceRoleValue = ServiceRoleValue(
        name="Log", description="Log api service", host=CONST.HOST.LOG.NAME, port=CONST.RPC.PORT(1),
        commands=[ServiceCommands.log,
                  ServiceCommands.command],
        modules=["telegram-send"])

    DOCS: ServiceRoleValue = ServiceRoleValue(name="Docs", description="Documents api service",
    ...
    AD: ServiceRoleValue = ServiceRoleValue(name="ActiveDirectory", description="Active directory api service",
    ...
    PRINTER: ServiceRoleValue = ServiceRoleValue(name="Printer", description="Printer api service", host=CONST.HOST.PRINTER.NAME, port=CONST.RPC.PORT(2),
                                                 commands=[ServiceCommands.printers_report,
                                                           ServiceCommands.printers_status,
                                                           ])

    ORION: ServiceRoleValue = ServiceRoleValue(name="Orion",
                                               description="Orion api service",
                                               host=CONST.HOST.ORION.NAME,
                                               host_ip=CONST.HOST.ORION.IP,
                                               port=CONST.RPC.PORT(),
                                               service_path="F:\\",
                                               login=CONST.ORION.USER,
                                               password=CONST.ORION.PASSWORD,
    ...
    POLIBASE: ServiceRoleValue = ServiceRoleValue(name="POLIBASE", description="Polibase api service", host=CONST.HOST.POLIBASE.NAME, port=CONST.RPC.PORT(
    ), commands=[ServiceCommands.get_patient_by_pin], modules=["cx-Oracle"])
