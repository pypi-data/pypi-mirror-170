import { S as SvelteComponent, i as init, s as safe_not_equal, v as svg_element, b as attr, f as insert, g as append, w as noop, n as detach, e as element, a as space, t as text, c as create_component, L as src_url_equal, aa as add_render_callback, d as toggle_class, Y as set_style, m as mount_component, l as listen, y as prevent_default, W as stop_propagation, C as group_outros, k as transition_out, D as check_outros, j as transition_in, h as set_data, o as destroy_component, z as run_all, al as globals, am as raf, a6 as tick, J as bubble, H as binding_callbacks, A as empty, E as createEventDispatcher, N as bind, K as add_flush_callback, O as component_subscribe, X, P as assign, Q as StatusTracker, R as get_spread_update, T as get_spread_object } from './index.4e854d0e.js';
...
import { U as Undo, W as Webcam } from './Webcam.15f3892e.js';
...
function create_if_block_3(ctx) {
	...
	player.$on("play", /*play_handler*/ ctx[15]);
	player.$on("pause", /*pause_handler*/ ctx[16]);
	player.$on("ended", /*ended_handler*/ ctx[17]);
...
function create_if_block_2(ctx) {
	...
	webcam.$on("error", /*error_handler*/ ctx[13]);
	webcam.$on("capture", /*capture_handler*/ ctx[14]);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*$$scope, upload_text, or_text, drop_text*/ 262368) {
...
function create_else_block(ctx) {
	...
	video.$on("error", /*error_handler*/ ctx[16]);
	video.$on("change", /*change_handler*/ ctx[17]);
	video.$on("clear", /*clear_handler*/ ctx[18]);
	video.$on("play", /*play_handler*/ ctx[19]);
	video.$on("pause", /*pause_handler*/ ctx[20]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*label*/ 16) video_changes.label = /*label*/ ctx[4];
			if (dirty & /*show_label*/ 64) video_changes.show_label = /*show_label*/ ctx[6];
			if (dirty & /*source*/ 32) video_changes.source = /*source*/ ctx[5];
...
// (22:0) <Block  {visible}  variant={mode === "dynamic" && value === null && source === "upload"   ? "dashed"   : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id}  style={{ height: style.height, width: style.width }} >
...
function create_fragment(ctx) {
	...
	block = new Block({
			props: {
				...
				variant: /*mode*/ ctx[9] === "dynamic" && /*value*/ ctx[0] === null && /*source*/ ctx[5] === "upload"
				? "dashed"
				: "solid",
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*mode, value, source*/ 545) block_changes.variant = /*mode*/ ctx[9] === "dynamic" && /*value*/ ctx[0] === null && /*source*/ ctx[5] === "upload"
			? "dashed"
			: "solid";
			...
			if (dirty & /*$$scope, _value, label, show_label, mode, source, $_, mirror_webcam, value, dragging, loading_status*/ 2105203) {
