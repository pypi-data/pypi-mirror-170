import { S as SvelteComponent, i as init, s as safe_not_equal, c as create_component, a as space, A as empty, m as mount_component, f as insert, C as group_outros, k as transition_out, D as check_outros, j as transition_in, o as destroy_component, n as detach, e as element, b as attr, g as append, w as noop, t as text, h as set_data, B as destroy_each, E as createEventDispatcher, a6 as tick, H as binding_callbacks, N as bind, K as add_flush_callback, O as component_subscribe, X, P as assign, Q as StatusTracker, R as get_spread_update, T as get_spread_object, J as bubble } from './index.17b0663f.js';
import { B as BlockLabel } from './BlockLabel.90b95396.js';
import { F as File } from './File.988d6141.js';
import { U as Upload } from './Upload.f2b8d82b.js';
import { M as ModifyUpload } from './ModifyUpload.04c84df5.js';
import { B as Block } from './Block.3a24a31e.js';
import { n as normalise_file } from './utils.27234e1d.js';
...
function create_else_block$2(ctx) {
	...
	return {
		c() {
			...
			attr(a, "download", a_download_value = display_file_name(/*value*/ ctx[0]));
		...
		p(ctx, dirty) {
			...
			if (dirty & /*value*/ 1 && a_download_value !== (a_download_value = display_file_name(/*value*/ ctx[0]))) {
...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*download_files, value, display_file_name, display_file_size*/ 1) {
...
function create_each_block$1(ctx) {
	...
	return {
		c() {
			...
			attr(a, "download", a_download_value = display_file_name(/*file*/ ctx[4]));
			attr(a, "class", "text-indigo-600 hover:underline dark:text-indigo-300");
			attr(div2, "class", "file-size w-3/12 p-2 hover:underline");
		...
		p(ctx, dirty) {
			...
			if (dirty & /*value*/ 1 && a_download_value !== (a_download_value = display_file_name(/*file*/ ctx[4]))) {
				attr(a, "download", a_download_value);
			}
		},
		d(detaching) {
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			attr(a, "download", a_download_value = display_file_name(/*file*/ ctx[13]));
			attr(a, "class", "text-indigo-600 hover:underline dark:text-indigo-300");
			attr(div2, "class", "file-size w-3/12 p-2 hover:underline");
			attr(div3, "class", "flex flex-row w-full justify-between");
		},
		...
		p(ctx, dirty) {
			...
			if (dirty & /*value*/ 1 && a_download_value !== (a_download_value = display_file_name(/*file*/ ctx[13]))) {
				attr(a, "download", a_download_value);
			}
		},
		d(detaching) {
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const file_changes = {};
			if (dirty & /*_value*/ 256) file_changes.value = /*_value*/ ctx[8];
			if (dirty & /*label*/ 16) file_changes.label = /*label*/ ctx[4];
			if (dirty & /*show_label*/ 32) file_changes.show_label = /*show_label*/ ctx[5];
			if (dirty & /*file_count*/ 64) file_changes.file_count = /*file_count*/ ctx[6];
...
function create_if_block(ctx) {
	...
	fileupload = new FileUpload({
			props: {
				...
				value: /*_value*/ ctx[8],
				file_count: /*file_count*/ ctx[6],
				drop_text: /*$_*/ ctx[10]("interface.drop_file"),
				or_text: /*$_*/ ctx[10]("or"),
				upload_text: /*$_*/ ctx[10]("interface.click_to_upload")
			}
		});

	fileupload.$on("change", /*change_handler_1*/ ctx[12]);
	fileupload.$on("drag", /*drag_handler*/ ctx[13]);
	fileupload.$on("change", /*change_handler*/ ctx[14]);
	fileupload.$on("clear", /*clear_handler*/ ctx[15]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*_value*/ 256) fileupload_changes.value = /*_value*/ ctx[8];
			if (dirty & /*file_count*/ 64) fileupload_changes.file_count = /*file_count*/ ctx[6];
			if (dirty & /*$_*/ 1024) fileupload_changes.drop_text = /*$_*/ ctx[10]("interface.drop_file");
			if (dirty & /*$_*/ 1024) fileupload_changes.or_text = /*$_*/ ctx[10]("or");
			if (dirty & /*$_*/ 1024) fileupload_changes.upload_text = /*$_*/ ctx[10]("interface.click_to_upload");
...
// (20:0) <Block  {visible}  variant={mode === "dynamic" && value === null ? "dashed" : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id} >
...
function create_fragment(ctx) {
	...
	block = new Block({
			props: {
				...
				? "dashed"
				: "solid",
				color: /*dragging*/ ctx[9] ? "green" : "grey",
				padding: false,
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*dragging*/ 512) block_changes.color = /*dragging*/ ctx[9] ? "green" : "grey";
			if (dirty & /*elem_id*/ 2) block_changes.elem_id = /*elem_id*/ ctx[1];

			if (dirty & /*$$scope, label, show_label, _value, file_count, $_, value, dragging, mode, loading_status*/ 67577) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const drag_handler = ({ detail }) => $$invalidate(9, dragging = detail);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*value, root*/ 2049) {
			$$invalidate(8, _value = normalise_file(value, root));
		}
	};
