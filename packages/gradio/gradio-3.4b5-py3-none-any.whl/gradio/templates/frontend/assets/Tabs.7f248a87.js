import { S as SvelteComponent, i as init, s as safe_not_equal, A as empty, f as insert, n as detach, p as create_slot, e as element, a as space, b as attr, d as toggle_class, g as append, a7 as update_keyed_each, u as update_slot_base, q as get_all_dirty_from_scope, r as get_slot_changes, j as transition_in, k as transition_out, O as component_subscribe, E as createEventDispatcher, Z as setContext, ak as destroy_block, $ as writable, _ as set_store_value, t as text, l as listen, h as set_data } from './index.17b0663f.js';
...
function create_else_block(ctx) {
	...
	function click_handler() {
		return /*click_handler*/ ctx[9](/*t*/ ctx[11]);
	}
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*tabs*/ 4 && t0_value !== (t0_value = /*t*/ ctx[11].name + "")) set_data(t0, t0_value);
		},
		d(detaching) {
...
// (35:2) {#each tabs as t (t.id)}
function create_each_block(key_1, ctx) {
	let first;
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (/*t*/ ctx[11].id === /*$selected_tab*/ ctx[3]) return create_if_block;
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			toggle_class(div1, "hidden", !/*visible*/ ctx[0]);
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*tabs, $selected_tab, change_tab*/ 44) {
