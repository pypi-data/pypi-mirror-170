import { S as SvelteComponent, i as init, s as safe_not_equal, e as element, b as attr, d as toggle_class, f as insert, a3 as set_input_value, l as listen, n as detach, z as run_all, a as space, w as noop, J as bubble, H as binding_callbacks, t as text, h as set_data, A as empty, a5 as HtmlTag, g as append, N as bind, c as create_component, m as mount_component, K as add_flush_callback, j as transition_in, k as transition_out, o as destroy_component, E as createEventDispatcher, a6 as tick, v as svg_element, C as group_outros, a7 as update_keyed_each, a8 as outro_and_destroy_block, D as check_outros, P as assign, Q as StatusTracker, R as get_spread_update, T as get_spread_object } from './index.4e854d0e.js';
import { U as Upload } from './Upload.08826d95.js';
...
// (443:6) {#each _headers as { value, id }
function create_each_block_2(key_1, ctx) {
	...
	function editablecell_el_binding(value) {
		/*editablecell_el_binding*/ ctx[30](value, /*id*/ ctx[56]);
	}

	function dblclick_handler() {
		return /*dblclick_handler*/ ctx[31](/*id*/ ctx[56]);
	}

	let editablecell_props = {
		value: /*value*/ ctx[55],
		edit: /*header_edit*/ ctx[13] === /*id*/ ctx[56],
		header: true
	};

	if (/*els*/ ctx[10][/*id*/ ctx[56]].input !== void 0) {
		editablecell_props.el = /*els*/ ctx[10][/*id*/ ctx[56]].input;
	}
	...
	function click_handler() {
		return /*click_handler*/ ctx[32](/*i*/ ctx[54]);
	}

	const assign_th = () => /*th_binding*/ ctx[33](th, id);
	const unassign_th = () => /*th_binding*/ ctx[33](null, id);
	...
	return {
		...
		c() {
			...
			attr(div0, "class", div0_class_value = "flex flex-none items-center justify-center p-2 cursor-pointer leading-snug transform transition-all " + (/*sort_by*/ ctx[12] !== /*i*/ ctx[54]
			? 'text-gray-200 hover:text-gray-500'
			: 'text-orange-500') + " " + (/*sort_by*/ ctx[12] === /*i*/ ctx[54] && /*sort_direction*/ ctx[11] === 'des'
			? '-scale-y-[1]'
			: ''));

			toggle_class(div0, "text-gray-200", /*sort_by*/ ctx[12] !== /*i*/ ctx[54]);
			...
			attr(th, "aria-sort", th_aria_sort_value = /*get_sort_status*/ ctx[15](/*value*/ ctx[55], /*sort_by*/ ctx[12], /*sort_direction*/ ctx[11]));
			toggle_class(th, "bg-orange-50", /*header_edit*/ ctx[13] === /*id*/ ctx[56]);
			toggle_class(th, "dark:bg-transparent", /*header_edit*/ ctx[13] === /*id*/ ctx[56]);
			toggle_class(th, "rounded-tl-lg", /*i*/ ctx[54] === 0);
			toggle_class(th, "rounded-tr-lg", /*i*/ ctx[54] === /*_headers*/ ctx[8].length - 1);
			this.first = th;
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*_headers*/ 256) editablecell_changes.value = /*value*/ ctx[55];
			if (dirty[0] & /*header_edit, _headers*/ 8448) editablecell_changes.edit = /*header_edit*/ ctx[13] === /*id*/ ctx[56];

			if (!updating_el && dirty[0] & /*els, _headers*/ 1280) {
				updating_el = true;
				editablecell_changes.el = /*els*/ ctx[10][/*id*/ ctx[56]].input;
				add_flush_callback(() => updating_el = false);
			}

			editablecell.$set(editablecell_changes);

			if (!current || dirty[0] & /*sort_by, _headers, sort_direction*/ 6400 && div0_class_value !== (div0_class_value = "flex flex-none items-center justify-center p-2 cursor-pointer leading-snug transform transition-all " + (/*sort_by*/ ctx[12] !== /*i*/ ctx[54]
			? 'text-gray-200 hover:text-gray-500'
			: 'text-orange-500') + " " + (/*sort_by*/ ctx[12] === /*i*/ ctx[54] && /*sort_direction*/ ctx[11] === 'des'
			? '-scale-y-[1]'
			: ''))) {
			...
			if (!current || dirty[0] & /*_headers, sort_by, sort_direction*/ 6400 && th_aria_sort_value !== (th_aria_sort_value = /*get_sort_status*/ ctx[15](/*value*/ ctx[55], /*sort_by*/ ctx[12], /*sort_direction*/ ctx[11]))) {
			...
			if (dirty[0] & /*header_edit, _headers*/ 8448) {
				toggle_class(th, "bg-orange-50", /*header_edit*/ ctx[13] === /*id*/ ctx[56]);
			}
...
function create_each_block_1(key_1, ctx) {
	...
	function editablecell_value_binding(value) {
		/*editablecell_value_binding*/ ctx[34](value, /*value*/ ctx[55], /*each_value_1*/ ctx[57], /*j*/ ctx[58]);
	}

	function editablecell_el_binding_1(value) {
		/*editablecell_el_binding_1*/ ctx[35](value, /*id*/ ctx[56]);
	}

	let editablecell_props = {
		edit: /*editing*/ ctx[6] === /*id*/ ctx[56],
		datatype: Array.isArray(/*datatype*/ ctx[0])
		? /*datatype*/ ctx[0][/*j*/ ctx[58]]
		: /*datatype*/ ctx[0]
	};
	...
	const assign_td = () => /*td_binding*/ ctx[36](td, id);
	const unassign_td = () => /*td_binding*/ ctx[36](null, id);

	function touchstart_handler() {
		return /*touchstart_handler*/ ctx[37](/*id*/ ctx[56]);
	}

	function click_handler_1() {
		return /*click_handler_1*/ ctx[38](/*id*/ ctx[56]);
	}

	function dblclick_handler_1() {
		return /*dblclick_handler_1*/ ctx[39](/*id*/ ctx[56]);
	}

	function keydown_handler(...args) {
		return /*keydown_handler*/ ctx[40](/*i*/ ctx[54], /*j*/ ctx[58], /*id*/ ctx[56], ...args);
	}
	...
	return {
		...
		c() {
			...
			toggle_class(div, "border-transparent", /*selected*/ ctx[7] !== /*id*/ ctx[56]);
			attr(td, "tabindex", "0");
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const editablecell_changes = {};
			if (dirty[0] & /*editing, data*/ 576) editablecell_changes.edit = /*editing*/ ctx[6] === /*id*/ ctx[56];
...
function create_each_block(key_1, ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*els, data, start_edit, handle_cell_click, handle_keydown, selected, editing, datatype*/ 460481) {
...
// (424:2) <Upload    flex={false}    center={false}    boundedheight={false}    click={false}    on:load={(e) => blob_to_string(data_uri_to_blob(e.detail.data))}    bind:dragging   >
function create_default_slot(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*get_sort_status, _headers, sort_by, sort_direction, els, header_edit, handle_sort, end_header_edit, edit_header*/ 3718400) {
			...
			if (dirty[0] & /*data, els, start_edit, handle_cell_click, handle_keydown, selected, editing, datatype*/ 460481) {
...
function create_if_block_2(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", /*click_handler_2*/ ctx[43]);
				mounted = true;
			}
		},
		p: noop,
...
function create_fragment$1(ctx) {
	...
	function upload_dragging_binding(value) {
		/*upload_dragging_binding*/ ctx[41](value);
	}
	...
	upload.$on("load", /*load_handler*/ ctx[42]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*dragging, data, els, selected, editing, datatype, _headers, sort_by, sort_direction, header_edit, label*/ 32707 | dirty[1] & /*$$scope*/ 536870912) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('headers' in $$props) $$invalidate(26, headers = $$props.headers);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*values, headers*/ 201326592) {
			{
				if (values && !Array.isArray(values)) {
					$$invalidate(26, headers = values.headers);

					$$invalidate(27, values = values.data.length === 0
		...
		if ($$self.$$.dirty[0] & /*headers, old_headers*/ 335544320) {
			{
		...
		if ($$self.$$.dirty[0] & /*values, old_val*/ 671088640) {
...
function create_fragment(ctx) {
	...
	table.$on("change", /*change_handler*/ ctx[12]);
