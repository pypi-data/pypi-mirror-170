import { S as SvelteComponent, i as init, s as safe_not_equal, v as svg_element, b as attr, f as insert, g as append, w as noop, n as detach, e as element, d as toggle_class, l as listen, x as is_function, y as prevent_default, t as text, h as set_data, z as run_all, A as empty, a as space, B as destroy_each, c as create_component, m as mount_component, j as transition_in, k as transition_out, o as destroy_component, C as group_outros, D as check_outros, E as createEventDispatcher, F as spring, G as subscribe, H as binding_callbacks, I as onDestroy, J as bubble, K as add_flush_callback, L as src_url_equal, M as action_destroyer, N as bind, O as component_subscribe, X, P as assign, Q as StatusTracker, R as get_spread_update, T as get_spread_object } from './index.4e854d0e.js';
...
// (201:1) {#if mode === "edit" && player?.duration}
...
// (173:2) <Upload filetype="audio/*" on:load={handle_load} bind:dragging>
...
function create_else_block(ctx) {
	...
	staticaudio = new StaticAudio({
			props: {
				...
				value: /*_value*/ ctx[11],
				name: /*_value*/ ctx[11]?.name || "audio_file",
				label: /*label*/ ctx[7]
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*_value*/ 2048) staticaudio_changes.value = /*_value*/ ctx[11];
			if (dirty & /*_value*/ 2048) staticaudio_changes.name = /*_value*/ ctx[11]?.name || "audio_file";
...
function create_if_block(ctx) {
	...
	audio = new Audio({
			props: {
				...
				drop_text: /*$_*/ ctx[13]("interface.drop_audio"),
				or_text: /*$_*/ ctx[13]("or"),
	...
	audio.$on("error", /*error_handler*/ ctx[24]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*_value*/ 2048) audio_changes.value = /*_value*/ ctx[11];
			...
			if (dirty & /*$_*/ 8192) audio_changes.drop_text = /*$_*/ ctx[13]("interface.drop_audio");
			if (dirty & /*$_*/ 8192) audio_changes.or_text = /*$_*/ ctx[13]("or");
			if (dirty & /*$_*/ 8192) audio_changes.upload_text = /*$_*/ ctx[13]("interface.click_to_upload");
...
// (26:0) <Block  variant={mode === "dynamic" && value === null && source === "upload"   ? "dashed"   : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id}  {visible} >
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, label, show_label, _value, name, source, pending, streaming, $_, value, dragging, loading_status, mode*/ 33570803) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*value, root*/ 65537) {
			$$invalidate(11, _value = normalise_file(value, root));
		}
	};
