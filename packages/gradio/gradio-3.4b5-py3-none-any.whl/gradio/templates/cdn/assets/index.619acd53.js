import { S as SvelteComponent, i as init, s as safe_not_equal, p as create_slot, e as element, b as attr, d as toggle_class, f as insert, l as listen, u as update_slot_base, q as get_all_dirty_from_scope, r as get_slot_changes, j as transition_in, k as transition_out, n as detach, J as bubble, c as create_component, m as mount_component, o as destroy_component, O as component_subscribe, X, t as text, h as set_data } from './index.4e854d0e.js';
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(button, "class", button_class_value = "gr-button gr-button-" + /*size*/ ctx[3] + " gr-button-" + /*variant*/ ctx[2] + " " + /*classes*/ ctx[4]);
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*size, variant, classes*/ 28 && button_class_value !== (button_class_value = "gr-button gr-button-" + /*size*/ ctx[3] + " gr-button-" + /*variant*/ ctx[2] + " " + /*classes*/ ctx[4])) {
