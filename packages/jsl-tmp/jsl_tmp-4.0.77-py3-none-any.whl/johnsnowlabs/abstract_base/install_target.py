...
class JslLibDependencyResolverABC(ABC):
    ...
    has_secret: bool = False  # TODO INTEGRATE
    ...
    @abstractmethod
    def get_all_libs_on_target(cls,
                           install_type: Union[JvmHardwareTarget, PyInstallTypes],
                           spark_version_to_match: Optional[Union[str, LibVersion]],
                           secret: Optional[str] = None,
                           ) -> UrlDependency:
        # pypi_ref, whl_ref, jar_ref
        # # TODO REMOVE THIS HACK AFTER JAR/WHEELS ARE ONLINE!!!
        # if cls.product_name == ProductName.hc:
        #     if install_type in PyInstallTypes:
        #         return UrlDependency(url='https://ckl-it.de/jsl/internal_with_finleg-4.0.0rc1-py3-none-any.whl',
        #                              dependency_type=PyInstallTypes.wheel,
        #                              spark_version=SparkVersion.spark3xx,
        #                              product_name=ProductName.hc,
        #                              file_name=ProductName.hc.name,
        #                              dependency_version=LatestCompatibleProductVersion.spark_nlp.value
        #                              )
        # elif install_type in JvmHardwareTarget:
        #     return UrlDependency(url='https://ckl-it.de/jsl/spark-nlp-jsl-assembly-4.2.0fl1.jar',
    ...
    def get_url_from_compat_map(cls,
        ...
        # if cls.product_name ==ProductName.hc and install_type in JvmHardwareTarget:
        #     # TODO QUICK HACK REMOVE AFTER RELEASE!!!
        #     return UrlDependency(url='https://ckl-it.de/jsl/spark-nlp-jsl-assembly-4.2.0fl1.jar',
        #                          dependency_type=JvmHardwareTarget.cpu,
        #                          spark_version=SparkVersion.spark3xx,
        #                          product_name=ProductName.hc,
        ...
        #                          dependency_version=LatestCompatibleProductVersion.spark_nlp.value
        #                          )
        # Find matching entry in compatible_spark_to_jar_map for spark_version_to_match
