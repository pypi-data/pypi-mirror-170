...
class CertificateManagerCertificateSelfManagedOutputReference(
    ...
    def pem_certificate(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CertificateManagerCertificateSelfManagedOutputReference, "pem_certificate").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def pem_private_key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CertificateManagerCertificateSelfManagedOutputReference, "pem_private_key").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
