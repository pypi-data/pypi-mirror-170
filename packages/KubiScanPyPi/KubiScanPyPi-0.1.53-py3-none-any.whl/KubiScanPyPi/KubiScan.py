...
def print_join_token():
    import os
    from api.api_client import running_in_container
...
def main():
    opt = ArgumentParser(description='KubiScanPyPi.py - script used to get information on risky permissions on Kubernetes', usage="""KubiScanPyPi.py [options...]

This tool can get information about risky roles\clusterroles, rolebindings\clusterrolebindings, users and pods.
Use "KubiScanPyPi.py -h" for help or "KubiScanPyPi.py -e" to see examples.
Requirements:
    - Python 3
