...
from replifactory.status import Status
...
class Experiment:
    ...
    def run(self):
        ...
        if device.is_lagoon_device(): # TODO: add to config
            device.pump1.max_speed_rps = 1
            device.pump2.max_speed_rps = 1
            device.pump4.max_speed_rps = 1
            device.pump1.reset_speeds()
            device.pump2.reset_speeds()
            device.pump4.reset_speeds()
