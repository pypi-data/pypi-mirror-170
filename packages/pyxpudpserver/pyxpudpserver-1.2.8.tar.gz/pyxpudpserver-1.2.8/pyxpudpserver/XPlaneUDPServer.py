	...
	def run(self):
		...
		while self.running:
			...
			try:
				...
				#print(self.XPbeacon)
				if self.XPbeacon['computer_name'] == self.XPComputerName : #and address[0] == self.XPAddress[0]: # it seems the XPlane instance we are trying to communicate with is alive 2/10/22. removed check on address as was coming from router??
