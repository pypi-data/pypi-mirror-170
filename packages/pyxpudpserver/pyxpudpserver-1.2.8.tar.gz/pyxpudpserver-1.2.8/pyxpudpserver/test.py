...
pyXPUDPServer.initialiseUDP(('127.0.0.1',49008), ('192.168.1.64',49000), 'DESKTOP-I3NTFEA')
...
while True: # infinite loop - for a real application plan for a 'proper' way to exit the programme and break this loop
    ...
    pyXPUDPServer.sendXPDref('sim/cockpit2/engine/actuators/throttle_ratio',0,throttle)
    ...
    time.sleep(0.1)
    print(pyXPUDPServer.getData('sim/cockpit2/engine/actuators/throttle_ratio[0]'))
    
    print(pyXPUDPServer.statusMsg)
    
    print(pyXPUDPServer.XPbeacon)
    #print(value)
