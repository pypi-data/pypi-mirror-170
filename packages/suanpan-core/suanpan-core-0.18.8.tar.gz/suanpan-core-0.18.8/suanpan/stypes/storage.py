...
class StorageT(object):
    ...
    def download(self, key, path=None, progress=None, bucketOrBucketName=None, ignores=None, quiet=not g.debug):
        """download a file or folder from remote storage, oss or minio
    ...
    @abc.abstractmethod
    def downloadFolder(self, key, path=None, progress=None, delimiter=None, bucketOrBucketName=None, ignores=None,
                       quiet=not g.debug, ):
        ...

    @abc.abstractmethod
    def downloadFile(self, key, path=None, progress=None, bucketOrBucketName=None, ignores=None, quiet=not g.debug):
        ...

    @abc.abstractmethod
    def upload(self, key, path=None, progress=None, bucketOrBucketName=None, ignores=None, quiet=not g.debug):
        """upload a file or folder to remote storage, oss or minio
    ...
    @abc.abstractmethod
    def uploadFolder(self, key, path=None, progress=None, bucketOrBucketName=None, ignores=None, quiet=not g.debug):
        ...

    @abc.abstractmethod
    def uploadFile(self, key, path=None, progress=None, bucketOrBucketName=None, ignores=None, quiet=not g.debug):
        ...
    ...
    @abc.abstractmethod
    def getObject(self, key, bucket=None, **kwargs):
    ...
    @abc.abstractmethod
    def putObject(self, key, data, bucket=None, **kwargs):
