...
class SHA512_224:
    ...
    def register_values_to_hex_string(self) -> str:
        """Read the values of the 4 (h0-h3) registers and convert them to a hexadecimal string.

        Returns:
            str: The hexadecimal string represented by the 4 registers up to 224 bits.
        """
    ...
    def generate_hash(self, message: str) -> str:
        """Generates a 224-bit SHA-512/224 hash of the input message.

        Args:
            message (str): The input message/text.

        Returns:
            str: The 224-bit SHA-512/224 hash of the message.
        """
...
print(SHA512_224().generate_hash("abc"))
