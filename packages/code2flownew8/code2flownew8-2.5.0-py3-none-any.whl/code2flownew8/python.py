...
class Python(BaseLanguage):
    ...
    @staticmethod
    def make_nodes(tree, parent): #TO DO
        """
    ...
    def make_class_group(tree, parent,caller_file=None):
        print("python.py make_class_group 236 caller_file: ", caller_file)
        """
        ...
        for node_tree in node_trees:
            class_group.add_node(Python.make_nodes(node_tree, parent=class_group)[0],caller_file)
