...
def contour(srcfile, dstfile, attrname, interval, offset=0, band=1,
    ...
    :param srcfile:
    :param dstfile:
    :param attrname: Provides a name for the attribute in which to put the elevation.
                     If not provided no elevation attribute is attached.
                     Ignored in polygonal contouring (-p) mode.
    :param interval: Elevation interval between contours.
    :param offset: Offset from zero relative to which to interpret intervals.
    :param band: Picks a particular band to get the DEM from. Defaults to band 1.
    :param srcNoData: Input pixel value to treat as “nodata”.
    :param polygons: Generate contour polygons rather than contour lines.
    :param format: Create output in a particular format. Defualt is "ESRI Shapefile".
    :return:
    '''
