...
def check_and_install_dependencies(product: AbstractSoftwareProduct,
    ...
    :param py_dir:
    :param product:
    :param python_exec_path: A Python py_executable into which products should be installed.
        The pip module of this py_executable is used to install all libs
    ...
    if offline_zip_dir:
        ...
        # TODO logs and return rightt away
        print("Done zipping")
        return
    else:
