...
#     script = old_lic'{prefix}{script}{postfix}'
#     print(script)
...
def execute_py_script_as_new_proc(py_script_path: str,
    ...
    if use_i_py:
        cmd_args = [py_exec_path, '-py_executable', 'IPython', py_script_path]
    else:
        cmd_args = [py_exec_path, py_script_path]  # '-py_executable', 'IPython',
