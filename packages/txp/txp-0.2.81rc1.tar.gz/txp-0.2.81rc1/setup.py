...
['ArmSDK',
 ...
 'txp.cloud.composer',
 'txp.cloud.pipelines',
 'txp.cloud.pipelines.reports.reports_batch_pipeline',
 'txp.cloud.pipelines.reports.sections_realtime_pipeline',
 'txp.cloud.pipelines.reports.sections_realtime_pipeline.schemas',
 'txp.cloud.pipelines.reports.sections_realtime_pipeline.test',
...
{'': ['*'],
 ...
 'txp.cloud.pipelines.reports.reports_batch_pipeline': ['batch_signals_to_bigquery.egg-info/*'],
 'txp.cloud.pipelines.reports.sections_realtime_pipeline': ['pub_sub_to_bigquery.egg-info/*'],
 'txp.common': ['configs/*'],
...
{':extra == "cloud"': ['scipy>=1.4.0,<2.0.0'],
 ':extra == "ml"': ['fastapi>=0.78.0,<0.79.0'],
 ...
 'cloud': ['prophet>=1.1,<2.0', 'cronsim>=2.3,<3.0', 'fpdf>=1.7.2,<2.0.0'],
