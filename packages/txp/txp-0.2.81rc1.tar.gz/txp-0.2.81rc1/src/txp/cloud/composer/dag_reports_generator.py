...
def set_dates():
    ...
    default_args["star_datetime"] = start_date
    default_args["end_datetime"] = end_date
    firestore_db.close()


LOCAL_SETUP_FILE = os.path.join(configuration.get('core', 'dags_folder'), 'setup.py')
set_dates()
...
with DAG(nameDAG,
    ...
    task_launch_batch_dataflow = DataFlowPythonOperator(
        ...
        py_file=f'{default_args["composer_resources_bucket"]}/pipelines/reports_batch_pipeline/batch_pipeline.py',
        ...
        options={
            ...
            "reports_bucket_name": default_args["reports_becket"],
