...
['ArmSDK',
 ...
 'txp.cloud.pipelines.reports.realtime_pipeline',
 'txp.cloud.pipelines.reports.realtime_pipeline.test',
 'txp.cloud.pipelines.reports.schemas',
...
{'': ['*'],
 ...
 'txp.cloud.pipelines.reports.realtime_pipeline': ['pub_sub_to_bigquery.egg-info/*'],
 'txp.cloud.pipelines.telemetry.batch_pipeline': ['batch_signals_to_bigquery.egg-info/*'],
...
{':extra == "cloud"': ['scipy>=1.4.0,<2.0.0'],
 ...
 'cloud': ['cronsim>=2.3,<3.0', 'fpdf>=1.7.2,<2.0.0'],
