...
class FeedbackRenderer(AppComponent):
    def __init__(self, tenant_id: str, task_id: str, asset_id: str, model_registry: ModelRegistry, project_model: ProjectModel):
        ...
        self._project_model_ref: ProjectModel = project_model
