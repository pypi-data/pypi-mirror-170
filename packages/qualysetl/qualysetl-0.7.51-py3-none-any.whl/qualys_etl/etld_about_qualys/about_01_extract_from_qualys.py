...
def about_extract(host_xml_file=None, id_min=0,
    ...
    url = f"https://{cred_dict['api_fqdn_server']}/msp/about.php"  # Qualys Endpoint
...
def main():
    host_list_extract(cred_dict=etld_lib_credentials.get_cred())
