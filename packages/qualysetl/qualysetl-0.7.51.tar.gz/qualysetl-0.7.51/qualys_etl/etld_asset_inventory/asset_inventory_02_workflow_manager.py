...
# TODO for restart, clone asset_inventory_03_extract_controller_wrapper to a restart wrapper.
...
def prepare_asset_inventory_06_distribution():
    module_function = prepare_asset_inventory_06_distribution
    try:
        export_dir = etld_lib_config.asset_inventory_export_dir
...
def asset_inventory_etl_workflow():
    try:
        ...
        if prepare_asset_inventory_06_distribution():
