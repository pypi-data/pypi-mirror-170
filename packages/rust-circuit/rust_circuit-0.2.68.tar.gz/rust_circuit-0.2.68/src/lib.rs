...
fn rust_circuit(py: Python<'_>, m: &PyModule) -> PyResult<()> {
    use circuit::algebraic_rewrite::{
        ...
        concat_repeat_to_rearrange, distribute, distribute_all, einsum_elim_identity,
        einsum_elim_zero, einsum_flatten_once, einsum_merge_scalars, einsum_nest_path,
        einsum_of_permute_merge, einsum_pull_removable_axes, extract_add,
