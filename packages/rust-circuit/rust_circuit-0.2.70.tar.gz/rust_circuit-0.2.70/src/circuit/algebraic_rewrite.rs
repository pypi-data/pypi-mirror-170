...
use super::{
    circuit_optimizer::OptimizationContext, computational_node::EinsumArgs, evaluate_fn,
    prelude::*, py_circuit_items::PY_CIRCUIT_ITEMS, Add, Concat, Einsum, GeneralFunction,
    HashBytes, Index, Rearrange, ScalarConstant, Scatter, Symbol,
};
use crate::{
    filter_by_variant,
...
pub fn add_fuse_scalar_multiples(add: &Add) -> Option<Add> {
    ...
    return Some(Add::try_new(nodes, add.name_cloned()).unwrap());
}
