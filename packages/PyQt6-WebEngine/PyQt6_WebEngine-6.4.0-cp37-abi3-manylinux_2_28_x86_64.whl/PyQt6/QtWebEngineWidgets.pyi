...
class QWebEngineView(QtWidgets.QWidget):
    ...
    @typing.overload
    def __init__(self, page: QtWebEngineCore.QWebEnginePage, parent: typing.Optional[QtWidgets.QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, profile: QtWebEngineCore.QWebEngineProfile, parent: typing.Optional[QtWidgets.QWidget] = ...) -> None: ...
    @typing.overload
