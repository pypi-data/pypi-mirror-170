...
class Interface0DIterator:
    ...
    def __init__(self, it: 'SVertexIterator'):
...
class Material:
    ...
    def __init__(self, line: 'mathutils.Vector', diffuse: 'mathutils.Vector',
                 ambient: 'mathutils.Vector', specular: 'mathutils.Vector',
                 emission: 'mathutils.Vector', shininess: float,
                 priority: int):
