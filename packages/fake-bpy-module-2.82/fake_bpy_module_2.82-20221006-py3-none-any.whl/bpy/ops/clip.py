...
def constraint_to_fcurve(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Create F-Curves for object which will copy object's movement caused by this constraint :file: startup/bl_operators/clip.py\:529 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$529> _
...
def set_active_clip(override_context: typing.
                    ...
                    execution_context: typing.Union[str, int] = None,
                    undo: bool = None):
    ''' Undocumented contribute <https://developer.blender.org/T51061> :file: startup/bl_operators/clip.py\:228 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$228> _
...
def setup_tracking_scene(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Prepare scene for compositing 3D objects into this footage :file: startup/bl_operators/clip.py\:983 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$983> _
...
def track_settings_as_default(override_context: typing.
                              ...
                              execution_context: typing.Union[str, int] = None,
                              undo: bool = None):
    ''' Copy tracking settings from active track to default settings :file: startup/bl_operators/clip.py\:1014 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$1014> _
...
def track_settings_to_track(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: bool = None):
    ''' Copy tracking settings from active track to selected tracks :file: startup/bl_operators/clip.py\:1062 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$1062> _
