...
def software_install_one_shot_task(task, host_dict):
    """
...
def software_install_one_shot(nr_obj, host_dict, verbose=False):
    """
    ...
    task = nr_obj.run(task=software_install_one_shot_task, host_dict=host_dict, on_failed=True)
