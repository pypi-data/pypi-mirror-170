...
def verify_destination_md5(task, verify_source_result):
    """
    ...
    source_md5 = verify_source_result[str(task.host)].result["source_md5"]
...
def verify_destination_file(nr_obj, verify_source_result):
    """
    ...
    md5_result = nr_obj.run(task=verify_destination_md5, verify_source_result=verify_source_result)
    ...
    for host in md5_result:
        ...
        source_md5 = verify_source_result[host].result["source_md5"]
