...
class CodeMapping:
    ...
    def load_NDC112Name(self):
        if not os.path.exists("./data/NDC112Name.csv"):
            ...
            NDC112Name.to_csv("./data/NDC112Name.csv", index=False)
            # print ('source loaded from https://drive.google.com/uc?id=1Z11J4st1sI44jPborls9jIxzcpF-GpGt')
        else:
            NDC112Name = pd.read_csv(
                "./data/NDC112Name.csv", dtype={"NDC11": str, "Name": str}
            )
            # print ('source loaded from ./data cache')
    ...
    def load_NDC102RXCUI2atc4(self):
        if not os.path.exists("./data/NDC102RXCUI2atc4.csv"):
    ...
    def load_NDC112RXCUI(self):
        if not os.path.exists("./data/NDC112RXCUI.txt"):
            ...
            infile = open("./data/NDC112RXCUI.txt", "r")
