...
VERSION = "0.0.4a1664744442"
PLUGIN_VERSION = "0.0.4-alpha.1664744442+4f796c0f"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the grafana resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource grafana {PLUGIN_VERSION}`
                """)
            else:
                raise
