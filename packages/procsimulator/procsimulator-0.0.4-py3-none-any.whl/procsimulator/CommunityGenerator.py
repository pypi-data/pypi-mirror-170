...
class CommunityGenerator:
  ...
  def __init__(self, path_steps_seconds, path_steps_minutes):
    """
  ...
  def calculate_netload(self, netload_df):
    ...
    df.columns = ['Date', 'Demand', 'Production']
    ...
    df.to_csv(outname, columns=['Date', 'Demand', 'Production', 'Netload'], sep=";", index=False)
