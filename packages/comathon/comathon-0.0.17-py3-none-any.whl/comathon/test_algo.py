...
comathon_ID = 'kptib88'
code_loc = code_status(comathon_ID)
...
while True:
    ...
    ticker_balance = upbit.get_balance(krw_ticker)
    ...
    if GC == 1 and DC == 0:
        ...
        # buy_coin = cmt.buy_market_order('KRW-BTC', buy_amount_KRW) ## 시장가 매수
        buy_coin = cmt.buy_market_order(krw_ticker, 5000) ## 시장가 매수
        ...
        if (ticker_balance is None):
            ...
            sell_coin = cmt.sell_market_order(krw_ticker, 1) ## Sell all balance
