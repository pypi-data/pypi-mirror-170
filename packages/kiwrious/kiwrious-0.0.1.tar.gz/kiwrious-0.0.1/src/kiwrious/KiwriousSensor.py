from src.Kiwrious_sensor_FICS.SensorData import SensorData
from src.Kiwrious_sensor_FICS.KiwriousUtility import *
...
class KiwriousSensor:
    ...
    def __init__(self, sensor, service):
        ...
        if (self.sensor_type == 1) or (self.sensor_type == 11):
            ...
            voc = SensorData(self.sensor_type, to_int16(self.sensor_packet[12:16]), 0)
            co2 = SensorData(self.sensor_type, to_int16(self.sensor_packet[16:20]), 1)
    ...
    def __get_air_quality_data(self):
        ...
        self.sensor_data[0].data_value = (to_int16(self.sensor_packet[12:16]))
        self.sensor_data[1].data_value = (to_int16(self.sensor_packet[16:20]))
