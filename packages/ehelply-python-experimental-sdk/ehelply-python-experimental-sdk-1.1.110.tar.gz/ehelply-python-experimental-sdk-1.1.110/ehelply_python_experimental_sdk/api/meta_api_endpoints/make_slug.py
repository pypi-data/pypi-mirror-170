...
# body param
SchemaForRequestBodyApplicationJson = MetaSlugger


request_body_meta_slugger = api_client.RequestBody(
    content={
...
class MakeSlug(api_client.Api):
    ...
    def make_slug(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_meta_slugger.serialize(body, content_type)
