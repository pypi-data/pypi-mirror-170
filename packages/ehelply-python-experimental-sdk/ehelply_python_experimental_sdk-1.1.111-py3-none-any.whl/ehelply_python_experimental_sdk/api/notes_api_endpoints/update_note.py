...
request_path_note_id = api_client.PathParameter(
    name="note_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=NoteIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = NoteBase


request_body_note_base = api_client.RequestBody(
    content={
...
class UpdateNote(api_client.Api):
    ...
    def update_note(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_note_base.serialize(body, content_type)
