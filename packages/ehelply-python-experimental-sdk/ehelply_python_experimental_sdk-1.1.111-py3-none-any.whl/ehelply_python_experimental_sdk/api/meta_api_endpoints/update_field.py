...
# body param
SchemaForRequestBodyApplicationJson = Field


request_body_field = api_client.RequestBody(
    content={
...
class UpdateField(api_client.Api):
    ...
    def update_field(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_field.serialize(body, content_type)
