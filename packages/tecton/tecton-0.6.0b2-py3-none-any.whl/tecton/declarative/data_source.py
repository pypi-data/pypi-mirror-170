...
class KafkaConfig(BaseStreamConfig):
    ...
    def __init__(
        ...
        .. _User Guide: https://docs.tecton.ai/0.4/examples/create-a-streaming-data-source.html#write-the-stream-message-post-processor-function
        .. _Productionizing a Stream: https://docs.tecton.ai/0.4/overviews/framework/feature_views/stream/index.html#productionizing-a-stream
...
class PushSource(BaseDataSource):
    ...
    def __init__(
        ...
        *,
        ...
        basic_info = prepare_basic_info(name=name, description=description, owner=owner, family=None, tags=tags)
        args = prepare_ds_args(
            basic_info=basic_info, batch_config=batch_config, stream_config=None, ds_type=DataSourceType.PUSH
        )
    ...
    @property
    def data_delay(self):
        return self._args.batch_config.data_delay
