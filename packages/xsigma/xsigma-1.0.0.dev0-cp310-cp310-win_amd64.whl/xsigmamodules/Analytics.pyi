...
class calibrationIrHjm(object):
    def calibrate(self, volatility_surface:'irVolatilitySurface', correlation:'matrix_IdE', settings:'calibrationIrHjmSettings', strikes:Sequence[float]=..., initial_parameter:'parameterMarkovianHjm'=...) -> 'parameterMarkovianHjm': ...
