...
class Plot:
    ...
    def __new__(self, filename, output_folder, start_date, end_date, para_dict, result_df, generate_filepath, settings):
            ...
            html.Div(
                dbc.Row([
                    ...
                    dbc.Col(html.Div([
                        ...
                        # html.Div('Filters for:', style={'font-size': '15px', 'margin-left': '15px'}),
        ...
        #     State('save', "style"),
        # )
        # def save(save_click, save_style):
        #     print(output_folder)
        #     # print('Saved!')
        #     if not os.path.isfile('saved_strategies.csv'):
        #         print('No File!!!!')
        #         saved_df = pd.DataFrame(columns=['parameters','start_date','end_date' ])
        #         print(saved_df)
        #
        #     else:
        #         pass
