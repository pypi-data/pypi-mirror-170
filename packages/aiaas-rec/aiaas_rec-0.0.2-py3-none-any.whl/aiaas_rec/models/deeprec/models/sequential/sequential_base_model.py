...
from aiaas_rec.models.deeprec.models.base_model import BaseModel
from aiaas_rec.models.deeprec.deeprec_utils import cal_metric, load_dict
...
class SequentialBaseModel(BaseModel):
    ...
    def set_auxiliary_data(self, items_with_popular, item2cate):
        self.items_with_popular = items_with_popular
