...
formats: amos.Dictionary[str, formats.FileFormat] = amos.Dictionary(
    contents = {
...
class Clerk(object):
    ...
    Args:
        ...
        parameters (MutableMapping[str, str]): keys are the obi names of 
    ...
    def _validate_io_folder(
        ...
        """
        try:
            return amos.pathlibify(item = path)
        except FileNotFoundError:
            return amos.pathlibify(item = self.root_folder / path)
