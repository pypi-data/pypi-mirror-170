...
from bztt_fastapi_plus.utils.db import DbConfig
...
class SyncModel(object):
    ...
    app_dir: str  # 应用目录名
    model_header = 'from bztt_fastapi_plus.model.base import *\n\n\n'
    ...
    def _save_model(self, content):
        ...
        if "_log" in table_name and self.is_use_base_model:
        ...
        file_content = self.model_header + 'class ' + class_name + '(' + BaseClass + '):\n' + content
