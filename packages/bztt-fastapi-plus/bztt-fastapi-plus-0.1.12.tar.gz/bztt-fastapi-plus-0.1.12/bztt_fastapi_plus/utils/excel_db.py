...
class ExcelDbUtils(object):
    ...
    sess: Session = None
    default_config: ExcelDbConfig = None

    def __init__(self, config: ExcelDbConfig = None):
        if not config:
    ...
    @staticmethod
    def _create_scoped_session(config: ExcelDbConfig):
    ...
    def get_sql_by_file(file_path, params={}):
        sql = ExcelDbUtils._get_file(file_path)
