...
class SrcAttachmentMixin:
    ...
    def __get_fs_path(self, path: typing.Union[str, PurePosixPath, None]) -> Path:
        src = self.absolute_path
        if path:
            src = src / path
        return src

    def __get_zip_path(self, path: typing.Union[str, PurePosixPath, None]) -> str:
        src = self.src
        if path:
            src = src / path
        return str(src)
    ...
    def is_dir(self: typing.Union[ElementMixinProtocol, "SrcAttachmentMixin"],
               path: typing.Union[str, PurePosixPath, None] = None) -> bool:
    ...
    def __validate_path(self, path: typing.Union[str, PurePosixPath, None]):
    ...
    def open(self: typing.Union[ElementMixinProtocol, "SrcAttachmentMixin"],
             path: typing.Union[str, PurePosixPath, None] = None) -> typing.BinaryIO:
    ...
    def read(self, path: typing.Union[str, PurePosixPath, None] = None) -> bytes:
    ...
    def _copy_dir_zip(self: typing.Union[ElementMixinProtocol, "SrcAttachmentMixin"], dest_path: PurePath,
                      dst_zip_file: zipfile.ZipFile, args: FileConstructionArguments):
        for name in self.iterdir():
            self.__copy_file_obj_zip(name, dest_path / name, dst_zip_file, args)

    def file_size(self: typing.Union[ElementMixinProtocol, "SrcAttachmentMixin"],
                  path: typing.Union[str, PurePosixPath, None] = None) -> typing.Optional[int]:
    ...
    def file_ctime(self: typing.Union[ElementMixinProtocol, "SrcAttachmentMixin"],
                   path: typing.Union[str, PurePosixPath, None] = None) -> typing.Optional[time.struct_time]:
