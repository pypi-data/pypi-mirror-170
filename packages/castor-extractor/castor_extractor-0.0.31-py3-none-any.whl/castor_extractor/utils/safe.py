...
class SafeMode:
    ...
    Attributes:
        self.exceptions: tuple of exception that will be catched
...
def safe_mode(
    safe_mode_params: Optional[SafeMode] = None,
    ...
    Args :
        safe_mode_params: param exception and number of exceptions to catch
        default: Optional - default function to execute if decorated function raises exception
    """
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if safe_mode_params.should_raise:
                    raise e
                logging.error(
                    f"Safe mode : skip error in function {function.__name__} with args {args} kwargs {kwargs}"
                )
