...
job = {
    'name': 'P-UD-10to60',
    'version': '99.99.99',
    'input_stream_name': create_key_name(Type.STREAM.value, '10MINUTES', Dimension.PAGE.value, '', '', Metric.UNIQUE_DEVICES.value),
    ...
    'output_stream_name': create_key_name(Type.STREAM.value, '1HOUR', Dimension.PAGE.value, '', '', Metric.UNIQUE_DEVICES.value)
}
...
desc_json = {
    ...
    "desc": f"Rotate Page Pageviews Keys, 10 minutes to 60 minutes buckets"
}
