...
job = {
    'name': 'S-PG-10to60',
    'version': '99.99.99',
    'input_stream_name': create_key_name(Type.STREAM.value, '10MINUTES', Dimension.SECTION.value, '', '', Metric.PAGEVIEWS.value),
    ...
    'output_stream_name': create_key_name(Type.STREAM.value, '1HOUR', Dimension.SECTION.value, '', '', Metric.PAGEVIEWS.value)
}
...
desc_json = {
    ...
    "desc": f"Rotate Section Pageviews Keys, 10 minutes to 60 minutes buckets"
}
