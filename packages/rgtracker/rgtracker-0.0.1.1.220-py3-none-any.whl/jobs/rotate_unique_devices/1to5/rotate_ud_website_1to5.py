...
job = {
    'name': 'W-UD-1to5',
    'version': '99.99.99',
    'input_stream_name': create_key_name(Type.STREAM.value, '1MINUTE', Dimension.WEBSITE.value, '', '', Metric.UNIQUE_DEVICES.value),
    ...
    'output_stream_name': create_key_name(Type.STREAM.value, '5MINUTES', Dimension.WEBSITE.value, '', '', Metric.UNIQUE_DEVICES.value)
}
...
desc_json = {
    ...
    "desc": f"Rotate Website Unique Devices Keys, 1 minute to 5 minutes buckets"
}
