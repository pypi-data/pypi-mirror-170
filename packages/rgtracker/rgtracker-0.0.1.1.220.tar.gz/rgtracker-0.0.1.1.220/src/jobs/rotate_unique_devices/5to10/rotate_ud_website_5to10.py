...
job = {
    'name': 'W-UD-5to10',
    'version': '99.99.99',
    'input_stream_name': create_key_name(Type.STREAM.value, '5MINUTES', Dimension.WEBSITE.value, '', '', Metric.UNIQUE_DEVICES.value),
    ...
    'output_stream_name': create_key_name(Type.STREAM.value, '10MINUTES', Dimension.WEBSITE.value, '', '', Metric.UNIQUE_DEVICES.value)
}
...
desc_json = {
    ...
    "desc": f"Rotate Website Unique Devices Keys, 5 minutes to 10 minutes buckets"
}
