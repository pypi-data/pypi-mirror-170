...
job = {
    'name': 'W-PG-10to60',
    'version': '99.99.99',
    'input_stream_name': create_key_name(Type.STREAM.value, '10MINUTES', Dimension.WEBSITE.value, '', '', Metric.PAGEVIEWS.value),
    ...
    'output_stream_name': create_key_name(Type.STREAM.value, '1HOUR', Dimension.WEBSITE.value, '', '', Metric.PAGEVIEWS.value)
}
