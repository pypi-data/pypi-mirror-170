...
class Formation(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, xid, allocation_factor, compressibility_rock, pressure_formation_initial_datum, temperature_formation_datum, depth, thickness_formation, primary_fluid_type, rsi, fluid_gravity_api, fluid_gravity_gas, fluid_salinity_water, *args, **kwargs):  # noqa: E501
