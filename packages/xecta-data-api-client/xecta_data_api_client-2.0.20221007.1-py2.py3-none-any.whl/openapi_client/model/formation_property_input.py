...
class FormationPropertyInput(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, allocation_factor, pressure_formation_initial_datum, temperature_formation_datum, depth, primary_fluid_type, rsi, fluid_gravity_api, fluid_gravity_gas, fluid_salinity_water, *args, **kwargs):  # noqa: E501
        """FormationPropertyInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            compressibility_rock (float): [optional]  # noqa: E501
            thickness_formation (float): [optional]  # noqa: E501
