...
class FormationInput(ModelNormal):
    ...
    attribute_map = {
        'uwi': 'uwi',  # noqa: E501
        'wellbore_index': 'wellboreIndex',  # noqa: E501
        'name': 'name',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, uwi, wellbore_index, name, allocation_factor, compressibility_rock, pressure_formation_initial_datum, temperature_formation_datum, depth, thickness_formation, primary_fluid_type, rsi, fluid_gravity_api, fluid_gravity_gas, fluid_salinity_water, *args, **kwargs):  # noqa: E501
        ...
        self.uwi = uwi
        self.wellbore_index = wellbore_index
        self.name = name
