...
__all__ = ["attach_available_efses", "get_available_efses", "get_efs_ip_address"]

logger = logging.getLogger(__name__)


def get_available_efses(env: str, efs_client: boto3.client, ec2_client: boto3.client, availability_zone: str) -> Union[List, None]:
...
def get_efs_ip_address(efs_id: str, zone_id: str, efs_client: boto3.client, ec2_client: boto3.client) -> Union[str, None]:
