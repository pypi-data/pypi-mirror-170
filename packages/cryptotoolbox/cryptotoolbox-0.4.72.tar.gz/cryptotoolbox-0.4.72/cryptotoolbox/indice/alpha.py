...
def compute_daily_signal_lo(df=None, core_tokens=['BTC', 'ETH'], extra_tokens=['AVAX'],tone=15, ttwo=26, p1btc = 1.,p2btc = 1.05,p1eth = 1.,p2eth = 1.05,lo_sig_suffix='LO',compute_lo_strat=True, plot_html=False, whole_kpis = False, local_root_directory='none'):
