...
class AssertionsProvider(
    ...
    def add_to_role_policy(self, statement: typing.Any) -> None:
        ...
        **Please note**: this is a direct IAM JSON policy blob, *not* a ``iam.PolicyStatement``
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AssertionsProvider.add_to_role_policy)
...
class IApiCall(constructs.IConstruct, typing_extensions.Protocol):
...
class _IApiCallProxy(
    ...
    def assert_at_path(self, path: builtins.str, expected: ExpectedResult) -> IApiCall:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApiCall.assert_at_path)
    ...
    def expect(self, expected: ExpectedResult) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApiCall.expect)
            check_type(argname="argument expected", value=expected, expected_type=type_hints["expected"])
    ...
    def get_att(self, attribute_name: builtins.str) -> aws_cdk.Reference:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApiCall.get_att)
    ...
    def get_att_string(self, attribute_name: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApiCall.get_att_string)
            check_type(argname="argument attribute_name", value=attribute_name, expected_type=type_hints["attribute_name"])
    ...
    def next(self, next: IApiCall) -> IApiCall:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApiCall.next)
...
class _IDeployAssertProxy:
    ...
    def aws_api_call(
        ...
        if __debug__:
            ...
            check_type(argname="argument api", value=api, expected_type=type_hints["api"])
            check_type(argname="argument parameters", value=parameters, expected_type=type_hints["parameters"])
        return typing.cast(IApiCall, jsii.invoke(self, "awsApiCall", [service, api, parameters]))
...
class ApiCallBase(
    ...
    def __init__(self, scope: constructs.Construct, id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiCallBase.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        jsii.create(self.__class__, self, [scope, id])
    ...
    def expect(self, expected: ExpectedResult) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiCallBase.expect)
            check_type(argname="argument expected", value=expected, expected_type=type_hints["expected"])
        return typing.cast(None, jsii.invoke(self, "expect", [expected]))
    ...
    def get_att(self, attribute_name: builtins.str) -> aws_cdk.Reference:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiCallBase.get_att)
            check_type(argname="argument attribute_name", value=attribute_name, expected_type=type_hints["attribute_name"])
        return typing.cast(aws_cdk.Reference, jsii.invoke(self, "getAtt", [attribute_name]))
    ...
    def get_att_string(self, attribute_name: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiCallBase.get_att_string)
            check_type(argname="argument attribute_name", value=attribute_name, expected_type=type_hints["attribute_name"])
        return typing.cast(builtins.str, jsii.invoke(self, "getAttString", [attribute_name]))
    ...
    def next(self, next: IApiCall) -> IApiCall:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiCallBase.next)
            check_type(argname="argument next", value=next, expected_type=type_hints["next"])
        return typing.cast(IApiCall, jsii.invoke(self, "next", [next]))
    ...
    @abc.abstractmethod
    def _api_call_resource(self) -> aws_cdk.CustomResource:
        '''
        :stability: experimental
        '''
        ...
    ...
    def _flatten_response(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ApiCallBase, "_flatten_response").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _expected_result(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ApiCallBase, "_expected_result").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _ApiCallBaseProxy(ApiCallBase):
    ...
    def assert_at_path(self, path: builtins.str, expected: ExpectedResult) -> IApiCall:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiCallBase.assert_at_path)
            check_type(argname="argument path", value=path, expected_type=type_hints["path"])
            check_type(argname="argument expected", value=expected, expected_type=type_hints["expected"])
        return typing.cast(IApiCall, jsii.invoke(self, "assertAtPath", [path, expected]))
    ...
    def _api_call_resource(self) -> aws_cdk.CustomResource:
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.CustomResource, jsii.get(self, "apiCallResource"))
