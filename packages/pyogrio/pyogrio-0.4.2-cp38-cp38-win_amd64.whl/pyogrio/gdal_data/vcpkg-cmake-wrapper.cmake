...
if(GDAL_FOUND)
    ...
    set(Z_VCPKG_PORT_FEATURES "core")
    ...
    z_vcpkg_gdal_add_libs(optimized Release  ${CMAKE_CURRENT_LIST_DIR}/../../lib/iconv.lib ${CMAKE_CURRENT_LIST_DIR}/../../lib/charset.lib)
    z_vcpkg_gdal_add_libs(debug Debug  ${CMAKE_CURRENT_LIST_DIR}/../../debug/lib/iconv.lib ${CMAKE_CURRENT_LIST_DIR}/../../debug/lib/charset.lib)
