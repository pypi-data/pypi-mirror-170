...
REQUIREMENTS = {
    "Cycle": {
        "or": {
            "inputs": [
                {"@type": "Input", "value": "", "term.termType": ["inorganicFertilizer", "inorganicNitrogenFertilizerUnspecifiedKgN"]}  # noqa: E501
            ],
...
LOOKUPS = {
    "inorganicFertilizer": ["NH3_emissions_factor_acidic", "NH3_emissions_factor_basic"],
    "region-inorganicFertilizer-fertGroupingNitrogen-breakdown": ""
}
RETURNS = {
    "Emission": [{
        "value": "",
...
def _should_run(cycle: dict):
    ...
    has_unspecifiedKgN = len(unspecifiedKgN) > 0 or fertilizer_complete
    ...
    unspecifiedKgN = (
        [0] if len(unspecifiedKgN) == 0 and fertilizer_complete else unspecifiedKgN
