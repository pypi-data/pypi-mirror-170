...
from hestia_earth.models.utils.cycle import get_inorganic_fertilizer_P_total
...
LOOKUPS = {
    "organicFertilizer": "OrganicFertilizerClassification"
}
...
def _should_run(cycle: dict):
    ...
    should_run = all([slope is not None])
