...
from hestia_earth.models.ipcc2019.no3ToGroundwaterOrganicFertilizer import MODEL, TERM_ID, run, _should_run
...
@patch(f"{class_path}.get_organic_fertilizer_N_total", return_value=0)
