...
from hestia_earth.models.utils.cycle import get_inorganic_fertilizer_N_total
...
REQUIREMENTS = {
    "Cycle": {
        ...
        "emissions": [
            {"@type": "Emission", "value": "", "term.@id": "no3ToGroundwaterInorganicFertilizer"},
            {"@type": "Emission", "value": "", "term.@id": "nh3ToAirInorganicFertilizer"},
            {"@type": "Emission", "value": "", "term.@id": "noxToAirInorganicFertilizer"}
        ]
    }
}
RETURNS = {
