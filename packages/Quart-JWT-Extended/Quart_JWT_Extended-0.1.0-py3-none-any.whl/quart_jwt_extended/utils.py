...
from quart import g as ctx_stack
...
def get_raw_jwt():
    ...
    """
    return getattr(ctx_stack, "_jwt_extended_jwt", {})
...
def get_raw_jwt_header():
    ...
    JWT is currently present, an empty dict is returned instead.
    """
    return getattr(ctx_stack, "_jwt_extended_jwt_header", {})
...
def get_current_user():
    ...
    return `None`.
    """
    return getattr(ctx_stack, "_jwt_extended_jwt_user", None)
...
def decode_token(encoded_token, csrf_value=None, allow_expired=False):
    ...
    try:
        ...
        ctx_stack._jwt_extended_expired_jwt = expired_token
        raise
