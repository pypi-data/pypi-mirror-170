    ...
    **Autogenerated function**
    ...
    Args:
        ...
        outpost_config(Dict, optional):
            ...
            * outpostArns(List) : The ARN of the Outpost that you want to use for your local Amazon EKS cluster on
              Outposts. Only a single Outpost ARN is supported.
            * controlPlaneInstanceType(str): The Amazon EC2 instance type that you want to use for your local
              Amazon EKS cluster on Outposts. The instance type that you specify is used for all Kubernetes control
