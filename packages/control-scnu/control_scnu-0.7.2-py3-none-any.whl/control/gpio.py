...
if 'win' in system_platform:
    ...
    try:
        ...
        raise BaseException('树莓派没有打开SPI接口！')
    import serial
    import Adafruit_DHT
    ...
    try:
        ...
        try:
            ...
            raise BaseException('没有连接网络，无法安装相关库！')
...
class Screen:
    ...
    def screen_display(self, string: str, background_color: str = 'white', font_color: str = 'black',
                       font_size: int = 20, a: int = 0, b: int = 0):
        """
        LCD屏幕显示
        Args:
            string:
