...
def generar_kpis_p_deser_by_dist(df,anio_df=None , anio_h = None,t_anios=0 ,decimals=2 , cache=False):
    ...
    df_final["P_DESERCION_CODGEO_SLOPE"] = df_final[cls_list_old_new].apply(get_coeff, axis=1)
...
def generar_kpis_agg_servicios(df,anio_df=None , anio_h =None ,t_anios=1,modalidad=None,cache=False):
