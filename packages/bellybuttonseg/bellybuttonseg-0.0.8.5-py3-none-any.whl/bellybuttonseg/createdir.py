...
def createdir(example=0):
    ...
    if example ==1:
        download_image("https://raw.githubusercontent.com/sdillavou/BellybuttonExampleData/blob/main/PhotoelasticDisks/areas_of_interest/test.png",full_filename+'/areas_of_interest/test_early.png')
