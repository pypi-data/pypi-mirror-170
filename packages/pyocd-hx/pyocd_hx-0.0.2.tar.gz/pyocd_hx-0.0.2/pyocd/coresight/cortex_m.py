...
from ..debug.breakpoints.hxsoftware import HxSoftwareBreakpointProvider  #YX 20220926
...
class CortexM(CoreTarget, CoreSightCoreComponent): # lgtm[py/multiple-calls-to-init]
    ...
    def __init__(self,
        ...
        hxsoftwarebreakpoint_provider = self.session.options.get('enable_hxsoftwarebreakpoint_provider')
        self.sw_bp = SoftwareBreakpointProvider(self)
        
        if (hxsoftwarebreakpoint_provider):
            self.sw_bp = HxSoftwareBreakpointProvider(self) #YX 20220927
