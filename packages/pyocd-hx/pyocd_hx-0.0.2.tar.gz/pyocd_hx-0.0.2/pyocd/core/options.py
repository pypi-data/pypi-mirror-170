...
BUILTIN_OPTIONS = [
    ...
    OptionInfo('enable_multicore_debug', bool, False, #YX 20220928 fixed
    ...
    OptionInfo('enable_hxsoftwarebreakpoint_provider', bool, True,
        "Whether to use HxSoftwareBreakpointProvider as CortexM sw_bp. Default is True."),  #YX 20220927
    ...
    OptionInfo('enable_z0_breakpoint_type_auto', bool, False,
        "Whether to use Target.BreakpointType.AUTO to handle software breakpoint. Default is False."), #YX 20220927
    ]
