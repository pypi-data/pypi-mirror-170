...
def rollout(config: Any) -> None:
    print("Congratulations! You've configured cinnaroll rollout!")


class RolloutConfig(abc.ABC):
    def __init__(self, *, project_id: str, model_object: Any, model_input_sample: Any, input_format: str,
                 output_format: str, infer_func_input_sample: Any, metrics: Dict[str, str] = {}):
        """
        ...
        :param input_format: Required. Input format of your infer() function, one of:
            "json" - JSON
            "img"  - image that you can open with PIL.Image.open() or other image opening methods
            "file" - arbitrary file that you can open
        :param output_format: Required. Output format of your infer() function, one of:
            "json" - JSON
            "img"  - image
