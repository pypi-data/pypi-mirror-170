...
class CfnTopic(
    ...
    def __init__(
        ...
        *,
        ...
        subscription: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnTopic.SubscriptionProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
...
class TopicSubscriptionConfig(SubscriptionOptions):
    def __init__(
        ...
        *,
        ...
        subscription_dependency: typing.Optional[constructs.IDependable] = None,
    ) -> None:
    ...
    @builtins.property
    def subscription_dependency(self) -> typing.Optional[constructs.IDependable]:
