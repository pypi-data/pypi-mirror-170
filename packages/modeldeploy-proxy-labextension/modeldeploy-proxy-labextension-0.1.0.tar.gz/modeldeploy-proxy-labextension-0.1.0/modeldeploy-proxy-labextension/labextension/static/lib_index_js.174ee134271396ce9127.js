...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([_sidebar__WEBPACK_IMPORTED_MODULE_0__["default"], _leftpanel__WEBPACK_IMPORTED_MODULE_1__["default"]]);
...
/* harmony import */ var _transformerleftpanel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./transformerleftpanel */ "./lib/transformerleftpanel.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    requires: [_jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.ILabShell, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.ILayoutRestorer, _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_3__.INotebookTracker, _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.IToolbarWidgetRegistry, _jupyterlab_docmanager__WEBPACK_IMPORTED_MODULE_4__.IDocumentManager],
    optional: [_jupyterlab_translation__WEBPACK_IMPORTED_MODULE_2__.ITranslator],
    autoStart: true,
    activate: async (app, labShell, restorer, tracker, docManager, toolbarRegistry, translator) => {
        let widget;
        ...
        app.started.then(() => {
            ...
            widget = _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget.create(react__WEBPACK_IMPORTED_MODULE_5__.createElement(_transformerleftpanel__WEBPACK_IMPORTED_MODULE_7__.TransformerLeftPanel, { app: app, tracker: tracker, docManager: docManager }));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    autoStart: true,
    activate: async (app, tracker, settingRegistry, toolbarRegistry, translator) => {
        ...
        app.commands.addCommand('notebook:transformer', {
            ...
            execute: args => {
                let currentCellIndex = tracker.currentWidget.content.activeCellIndex;
                let toggle = tracker.currentWidget.content.node.childNodes[currentCellIndex].querySelector('.transformer-cell-metadata-editor-toggle');
                toggle.click();
            },
        ...
        const toolbarItems = settingRegistry && toolbarRegistry ? (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.createToolbarFactory)(toolbarRegistry, settingRegistry, _jupyterlab_cell_toolbar__WEBPACK_IMPORTED_MODULE_3__.CellBarExtension.FACTORY_NAME, // "Cell"
        sidebar_id, translator !== null && translator !== void 0 ? translator : _jupyterlab_translation__WEBPACK_IMPORTED_MODULE_2__.nullTranslator) : undefined;
    ...
    optional: [_jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_1__.ISettingRegistry, _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.IToolbarWidgetRegistry, _jupyterlab_translation__WEBPACK_IMPORTED_MODULE_2__.ITranslator]
});
...
/* harmony import */ var _widgets_InlineCellsMetadata__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./widgets/InlineCellsMetadata */ "./lib/widgets/InlineCellsMetadata.js");
...
class TransformerLeftPanel extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        ...
        this.getActiveNotebookPanel = () => {
            return this.props.tracker.currentWidget;
        };
        this.getActiveNotebookPath = () => {
            return (this.getActiveNotebookPanel() && _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_3__.PageConfig.getOption('serverRoot') + '/' + this.getActiveNotebookPanel().context.path);
        };
        ...
        this.resetState = () => this.setState((prevState, props) => (Object.assign(Object.assign({}, DefaultState), { isEnabled: prevState.isEnabled })));
        ...
        this.applyTransformerToProxy = async () => {
            ...
            await _lib_NotebookUtils__WEBPACK_IMPORTED_MODULE_4__["default"].saveNotebook(this.getActiveNotebookPanel(), true, true);
            ...
            try {
                ...
                await (0,_lib_RPCUtils__WEBPACK_IMPORTED_MODULE_5__.executeRpc)(kernel, 'log.setup_logging');
                const args = {
                    source_notebook_path: this.getActiveNotebookPath()
                };
                const result = await (0,_lib_RPCUtils__WEBPACK_IMPORTED_MODULE_5__.executeRpc)(kernel, 'nb.parse_notebook', args);
                console.log(result);
            }
            catch (error) {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core_styles__WEBPACK_IMPORTED_MODULE_6__["default"], { theme: _theme__WEBPACK_IMPORTED_MODULE_7__.theme },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'leftpanel-transformer-widget', key: "transformer-widget" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'leftpanel-transformer-widget-content' },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "cells-meta-component" },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_widgets_InlineCellsMetadata__WEBPACK_IMPORTED_MODULE_8__.InlineCellsMetadata, { onMetadataEnable: this.onMetadataEnable, notebookPanel: this.getActiveNotebookPanel() })),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'kale-component ' + (this.state.isEnabled ? '' : 'hidden') },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", { className: "kale-header", style: { color: _theme__WEBPACK_IMPORTED_MODULE_7__.theme.transformer.headers.main } }, "Transformer is the plugin for pre-processor / post-preocessor..."))),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'kale-component ' + (this.state.isEnabled ? '' : 'hidden') },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", { className: "transformer-header", style: { color: _theme__WEBPACK_IMPORTED_MODULE_7__.theme.transformer.headers.main } }, "Run")),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "input-container add-button" },
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__.Button, { variant: "contained", color: "primary", size: "small", title: "SetupKatibJob", onClick: this.applyTransformerToProxy, disabled: false, style: { marginLeft: '10px', marginTop: '0px' } }, "Apply Changes"))),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'kale-component ' + (this.state.isEnabled ? '' : 'hidden') })),
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'transformer-metadata-editor-wrapper' + (this.state.isSelectorVisible ? '' : ' hidden') },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'transformer-cell-metadata-editor', style: { borderLeft: `2px solid ${cellColor}` } },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__.IconButton, { "aria-label": "hide", onClick: () => this.hideSelector() },
...
/***/ "./lib/widgets/InlineCellsMetadata.js":
/*!********************************************!*\
  !*** ./lib/widgets/InlineCellsMetadata.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _CellMetadataEditor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CellMetadataEditor */ "./lib/widgets/CellMetadataEditor.js");
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @material-ui/core */ "webpack/sharing/consume/default/@material-ui/core/@material-ui/core");
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__);
...
class InlineCellsMetadata extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor(props) {
        ...
        this.connectAndInitWhenReady = (notebookPanel) => {
            ...
            notebookPanel.context.ready.then(() => {
                ...
                this.state.editors.forEach((editor, index) => {
                    const transformerTag = _lib_TagsUtils__WEBPACK_IMPORTED_MODULE_4__["default"].getCellTransformerTag(notebookPanel, index) ? _lib_TagsUtils__WEBPACK_IMPORTED_MODULE_4__["default"].getCellTransformerTag(notebookPanel, index) : null;
        ...
        this.createCellTransformerWidgets = (notebookPanel, cellElement, transformerTag) => {
            ...
            react_dom__WEBPACK_IMPORTED_MODULE_3__.render(react__WEBPACK_IMPORTED_MODULE_0__.createElement(_CellMetadataEditor__WEBPACK_IMPORTED_MODULE_5__.CellMetadataEditor, { notebookPanel: notebookPanel, cellElement: cellElement, transformerTag: transformerTag }), newChildNode);
        };
        this.connectHandlersToNotebook = (notebookPanel) => {
        ...
        this.disconnectHandlersFromNotebook = (notebookPanel) => {
        ...
        this.onActiveCellChanged = (notebook, activeCell) => {
            ...
            if (!transformerWidget) {
                const transformerTag = _lib_TagsUtils__WEBPACK_IMPORTED_MODULE_4__["default"].getCellTransformerTag(this.props.notebookPanel, notebook.activeCellIndex);
        ...
        this.generateEditorsPropsAndInlineMetadata = () => {
            ...
            for (let index = 0; index < cells.length; index++) {
                const isCodeCell = (0,_jupyterlab_cells__WEBPACK_IMPORTED_MODULE_1__.isCodeCellModel)(this.props.notebookPanel.model.cells.get(index));
                if (!isCodeCell) {
                    continue;
                }
                editors[index] = {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "toolbar input-container" },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__.Switch, { checked: this.state.checked, onChange: c => this.toggleGlobalKaleSwitch(c.target.checked), color: "primary", name: "enableKale", inputProps: { 'aria-label': 'primary checkbox' }, classes: { root: 'material-switch' } }))));
    }
}
...
//# sourceMappingURL=lib_index_js.174ee134271396ce9127.js.map