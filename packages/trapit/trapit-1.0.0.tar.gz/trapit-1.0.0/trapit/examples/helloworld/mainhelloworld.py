'''*************************************************************************************************
Name: mainhelloworld.py                Author: Brendan Furey                       Date: 08-Oct-2022
...
This file is the driver script for a Hello World program implemented as a pure function to allow for
unit testing as a simple edge case.
