...
timer = start_script('user_settings.yaml')  # 启动模拟器和游戏，得到一个游戏控制器
show_all_debug_info()
...
battleship_battle_plan = BattlePlan(timer, 'plans\\battle\\hard_Battleship.yaml',
                                    'plans\\default.yaml')  # 指定 plan 参数和 default 参数
for _ in range(8):
    pass
