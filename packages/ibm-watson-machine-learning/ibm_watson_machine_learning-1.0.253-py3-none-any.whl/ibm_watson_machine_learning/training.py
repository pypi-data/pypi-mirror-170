        ...
        **Parameters**
        ...
        .. important::
            ...
            #. **limit**:  limit number of fetched records (optional)\n
               **type**: int\n
            #. **asynchronous**:  if True, it will work as a generator (optional)\n
               **type**: bool\n
            #. **get_all**:  if True, it will get all entries in 'limited' chunks (optional)\n
               **type**: bool\n
            #. **training_type**: Filter the fetched list of trainings based on training type
                                  [`pipeline` or `experiment`] (optional)\n
               **type**: str\n
            #. **state**: Filter the fetched list of training based on their state:
                          [`queued`, `running`, `completed`, `failed`] (optional)\n
               **type**: str\n
            #. **tag_value**: Filter the fetched list of training based on ther tag value (optional)\n
               **type**: str\n
            #. **training_definition_id**: Filter the fetched trainings which are using the given training_definition
                                           (optional)\n
               **type**: str\n
    ...
    def list(self, limit=None, asynchronous=False, get_all=False):
        """
           ...
           **Parameters**
           ...
           .. important::
                #. **limit**:  limit number of fetched records at once\n
                   **type**: int\n
                #. **asynchronous**:  if True, it will work as a generator (optional)\n
                   **type**: bool\n
                #. **get_all**:  if True, it will get all entries in 'limited' chunks (optional)\n
        ...
        if asynchronous:
            ...
            return preprocess_details(details)
