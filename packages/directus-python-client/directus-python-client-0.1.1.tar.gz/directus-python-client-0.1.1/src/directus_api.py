...
class DirectusApi:
    ...
    def updates_items(self, items: list, collection: str) -> Response:
        ...
        response = requests.patch(url, json=items, headers=headers)
        return response
    ...
    def get_items_from_collection(self, collection: str, limit: int, page_size: int = 25000, filter_dict: dict = None):
        """
