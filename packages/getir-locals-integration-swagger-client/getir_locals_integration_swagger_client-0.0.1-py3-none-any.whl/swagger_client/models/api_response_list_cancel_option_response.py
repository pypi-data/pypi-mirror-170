...
class ApiResponseListCancelOptionResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'list[CancelOptionResponse]'
    }
    ...
    def __init__(self, meta=None, data=None):  # noqa: E501
        """ApiResponseListCancelOptionResponse - a model defined in Swagger"""  # noqa: E501
        self._meta = None
        self._data = None
    ...
    @property
    def meta(self):
        """Gets the meta of this ApiResponseListCancelOptionResponse.  # noqa: E501


        :return: The meta of this ApiResponseListCancelOptionResponse.  # noqa: E501
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ApiResponseListCancelOptionResponse.


        :param meta: The meta of this ApiResponseListCancelOptionResponse.  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ApiResponseListCancelOptionResponse.  # noqa: E501


        :return: The data of this ApiResponseListCancelOptionResponse.  # noqa: E501
        :rtype: list[CancelOptionResponse]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ApiResponseListCancelOptionResponse.


        :param data: The data of this ApiResponseListCancelOptionResponse.  # noqa: E501
        :type: list[CancelOptionResponse]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiResponseListCancelOptionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiResponseListCancelOptionResponse):
            return False
