...
class ProductBatchRequest(object):
    ...
    def __init__(self, products=None):  # noqa: E501
        """ProductBatchRequest - a model defined in Swagger"""  # noqa: E501
        self._products = None
    ...
    @property
    def products(self):
        """Gets the products of this ProductBatchRequest.  # noqa: E501


        :return: The products of this ProductBatchRequest.  # noqa: E501
        :rtype: list[ProductRequest]
        """
        return self._products

    @products.setter
    def products(self, products):
        """Sets the products of this ProductBatchRequest.


        :param products: The products of this ProductBatchRequest.  # noqa: E501
        :type: list[ProductRequest]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductBatchRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductBatchRequest):
            return False
