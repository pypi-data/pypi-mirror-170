...
class PageableResponseSupplierProductResponse(object):
    ...
    swagger_types = {
        'total_count': 'int',
        'data': 'list[SupplierProductResponse]'
    }
    ...
    def __init__(self, total_count=None, data=None):  # noqa: E501
        """PageableResponseSupplierProductResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def total_count(self):
        """Gets the total_count of this PageableResponseSupplierProductResponse.  # noqa: E501


        :return: The total_count of this PageableResponseSupplierProductResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def total_count(self, total_count):
        """Sets the total_count of this PageableResponseSupplierProductResponse.


        :param total_count: The total_count of this PageableResponseSupplierProductResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def data(self):
        """Gets the data of this PageableResponseSupplierProductResponse.  # noqa: E501


        :return: The data of this PageableResponseSupplierProductResponse.  # noqa: E501
        :rtype: list[SupplierProductResponse]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PageableResponseSupplierProductResponse.


        :param data: The data of this PageableResponseSupplierProductResponse.  # noqa: E501
        :type: list[SupplierProductResponse]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PageableResponseSupplierProductResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PageableResponseSupplierProductResponse):
            return False
