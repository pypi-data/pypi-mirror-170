...
Run a global hybridization detection analysis or test for any hybrid species given a set of taxa.
...
Output
------
Return the p-value that test the null hyphothesis that there is no hybrid species in the data.
"""
import pyghdet
import argparse
...
if __name__ == "__main__":
    ...
    print(quiet)
    print(ignore_amb_sites)
    if not quiet: print("\nRunning individual_level.py")
    ...
    pyghdet.comb_species(infile, mapfile, outgroup, nind, ntaxa, nsites, sus_hyb, alpha, ignore_amb_sites)
