...
from ..collections.training_data_sets import TrainingDataSets
...
class FeatureView:
    def __init__(self, stub: CoreServiceStub, feature_view):
        ...
        self._stub = stub
        self.training_data_sets = TrainingDataSets(stub, self)
    ...
    def create_new_version(self, new_query: Query):
        ...
        response: pb.FeatureViewResponse = self._stub.CreateFeatureViewNewVersion(
            request
        )
