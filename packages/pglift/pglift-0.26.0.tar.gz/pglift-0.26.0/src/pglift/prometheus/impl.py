...
from .models import PostgresExporter, Service, ServiceManifest, default_port
...
def system_lookup(
    ctx: "BaseContext", name: str, settings: "PrometheusSettings"
) -> Optional[Service]:
    try:
...
def start(ctx: "BaseContext", service: Service, *, foreground: bool = False) -> None:
...
def stop(ctx: "BaseContext", service: Service) -> None:
