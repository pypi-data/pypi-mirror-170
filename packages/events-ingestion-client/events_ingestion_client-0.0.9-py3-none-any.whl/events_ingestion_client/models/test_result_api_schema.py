...
class TestResultApiSchema(object):
    ...
    def __init__(self, pipeline_name=None, test_suite=None, external_url=None, event_timestamp=None, metadata=None, test_results=None, run_tag=None, task_name=None):  # noqa: E501
    ...
    @property
    def run_tag(self):
        """Gets the run_tag of this TestResultApiSchema.  # noqa: E501
        ...
        :return: The run_tag of this TestResultApiSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def run_tag(self, run_tag):
        """Sets the run_tag of this TestResultApiSchema.

        The tag of the target run for the event action. This identifier is created and managed by the user. If no run_tag is specified, the event applies to the default open run for the pipeline.  # noqa: E501

        :param run_tag: The run_tag of this TestResultApiSchema.  # noqa: E501
        :type: str
        """
