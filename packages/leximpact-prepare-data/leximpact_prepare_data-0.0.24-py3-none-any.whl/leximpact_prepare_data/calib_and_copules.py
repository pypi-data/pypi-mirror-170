# AUTOGENERATED! DO NOT EDIT! File to edit: ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb.
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 4
import copy
import gc
import random
import statistics
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 6
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 8
def get_borders(
    dataset_size: int,
    nb_bucket: int,
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 11
def enforce_secret(
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 12
def sanitize_bucket(buckets):
    ...
    for b in buckets:
        if b == SECRET_VIOLATION:
            raise SecretViolation("SECRET STATISTIQUE > 0.85 NON RESPECTE")
    # Remove empty bucket
    # buckets = [b for b in buckets if type(b["bucket_count"]) is str or (type(b["bucket_count"]) is int and b["bucket_count"] > 0)]
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 13
class Quantile:
    def __init__(
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 15
list_revenus_each_bucket = [[]]
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 17
def get_copulas(
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 19
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 21
def get_fake_data(
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 23
def pandas_to_vaex(df):
    return vaex.from_pandas(df)


# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 31
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 34
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 36
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 38
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 42
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 46
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 48
def anonimyze_lower_and_upper_bound(content, min_len: int = 4):
    ...
    if content == [] or type(content) is str:
        return
    ...
    if type(content) is dict and content.get("copules"):
        content = content.get("copules")

    if type(content) is dict and content.get("upper_bound"):
    ...
    # Change Lower Bound
    if type(content) is list and content[0].get("lower_bound"):
        _anonimyze_dict(content[0], "lower_bound", min_len)

    # Change Lower Bound
    if type(content) is list and content[-1].get("upper_bound"):
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 50
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 53
...
# %% ../notebooks/retraitement_erfs-fpr/modules/calib_and_copule.ipynb 64
