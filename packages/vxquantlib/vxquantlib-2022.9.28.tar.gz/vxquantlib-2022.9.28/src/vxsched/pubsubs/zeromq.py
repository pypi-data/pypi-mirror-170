...
from vxsched.core import vxPublisher, vxSubscriber
...
_FRONTEND_TAGS = {
    "READY": b"__READY__",
    "PUBLISH": b"__PUBLISH__",
    "RPCMETHODS": b"__RPC_METHODS__",
    "RPCCALL": b"__RPC_CALL__",
}
_FRONTEND_REPLY_TAGS = {
    "ACK": b"__ACK__",
    "RPCMETHODS": b"__RPC_METHODS__",
    "RPCREPLY": b"__RPC_REPLY__",
}
_BACKEND_TAGS = {"PUBLISH": b"__PUBLISH__", "RPCCALL": b"__RPC_CALL__"}
_BACKEND_REPLY_TAGS = {
    "RPCMETHODS": b"__RPC_METHODS__",
    "RPCREPLY": b"__RPC_REPLY__",
}

_SUBSCRIBE_TAG = b"\x01"
_UNSUBSCRIBE_TAG = b"\x00"
...
class vxZMQSubscriber(vxSubscriber):
    ...
    def __init__(
        ...
        self._as_broker = bool(as_broker)
    ...
    def __call__(self) -> List[vxEvent]:
        ...
        with self._socket.lock:
            while self._socket.poll(10, zmq.POLLIN) != 0:
