                    ...
                    try:
                        for fact in self.control["fact-list"]:
                            ...
                            if fact["fact_type"] == "show_and_assert":
                                ...
                                status = self.get_template_multifacts_index(fact["data"], 'none', 'none', 'none')
                            elif fact["fact_type"] == "multitemplate_protofact":
                                status = self.get_template_multifacts_protofact_index(fact, 'none', 'none', 'none')
                            else:
...
#
    ...
    ##########################################################################################
                    ...
                    try:
                        parser = genie_str_to_class(fact["genie_parser"])
                        if parser == None:
                            self.print_log("\n%%%% DDR Error: Exception in run_show_parameter: parser not found: \n" + str(fact["genie_parser"]) + " \n")
                            return
...
#
   ...
   #
	...
	#
                ...
                self.print_log("\n%%%% DDR Error: Exception in run_process_file assert_fact response processing: " + str(fact) + " " + str(e))
	...
	#
                                ...
                                fact_found = True
                                self.assert_template_fact(protofact, 'device', str(device_id), sub_dictionary)
