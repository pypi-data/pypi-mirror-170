...
class G8032CheckRingStatus():
    ...
    Port0: Ethernet0/1 (Monitor: Service Instance 2)
      APS-Channel: Ethernet0/1                                                       
      Status: RPL, blocked     >>   check for status field as RPL,blocked  of port 0(Ethernet0/1) and Non-RPL for other port.
      Remote R-APS NodeId: 0000.0000.0000, BPR: 0
    Port1: Ethernet0/2 (Monitor: Service Instance 2)
      APS-Channel: Ethernet0/2
      Status: Non-RPL'''
