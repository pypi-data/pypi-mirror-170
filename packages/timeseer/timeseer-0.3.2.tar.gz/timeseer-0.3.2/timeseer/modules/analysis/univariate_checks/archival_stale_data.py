    ...
    "parameters": [
        {
            ...
            "default": 0.75,
            "helpText": "Percentile sets the upper limit of the range for calculating the IQR for stale data.",
        },
        {
            "name": "scale",
            "type": ModuleParameterType.FLOAT64,
            ...
            "default": 3,
            "helpText": "Scale sets the factor for considering an stale data frame an anomaly.",
        },
    ],
...
def _run_stale_data_check(
    ...
    delta = max(
        get_cutoff_for_sketch(stale_sketch, analysis_input), 5 * median_archival_step
    )
