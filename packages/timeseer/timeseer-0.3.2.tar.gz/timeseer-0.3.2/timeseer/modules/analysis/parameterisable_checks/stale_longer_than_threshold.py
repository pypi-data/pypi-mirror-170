...
_CHECK_NAME = "Stale longer than threshold"

META = {
    "checks": [
        {
            "name": _CHECK_NAME,
            "event_frames": ["Stale longer than threshold"],
        }
    ],
    "conditions": [
        {
    ...
    "parameters": [
        {
            ...
            "helpText": """Threshold defines when a frame in which no different value occurs
