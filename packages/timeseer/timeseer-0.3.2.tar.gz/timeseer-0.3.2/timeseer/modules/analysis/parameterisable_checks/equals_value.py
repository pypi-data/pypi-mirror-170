"""A check that evaluates whether a series is equal to a user-specified value.
"""
...
_CHECK_NAME = "Equals value"
_EVENT_FRAME_NAME = "Equals value"
    ...
    "parameters": [
        {
            ...
            "helpText": "All values equal to this parameter will be considered anomalous.",
        },
    ],
