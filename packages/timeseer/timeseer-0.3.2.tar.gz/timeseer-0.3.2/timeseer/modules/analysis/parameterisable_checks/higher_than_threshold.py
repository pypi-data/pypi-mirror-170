"""A check that evaluates whether a series is higher than a specific user-specified threshold.
"""
...
_CHECK_NAME = "Higher than threshold"
_EVENT_FRAME_NAME = "Higher than threshold"
    ...
    "parameters": [
        {
            ...
            "helpText": "All values higher than this parameter will be considerd anomalous.",
        },
    ],
