...
<template>
  <div class="form-group d-inline-block d-md-block mb-4 extra">
    <div class="form-row mr-0" :class="{'drag': extra.isDragging}">
      ...
      <!-- Key input, which is readonly if the current item is within a list. -->
      ...
      <div class="mb-1 mb-xl-0" :class="{'col-xl-3': showUnit, 'col-xl-5': !showUnit, 'mr-2 mr-xl-0': nestedType}">
        <div class="input-group input-group-sm">
      ...
      <!-- Remove and/or duplication button(s). -->
      <div class="col-xl-1" :class="{'mr-2 mr-xl-0': nestedType}">
