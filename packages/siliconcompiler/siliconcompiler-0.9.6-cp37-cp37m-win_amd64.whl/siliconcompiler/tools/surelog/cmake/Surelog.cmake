...
foreach(_cmake_expected_target IN ITEMS surelog antlr4_static flatbuffers capnp kj uhdm)
...
set_target_properties(surelog PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "antlr4_static;flatbuffers;uhdm"
)
...
set_target_properties(uhdm PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "capnp"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/Surelog-*.cmake")
