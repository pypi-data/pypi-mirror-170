...
class any_pattern final : public BaseClass {
  UHDM_IMPLEMENT_RTTI(any_pattern, BaseClass)
public:
  // Implicit constructor used to initialize all members,
  // comment: any_pattern();
  virtual ~any_pattern() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiAnyPattern; }

  virtual any_pattern* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmany_pattern; }

protected:
  void DeepCopy(any_pattern* clone, Serializer* serializer,
