...
/*
 * File:   virtual_interface_var.h
 * Author:
 *
 * Created on December 14, 2019, 10:03 PM
 */

#ifndef UHDM_VIRTUAL_INTERFACE_VAR_H
#define UHDM_VIRTUAL_INTERFACE_VAR_H
...
class virtual_interface_var final : public BaseClass {
  UHDM_IMPLEMENT_RTTI(virtual_interface_var, BaseClass)
public:
  // Implicit constructor used to initialize all members,
  // comment: virtual_interface_var();
  virtual ~virtual_interface_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiVirtualInterfaceVar; }

  virtual virtual_interface_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmvirtual_interface_var; }

protected:
  void DeepCopy(virtual_interface_var* clone, Serializer* serializer,
