...
public:
  ...
  bool Property(property_decl* data) { property_ = data; return true; }

  const sequence_decl* Sequence() const { return sequence_; }

  bool Sequence(sequence_decl* data) { sequence_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiCheckerPort; }

  virtual checker_port* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmchecker_port; }

protected:
  void DeepCopy(checker_port* clone, Serializer* serializer,
