...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiExpectStmt; }

  virtual expect_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmexpect_stmt; }

protected:
  void DeepCopy(expect_stmt* clone, Serializer* serializer,
