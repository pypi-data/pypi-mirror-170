...
/*
 * File:   short_real_var.h
 * Author:
 *
 * Created on December 14, 2019, 10:03 PM
 */

#ifndef UHDM_SHORT_REAL_VAR_H
#define UHDM_SHORT_REAL_VAR_H
...
class short_real_var final : public variables {
  UHDM_IMPLEMENT_RTTI(short_real_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: short_real_var();
  virtual ~short_real_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiShortRealVar; }

  virtual short_real_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmshort_real_var; }

protected:
  void DeepCopy(short_real_var* clone, Serializer* serializer,
