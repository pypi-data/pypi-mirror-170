...
#ifndef UHDM_INT_VAR_H
#define UHDM_INT_VAR_H
...
class int_var final : public variables {
  UHDM_IMPLEMENT_RTTI(int_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: int_var();
  virtual ~int_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiIntVar; }

  virtual int_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmint_var; }

protected:
  void DeepCopy(int_var* clone, Serializer* serializer,
