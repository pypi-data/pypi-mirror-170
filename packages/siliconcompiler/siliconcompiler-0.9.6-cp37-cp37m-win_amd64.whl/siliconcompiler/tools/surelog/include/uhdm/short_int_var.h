...
/*
 * File:   short_int_var.h
 * Author:
 *
 * Created on December 14, 2019, 10:03 PM
 */

#ifndef UHDM_SHORT_INT_VAR_H
#define UHDM_SHORT_INT_VAR_H
...
class short_int_var final : public variables {
  UHDM_IMPLEMENT_RTTI(short_int_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: short_int_var();
  virtual ~short_int_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiShortIntVar; }

  virtual short_int_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmshort_int_var; }

protected:
  void DeepCopy(short_int_var* clone, Serializer* serializer,
