...
public:
  ...
  bool Named_event(named_event* data) { named_event_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiEventStmt; }

  virtual event_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmevent_stmt; }

protected:
  void DeepCopy(event_stmt* clone, Serializer* serializer,
