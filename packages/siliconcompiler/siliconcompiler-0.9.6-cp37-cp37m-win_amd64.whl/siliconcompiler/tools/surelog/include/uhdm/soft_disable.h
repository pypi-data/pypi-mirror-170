...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiSoftDisable; }

  virtual soft_disable* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmsoft_disable; }

protected:
  void DeepCopy(soft_disable* clone, Serializer* serializer,
