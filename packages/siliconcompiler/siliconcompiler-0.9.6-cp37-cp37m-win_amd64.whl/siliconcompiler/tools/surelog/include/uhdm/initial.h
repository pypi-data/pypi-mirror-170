...
#ifndef UHDM_INITIAL_H
#define UHDM_INITIAL_H
...
class initial final : public process_stmt {
  UHDM_IMPLEMENT_RTTI(initial, process_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: initial();
  virtual ~initial() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiInitial; }

  virtual initial* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdminitial; }

protected:
  void DeepCopy(initial* clone, Serializer* serializer,
