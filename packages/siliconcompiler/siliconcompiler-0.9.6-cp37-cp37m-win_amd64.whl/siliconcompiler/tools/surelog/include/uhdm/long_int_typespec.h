...
class long_int_typespec final : public typespec {
  UHDM_IMPLEMENT_RTTI(long_int_typespec, typespec)
public:
  // Implicit constructor used to initialize all members,
  // comment: long_int_typespec();
  virtual ~long_int_typespec() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiLongIntTypespec; }

  virtual long_int_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmlong_int_typespec; }

protected:
  void DeepCopy(long_int_typespec* clone, Serializer* serializer,
