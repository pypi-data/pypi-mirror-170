...
public:
  ...
  bool Nets(VectorOfnets* data) { nets_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiStructNet; }

  virtual struct_net* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmstruct_net; }

protected:
  void DeepCopy(struct_net* clone, Serializer* serializer,
