...
#ifndef UHDM_STRING_VAR_H
#define UHDM_STRING_VAR_H
...
class string_var final : public variables {
  UHDM_IMPLEMENT_RTTI(string_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: string_var();
  virtual ~string_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiStringVar; }

  virtual string_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmstring_var; }

protected:
  void DeepCopy(string_var* clone, Serializer* serializer,
