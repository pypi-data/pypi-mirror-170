...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiByteVar; }

  virtual byte_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmbyte_var; }

protected:
  void DeepCopy(byte_var* clone, Serializer* serializer,
