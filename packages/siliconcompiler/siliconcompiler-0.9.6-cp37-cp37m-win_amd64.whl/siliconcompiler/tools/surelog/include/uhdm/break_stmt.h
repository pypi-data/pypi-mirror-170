...
class break_stmt final : public atomic_stmt {
  UHDM_IMPLEMENT_RTTI(break_stmt, atomic_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: break_stmt();
  virtual ~break_stmt() final = default;
  ...
  unsigned int VpiType() const final { return vpiBreak; }

  virtual break_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmbreak_stmt; }

protected:
  void DeepCopy(break_stmt* clone, Serializer* serializer,
