...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiVoidTypespec; }

  virtual void_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmvoid_typespec; }

protected:
  void DeepCopy(void_typespec* clone, Serializer* serializer,
