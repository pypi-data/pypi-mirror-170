...
#ifndef UHDM_TIME_VAR_H
#define UHDM_TIME_VAR_H
...
class time_var final : public variables {
  UHDM_IMPLEMENT_RTTI(time_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: time_var();
  virtual ~time_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiTimeVar; }

  virtual time_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmtime_var; }

protected:
  void DeepCopy(time_var* clone, Serializer* serializer,
