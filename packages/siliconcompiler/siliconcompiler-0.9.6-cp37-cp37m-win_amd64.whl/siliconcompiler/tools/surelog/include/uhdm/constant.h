...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiConstant; }

  virtual constant* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmconstant; }

protected:
  void DeepCopy(constant* clone, Serializer* serializer,
