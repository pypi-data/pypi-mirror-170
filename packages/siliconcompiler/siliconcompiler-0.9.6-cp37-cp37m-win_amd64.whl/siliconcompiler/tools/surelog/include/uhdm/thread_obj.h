...
#ifndef UHDM_THREAD_OBJ_H
#define UHDM_THREAD_OBJ_H
...
class thread_obj final : public BaseClass {
  UHDM_IMPLEMENT_RTTI(thread_obj, BaseClass)
public:
  // Implicit constructor used to initialize all members,
  // comment: thread_obj();
  virtual ~thread_obj() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiThread; }

  virtual thread_obj* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmthread_obj; }

protected:
  void DeepCopy(thread_obj* clone, Serializer* serializer,
