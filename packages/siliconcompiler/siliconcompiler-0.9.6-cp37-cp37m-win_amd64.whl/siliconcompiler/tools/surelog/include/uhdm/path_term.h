...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiPathTerm; }

  virtual path_term* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmpath_term; }

protected:
  void DeepCopy(path_term* clone, Serializer* serializer,
