...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiBegin; }

  virtual begin* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmbegin; }

protected:
  void DeepCopy(begin* clone, Serializer* serializer,
