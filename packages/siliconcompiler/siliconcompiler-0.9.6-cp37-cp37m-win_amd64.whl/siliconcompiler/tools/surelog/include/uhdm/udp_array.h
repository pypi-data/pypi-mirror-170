...
class udp_array final : public primitive_array {
  UHDM_IMPLEMENT_RTTI(udp_array, primitive_array)
public:
  // Implicit constructor used to initialize all members,
  // comment: udp_array();
  virtual ~udp_array() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiUdpArray; }

  virtual udp_array* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmudp_array; }

protected:
  void DeepCopy(udp_array* clone, Serializer* serializer,
