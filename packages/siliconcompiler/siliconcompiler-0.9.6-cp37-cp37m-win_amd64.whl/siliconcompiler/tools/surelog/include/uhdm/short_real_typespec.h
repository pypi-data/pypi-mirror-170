...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiShortRealTypespec; }

  virtual short_real_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmshort_real_typespec; }

protected:
  void DeepCopy(short_real_typespec* clone, Serializer* serializer,
