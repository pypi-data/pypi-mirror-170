...
#ifndef UHDM_NULL_STMT_H
#define UHDM_NULL_STMT_H
...
class null_stmt final : public atomic_stmt {
  UHDM_IMPLEMENT_RTTI(null_stmt, atomic_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: null_stmt();
  virtual ~null_stmt() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiNullStmt; }

  virtual null_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmnull_stmt; }

protected:
  void DeepCopy(null_stmt* clone, Serializer* serializer,
