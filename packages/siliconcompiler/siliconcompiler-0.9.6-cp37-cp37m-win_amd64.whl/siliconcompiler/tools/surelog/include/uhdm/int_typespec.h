...
public:
  ...
  bool Cast_to_expr(expr* data) { cast_to_expr_ = data; return true; }
  ...
  virtual unsigned int VpiType() const final { return vpiIntTypespec; }

  virtual int_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmint_typespec; }

protected:
  void DeepCopy(int_typespec* clone, Serializer* serializer,
