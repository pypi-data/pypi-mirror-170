...
#ifndef UHDM_NAMED_BEGIN_H
#define UHDM_NAMED_BEGIN_H
...
class named_begin final : public scope {
  UHDM_IMPLEMENT_RTTI(named_begin, scope)
public:
  // Implicit constructor used to initialize all members,
  // comment: named_begin();
  virtual ~named_begin() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiNamedBegin; }

  virtual named_begin* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmnamed_begin; }

protected:
  void DeepCopy(named_begin* clone, Serializer* serializer,
