...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiForce; }

  virtual force* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmforce; }

protected:
  void DeepCopy(force* clone, Serializer* serializer,
