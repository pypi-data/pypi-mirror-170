...
class byte_typespec final : public typespec {
  UHDM_IMPLEMENT_RTTI(byte_typespec, typespec)
public:
  // Implicit constructor used to initialize all members,
  // comment: byte_typespec();
  virtual ~byte_typespec() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiByteTypespec; }

  virtual byte_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmbyte_typespec; }

protected:
  void DeepCopy(byte_typespec* clone, Serializer* serializer,
