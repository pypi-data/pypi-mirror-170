...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiGateArray; }

  virtual gate_array* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmgate_array; }

protected:
  void DeepCopy(gate_array* clone, Serializer* serializer,
