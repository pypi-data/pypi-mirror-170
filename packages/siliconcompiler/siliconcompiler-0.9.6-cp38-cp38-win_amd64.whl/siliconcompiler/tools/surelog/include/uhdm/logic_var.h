...
#ifndef UHDM_LOGIC_VAR_H
#define UHDM_LOGIC_VAR_H
...
class logic_var final : public variables {
  UHDM_IMPLEMENT_RTTI(logic_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: logic_var();
  virtual ~logic_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiLogicVar; }

  virtual logic_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmlogic_var; }

protected:
  void DeepCopy(logic_var* clone, Serializer* serializer,
