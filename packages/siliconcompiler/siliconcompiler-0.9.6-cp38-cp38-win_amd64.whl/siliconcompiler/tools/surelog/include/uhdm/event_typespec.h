...
class event_typespec final : public typespec {
  UHDM_IMPLEMENT_RTTI(event_typespec, typespec)
public:
  // Implicit constructor used to initialize all members,
  // comment: event_typespec();
  virtual ~event_typespec() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiEventTypespec; }

  virtual event_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmevent_typespec; }

protected:
  void DeepCopy(event_typespec* clone, Serializer* serializer,
