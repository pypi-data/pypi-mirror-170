...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiRepeatControl; }

  virtual repeat_control* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmrepeat_control; }

protected:
  void DeepCopy(repeat_control* clone, Serializer* serializer,
