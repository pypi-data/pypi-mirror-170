...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiRestrict; }

  virtual restrict* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmrestrict; }

protected:
  void DeepCopy(restrict* clone, Serializer* serializer,
