...
class tagged_pattern final : public BaseClass {
  UHDM_IMPLEMENT_RTTI(tagged_pattern, BaseClass)
public:
  // Implicit constructor used to initialize all members,
  // comment: tagged_pattern();
  virtual ~tagged_pattern() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiTaggedPattern; }

  virtual tagged_pattern* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmtagged_pattern; }

protected:
  void DeepCopy(tagged_pattern* clone, Serializer* serializer,
