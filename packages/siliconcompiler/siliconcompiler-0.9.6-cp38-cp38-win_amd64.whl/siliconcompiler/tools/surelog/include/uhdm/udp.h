...
class udp final : public primitive {
  UHDM_IMPLEMENT_RTTI(udp, primitive)
public:
  // Implicit constructor used to initialize all members,
  // comment: udp();
  virtual ~udp() final = default;
  ...
  const udp_defn* Udp_defn() const { return udp_defn_; }

  bool Udp_defn(udp_defn* data) { udp_defn_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiUdp; }

  virtual udp* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmudp; }

protected:
  void DeepCopy(udp* clone, Serializer* serializer,
