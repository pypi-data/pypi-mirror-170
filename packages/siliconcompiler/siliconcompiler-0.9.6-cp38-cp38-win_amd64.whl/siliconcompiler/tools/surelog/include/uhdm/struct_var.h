...
#ifndef UHDM_STRUCT_VAR_H
#define UHDM_STRUCT_VAR_H
...
class struct_var final : public variables {
  UHDM_IMPLEMENT_RTTI(struct_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: struct_var();
  virtual ~struct_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiStructVar; }

  virtual struct_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmstruct_var; }

protected:
  void DeepCopy(struct_var* clone, Serializer* serializer,
