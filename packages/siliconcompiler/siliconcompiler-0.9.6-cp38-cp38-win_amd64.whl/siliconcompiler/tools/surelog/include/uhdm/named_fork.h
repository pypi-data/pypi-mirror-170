...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiNamedFork; }

  virtual named_fork* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmnamed_fork; }

protected:
  void DeepCopy(named_fork* clone, Serializer* serializer,
