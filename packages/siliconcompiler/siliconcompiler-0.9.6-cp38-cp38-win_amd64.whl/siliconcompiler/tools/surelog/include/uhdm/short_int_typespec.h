...
/*
 * File:   short_int_typespec.h
 * Author:
 *
 * Created on December 14, 2019, 10:03 PM
 */

#ifndef UHDM_SHORT_INT_TYPESPEC_H
#define UHDM_SHORT_INT_TYPESPEC_H
...
class short_int_typespec final : public typespec {
  UHDM_IMPLEMENT_RTTI(short_int_typespec, typespec)
public:
  // Implicit constructor used to initialize all members,
  // comment: short_int_typespec();
  virtual ~short_int_typespec() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiShortIntTypespec; }

  virtual short_int_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmshort_int_typespec; }

protected:
  void DeepCopy(short_int_typespec* clone, Serializer* serializer,
