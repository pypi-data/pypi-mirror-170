...
class repeat final : public atomic_stmt {
  UHDM_IMPLEMENT_RTTI(repeat, atomic_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: repeat();
  virtual ~repeat() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiRepeat; }

  virtual repeat* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmrepeat; }

protected:
  void DeepCopy(repeat* clone, Serializer* serializer,
