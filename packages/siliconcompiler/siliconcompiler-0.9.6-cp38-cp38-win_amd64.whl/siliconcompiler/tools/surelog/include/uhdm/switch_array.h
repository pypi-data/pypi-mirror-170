...
class switch_array final : public primitive_array {
  UHDM_IMPLEMENT_RTTI(switch_array, primitive_array)
public:
  // Implicit constructor used to initialize all members,
  // comment: switch_array();
  virtual ~switch_array() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiSwitchArray; }

  virtual switch_array* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmswitch_array; }

protected:
  void DeepCopy(switch_array* clone, Serializer* serializer,
