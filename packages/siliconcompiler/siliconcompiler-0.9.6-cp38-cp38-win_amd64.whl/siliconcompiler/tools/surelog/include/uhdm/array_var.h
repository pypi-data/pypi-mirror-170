...
#ifndef UHDM_ARRAY_VAR_H
#define UHDM_ARRAY_VAR_H
...
class array_var final : public variables {
  UHDM_IMPLEMENT_RTTI(array_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: array_var();
  virtual ~array_var() final = default;
  ...
  VectorOfvar_select* Var_selects() const { return var_selects_; }

  bool Var_selects(VectorOfvar_select* data) { var_selects_ = data; return true; }
  ...
  virtual unsigned int VpiType() const final { return vpiArrayVar; }

  virtual array_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmarray_var; }

protected:
  void DeepCopy(array_var* clone, Serializer* serializer,
...
private:
  ...
  VectorOfvar_select* var_selects_ = nullptr;
