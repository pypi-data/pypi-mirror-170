...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiRelease; }

  virtual release* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmrelease; }

protected:
  void DeepCopy(release* clone, Serializer* serializer,
