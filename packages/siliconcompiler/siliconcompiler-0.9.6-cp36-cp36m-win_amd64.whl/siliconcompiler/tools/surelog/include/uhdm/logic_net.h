...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiLogicNet; }

  virtual logic_net* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmlogic_net; }

protected:
  void DeepCopy(logic_net* clone, Serializer* serializer,
