...
class wait_fork final : public waits {
  UHDM_IMPLEMENT_RTTI(wait_fork, waits)
public:
  // Implicit constructor used to initialize all members,
  // comment: wait_fork();
  virtual ~wait_fork() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiWaitFork; }

  virtual wait_fork* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmwait_fork; }

protected:
  void DeepCopy(wait_fork* clone, Serializer* serializer,
