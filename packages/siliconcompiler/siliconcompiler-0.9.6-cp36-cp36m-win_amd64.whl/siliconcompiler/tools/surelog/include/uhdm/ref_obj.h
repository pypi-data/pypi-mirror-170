...
class ref_obj final : public simple_expr {
  UHDM_IMPLEMENT_RTTI(ref_obj, simple_expr)
public:
  // Implicit constructor used to initialize all members,
  // comment: ref_obj();
  virtual ~ref_obj() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiRefObj; }

  virtual ref_obj* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmref_obj; }

protected:
  void DeepCopy(ref_obj* clone, Serializer* serializer,
