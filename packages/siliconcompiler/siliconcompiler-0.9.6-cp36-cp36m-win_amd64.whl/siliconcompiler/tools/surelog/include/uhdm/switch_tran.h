...
#ifndef UHDM_SWITCH_TRAN_H
#define UHDM_SWITCH_TRAN_H
...
class switch_tran final : public primitive {
  UHDM_IMPLEMENT_RTTI(switch_tran, primitive)
public:
  // Implicit constructor used to initialize all members,
  // comment: switch_tran();
  virtual ~switch_tran() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiSwitch; }

  virtual switch_tran* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmswitch_tran; }

protected:
  void DeepCopy(switch_tran* clone, Serializer* serializer,
