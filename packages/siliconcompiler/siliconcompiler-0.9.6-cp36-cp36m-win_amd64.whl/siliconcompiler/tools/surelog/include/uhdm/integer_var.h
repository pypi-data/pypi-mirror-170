...
#ifndef UHDM_INTEGER_VAR_H
#define UHDM_INTEGER_VAR_H
...
class integer_var final : public variables {
  UHDM_IMPLEMENT_RTTI(integer_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: integer_var();
  virtual ~integer_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiIntegerVar; }

  virtual integer_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdminteger_var; }

protected:
  void DeepCopy(integer_var* clone, Serializer* serializer,
