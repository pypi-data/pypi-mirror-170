...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiUnsupportedTypespec; }

  virtual unsupported_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmunsupported_typespec; }

protected:
  void DeepCopy(unsupported_typespec* clone, Serializer* serializer,
