...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiNamedEventArray; }

  virtual named_event_array* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmnamed_event_array; }

protected:
  void DeepCopy(named_event_array* clone, Serializer* serializer,
