...
public:
  ...
  bool VpiExpr(any* data) { if (!task_func_named_begin_fork_groupGroupCompliant(data)) return false; vpiExpr_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiDisable; }

  virtual disable* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmdisable; }

protected:
  void DeepCopy(disable* clone, Serializer* serializer,
