...
class task final : public task_func {
  UHDM_IMPLEMENT_RTTI(task, task_func)
public:
  // Implicit constructor used to initialize all members,
  // comment: task();
  virtual ~task() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiTask; }

  virtual task* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
...
protected:
  void DeepCopy(task* clone, Serializer* serializer,
