...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiImmediateAssume; }

  virtual immediate_assume* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmimmediate_assume; }

protected:
  void DeepCopy(immediate_assume* clone, Serializer* serializer,
