...
class while_stmt final : public atomic_stmt {
  UHDM_IMPLEMENT_RTTI(while_stmt, atomic_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: while_stmt();
  virtual ~while_stmt() final = default;
  ...
  unsigned int VpiType() const final { return vpiWhile; }
  ...
  virtual while_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmwhile_stmt; }

protected:
  void DeepCopy(while_stmt* clone, Serializer* serializer,
