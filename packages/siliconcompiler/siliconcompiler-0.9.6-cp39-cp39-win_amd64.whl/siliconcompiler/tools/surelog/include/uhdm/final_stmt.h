...
class final_stmt final : public process_stmt {
  UHDM_IMPLEMENT_RTTI(final_stmt, process_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: final_stmt();
  virtual ~final_stmt() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiFinal; }

  virtual final_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmfinal_stmt; }

protected:
  void DeepCopy(final_stmt* clone, Serializer* serializer,
