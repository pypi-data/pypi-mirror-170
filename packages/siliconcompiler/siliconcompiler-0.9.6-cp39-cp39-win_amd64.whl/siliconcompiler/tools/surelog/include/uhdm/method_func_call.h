...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiMethodFuncCall; }
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmmethod_func_call; }

protected:
  void DeepCopy(method_func_call* clone, Serializer* serializer,
