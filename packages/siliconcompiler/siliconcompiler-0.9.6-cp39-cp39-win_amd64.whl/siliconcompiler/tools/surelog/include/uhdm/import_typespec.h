...
public:
  ...
  unsigned int VpiType() const final { return uhdmimport_typespec; }

  const constant* Item() const { return item_; }

  bool Item(constant* data) { item_ = data; return true; }

  virtual import_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmimport_typespec; }

protected:
  void DeepCopy(import_typespec* clone, Serializer* serializer,
