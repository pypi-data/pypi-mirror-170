...
#ifndef UHDM_CHANDLE_VAR_H
#define UHDM_CHANDLE_VAR_H
...
class chandle_var final : public variables {
  UHDM_IMPLEMENT_RTTI(chandle_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: chandle_var();
  virtual ~chandle_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiChandleVar; }

  virtual chandle_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmchandle_var; }

protected:
  void DeepCopy(chandle_var* clone, Serializer* serializer,
