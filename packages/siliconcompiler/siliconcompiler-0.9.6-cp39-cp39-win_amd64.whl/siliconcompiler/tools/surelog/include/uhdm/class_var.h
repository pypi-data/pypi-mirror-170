...
#ifndef UHDM_CLASS_VAR_H
#define UHDM_CLASS_VAR_H
...
class class_var final : public variables {
  UHDM_IMPLEMENT_RTTI(class_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: class_var();
  virtual ~class_var() final = default;
  ...
  const class_obj* Class_obj() const { return class_obj_; }

  bool Class_obj(class_obj* data) { class_obj_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiClassVar; }

  virtual class_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmclass_var; }

protected:
  void DeepCopy(class_var* clone, Serializer* serializer,
