...
public:
  ...
  bool Cont_assign_bits(VectorOfcont_assign_bit* data) { cont_assign_bits_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiContAssign; }

  virtual cont_assign* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmcont_assign; }

protected:
  void DeepCopy(cont_assign* clone, Serializer* serializer,
