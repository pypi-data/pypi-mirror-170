...
public:
  ...
  virtual net_loads* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override = 0;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const override { return uhdmnet_loads; }

protected:
  void DeepCopy(net_loads* clone, Serializer* serializer,
