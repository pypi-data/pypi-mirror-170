...
public:
  ...
  bool Ports(VectorOfchecker_inst_port* data) { ports_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiCheckerInst; }

  virtual checker_inst* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmchecker_inst; }

protected:
  void DeepCopy(checker_inst* clone, Serializer* serializer,
