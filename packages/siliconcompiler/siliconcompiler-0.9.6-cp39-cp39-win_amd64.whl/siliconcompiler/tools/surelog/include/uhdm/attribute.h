...
public:
  ...
  bool VpiDefAttribute(bool data) { vpiDefAttribute_ = data; return true; }
  ...
  virtual unsigned int VpiType() const final { return vpiAttribute; }

  virtual attribute* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmattribute; }

protected:
  void DeepCopy(attribute* clone, Serializer* serializer,
