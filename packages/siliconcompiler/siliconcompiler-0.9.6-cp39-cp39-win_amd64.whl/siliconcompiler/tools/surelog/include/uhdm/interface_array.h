...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiInterfaceArray; }

  virtual interface_array* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdminterface_array; }

protected:
  void DeepCopy(interface_array* clone, Serializer* serializer,
