...
/*
 * File:   real_typespec.h
 * Author:
 *
 * Created on December 14, 2019, 10:03 PM
 */

#ifndef UHDM_REAL_TYPESPEC_H
#define UHDM_REAL_TYPESPEC_H
...
class real_typespec final : public typespec {
  UHDM_IMPLEMENT_RTTI(real_typespec, typespec)
public:
  // Implicit constructor used to initialize all members,
  // comment: real_typespec();
  virtual ~real_typespec() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiRealTypespec; }

  virtual real_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmreal_typespec; }

protected:
  void DeepCopy(real_typespec* clone, Serializer* serializer,
