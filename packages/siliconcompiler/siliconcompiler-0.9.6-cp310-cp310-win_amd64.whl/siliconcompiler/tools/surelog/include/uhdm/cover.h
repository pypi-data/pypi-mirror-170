...
public:
  ...
  bool VpiIsCoverSequence(bool data) { vpiIsCoverSequence_ = data; return true; }
  ...
  virtual unsigned int VpiType() const final { return vpiCover; }

  virtual cover* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmcover; }

protected:
  void DeepCopy(cover* clone, Serializer* serializer,
