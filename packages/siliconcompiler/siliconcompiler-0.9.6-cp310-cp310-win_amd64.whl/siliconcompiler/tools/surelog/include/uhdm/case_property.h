...
public:
  ...
  bool Case_property_items(VectorOfcase_property_item* data) { case_property_items_ = data; return true; }

  virtual unsigned int VpiType() const final { return vpiCaseProperty; }

  virtual case_property* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmcase_property; }

protected:
  void DeepCopy(case_property* clone, Serializer* serializer,
