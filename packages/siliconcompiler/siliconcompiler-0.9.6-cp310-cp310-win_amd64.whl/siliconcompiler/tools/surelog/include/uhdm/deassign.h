...
#ifndef UHDM_DEASSIGN_H
#define UHDM_DEASSIGN_H
...
class deassign final : public atomic_stmt {
  UHDM_IMPLEMENT_RTTI(deassign, atomic_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: deassign();
  virtual ~deassign() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiDeassign; }

  virtual deassign* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmdeassign; }

protected:
  void DeepCopy(deassign* clone, Serializer* serializer,
