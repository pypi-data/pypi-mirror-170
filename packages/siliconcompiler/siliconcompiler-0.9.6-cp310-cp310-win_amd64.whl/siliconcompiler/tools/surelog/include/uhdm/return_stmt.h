...
class return_stmt final : public atomic_stmt {
  UHDM_IMPLEMENT_RTTI(return_stmt, atomic_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: return_stmt();
  virtual ~return_stmt() final = default;
  ...
  unsigned int VpiType() const final { return vpiReturn; }

  const expr* VpiCondition() const { return vpiCondition_; }

  bool VpiCondition(expr* data) { vpiCondition_ = data; return true; }

  virtual return_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmreturn_stmt; }

protected:
  void DeepCopy(return_stmt* clone, Serializer* serializer,
