...
class immediate_cover final : public atomic_stmt {
  UHDM_IMPLEMENT_RTTI(immediate_cover, atomic_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: immediate_cover();
  virtual ~immediate_cover() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiImmediateCover; }

  virtual immediate_cover* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmimmediate_cover; }

protected:
  void DeepCopy(immediate_cover* clone, Serializer* serializer,
