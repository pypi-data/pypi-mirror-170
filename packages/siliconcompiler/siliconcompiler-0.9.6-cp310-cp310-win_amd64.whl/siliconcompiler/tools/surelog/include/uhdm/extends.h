...
class extends final : public BaseClass {
  UHDM_IMPLEMENT_RTTI(extends, BaseClass)
public:
  // Implicit constructor used to initialize all members,
  // comment: extends();
  virtual ~extends() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiExtends; }

  virtual extends* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmextends; }

protected:
  void DeepCopy(extends* clone, Serializer* serializer,
