...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiAssert; }

  virtual assert_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmassert_stmt; }

protected:
  void DeepCopy(assert_stmt* clone, Serializer* serializer,
