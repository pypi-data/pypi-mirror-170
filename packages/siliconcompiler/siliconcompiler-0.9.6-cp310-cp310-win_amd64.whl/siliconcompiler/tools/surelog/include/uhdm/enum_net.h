...
#ifndef UHDM_ENUM_NET_H
#define UHDM_ENUM_NET_H
...
class enum_net final : public net {
  UHDM_IMPLEMENT_RTTI(enum_net, net)
public:
  // Implicit constructor used to initialize all members,
  // comment: enum_net();
  virtual ~enum_net() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiEnumNet; }

  virtual enum_net* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmenum_net; }

protected:
  void DeepCopy(enum_net* clone, Serializer* serializer,
