...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiGenVar; }

  virtual gen_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmgen_var; }

protected:
  void DeepCopy(gen_var* clone, Serializer* serializer,
