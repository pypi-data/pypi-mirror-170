...
/*
 * File:   string_typespec.h
 * Author:
 *
 * Created on December 14, 2019, 10:03 PM
 */

#ifndef UHDM_STRING_TYPESPEC_H
#define UHDM_STRING_TYPESPEC_H
...
class string_typespec final : public typespec {
  UHDM_IMPLEMENT_RTTI(string_typespec, typespec)
public:
  // Implicit constructor used to initialize all members,
  // comment: string_typespec();
  virtual ~string_typespec() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiStringTypespec; }

  virtual string_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmstring_typespec; }

protected:
  void DeepCopy(string_typespec* clone, Serializer* serializer,
