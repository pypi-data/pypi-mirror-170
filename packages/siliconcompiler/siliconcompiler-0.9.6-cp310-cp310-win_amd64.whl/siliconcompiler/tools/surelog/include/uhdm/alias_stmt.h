...
class alias_stmt final : public BaseClass {
  UHDM_IMPLEMENT_RTTI(alias_stmt, BaseClass)
public:
  // Implicit constructor used to initialize all members,
  // comment: alias_stmt();
  virtual ~alias_stmt() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiAliasStmt; }

  virtual alias_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmalias_stmt; }

protected:
  void DeepCopy(alias_stmt* clone, Serializer* serializer,
