...
#ifndef UHDM_INTEGER_NET_H
#define UHDM_INTEGER_NET_H
...
class integer_net final : public net {
  UHDM_IMPLEMENT_RTTI(integer_net, net)
public:
  // Implicit constructor used to initialize all members,
  // comment: integer_net();
  virtual ~integer_net() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiIntegerNet; }

  virtual integer_net* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdminteger_net; }

protected:
  void DeepCopy(integer_net* clone, Serializer* serializer,
