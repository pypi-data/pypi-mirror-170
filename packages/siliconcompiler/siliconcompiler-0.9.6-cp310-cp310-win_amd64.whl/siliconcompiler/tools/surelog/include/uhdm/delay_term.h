...
#ifndef UHDM_DELAY_TERM_H
#define UHDM_DELAY_TERM_H
...
class delay_term final : public BaseClass {
  UHDM_IMPLEMENT_RTTI(delay_term, BaseClass)
public:
  // Implicit constructor used to initialize all members,
  // comment: delay_term();
  virtual ~delay_term() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiDelayTerm; }

  virtual delay_term* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmdelay_term; }

protected:
  void DeepCopy(delay_term* clone, Serializer* serializer,
