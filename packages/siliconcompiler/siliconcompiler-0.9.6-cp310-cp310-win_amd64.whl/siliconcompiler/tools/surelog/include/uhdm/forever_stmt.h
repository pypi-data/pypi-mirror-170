...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiForever; }

  virtual forever_stmt* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmforever_stmt; }

protected:
  void DeepCopy(forever_stmt* clone, Serializer* serializer,
