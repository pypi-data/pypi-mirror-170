...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiSequenceTypespec; }

  virtual sequence_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmsequence_typespec; }

protected:
  void DeepCopy(sequence_typespec* clone, Serializer* serializer,
