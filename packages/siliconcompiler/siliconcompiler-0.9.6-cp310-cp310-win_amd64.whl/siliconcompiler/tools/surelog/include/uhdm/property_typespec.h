...
/*
 * File:   property_typespec.h
 * Author:
 *
 * Created on December 14, 2019, 10:03 PM
 */

#ifndef UHDM_PROPERTY_TYPESPEC_H
#define UHDM_PROPERTY_TYPESPEC_H
...
class property_typespec final : public typespec {
  UHDM_IMPLEMENT_RTTI(property_typespec, typespec)
public:
  // Implicit constructor used to initialize all members,
  // comment: property_typespec();
  virtual ~property_typespec() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiPropertyTypespec; }

  virtual property_typespec* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmproperty_typespec; }

protected:
  void DeepCopy(property_typespec* clone, Serializer* serializer,
