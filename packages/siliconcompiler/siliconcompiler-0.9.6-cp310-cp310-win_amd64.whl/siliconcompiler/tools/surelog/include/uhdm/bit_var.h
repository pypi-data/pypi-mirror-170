...
#ifndef UHDM_BIT_VAR_H
#define UHDM_BIT_VAR_H
...
class bit_var final : public variables {
  UHDM_IMPLEMENT_RTTI(bit_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: bit_var();
  virtual ~bit_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiBitVar; }

  virtual bit_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmbit_var; }

protected:
  void DeepCopy(bit_var* clone, Serializer* serializer,
