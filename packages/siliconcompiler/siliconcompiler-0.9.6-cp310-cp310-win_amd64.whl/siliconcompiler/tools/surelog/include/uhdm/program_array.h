...
public:
  ...
  virtual unsigned int VpiType() const final { return vpiProgramArray; }

  virtual program_array* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmprogram_array; }

protected:
  void DeepCopy(program_array* clone, Serializer* serializer,
