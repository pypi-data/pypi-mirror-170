...
#ifndef UHDM_LONG_INT_VAR_H
#define UHDM_LONG_INT_VAR_H
...
class long_int_var final : public variables {
  UHDM_IMPLEMENT_RTTI(long_int_var, variables)
public:
  // Implicit constructor used to initialize all members,
  // comment: long_int_var();
  virtual ~long_int_var() final = default;
  ...
  virtual unsigned int VpiType() const final { return vpiLongIntVar; }

  virtual long_int_var* DeepClone(Serializer* serializer, ElaboratorListener* elaborator, BaseClass* parent) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmlong_int_var; }

protected:
  void DeepCopy(long_int_var* clone, Serializer* serializer,
