...
class DiskPoolIscsiTargetLun(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["DiskPoolIscsiTargetLunTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        :param disk_pool_managed_disk_attachment_id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool_iscsi_target_lun#disk_pool_managed_disk_attachment_id DiskPoolIscsiTargetLun#disk_pool_managed_disk_attachment_id}.
        :param iscsi_target_id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool_iscsi_target_lun#iscsi_target_id DiskPoolIscsiTargetLun#iscsi_target_id}.
        :param name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool_iscsi_target_lun#name DiskPoolIscsiTargetLun#name}.
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool_iscsi_target_lun#id DiskPoolIscsiTargetLun#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool_iscsi_target_lun#timeouts DiskPoolIscsiTargetLun#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DiskPoolIscsiTargetLun.__init__)
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool_iscsi_target_lun#create DiskPoolIscsiTargetLun#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool_iscsi_target_lun#delete DiskPoolIscsiTargetLun#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool_iscsi_target_lun#read DiskPoolIscsiTargetLun#read}.
        '''
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DiskPoolIscsiTargetLunTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DiskPoolIscsiTargetLunTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
    ...
    def disk_pool_managed_disk_attachment_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DiskPoolIscsiTargetLun, "disk_pool_managed_disk_attachment_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DiskPoolIscsiTargetLun, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def iscsi_target_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DiskPoolIscsiTargetLun, "iscsi_target_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DiskPoolIscsiTargetLun, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DiskPoolIscsiTargetLunConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DiskPoolIscsiTargetLunConfig.__init__)
...
class DiskPoolIscsiTargetLunTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DiskPoolIscsiTargetLunTimeouts.__init__)
...
class DiskPoolIscsiTargetLunTimeoutsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DiskPoolIscsiTargetLunTimeoutsOutputReference.__init__)
    ...
    def create(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DiskPoolIscsiTargetLunTimeoutsOutputReference, "create").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def delete(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DiskPoolIscsiTargetLunTimeoutsOutputReference, "delete").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def read(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DiskPoolIscsiTargetLunTimeoutsOutputReference, "read").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DiskPoolIscsiTargetLunTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DiskPoolIscsiTargetLunTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DiskPoolIscsiTargetLunTimeoutsOutputReference, "internal_value").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
