...
class NodeDataTypes:
    props: Union[Activation, ActivityRegularization, Add, AdditiveAttention, AlphaDropout, Average, AveragePooling1D, 
                 ...
                 SquaredHinge, Adadelta, Adagrad, Adam, Adamax, Ftrl, Nadam, RMSprop, SGD, OnnxErf, OnnxHardSigmoid, 
                 OnnxReduceMean, OnnxSqrt, Dataset, RepresentationBlock, GroundTruth, CustomLoss, Visualizer, Lambda, 
                 TFOpLambda, SlicingOpLambda, Repeat, Variable, Gather, FixedDropout]
