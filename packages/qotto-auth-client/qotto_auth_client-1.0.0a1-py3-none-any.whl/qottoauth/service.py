...
class QottoAuthService:
    ...
    def get_account(self, account_id: str) -> Optional[Account]:
        ...
        return Account(
            ...
            enabled=account_data['enabled'],
            data=json.loads(account_data['data']),
        )
    ...
    def get_identities(self) -> list[Identity]:
        ...
        return [
            Identity(
                ...
                ) if 'user' in identity_data else None,
    ...
    def delete_organization(self, organization: Organization) -> bool:
        ...
        logger.info(f"Organization {organization.name} deleted: {organization_data}.")
    ...
    def delete_identity(self, identity: Identity) -> bool:
        logger.info(f"Deleting identity {identity.name}.")
        ...
        logger.info(f"Identity {identity.name} deleted: {identity_data}.")
    ...
    def delete_member(self, member: Member) -> bool:
        logger.info(f"Deleting member {member.member_id}.")
        member_data = self.api.mutation(
            name='deleteMember',
            input_value={
                'memberId': member.member_id,
        ...
        logger.info(f"Member {member.member_id} deleted: {member_data}.")
    ...
    def delete_role(self, role: Role) -> bool:
        ...
        logger.info(f"Role {role.name} deleted: {role_data}.")
    ...
    def delete_authorization(self, authorization: Authorization) -> bool:
        logger.info(f"Deleting authorization {authorization.name}.")
        authorization_data = self.api.mutation(
        ...
        logger.info(f"Authorization {authorization.name} deleted: {authorization_data}.")
