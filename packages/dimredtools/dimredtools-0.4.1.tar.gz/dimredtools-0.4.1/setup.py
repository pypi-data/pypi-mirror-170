...
setup(
    name="dimredtools",
    version=version,
    author="Filipp Zapolskikh",
    author_email="fmzapolskikh@edu.hse.ru",
    description="DimRedTools is a set of algorithms and data structures for dimensionality reduction",
    url='https://github.com/Keeper318/DimRedTools',
    long_description=open('README.md').read(),
    long_description_content_type='text/markdown',
    license="MIT",
    include_package_data=True,
    packages=['dimredtools'],
    package_dir={'':'src/Python'},
    ext_modules=[CMakeExtension("dimredtools_pybind")],
