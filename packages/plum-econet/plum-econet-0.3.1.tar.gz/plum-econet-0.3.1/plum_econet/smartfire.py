...
class Smartfire(object):
    ...
    @property
    def central_heating_pump(self) -> str:
        if (sensor := self.sensors.get("central_heating_pump")) is None:
            raise EconetUninitilized
        return sensor
    ...
    async def update(self) -> None:
        if hasattr(self, "_econet") is False:
            ...
            self.sensors["central_heating_pump"] = Sensor(
                self._econet, Params.PUMP_MIXER_1
            )
