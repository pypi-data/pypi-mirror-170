...
class CSVImportOptions():
    ...
    def compression(self) -> typing.Optional[str]:
        ...
        """
    @compression.setter
    def compression(self, arg0: typing.Optional[str]) -> None:
        pass
...
class Relation():
    ...
    def count(self) -> typing.Optional[typing.Tuple[int, ]]: ...
    def push(self, alias: str) -> Relation: ...

    def distinct(self) -> Relation: ...
    def sql_transform(self, alias: str, query: str) -> Relation: ...
    ...
    def materialize(self, name: typing.Optional[str] = None, schema: typing.Optional[str] = None) -> Result: ...
    def insertIntoTable(self, name: str, schema: typing.Optional[str] = None) -> None: ...
...
class Result():
    ...
    def to_arrow_table(self, maxRows: int) -> pyarrow.lib.Table:
        ...

    def to_arrow_record_batch_reader(self, maxRows: int) -> pyarrow.lib.RecordBatchReader:
        ...
...
class SandBoxConnection:
    ...
    def execute(self, query: str, params: typing.Any, many: bool) -> Result:
        ...
    ...
    def arrow(self,
              arrowObj: ArrowObject,
              name: str) -> Relation:
        ...

    def relationFromQuery(self,
                          query: str,
                          name: str) -> Relation:
        ...
