#!/usr/bin/env python
"""
Package metadata for instruqtxblock.
"""
import os
import re
import sys
...
VERSION = get_version('instruqtxblock', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""XBlock to embed Instruqt track in Open edX""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edly',
    author_email='admin@edly.io',
    url='https://github.com/edly-io/instruqt-xblock',
    packages=[
        'instruqtxblock',
    ],
    ...
    entry_points={
        'xblock.v1': [
            'instruqtxblock = instruqtxblock:InstruqtXBlock',
        ]
    },
    package_data=package_data("instruqtxblock", ["static", "public"]),
)
