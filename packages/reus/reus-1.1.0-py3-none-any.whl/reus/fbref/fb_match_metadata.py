...
def fb_match_metadata(pageSoup=None, url: str = None, verbose: bool = True) -> tuple:
    ...
    if len(managers) == 4:
        ...
        if verbose:
            print(
                f"{match_id} match between {team_x} and {team_y} missing manager or captain"
            )
