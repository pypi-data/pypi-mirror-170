...
class BuilderLEDET:
    ...
    def __init__(self, path_magnet: Path = None, input_model_data=None,
        ...
        if self.case_model == 'magnet':
            ...
            if flag_build:
                ...
                if type_windings in ['multipole', 'solenoid', 'busbar', 'CCT_straight']:
    ...
    def setThermalConnections(self):
        ...
        if typeWindings in ['multipole', 'solenoid', 'busbar']:
    ...
    def setSelfMutualInductances(self):
        ...
        if self.Auxiliary.overwrite_HalfTurnToInductanceBlock:
            ...
            elif (magnet_type == 'solenoid') or (magnet_type == 'CCT_straight') or (magnet_type == 'busbar'):
    ...
    def assignCCTTurnsRefinement(self):
        ...
        field_map_3D_csv = Path.joinpath(self.path_magnet, f'{self.model_data.GeneralParameters.magnet_name}_{str(self.model_data.Options_LEDET.simulation_3D.sim3D_import3DGeometry_modelNumber)}.csv')
        ...
        sim3D_idxFinerMeshHalfTurn = physical_turns_Tpulse + ph_turns_height + ph_turns_width
        print(f'sim3D_idxFinerMeshHalfTurn: {sim3D_idxFinerMeshHalfTurn}')
        self.setAttribute(self.Inputs, 'sim3D_idxFinerMeshHalfTurn', np.array(sim3D_idxFinerMeshHalfTurn, dtype='int'))
