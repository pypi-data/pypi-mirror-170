...
];let HuiPictureEntityCardEditor=_decorate([n("hui-picture-camera-card-editor")],function(_initialize,_LitElement){class HuiPictureEntityCardEditor extends _LitElement{constructor(...args){super(...args);_initialize(this);}}return {F:HuiPictureEntityCardEditor,d:[{kind:"field",decorators:[e({attribute:false})],key:"hass",value:void 0},{kind:"field",decorators:[t()],key:"_config",value:void 0},{kind:"method",key:"setConfig",value:function setConfig(config){assert(config,cardConfigStruct);this._config=config;}},{kind:"get",key:"_tap_action",value:function _tap_action(){return this._config.tap_action||{action:"more-info"};}},{kind:"get",key:"_hold_action",value:function _hold_action(){return this._config.hold_action;}},{kind:"method",key:"render",value:function render(){if(!this.hass||!this._config){return $``;}const actions=["more-info","toggle","navigate","call-service","none"];const data={show_state:true,show_name:true,camera_view:"auto",...this._config};return $`
      <ha-form
        .hass=${this.hass}
        .data=${data}
        .schema=${SCHEMA}
