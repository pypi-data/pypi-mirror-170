...
class abstract_interface(QtCore.QObject):
    ...
    def __init__(self, app ,name_logger=None,config=None):
        """
    ...
    def check_property_until(self, property_to_check, values_list, actions_list, refresh_time=0.1):
        '''
        property_to_check: functionm takes no parameter in input
        ...
        if call_again:
            QtCore.QTimer.singleShot(int(refresh_time*1e3), lambda :  self.check_property_until(property_to_check, values_list, actions_list, refresh_time))
