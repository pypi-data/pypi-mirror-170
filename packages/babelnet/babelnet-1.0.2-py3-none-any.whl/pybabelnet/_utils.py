"""A PyBabelNet utility module. Mainly for internal use."""
...
def lemma_to_string(lemma: str) -> str:
    """Transform a lemma in a string. It filters the input by removing the annotations inside the parenthesis at the
    end of the lemma (if present)
...
def simple_lemma_to_string(lemma: str) -> str:
    """Transform a simpleLemma in a string. It filters the input by removing the annotations inside the parenthesis at the
    end of the simpleLemma (if present)
