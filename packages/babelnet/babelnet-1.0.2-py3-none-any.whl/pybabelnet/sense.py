...
from pybabelnet._utils import comparator, cmp, simple_lemma_to_string, lemma_to_string
from pybabelnet.data.lemma import BabelLemma, BabelLemmaType
from pybabelnet.data.license import BabelLicense
from pybabelnet.data.phonetics import BabelSensePhonetics
...
from pybabelnet.resources import BabelExternalResource
...
class BabelSense:
    ...
    @ivar simple_lemma: The simple lemma for this sense (without parentheses, etc.).
    ...
    @ivar synset: The synset this sense belongs to.
    ...
    def __init__(
        ...
        *,
        ...
        @type synset: L{BabelSynset <pybabelnet.synset.BabelSynset>}
        ...
        self.simple_lemma = simple_lemma_to_string(lemma)
    ...
    def __hash__(self):
        return hash((self.synset_id, hash(self.full_lemma), hash(self.source)))
    ...
    def synset(self) -> "BabelSynset":
        ...
        @return: the synset
        @rtype: L{BabelSynset <pybabelnet.synset.BabelSynset>}
        """
        if not self._synset:
    ...
    def synset(self, value: "BabelSynset"):
        ...
        @type value: L{BabelSynset <pybabelnet.synset.BabelSynset>}
        """
        self._synset = value
...
class BabelSenseComparator:
    ...
    def _sort_wordnet(self, b1: BabelSense, b2: BabelSense):
        wn1: WordNetSense = b1
        wn2: WordNetSense = b2
    ...
    def compare(self, b1: BabelSense, b2: BabelSense) -> int:
        ...
        if b_wordnet1 and b_wordnet2:
            return self._sort_wordnet(b1, b2)
...
class BabelWordSenseComparator(BabelSenseComparator):
    ...
    def _sort_by_parentheses(self, b1: BabelSense, b2: BabelSense) -> int:
        ...
        if self.word:
            lemmab1 = b1.simple_lemma
            lemmab2 = b2.simple_lemma
