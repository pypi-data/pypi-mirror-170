...
from pybabelnet.indices import local_index
from pybabelnet.apis.abstract_api import AbstractAPI
from pybabelnet.data.relation import BabelSynsetRelation
...
from pybabelnet.sense import BabelSense, WordNetSense
from pybabelnet.synset import BabelSynset
...
class LocalAPI(AbstractAPI):
    ...
    def _get_senses(
        ...
        **kwargs,
        ...
        # TODO: DEBUG ##
        # from pybabelnet.synset import BabelSynsetComparator
        ...
        for synset in synsets:
            ...
            #     from pybabelnet.sense import BabelSenseComparator
            ...
            for sense in synset.senses():
                if containing and words and sense.simple_lemma.lower() not in words:
                    continue
    ...
    def images(self, synset_id: BabelSynsetID):
        return self._index.images(synset_id)
