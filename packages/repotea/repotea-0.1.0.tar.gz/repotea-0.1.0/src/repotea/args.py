...
class ArgumentParser:
    ...
    def empty_subcommand_handler(self, fn):
        """Decorator for marking a function which should handle the lack of
        subcommand chosen.
        """
        self.parser.set_defaults(func=fn)
        return fn
...
cli = ArgumentParser(description="Command line Gitea API interface.")
