...
curl -L https://github.com/PyO3/maturin/releases/download/v0.13.5/maturin-x86_64-unknown-linux-musl.tar.gz | tar -xz -C /usr/local/bin
...
echo "::endgroup::"
maturin publish -i 3.8 --username LaihoE --password thisismypypipassword --target x86_64-unknown-linux-gnu