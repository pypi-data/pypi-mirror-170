"""
    Copyright (C) 2007-2022, Michele Cappellari
...
class quad1d:
    """
    Calling sequence: ``q = quad1d(fun,interval,epsrel=1e-5, epsabs=1e-10)``
    ...
    """
    def __init__(self, fun, interval, epsrel=1e-5, epsabs=1e-10, plot=False,
                 verbose=0, singular=True, args=()):
...
def quad1d_examples():
    ...
    print('\ntest 1 ###############################\n')
    ifx = quad1d(quad1d_test1, [0, 8], args=(3, 5), epsrel=0, epsabs=1e-12, verbose=1).integ
    print('actual error:', ifx - 0.33333333332074955152)
    print('\ntest 2 ###############################\n')
    ifx = quad1d(quad1d_test2, [-1, 2], epsrel=0, epsabs=1e-12, verbose=1).integ
    print('actual error:', ifx - 5.9630898453302550932)
    print('\ntest 2 with breakpoints ##############\n')
    ifx = quad1d(quad1d_test2, [-1, -1/np.sqrt(2), 1/np.sqrt(3), 2], epsrel=0, epsabs=1e-12, verbose=1).integ
    print('actual error:', ifx - 5.9630898453302550932)
    print('\ntest 3 ###############################\n')
    ifx = quad1d(quad1d_test3, [0, 1], args=(-2.0/3,), epsrel=0, epsabs=1e-12, verbose=1).integ
    print('actual error:', ifx - 3)
    print('\ntest 4 ###############################\n')
    ifx = quad1d(quad1d_test4, [-np.Inf, np.Inf], epsrel=1e-8, epsabs=0, verbose=1).integ
    print('actual error:', ifx - 2.5066282746310005024, "\n")
    ifx = quad1d(quad1d_test4, [-8, 8], epsrel=1e-8, epsabs=0, verbose=1, plot=0, singular=0).integ
    print('actual error:', ifx - 2.5066282746310005024)
