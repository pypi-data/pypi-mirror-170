...
*DefaultApi* | [**enable_wandb_integration_api_v2_experimental_integrations_enable_wandb_integration_cloud_id_post**](docs/DefaultApi.md#enable_wandb_integration_api_v2_experimental_integrations_enable_wandb_integration_cloud_id_post) | **POST** /api/v2/experimental_integrations/enable_wandb_integration/{cloud_id} | Enable Wandb Integration
...
*DefaultApi* | [**get_wandb_url_for_production_job_api_v2_experimental_integrations_wandb_url_production_job_id_get**](docs/DefaultApi.md#get_wandb_url_for_production_job_api_v2_experimental_integrations_wandb_url_production_job_id_get) | **GET** /api/v2/experimental_integrations/wandb_url/{production_job_id} | Get Wandb Url For Production Job
*DefaultApi* | [**get_wandb_url_for_workspace_api_v2_experimental_integrations_wandb_url_for_workspace_workspace_id_get**](docs/DefaultApi.md#get_wandb_url_for_workspace_api_v2_experimental_integrations_wandb_url_for_workspace_workspace_id_get) | **GET** /api/v2/experimental_integrations/wandb_url_for_workspace/{workspace_id} | Get Wandb Url For Workspace
...
*DefaultApi* | [**update_wandb_run_values_api_v2_experimental_integrations_update_wandb_run_values_production_job_id_get**](docs/DefaultApi.md#update_wandb_run_values_api_v2_experimental_integrations_update_wandb_run_values_production_job_id_get) | **GET** /api/v2/experimental_integrations/update_wandb_run_values/{production_job_id} | Update Wandb Run Values
*DefaultApi* | [**update_wandb_run_values_for_workspace_api_v2_experimental_integrations_update_wandb_run_values_for_workspace_workspace_id_get**](docs/DefaultApi.md#update_wandb_run_values_for_workspace_api_v2_experimental_integrations_update_wandb_run_values_for_workspace_workspace_id_get) | **GET** /api/v2/experimental_integrations/update_wandb_run_values_for_workspace/{workspace_id} | Update Wandb Run Values For Workspace
...
## Documentation For Models
 ...
 - [WandBData](docs/WandBData.md)
 - [WandBURLResponse](docs/WandBURLResponse.md)
 - [WandburlresponseResponse](docs/WandburlresponseResponse.md)
