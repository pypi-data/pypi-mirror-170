...
def test_register_cloud(verify_success) -> None:
    ...
    mock_anyscale_iam_role_id = "arn:aws:iam::123:role/mock_anyscale_role"
    mock_instance_iam_role_id = "arn:aws:iam::123:role/mock_instance_role"
    ...
    with patch(
        ...
        if verify_success:
            cloud_controller.register_aws_cloud(
                ...
                efs_id=mock_efs_id,
                anyscale_iam_role_id=mock_anyscale_iam_role_id,
                instance_iam_role_id=mock_instance_iam_role_id,
    ...
    mock_api_client.create_cloud_api_v2_clouds_post.assert_called_with(
        write_cloud=WriteCloud(
            provider="AWS",
            region=mock_region,
            credentials=mock_anyscale_iam_role_id,
            name=mock_cloud_name,
        ...
        mock_api_client.update_cloud_with_cloud_resource_api_v2_clouds_with_cloud_resource_router_cloud_id_put.assert_called_with(
            ...
            update_cloud_with_cloud_resource=UpdateCloudWithCloudResource(
                cloud_resource_to_update=CreateCloudResource(
                    ...
                    aws_iam_role_arns=[
                        mock_anyscale_iam_role_id,
                        mock_instance_iam_role_id,
                    ],
