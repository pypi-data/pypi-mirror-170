...
CREDENTIALS_FOUND = (
    ZOHO_CLIENT_ID is not None
    and ZOHO_CLIENT_PASSWORD is not None
    and (ZOHO_CODE is not None or ZOHO_REFRESH_TOKEN is not None)
)
...
class ZohoApi:
    ...
    tokens_path: Path = STATIC_DIR / "tokens"
