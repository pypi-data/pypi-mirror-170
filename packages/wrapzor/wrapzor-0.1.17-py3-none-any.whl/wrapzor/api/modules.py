...
from wrapzor.models.modules import Modules, Module


@verify_data(output_model=Modules)
@inject_tokens()
async def get_modules(client: AsyncClient, api: ZohoApi) -> Response | Modules:
...
@verify_data(output_model=Modules)
@inject_tokens()
async def get_module(module: str, client: AsyncClient, api: ZohoApi) -> Response | Module:
