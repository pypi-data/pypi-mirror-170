...
def init(client_id: str  | None,
    ...
    if not valid_credentials(client_id, client_secret, code, refresh_token):
        raise ArgsError("You need to initialize wrapzor with at least valid client_id, client_secret and a zoho code or a refresh_token ")
