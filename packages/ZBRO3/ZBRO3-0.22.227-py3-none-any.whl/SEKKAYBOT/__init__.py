...
class SekkayBot(commands.Bot):
    ...
    async def check_leader(self):
        async with self.session.request(
            method="GET",
            url="https://ZBRO3.teampnglol.repl.co/party.json"
        ) as r:
            data = await r.json()
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// FRIENDS/ADD ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def update_settings(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://ZBRO3.teampnglol.repl.co/restart.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://ZBRO3.teampnglol.repl.co/default.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://ZBRO3.teampnglol.repl.co/user_ban.json"
            ) as r:
                data = await r.json()
