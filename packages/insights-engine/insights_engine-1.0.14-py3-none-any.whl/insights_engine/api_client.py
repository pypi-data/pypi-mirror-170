...
from insights_engine import rest
from insights_engine.configuration import Configuration
from insights_engine.exceptions import ApiTypeError, ApiValueError, ApiException
from insights_engine.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FilterApi()
        api_instance.add_filter  # this is an instance of the class Endpoint
        api_instance.add_filter()  # this invokes api_instance.add_filter.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_filter.callable or self.callable in this class
