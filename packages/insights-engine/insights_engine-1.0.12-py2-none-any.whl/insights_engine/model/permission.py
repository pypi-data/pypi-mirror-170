...
def lazy_import():
    ...
    globals()['TeamsPermissionValue'] = TeamsPermissionValue
...
class Permission(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'values': ([TeamsPermissionValue],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, values, *args, **kwargs):  # noqa: E501
        """Permission - a model defined in OpenAPI

        Args:
            type (str):
            values ([TeamsPermissionValue]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, values, *args, **kwargs):  # noqa: E501
        """Permission - a model defined in OpenAPI
