...
class AddFilterBatchInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, filters, *args, **kwargs):  # noqa: E501
        """AddFilterBatchInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, filters, *args, **kwargs):  # noqa: E501
        """AddFilterBatchInput - a model defined in OpenAPI
