...
def capex_from_investment(
    ...
    try:
        ...
        raise ValueError(
            f"The asset {asset_label} had a problem in the first call of get_replacement_costs"
        )
    ...
    try:
        ...
        raise ValueError(
            f"The asset {asset_label} had a problem in the second call of get_replacement_costs"
        )
    return (
        specific_capex,
