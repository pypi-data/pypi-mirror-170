...
@LastEditTime: 2022-09-27 18:05:09
...
class OperationLog:
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'operation_type', 'title', 'desc', 'detail', 'update_detail', 'request_params', 'model_name', 'protocol', 'method', 'handler_name', 'request_host', 'request_uri', 'remote_ip', 'operate_user_id', 'operate_user_name', 'operate_role_id', 'create_date', 'create_day']
