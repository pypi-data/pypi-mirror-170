...
class FrameBaseHandler(BaseApiHandler):
    ...
    def create_operation_log(self, operation_type=1, model_name="", handler_name="", old_detail=None, update_detail=None, operate_user_id="", operate_user_name="", operate_role_id="", title="", desc=""):
        """
        :description: 创建操作日志
        :param operation_type：操作类型：1-add，2-update，3-delete，4-review，5-copy
        :param model_name：模块或表名称
        :param handler_name：handler名称
        :param old_detail：当前对象
        :param update_detail：更新之后的对象
        ...
        operation_log.app_id = self.get_app_id()
