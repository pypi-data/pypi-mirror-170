/*! For license information please see 344b1f84.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[70175],{54040:(e,t,i)=>{var r=i(87480),n=i(33310),o=i(58417),s=i(39274);let a=class extends o.A{};a.styles=[s.W],a=(0,r.__decorate)([(0,n.Mo)("mwc-checkbox")],a)},56887:(e,t,i)=>{i.d(t,{F:()=>l});var r=i(87480),n=(i(54040),i(37500)),o=i(33310),s=i(8636),a=i(61092);class l extends a.K{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-deprecated-list-item__graphic":this.left,"mdc-deprecated-list-item__meta":!this.left},t=this.renderText(),i=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():n.dy``,r=this.hasMeta&&this.left?this.renderMeta():n.dy``,o=this.renderRipple();return n.dy`
      ${o}
      ${i}
      ${this.left?"":t}
      <span class=${(0,s.$)(e)}>
    ...
    `}},{kind:"method",key:"firstUpdated",value:function(e){v(y(i.prototype),"firstUpdated",this).call(this,e),(0,a.O)()}},{kind:"method",key:"_computeDeviceName",value:function(e,t){const i=e.find((e=>e.id===t));return i?(0,o.jL)(i,this.hass):`<${this.hass.localize("ui.panel.config.integrations.config_entry.unknown_via_device")}>`}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,r.iv`
      ...
      `;const f=(0,m.jL)(u,this.hass),v=this._integrations(u,this.entries),y=this._entities(this.deviceId,this.entities),g=this._entitiesByCategory(y),b=this._batteryEntity(y),w=this._batteryChargingEntity(y),k=b?this.hass.states[b.entity_id]:void 0,_=k&&"binary_sensor"===(0,l.N)(k),x=w?this.hass.states[w.entity_id]:void 0,$=this._computeArea(this.areas,u),C=[],P=[...this._deviceActions||[]];Array.isArray(this._diagnosticDownloadLinks)&&P.push(...this._diagnosticDownloadLinks),this._deleteButtons&&P.push(...this._deleteButtons),P.sort(((e,t)=>"warning"===e.classes&&"warning"!==t.classes?1:"warning"!==e.classes&&"warning"===t.classes?-1:0));const D=P.shift();u.disabled_by&&C.push(t.dy`
          ...
          ${"user"===u.disabled_by?t.dy`
              ...
              `:""}
        `),this._renderIntegrationInfo(u,v,C);const z=(0,s.p)(this.hass,"automation")?t.dy`
          <ha-card outlined>
            <h1 class="card-header">
              ...
              <ha-icon-button
                ...
                .label=${u.disabled_by?this.hass.localize("ui.panel.config.devices.automation.create_disable","type",this.hass.localize(`ui.panel.config.devices.type.${u.entry_type||"device"}`)):this.hass.localize("ui.panel.config.devices.automation.create","type",this.hass.localize(`ui.panel.config.devices.type.${u.entry_type||"device"}`))}
                .path=${M}
              ></ha-icon-button>
            </h1>
        ...
        `:"",A=(0,s.p)(this.hass,"scene")&&y.length?t.dy`
            <ha-card outlined>
              <h1 class="card-header">
                ...
                <ha-icon-button
                  ...
                  .disabled=${u.disabled_by}
                  .label=${u.disabled_by?this.hass.localize("ui.panel.config.devices.scene.create_disable","type",this.hass.localize(`ui.panel.config.devices.type.${u.entry_type||"device"}`)):this.hass.localize("ui.panel.config.devices.scene.create","type",this.hass.localize(`ui.panel.config.devices.type.${u.entry_type||"device"}`))}
                  .path=${M}
                ></ha-icon-button>
              </h1>
          ...
          <ha-card outlined>
            <h1 class="card-header">
              ...
              <ha-icon-button
                ...
                .disabled=${u.disabled_by}
                .label=${u.disabled_by?this.hass.localize("ui.panel.config.devices.script.create_disable","type",this.hass.localize(`ui.panel.config.devices.type.${u.entry_type||"device"}`)):this.hass.localize("ui.panel.config.devices.script.create","type",this.hass.localize(`ui.panel.config.devices.type.${u.entry_type||"device"}`))}
                .path=${M}
              ></ha-icon-button>
            </h1>
