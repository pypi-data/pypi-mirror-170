...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/resources/icons8-pictures-folder-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.mirror_emi_status.setPixmap(QtGui.QPixmap(":/resources/icons8-red-circle-48.png"))
        ...
        self.mirror_thread_status.setPixmap(QtGui.QPixmap(":/resources/icons8-red-circle-48.png"))
        ...
        self.mirror_obs_status.setPixmap(QtGui.QPixmap(":/resources/icons8-red-circle-48.png"))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/resources/icons8-internet-folder-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.mirror_checkBox.toggled['bool'].connect(self.mirroring_folder_text.setEnabled)
        self.mirror_checkBox.toggled['bool'].connect(self.select_mirroring_folder.setEnabled)
        self.watchdog_pushbutton.clicked['bool'].connect(MainWindow.toggled_watchdog)
        self.open_explorer_pushbuttom.clicked.connect(MainWindow.open_browser)
        self.edit_custom_html_file_pushbutton.clicked.connect(MainWindow.open_yaml_editor)
        self.select_protocol_folder.clicked.connect(MainWindow.open_protocol_folder)
        self.select_mirroring_folder.clicked.connect(MainWindow.open_mirroring_folder)
        self.watchdog_pushbutton.toggled['bool'].connect(self.open_explorer_pushbuttom.setEnabled)
        self.select_microscope_comboBox.currentIndexChanged['QString'].connect(MainWindow.changed_microscope)
        self.mirror_checkBox.toggled['bool'].connect(MainWindow.toggled_mirroring)
        self.protocol_folder_text.editingFinished.connect(MainWindow.validate_inputs)
        self.mirroring_folder_text.editingFinished.connect(MainWindow.validate_inputs)
        ...
        self.custom_ownership_checkbox.toggled['bool'].connect(self.projectID_field.setEnabled)
        self.custom_ownership_checkbox.toggled['bool'].connect(self.project_name_field.setEnabled)
        self.custom_ownership_checkbox.toggled['bool'].connect(self.responsible_field.setEnabled)
        self.custom_ownership_checkbox.toggled['bool'].connect(MainWindow.toggled_custom_ownership)
        self.projectID_field.editingFinished.connect(MainWindow.validate_inputs)
        self.project_name_field.editingFinished.connect(MainWindow.validate_inputs)
        self.responsible_field.editingFinished.connect(MainWindow.validate_inputs)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mirror_checkBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>Activating the mirroring will start the automatic copy of all files present in the protocol folder to the mirroring folder.</p></body></html>"))
        ...
        self.select_protocol_folder.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Click here to select a folder to be monitored. </span></p><p>It is recommended to name this folder as ProtocolID-Project-Responsible as, for example, 2204123-RADCAS-Bulgheroni</p></body></html>"))
        ...
        self.mirror_emi_status.setToolTip(_translate("MainWindow", "Status of the mirroring watchdog emitter thread"))
        self.auto_thread_status.setToolTip(_translate("MainWindow", "Status of the autologbook watchdog thread"))
        self.mirror_thread_status.setToolTip(_translate("MainWindow", "Status of the mirroring watchdog thread"))
        self.mirror_obs_status.setToolTip(_translate("MainWindow", "Status of the mirroring watchdog observer thread"))
        ...
        self.select_mirroring_folder.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Select a mirroring folder</span></p><p><br/></p><p>This folder <span style=\" font-weight:600;\">must </span>have be named as ProtocolID-Project-Responsible and must be on R:\\A226\\Results. If not, the watchdog won\'t be able to start.</p></body></html>"))
        ...
        self.open_explorer_pushbuttom.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Open protocol folder</span></p><p><br/></p><p>Click this button to open a file explorer pointing to either the protocol folder or the mirroring one if the mirroing option is activated.</p></body></html>"))
        self.open_explorer_pushbuttom.setText(_translate("MainWindow", "Open protocol folder"))
        self.edit_custom_html_file_pushbutton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Click this button to open the default text editor in order to modify the HTML customization file.</p></body></html>"))
