...
class CalendarApi(object):
    ...
    def calendar_retrieve(self, **kwargs):  # noqa: E501
        ...
        ## 입력변수  |입력변수 |설명 |필수 |기본값 |  |:-----|:-----|:-----|:-----|  |date_type |불러 올 날짜의 타입, 1: trading_day, 2: closed_day, 3: weekends 중 하나 선택하여 입력. 비워 두면 전체 날짜 출력|X |None |  |start_date |시작 날짜 |O | | |end_date |마지막 날짜 |O | | |exchange |krx 또는 us |X |krx | ## 출력변수  |출력변수  |설명               |타입                 |  |:--------|:------------------|:--------------------|  |exchange |krx 또는 us |string | |date_type |출력 날짜의 타입 |string |  |dates |기간 내 타입에 따른 날짜 리스트 |list of string |    # noqa: E501
        ...
        :param int date_type: set None for adjusted day. Other candidates: 1: trading_day, 2: closed_day, 3: weekends
        :param str end_date:
        :param str exchange:
