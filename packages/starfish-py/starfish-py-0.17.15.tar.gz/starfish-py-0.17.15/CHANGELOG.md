...
## Release v0.17.15
+   Update provenance contract to allow for asset_did to register provenance

## Release v0.17.14
+   Update provenance contract and provide more methods to access provenance data

## Release v0.17.13
+   Upgrade convex-api with built in Contract class

## Release v0.17.12
+   Refactor contract loading
+   Allow data to be saved with the provenance contract
