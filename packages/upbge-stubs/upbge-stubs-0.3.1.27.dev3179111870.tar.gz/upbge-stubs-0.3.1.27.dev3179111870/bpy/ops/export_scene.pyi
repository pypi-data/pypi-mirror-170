...
def gltf(filepath: str = '', check_existing: bool = True, export_format: str = 'GLB', ui_tab: str = 'GENERAL', export_copyright: str = '', export_image_format: str = 'AUTO', export_texture_dir: str = '', export_keep_originals: bool = False, export_texcoords: bool = True, export_normals: bool = True, export_draco_mesh_compression_enable: bool = False, export_draco_mesh_compression_level: int = 6, export_draco_position_quantization: int = 14, export_draco_normal_quantization: int = 10, export_draco_texcoord_quantization: int = 12, export_draco_color_quantization: int = 10, export_draco_generic_quantization: int = 12, export_tangents: bool = False, export_materials: str = 'EXPORT', export_original_specular: bool = False, export_colors: bool = True, export_attributes: bool = False, use_mesh_edges: bool = False, use_mesh_vertices: bool = False, export_cameras: bool = False, use_selection: bool = False, use_visible: bool = False, use_renderable: bool = False, use_active_collection_with_nested: bool = False, use_active_collection_without_nested: bool = False, use_active_scene: bool = False, export_extras: bool = False, export_yup: bool = True, export_apply: bool = False, export_animations: bool = True, export_frame_range: bool = True, export_frame_step: int = 1, export_force_sampling: bool = True, export_nla_strips: bool = True, export_nla_strips_merged_animation_name: str = 'Animation', export_def_bones: bool = False, export_optimize_animation_size: bool = False, export_anim_single_armature: bool = True, export_reset_pose_bones: bool = True, export_current_frame: bool = False, export_skins: bool = True, export_all_influences: bool = False, export_morph: bool = True, export_morph_normal: bool = True, export_morph_tangent: bool = False, export_lights: bool = False, will_save_settings: bool = False, filter_glob: str = '*args.glb;*args.gltf') -> None:
