...
def cloth_filter(area_normal_radius: float = 0.25, strength: float = 1.0, type: str = 'GRAVITY', force_axis: typing.Set[str] = {'X', 'Y', 'Z'}, orientation: str = 'LOCAL', cloth_mass: float = 1.0, cloth_damping: float = 0.0, use_face_sets: bool = False, use_collisions: bool = False) -> None:
...
def color_filter(area_normal_radius: float = 0.25, strength: float = 1.0, type: str = 'HUE', fill_color: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def mask_filter(filter_type: str = 'SMOOTH', iterations: int = 1, auto_iteration_count: bool = True) -> None:
...
def mask_from_cavity(mix_mode: str = 'MIX', mix_factor: float = 1.0, use_automask_settings: bool = False, factor: float = 0.5, blur_steps: int = 2, use_curve: bool = False, invert: bool = False) -> None:
...
def mesh_filter(area_normal_radius: float = 0.25, strength: float = 1.0, type: str = 'INFLATE', deform_axis: typing.Set[str] = {'X', 'Y', 'Z'}, orientation: str = 'LOCAL', surface_smooth_shape_preservation: float = 0.5, surface_smooth_current_vertex: float = 0.5, sharpen_smooth_ratio: float = 0.35, sharpen_intensify_detail_strength: float = 0.0, sharpen_curvature_smooth_iterations: int = 0) -> None:
