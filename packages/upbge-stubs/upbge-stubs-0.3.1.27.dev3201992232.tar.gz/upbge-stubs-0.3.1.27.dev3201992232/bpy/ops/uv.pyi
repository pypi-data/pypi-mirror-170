...
def randomize_uv_transform(random_seed: int = 0, use_loc: bool = True, loc: typing.Tuple[float, float] = (0.0, 0.0), use_rot: bool = True, rot: float = 0.0, use_scale: bool = True, scale_even: bool = False, scale: typing.Tuple[float, float] = (1.0, 1.0)) -> None:
...
def select(extend: bool = False, deselect: bool = False, toggle: bool = False, deselect_all: bool = False, select_passthrough: bool = False, location: typing.Tuple[float, float] = (0.0, 0.0)) -> None:
