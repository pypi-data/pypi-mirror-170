...
class ContainerLauncher:
    ...
    def __init__(self, options=None):
        ...
        if options is not None and 'spot_instance_deploying_timeout_in_minutes' in options:
            self.__SPOT_INSTANCE_DEPLOYING_TIMEOUT_IN_MINUTES = options.get('spot_instance_deploying_timeout_in_minutes')
    ...
    def start_container(self, container_input):
        ...
        try:
            ...
            if container_input.get('instance_type'):
                ...
                ec2_instance = ec2.get_optimal_instance_type(get_optimal_instance_type_input)
    ...
    def __wait_for_instance_deploying(self, is_spot):
        ...
        while True:
            ...
            if diff_minutes > timeout_in_minutes:
                raise Exception(f'EC2 instance deploying timeout ({timeout_in_minutes} minutes)')
            if len(instances) > 0:
