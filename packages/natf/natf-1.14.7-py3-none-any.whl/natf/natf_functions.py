            ...
            if mcnp_input.is_comment(line):
                ...
                if need_split:
                    ...
                    for i in range(len(tmp_cells)):
                        ...
                        oline = mcnp_input.mcnp_style_str_append(
                            oline, f"{mid}")
                        if mid > 0:
                            oline = mcnp_input.mcnp_style_str_append(
                                oline, f"{den}")
                        ...
                        if tmp_cells[i].fill is not None:
                            rotation_str = ''
                            if len(tmp_cells[i].fill[2]) > 0:
                                rotation_str = ' '.join(tmp_cells[i].fill[2])
                            oline = mcnp_input.mcnp_style_str_append(
                                oline, f"{tmp_cells[i].fill[1]}fill={tmp_cells[i].fill[0]}{rotation_str}")
