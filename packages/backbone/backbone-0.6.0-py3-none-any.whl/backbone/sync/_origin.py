...
class Reactor:
    ...
    def react(self, data: typing.Optional[cord.Record] = None):
        ...
        response = self._origin._driver.post("/", content=request_body, headers=headers)
...
class Origin:
    def __init__(
        ...
        **kwargs: typing.Any,
        ...
        self._count = 0
        self._driver: typing.Optional[httpx.Client] = None
    ...
    def _initialize_driver(self):
        ...
        self._driver = httpx.Client(base_url=self._endpoint, **self._kwargs, timeout=None)
