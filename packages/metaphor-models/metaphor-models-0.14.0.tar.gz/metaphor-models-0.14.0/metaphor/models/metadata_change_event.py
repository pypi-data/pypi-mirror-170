...
class ThoughtSpotInfo:
    ...
    def from_dict(obj: Any) -> 'ThoughtSpotInfo':
        ...
        return ThoughtSpotInfo(tags, type)
...
class QueryLog:
    ...
    sql: Optional[str] = None
    sql_checksum: Optional[str] = None
    ...
    def from_dict(obj: Any) -> 'QueryLog':
        ...
        sql = from_union([from_str, from_none], obj.get("sql"))
        sql_checksum = from_union([from_str, from_none], obj.get("sqlChecksum"))
        ...
        return QueryLog(id, bytes_read, bytes_written, duration, email, metadata, platform, query_id, rows_read, rows_written, sources, sql, sql_checksum, start_time, targets, type, user_id)
    ...
    def to_dict(self) -> dict:
        ...
        result["sql"] = from_union([from_str, from_none], self.sql)
        result["sqlChecksum"] = from_union([from_str, from_none], self.sql_checksum)
