...
class LBFGS(Optimizer):
    ...
    def __init__(self, 
        params:             typing.Sequence[torch.nn.Parameter],
        lr:                 float=1.0,
        max_iter:           int=20,
        max_eval:           int=None,
    ...
    def _add_grad(self, step_size, update):
        ...
        for p in self._params:
            ...
            p.data.add_(update[offset:offset + numel].view_as(p.data), alpha=step_size)  #NOTE: add_ deprecated
            offset += numel
        ...
        while n_iter < max_iter:
            ...
            if state['n_iter'] == 1:
                ...
                for i in range(num_old - 1, -1, -1):
                    ...
                    # q.add_(-al[i], old_dirs[i]) #NOTE: add_ deprecated
