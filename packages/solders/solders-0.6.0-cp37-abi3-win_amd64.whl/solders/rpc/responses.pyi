...
def parse_account_info_maybe_json(
    raw: str,
) -> Union[GetAccountInfoResp, GetAccountInfoJsonParsedResp]: ...
def parse_multiple_accounts_maybe_json(
    raw: str,
) -> Union[GetMultipleAccountsResp, GetMultipleAccountsJsonParsedResp]: ...
def parse_token_accounts_by_delegate_maybe_json(
    raw: str,
) -> Union[
    GetTokenAccountsByDelegateResp, GetTokenAccountsByDelegateJsonParsedResp
]: ...
def parse_token_accounts_by_owner_maybe_json(
    raw: str,
) -> Union[GetTokenAccountsByOwnerResp, GetTokenAccountsByOwnerJsonParsedResp]: ...
def parse_program_accounts_with_context_maybe_json(
    raw: str,
) -> Union[
    GetProgramAccountsWithContextResp, GetProgramAccountsWithContextJsonParsedResp
]: ...
def parse_program_accounts_without_context_maybe_json(
    raw: str,
) -> Union[
    GetProgramAccountsWithoutContextResp, GetProgramAccountsWithoutContextJsonParsedResp
]: ...
