...
Base Module
-----------
The ``ailca.chem.base`` module includes basic information and utilities to process chemical data.
...
def __load_mendeleev_attrs() -> torch.Tensor:
    """
