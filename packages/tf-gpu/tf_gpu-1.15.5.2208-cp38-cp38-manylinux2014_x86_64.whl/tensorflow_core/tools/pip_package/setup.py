...
build https://github.com/nvidia/tensorflow by https://github.com/ssbuild with mkl support. 
...
VERSION = _VERSION.replace('-', '')+".2208"+os.getenv('RELEASE_VERSION', "")
...
REQUIRED_PACKAGES = [
    ...
    'wrapt >= 1.11.1',
    'h5py >= 2.10.0 , < 4.0.0;python_version>="3.9"',
