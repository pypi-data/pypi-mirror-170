        ...
        for endpoint in context.endpoints:
            if proposed_data_connect_endpoint.type == endpoint.type:
                ...
                if proposed_data_connect_endpoint_url == reference_data_connect_endpoint_url:
                    return DataConnectClient.make(endpoint)
            else:
                pass

        _logger.debug(f'Unable to find a registered {proposed_data_connect_endpoint.type} endpoint at {proposed_data_connect_endpoint_url}.')

        # Fallback to the endpoint generated by the collection service client.
        return DataConnectClient.make(proposed_data_connect_endpoint)
...
def list_collections(context: Optional[str], endpoint_id: Optional[str], no_auth: bool = False, output: Optional[str] = None):
    """ List collections """
...
def list_items(context: Optional[str],
    ...
    data_connect_client = _switch_to_data_connect(_get_context(context), collection_service_client, actual_collection.slugName, no_auth)
