...
`;let se=class extends y{constructor(){super(...arguments),this._busy=!1,this._board="esp32dev",this._hasWifiSecrets=void 0,this._customBoard="",this._data={ssid:`!secret ${z}`,psk:`!secret ${U}`},this._state=$?"basic_config":"ask_esphome_web",this._installed=!1,this._cleanNameInput=e=>{this._error=void 0;const o=e.target;o.value=x(o.value)},this._cleanNameBlur=e=>{const o=e.target;o.value=C(o.value)},this._cleanSSIDBlur=e=>{const o=e.target;o.value=o.value.trim()}}render(){let e,o,t=!1;return"ask_esphome_web"===this._state?[e,o,t]=this._renderAskESPHomeWeb():"basic_config"===this._state?[e,o,t]=this._renderBasicConfig():"pick_board"===this._state?(e="Select your device type",o=this._renderPickBoard()):"connect_webserial"===this._state?(e="Installation",o=this._renderConnectSerial()):"connecting_webserial"===this._state?(o=this._renderProgress("Connecting"),t=!0):"prepare_flash"===this._state?(o=this._renderProgress("Preparing installation"),t=!0):"flashing"===this._state?(o=void 0===this._writeProgress?this._renderProgress("Erasing"):this._renderProgress(u`
    ...
    `}_renderAskESPHomeWeb(){return["New device",u`
      ...
      <div>
        ${O?"Your browser does not support WebSerial.":"You are not browsing the dashboard over a secure connection (HTTPS)."}
    ...
    `,!1]}_renderBasicConfig(){if(void 0===this._hasWifiSecrets)return[void 0,this._renderProgress("Initializing"),!0];return[$?"New device":"Create configuration",u`
