...
from . import generalized_equality
...
class BaseExperiment(CommonExperiment):
    ...
    def log_parameter(self, name, value, step=None, source=None):
        ...
        """
        try:
            return self._log_parameter(name, value, step=step, source=source)
        except Exception:
            LOGGER.error(
    ...
    def _log_parameter(self, name, value, step=None, framework=None, source=None):
        ...
        if self.alive:
            ...
            if source is None:
                source = ParameterMessage.source_sdk
    ...
    def log_parameters(self, parameters, prefix=None, step=None, source=None):
        """
        ...
        current context name as a prefix.
        """
        return self._log_parameters(parameters, prefix, step=step, source=source)
    ...
    def log_table(self, filename, tabular_data=None, headers=False, **format_kwargs):
        # type: (str, Optional[Any], Optional[Any], Union[Sequence[str], bool]) -> Optional[Dict[str, str]]
        """
