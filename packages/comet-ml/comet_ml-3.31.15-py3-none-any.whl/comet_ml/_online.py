...
class Experiment(BaseExperiment):
            ...
            if self.alive is True:
                ...
                LOGGER.debug(
                    ...
                    % self.config.get_bool(
                        None, "comet.override_feature.sdk_use_http_messages"
                    )
                )
    ...
    def _report_experiment_error(self, message):
        ...
        if self.streamer is None:
            return
        self.streamer._report_experiment_error(message)
    ...
    def _on_end(self, wait=True):
        ...
        try:
            ...
            if throttled:
                LOGGER.warning(ONLINE_EXPERIMENT_THROTTLED, message)
        except Exception:
            LOGGER.debug(
    ...
    def _check_experiment_throttled(self):
        ...
        if throttled:
            ...
            return throttled, message, reasons
