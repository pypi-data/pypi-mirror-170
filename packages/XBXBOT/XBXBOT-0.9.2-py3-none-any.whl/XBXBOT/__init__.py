...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// FRIENDS/ADD ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def event_ready(self) -> None:
       ...
       #   if self.remove_bots == 'T':
         #   for friend in self.friends:
              #if friend.display_name in self.ban_lobbybots or friend.id in self.ban_lobbybots:
              #  await friend.block()
    ...
    async def update_api(self) -> None:
        resp = requests.post(
                url=f'https://e51d3e57-f8fe-4d36-bbf1-06a317650b57.id.repl.co/update',
                json={
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// PARTY/FRIENDS/ADMIN //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    @is_admin()
    @commands.command(aliases=['unhide', 'hihiha', 'hey'])
