...
class Q3DBars(QAbstract3DGraph):
    ...
    def barSeriesMarginChanged(self, margin: QtCore.QSizeF) -> None: ...
...
class QBar3DSeries(QAbstract3DSeries):
    ...
    def rowColorsChanged(self, rowcolors: typing.Iterable[typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]]) -> None: ...
...
class QHeightMapSurfaceDataProxy(QSurfaceDataProxy):
    ...
    def autoScaleYChanged(self, enabled: bool) -> None: ...
    def maxYValueChanged(self, value: float) -> None: ...
    def minYValueChanged(self, value: float) -> None: ...
...
class QSurface3DSeries(QAbstract3DSeries):
    ...
    def wireframeColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
