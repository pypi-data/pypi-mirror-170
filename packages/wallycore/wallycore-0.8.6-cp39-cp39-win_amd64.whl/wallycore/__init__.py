...
_wallycore.WALLY_CA_PREFIX_LIQUID_TESTNET_swigconstant(_wallycore)
...
_wallycore.WALLY_NETWORK_LIQUID_TESTNET_swigconstant(_wallycore)
...
_wallycore.WALLY_ADDRESS_VERSION_P2PKH_LIQUID_TESTNET_swigconstant(_wallycore)
...
_wallycore.WALLY_ADDRESS_VERSION_P2SH_LIQUID_TESTNET_swigconstant(_wallycore)
...
_wallycore.BIP32_PATH_MAX_LEN_swigconstant(_wallycore)
...
_wallycore.BIP32_FLAG_STR_WILDCARD_swigconstant(_wallycore)
BIP32_FLAG_STR_WILDCARD = _wallycore.BIP32_FLAG_STR_WILDCARD

_wallycore.BIP32_FLAG_STR_BARE_swigconstant(_wallycore)
...
def bip32_key_from_seed_custom(bytes, version, hmac_key, flags):
    return _wallycore.bip32_key_from_seed_custom(bytes, version, hmac_key, flags)
bip32_key_from_seed_custom = _wallycore.bip32_key_from_seed_custom
...
def bip32_key_from_parent_path_str(hdkey, path_str, child_num, flags):
    return _wallycore.bip32_key_from_parent_path_str(hdkey, path_str, child_num, flags)
bip32_key_from_parent_path_str = _wallycore.bip32_key_from_parent_path_str

def bip32_key_from_parent_path_str_n(hdkey, path_str, path_str_len, child_num, flags):
    return _wallycore.bip32_key_from_parent_path_str_n(hdkey, path_str, path_str_len, child_num, flags)
bip32_key_from_parent_path_str_n = _wallycore.bip32_key_from_parent_path_str_n
...
def bip32_key_from_base58_n(base58, base58_len):
    return _wallycore.bip32_key_from_base58_n(base58, base58_len)
bip32_key_from_base58_n = _wallycore.bip32_key_from_base58_n
...
_wallycore.RIPEMD160_LEN_swigconstant(_wallycore)
...
_wallycore.EC_XONLY_PUBLIC_KEY_LEN_swigconstant(_wallycore)
...
_wallycore.EC_SCALAR_LEN_swigconstant(_wallycore)
...
_wallycore.WALLY_SCRIPT_TYPE_P2TR_swigconstant(_wallycore)
...
_wallycore.WALLY_SCRIPTPUBKEY_P2TR_LEN_swigconstant(_wallycore)
...
_wallycore.WALLY_SCRIPTSIG_MAX_LEN_swigconstant(_wallycore)
...
def map_init(allocation_len, verify_fn):
    return _wallycore.map_init(allocation_len, verify_fn)
...
def map_keypath_bip32_init(allocation_len):
    return _wallycore.map_keypath_bip32_init(allocation_len)
map_keypath_bip32_init = _wallycore.map_keypath_bip32_init

def map_keypath_public_key_init(allocation_len):
    return _wallycore.map_keypath_public_key_init(allocation_len)
map_keypath_public_key_init = _wallycore.map_keypath_public_key_init
...
_wallycore.WALLY_PSBT_VERSION_0_swigconstant(_wallycore)
WALLY_PSBT_VERSION_0 = _wallycore.WALLY_PSBT_VERSION_0

_wallycore.WALLY_PSBT_VERSION_2_swigconstant(_wallycore)
...
_wallycore.WALLY_PSBT_INIT_PSET_swigconstant(_wallycore)
...
_wallycore.WALLY_PSBT_PROPRIETARY_TYPE_swigconstant(_wallycore)
WALLY_PSBT_PROPRIETARY_TYPE = _wallycore.WALLY_PSBT_PROPRIETARY_TYPE

_wallycore.WALLY_PSBT_TXMOD_INPUTS_swigconstant(_wallycore)
WALLY_PSBT_TXMOD_INPUTS = _wallycore.WALLY_PSBT_TXMOD_INPUTS

_wallycore.WALLY_PSBT_TXMOD_OUTPUTS_swigconstant(_wallycore)
WALLY_PSBT_TXMOD_OUTPUTS = _wallycore.WALLY_PSBT_TXMOD_OUTPUTS

_wallycore.WALLY_PSBT_TXMOD_SINGLE_swigconstant(_wallycore)
WALLY_PSBT_TXMOD_SINGLE = _wallycore.WALLY_PSBT_TXMOD_SINGLE

_wallycore.WALLY_PSET_TXMOD_RESERVED_swigconstant(_wallycore)
WALLY_PSET_TXMOD_RESERVED = _wallycore.WALLY_PSET_TXMOD_RESERVED

_wallycore.WALLY_PSBT_PARSE_FLAG_STRICT_swigconstant(_wallycore)
WALLY_PSBT_PARSE_FLAG_STRICT = _wallycore.WALLY_PSBT_PARSE_FLAG_STRICT

_wallycore.WALLY_PSBT_ID_AS_V2_swigconstant(_wallycore)
WALLY_PSBT_ID_AS_V2 = _wallycore.WALLY_PSBT_ID_AS_V2

_wallycore.WALLY_PSBT_ID_USE_LOCKTIME_swigconstant(_wallycore)
WALLY_PSBT_ID_USE_LOCKTIME = _wallycore.WALLY_PSBT_ID_USE_LOCKTIME

_wallycore.WALLY_PSET_BLINDED_NONE_swigconstant(_wallycore)
WALLY_PSET_BLINDED_NONE = _wallycore.WALLY_PSET_BLINDED_NONE

_wallycore.WALLY_PSET_BLINDED_REQUIRED_swigconstant(_wallycore)
WALLY_PSET_BLINDED_REQUIRED = _wallycore.WALLY_PSET_BLINDED_REQUIRED

_wallycore.WALLY_PSET_BLINDED_PARTIAL_swigconstant(_wallycore)
WALLY_PSET_BLINDED_PARTIAL = _wallycore.WALLY_PSET_BLINDED_PARTIAL

_wallycore.WALLY_PSET_BLINDED_FULL_swigconstant(_wallycore)
WALLY_PSET_BLINDED_FULL = _wallycore.WALLY_PSET_BLINDED_FULL

_wallycore.WALLY_PSET_BLIND_ALL_swigconstant(_wallycore)
WALLY_PSET_BLIND_ALL = _wallycore.WALLY_PSET_BLIND_ALL

_wallycore.WALLY_SCALAR_OFFSET_LEN_swigconstant(_wallycore)
WALLY_SCALAR_OFFSET_LEN = _wallycore.WALLY_SCALAR_OFFSET_LEN

def psbt_init(version, inputs_allocation_len, outputs_allocation_len, global_unknowns_allocation_len, flags):
    return _wallycore.psbt_init(version, inputs_allocation_len, outputs_allocation_len, global_unknowns_allocation_len, flags)
...
def psbt_set_tx_version(psbt, tx_version):
    return _wallycore.psbt_set_tx_version(psbt, tx_version)
...
def psbt_blind(psbt, values, vbfs, assets, abfs, entropy, output_index, flags):
    return _wallycore.psbt_blind(psbt, values, vbfs, assets, abfs, entropy, output_index, flags)
psbt_blind = _wallycore.psbt_blind
...
_wallycore.LIBWALLY_CORE_PSBT_MEMBERS_H_swigconstant(_wallycore)
...
_wallycore.WALLY_TX_FLAG_PRE_BIP144_swigconstant(_wallycore)
...
_wallycore.WALLY_SIGHASH_RANGEPROOF_swigconstant(_wallycore)
...
_wallycore.WALLY_SIGHASH_MASK_swigconstant(_wallycore)
...
_wallycore.ASSET_EXPLICIT_RANGEPROOF_MAX_LEN_swigconstant(_wallycore)
ASSET_EXPLICIT_RANGEPROOF_MAX_LEN = _wallycore.ASSET_EXPLICIT_RANGEPROOF_MAX_LEN

_wallycore.ASSET_SURJECTIONPROOF_MAX_LEN_swigconstant(_wallycore)
ASSET_SURJECTIONPROOF_MAX_LEN = _wallycore.ASSET_SURJECTIONPROOF_MAX_LEN

_wallycore.ASSET_EXPLICIT_SURJECTIONPROOF_LEN_swigconstant(_wallycore)
...
map_get_item = _wrap_bin(map_get_item, map_get_item_length, resize=True)
...
_original_psbt_from_bytes = psbt_from_bytes
def psbt_from_bytes(bytes, flags=0):
    return _original_psbt_from_bytes(bytes, flags)

_original_psbt_from_base64 = psbt_from_base64
def psbt_from_base64(base64, flags=0):
    return _original_psbt_from_base64(base64, flags)
...
psbt_get_output_script = _wrap_bin(psbt_get_output_script, psbt_get_output_script_len, resize=True)
...
if is_elements_build():
    ...
    psbt_get_input_amount_rangeproof = _wrap_bin(psbt_get_input_amount_rangeproof, psbt_get_input_amount_rangeproof_len, resize=True)
    psbt_get_input_asset = _wrap_bin(psbt_get_input_asset, psbt_get_input_asset_len, resize=True)
    psbt_get_input_asset_surjectionproof = _wrap_bin(psbt_get_input_asset_surjectionproof, psbt_get_input_asset_surjectionproof_len, resize=True)
    psbt_get_input_issuance_amount_commitment = _wrap_bin(psbt_get_input_issuance_amount_commitment, psbt_get_input_issuance_amount_commitment_len, resize=True)
    psbt_get_input_issuance_amount_rangeproof = _wrap_bin(psbt_get_input_issuance_amount_rangeproof, psbt_get_input_issuance_amount_rangeproof_len, resize=True)
    psbt_get_input_issuance_blinding_nonce = _wrap_bin(psbt_get_input_issuance_blinding_nonce, psbt_get_input_issuance_blinding_nonce_len, resize=True)
    psbt_get_input_issuance_asset_entropy = _wrap_bin(psbt_get_input_issuance_asset_entropy, psbt_get_input_issuance_asset_entropy_len, resize=True)
    psbt_get_input_issuance_amount_blinding_rangeproof = _wrap_bin(psbt_get_input_issuance_amount_blinding_rangeproof, psbt_get_input_issuance_amount_blinding_rangeproof_len, resize=True)
    psbt_get_input_pegin_claim_script = _wrap_bin(psbt_get_input_pegin_claim_script, psbt_get_input_pegin_claim_script_len, resize=True)
    psbt_get_input_pegin_genesis_blockhash = _wrap_bin(psbt_get_input_pegin_genesis_blockhash, psbt_get_input_pegin_genesis_blockhash_len, resize=True)
    psbt_get_input_pegin_txout_proof = _wrap_bin(psbt_get_input_pegin_txout_proof, psbt_get_input_pegin_txout_proof_len, resize=True)
    psbt_get_input_inflation_keys_commitment = _wrap_bin(psbt_get_input_inflation_keys_commitment, psbt_get_input_inflation_keys_commitment_len, resize=True)
    psbt_get_input_inflation_keys_rangeproof = _wrap_bin(psbt_get_input_inflation_keys_rangeproof, psbt_get_input_inflation_keys_rangeproof_len, resize=True)
    psbt_get_input_inflation_keys_blinding_rangeproof = _wrap_bin(psbt_get_input_inflation_keys_blinding_rangeproof, psbt_get_input_inflation_keys_blinding_rangeproof_len, resize=True)
    psbt_get_input_utxo_rangeproof = _wrap_bin(psbt_get_input_utxo_rangeproof, psbt_get_input_utxo_rangeproof_len, resize=True)
    ...
    psbt_get_output_asset = _wrap_bin(psbt_get_output_asset, psbt_get_output_asset_len, resize=True)
    ...
    psbt_get_output_value_rangeproof = _wrap_bin(psbt_get_output_value_rangeproof, psbt_get_output_value_rangeproof_len, resize=True)
    psbt_get_output_asset_surjectionproof = _wrap_bin(psbt_get_output_asset_surjectionproof, psbt_get_output_asset_surjectionproof_len, resize=True)
    psbt_get_output_blinding_public_key = _wrap_bin(psbt_get_output_blinding_public_key, psbt_get_output_blinding_public_key_len, resize=True)
    psbt_get_output_ecdh_public_key = _wrap_bin(psbt_get_output_ecdh_public_key, psbt_get_output_ecdh_public_key_len, resize=True)
    psbt_get_output_value_blinding_rangeproof = _wrap_bin(psbt_get_output_value_blinding_rangeproof, psbt_get_output_value_blinding_rangeproof_len, resize=True)
    psbt_get_output_asset_blinding_surjectionproof = _wrap_bin(psbt_get_output_asset_blinding_surjectionproof, psbt_get_output_asset_blinding_surjectionproof_len, resize=True)
