...
def create_trainer_file(project_name, to_folder, test_file_type, createInitFile=True, from_folder=''):
    ...
    replace_in_template_and_create_file(project_name, to_folder, test_file_type, data, createInitFile)
...
def create_empty_init_file(folder):
...
def deploy_service_to_gae():
   ...
   """
    ...
    current_folder = os.path.abspath(os.getcwd())
    setup_file_path = f"{current_folder}/deploy/setup_deploy_params.sh"
