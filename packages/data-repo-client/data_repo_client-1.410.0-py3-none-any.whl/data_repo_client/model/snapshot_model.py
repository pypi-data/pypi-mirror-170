...
class SnapshotModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "createdDate", "consentCode", "source", "tables", "relationships", "profileId", "dataProject", "accessInformation", "creationInformation", "cloudPlatform", "properties", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "createdDate", "consentCode", "source", "tables", "relationships", "profileId", "dataProject", "accessInformation", "creationInformation", "cloudPlatform", "properties", ], str]):
