...
class SnapshotRequestModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "contents", "description", "consentCode", "readers", "profileId", "properties", "policies", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "contents", "description", "consentCode", "readers", "profileId", "properties", "policies", ], str]):
        return super().get_item_oapg(name)
