...
class SnapshotSummaryModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "createdDate", "profileId", "storage", "secureMonitoringEnabled", "consentCode", "phsId", "cloudPlatform", "dataProject", "storageAccount", "selfHosted", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "createdDate", "profileId", "storage", "secureMonitoringEnabled", "consentCode", "phsId", "cloudPlatform", "dataProject", "storageAccount", "selfHosted", ], str]):
