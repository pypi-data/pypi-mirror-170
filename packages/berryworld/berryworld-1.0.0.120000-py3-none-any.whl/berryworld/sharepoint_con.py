        ...
        try:
            ...
            if len(folders) == 1:
                ...
                if str(result.status_code).startswith("2"):
                    ...
                    raise Exception(f"There are no items in the root folder: {path}")
            ...
            if str(result.status_code).startswith("2"):
                ...
                if str(result.status_code).startswith("2"):
                    ...
                    raise Exception(f"There are no items in: {path}")
            else:
                raise Exception(f"There are no folders in: {path}")
        except Exception as e:
    ...
    def get_file_content(self, file_path):
        ...
        try:
            ...
            if str(result.status_code).startswith("2"):
                ...
                raise Exception(f"There are no files called: {folders[-1]}")
        except Exception as e:
            raise Exception(str(e))
        ...
        try:
            ...
            if not str(result.status_code).startswith("2"):
                ...
                if str(result.status_code).startswith("2"):
                    ...
                    raise Exception("Please provide a valid full path. The folders indicated do not exist")
            else:
                raise Exception(f"The folder already exists in path: {folders}")
        except Exception as e:
            raise Exception(str(e))
        ...
        try:
            ...
            if len(folders) == 2:
                ...
                if str(result.status_code).startswith("2"):
                    ...
                    raise Exception(f"The path where the file is to be created does not exist: {file_path}")
    ...
    def delete_file(self, file_path):
        ...
        try:
            ...
            if str(result.status_code).startswith("2"):
                ...
                raise Exception(f"The path indicated does not exist {file_path}")
        except Exception as e:
            raise Exception(str(e))
    ...
    def delete_folder(self, folder_path):
        ...
        try:
            ...
            if str(result.status_code).startswith("2"):
                ...
                raise Exception(f"The path indicated does not exist {folder_path}")
        except Exception as e:
            raise Exception(str(e))
