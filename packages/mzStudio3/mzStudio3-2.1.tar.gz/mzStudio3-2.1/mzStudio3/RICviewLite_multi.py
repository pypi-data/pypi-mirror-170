...
class RICWindow(BufferedWindow):
    ...
    def OnDraw(self, dc):
        ...
        for k in range(0, len(self.xic_axco)):
            pass#print "DRAWING... ric axis " + str(k)
            self.DrawXic(dc, k)
