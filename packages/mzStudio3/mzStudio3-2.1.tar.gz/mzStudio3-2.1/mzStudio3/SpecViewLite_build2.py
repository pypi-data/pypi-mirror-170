...
class SpecViewLitePanel(wx.Frame):
    ...
    def OnText(self,event):
        self.tb.ToggleTool(10, False)
        self.tb.ToggleTool(20, False)
        pass#print self.tb.GetToolState(30)
    ...
    def OnSetmz(self,event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            for i in range(0, self.spectrum.axes):
                ...
                current_mz += step
            pass#print self.spectrum.mass_ranges
            #self.ClearOverlay()           
            self.SpecWindow.UpdateDrawing()            
...
class SpecWindow(BufferedWindow):  #wx.Window
    def __init__(self, parent, ID, spectrum, parent_window):
        ...
        pass#print self.spectrum.filter
        pass#print "S"
        self.set_axes()
        ...
        try:
            ...
            pass        
        pass#print self.spectrum.scan_type
        if self.spectrum.scan_type in ['MS2', 'etd'] and self.spectrum.sequence:
    ...
    def OnLeftDown(self, event):
        ...
        self.found = found
        self.grid = grid
        pass#print "ON LEFT DOWN"
        pass#print grid
        pass#print found
        pass#print pos
        if grid > -1:
            self.yaxco = self.spectrum.axco[grid][1]
            pass#print self.yaxco
            pass#print "SET YAX"
            pass#print pos
            if found:
    ...
    def set_axes(self):
        ...
        for k in range(0, num_axes):
            ...
            pass#print str(k) + "-" + str((current_fm, current_fm + step))
            current_fm += step
        pass#print self.spectrum.mass_ranges
        pass#print self.spectrum.axco
    ...
    def OnDraw(self, dc):
        ...
        for k in range(0, self.spectrum.axes):
            pass#print "DRAWING... spec axis " + str(k)
