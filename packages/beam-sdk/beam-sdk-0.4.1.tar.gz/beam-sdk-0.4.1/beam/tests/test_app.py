...
def test_basic_app_reconstruction():
    app = beam.App(
        ...
        gpu=5,
        python_packages=["vim"],
        python_version=PythonVersion.Python36,
...
def test_adding_cron_trigger_correctly_should_succeed():
    app1 = beam.App(
        name="some_app",
        cpu=1,
        memory="128mi",
    ...
    app3.Trigger.RestAPI(
        inputs={
            "some_input": beam.Types.String,
        },
        outputs={
            "some_output": beam.Types.String,
        },
        handler="test.py:app",
    )
