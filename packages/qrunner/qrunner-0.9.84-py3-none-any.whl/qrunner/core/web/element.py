...
from qrunner.utils.exceptions import ElementTypeError, NoSuchElementException, ElementNameEmptyException
...
class WebElement:
    ...
    def __init__(self,
        ...
        if ltext is not None:
            kwargs['ltext'] = ltext
        if pltext is not None:
            kwargs['pltext'] = pltext
