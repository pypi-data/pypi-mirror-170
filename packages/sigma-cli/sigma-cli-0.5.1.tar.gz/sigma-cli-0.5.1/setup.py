...
['click>=8.0.3,<9.0.0',
 ...
 'pysigma-backend-insightidr>=0.1.8,<0.2.0',
 'pysigma-backend-opensearch>=0.1.0,<0.2.0',
 'pysigma-backend-qradar>=0.2.1,<0.3.0',
 'pysigma-backend-splunk>=0.3.7,<0.4.0',
 'pysigma-pipeline-crowdstrike>=0.1.8,<0.2.0',
 'pysigma-pipeline-sysmon>=1.0.1,<2.0.0',
 'pysigma-pipeline-windows>=1.0.1,<2.0.0',
 'pysigma>=0.8.4,<0.9.0']
