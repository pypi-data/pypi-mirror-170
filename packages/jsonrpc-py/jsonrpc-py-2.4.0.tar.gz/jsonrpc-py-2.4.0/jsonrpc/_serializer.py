...
from json import dump as _json_encode, load as _json_decode
from pickle import HIGHEST_PROTOCOL, dump as _pickle_encode, load as _pickle_decode
from typing import Any, ClassVar, Final

from ._errors import Error, ErrorEnum

__all__: Final[tuple[str, ...]] = ("JSONSerializer", "PickleSerializer")
...
class JSONSerializer(BaseSerializer):
    ...
    def serialize(self, obj: Any) -> bytes:
        ...
        with StringIO() as raw_buffer:
            try:
                _json_encode(obj, raw_buffer, separators=(",", ":"))
                return raw_buffer.getvalue().encode("ascii")
    ...
    def deserialize(self, obj: bytes) -> Any:
        ...
        with BytesIO(obj) as raw_buffer:
            try:
                return _json_decode(raw_buffer)
            except Exception as exc:
...
class PickleSerializer(BaseSerializer):
    ...
    def serialize(self, obj: Any) -> bytes:
        ...
        with BytesIO() as raw_buffer:
            try:
                _pickle_encode(obj, raw_buffer, self.PROTOCOL_VERSION)
    ...
    def deserialize(self, obj: bytes) -> Any:
        ...
        with BytesIO(obj) as raw_buffer:
            try:
                return _pickle_decode(raw_buffer)
            except Exception as exc:
