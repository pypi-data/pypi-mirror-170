    ...
    bindFullscreenHandlers() {
        this.fullscreenButton.onclick = () => {
            if (screenfull_1.default.isFullscreen) {
                screenfull_1.default.exit().then(() => {
                ...
                screenfull_1.default.request(this.el).then(() => {
