...
class ExpectedImprovement(AcquisitionFunction):
                ...
                if isinstance(self.sampler, SampleGenerator):
                    if self.sampler.num_new_points is None:
                        if isinstance(self.sampler, PolytopeSampling):
                            ...
                            self.sampler.num_new_points = 2**20
    ...
    def ehvi(
        ...
        for iteration in range(self.num_restarts):
            ...
            # Create every combination of the new possible samples and determines the ehvi of all of them
            ...
            def ehvi_process(candidates_Y, candidates_Y_stddev):
                try:
                    val = ehvi.ehvi_calc(
                        Y_new=candidates_Y,
                        Y_new_stddev=candidates_Y_stddev,
            ...
            # Selects the variables and objective values of the candidate(s) that produced the highest expected
            # hypervolume improvement
