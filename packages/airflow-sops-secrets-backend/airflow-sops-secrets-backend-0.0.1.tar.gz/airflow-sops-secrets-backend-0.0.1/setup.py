...
setup(
    ...
    name="airflow-sops-secrets-backend",  # Required
    ...
    description="A airflow_sops secrets backend with sops",  # Optional
    ...
    # project.
    author="Paul Vitic",  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="pvitic@comatch.com",  # Optional
    ...
    # larger catalog.
    keywords="airflow, sops, secrets-backend",  # Optional
