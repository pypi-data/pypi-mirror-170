...
class Dataset(Object):
    ...
    def _ipython_display_(self,**kwargs):
        ...
        return ObjectWidget(dataset)._ipython_display_(**kwargs)
...
class DatasetList(APIObject):
    ...
    def _ipython_display_(self,**kwargs):
        return ObjectWidget(self)._ipython_display_(**kwargs)
...
class ItemAssets(dict):
    ...
    def _ipython_display_(self,**kwargs):
        return ItemAssetsWidget(self)._ipython_display_(**kwargs)
