...
class FeatureCollection(APIObject):
    ...
    def _ipython_display_(self,**kwargs):
        return FeatureCollectionWidget(self)._ipython_display_(**kwargs)
    ...
    @staticmethod
    def from_file_geodatabase(path: Union[str, os.PathLike], layer: str, **kwargs) -> 'FeatureCollection':
    ...
    def from_gpx(path: Union[str, os.PathLike], layer: str, **kwargs) -> 'FeatureCollection':
        ...
        Args:
            ...
            **kwargs - additional keywords to pass to fiona.open
        """
        valid_gpx_layers = ['waypoints', 'routes', 'tracks', 'route_points', 'track_points']
    ...
    @staticmethod
    def from_file(path: Union[str, os.PathLike], layer: str = None, **kwargs) -> 'FeatureCollection':
