...
def img_dwt(path, wavelet = 'db3', flavor = 1):
    ...
    if (flavor == 1):
        ...
        mtx, _ = common.dwtmtx(w, wavelet, False)
...
def Image_Sensing_n_Recovery(path, k = 0.2, alpha = 0.01, t = 'DCT', fast_lasso = False):
    ...
    z, xr = cs.Sensing_n_Recovery(x, k = k, alpha = alpha, t = t, fast_lasso=fast_lasso)
