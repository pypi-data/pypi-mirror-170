...
from client.model.dashboard_dto import DashboardDto
...
class DashboardControllerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_dashboard_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (DashboardDto,),
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/api/v1/dashboard/{id}',
    ...
    def update_dashboard(
        ...
        **kwargs
        ...
        >>> thread = api.update_dashboard(id, body, async_req=True)
        >>> result = thread.get()
