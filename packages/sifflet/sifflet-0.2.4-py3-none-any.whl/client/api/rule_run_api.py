...
from client.model.rule_test_result_dto import RuleTestResultDto
from client.model.search_collection_rule_run_details_by_group_dto import SearchCollectionRuleRunDetailsByGroupDto
from client.model.search_collection_rule_run_dto import SearchCollectionRuleRunDto
...
class RuleRunApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_sifflet_rule_failing_rows_by_run_and_group_endpoint = _Endpoint(
            settings={
                'response_type': (RuleTestResultDto,),
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/api/v1/rules/{id}/runs/{runId}/_debug/{groupValue}',
                'operation_id': 'get_sifflet_rule_failing_rows_by_run_and_group',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_sifflet_rule_last_run_endpoint = _Endpoint(
            settings={
                'response_type': (RuleRunDto,),
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/api/v1/rules/{id}/runs/latest',
                'operation_id': 'get_sifflet_rule_last_run',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_sifflet_rule_run_details_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/rules/{id}/runs/{runId}/details',
        ...
        self.get_sifflet_rule_runs_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/rules/{id}/runs',
        ...
        self.sifflet_rule_run_debug_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/rules/{id}/runs/{runId}/_debug',
    ...
    def get_sifflet_rule_failing_rows_by_run_and_group(
        self,
        id,
        run_id,
        group_value,
        **kwargs
        ...
        """Debug a Sifflet Rule run for a given group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_sifflet_rule_failing_rows_by_run_and_group(id, run_id, group_value, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['group_value'] = \
            group_value
        return self.get_sifflet_rule_failing_rows_by_run_and_group_endpoint.call_with_http_info(**kwargs)

    def get_sifflet_rule_last_run(
        self,
        id,
        **kwargs
    ):
        """Fetch a Sifflet Rule last run  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_sifflet_rule_last_run(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_sifflet_rule_last_run_endpoint.call_with_http_info(**kwargs)
    ...
    def get_sifflet_rule_runs(
        ...
        **kwargs
        ...
        """Fetch a Sifflet Rule job runs  # noqa: E501
