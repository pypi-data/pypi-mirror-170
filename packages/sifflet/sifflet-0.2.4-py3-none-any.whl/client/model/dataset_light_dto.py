...
class DatasetLightDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, urn, name, datasource_id, datasource_name, datasource_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, urn, name, datasource_id, datasource_name, datasource_type, *args, **kwargs):  # noqa: E501
        """DatasetLightDto - a model defined in OpenAPI
