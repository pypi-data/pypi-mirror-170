...
from client.model.idp_json_schema_params_dto import IDPJsonSchemaParamsDto
from client.model.problem import Problem
from client.model.saml2_auth_n_config_dto import SAML2AuthNConfigDto
from client.model.saml2_config_dto import Saml2ConfigDto
...
class IDPApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_idp_json_schema_params_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (IDPJsonSchemaParamsDto,)},),
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/api/v1/idps/params',
                'operation_id': 'get_all_idp_json_schema_params',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_by_registration_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/idps/{registrationId}',
        ...
        self.get_sp_config_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/idps/spconfig',
        ...
        self.test_saml_config_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/idps/_test',
        ...
        self.update_idp_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'JWT'
    ...
    def create_idp(
        ...
        **kwargs
        ...
        kwargs['saml2_config_dto'] = \
            saml2_config_dto
        return self.create_idp_endpoint.call_with_http_info(**kwargs)

    def get_all_idp_json_schema_params(
        self,
        **kwargs
    ):
        """Map of IDP json schema params  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_idp_json_schema_params(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_all_idp_json_schema_params_endpoint.call_with_http_info(**kwargs)
    ...
    def update_idp(
        ...
        **kwargs
        ...
        """Update an IDP  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_idp(registration_id, saml2_config_dto, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['saml2_config_dto'] = \
            saml2_config_dto
        return self.update_idp_endpoint.call_with_http_info(**kwargs)
