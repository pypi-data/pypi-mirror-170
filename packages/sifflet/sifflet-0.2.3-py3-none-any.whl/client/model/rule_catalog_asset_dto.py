...
class RuleCatalogAssetDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, dataset_name, dataset_id, datasource_name, datasource_type, source_platform, selectable, criticality, rule_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, dataset_name, dataset_id, datasource_name, datasource_type, source_platform, selectable, criticality, rule_type, *args, **kwargs):  # noqa: E501
        """RuleCatalogAssetDto - a model defined in OpenAPI
