...
class RuleDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'input_values': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, rule_template_name, dataset_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            input_values ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, rule_template_name, dataset_id, *args, **kwargs):  # noqa: E501
        """RuleDto - a model defined in OpenAPI
