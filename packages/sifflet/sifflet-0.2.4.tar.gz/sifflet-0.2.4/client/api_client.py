...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.access_token_validity  # this is an instance of the class Endpoint
        api_instance.access_token_validity()  # this invokes api_instance.access_token_validity.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.access_token_validity.callable or self.callable in this class
