...
class SecretControllerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_secret_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (SecretDto,),
                'auth': [
                    'JWT'
                ...
                'endpoint_path': '/api/v1/secret',
                'operation_id': 'get_secret_by_name',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_secret(
        ...
        **kwargs
        ...
        >>> thread = api.create_secret(secret_dto, async_req=True)
        >>> result = thread.get()
    ...
    def get_secret_by_name(
        ...
        **kwargs
        ...
        """get_secret_by_name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_secret_by_name(name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['name'] = \
            name
        return self.get_secret_by_name_endpoint.call_with_http_info(**kwargs)
    ...
    def update(
        ...
        **kwargs
        ...
        >>> thread = api.update(secret_dto, async_req=True)
        >>> result = thread.get()
