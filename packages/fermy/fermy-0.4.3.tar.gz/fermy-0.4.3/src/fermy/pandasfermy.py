...
==> next step groupby option for fanodygrowth function calcul mean
==> next step add minimal DeltaBiomassProxy for fanodygrowth function
==> nex step calcul max Proxxy at max slope
...
def fanodygrowth(data: pd.DataFrame, percentofmax:float=0.05, usemax:bool=False, timethreshold:Union[None, float]=None, deltathreshold:Union[None, float]=None) -> pd.DataFrame:
