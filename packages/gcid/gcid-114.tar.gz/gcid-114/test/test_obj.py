...
from gcid import Object, get, items, keys, register, update, values
from gcid import load, otype, save
from gcid import edit, printable
from gcid import ObjectDecoder, ObjectEncoder
from gcid import Wd
...
class TestObject(unittest.TestCase):
    ...
    def test_otype(self):
        self.assertEqual(otype(Object()), "gcid.obj.Object")
