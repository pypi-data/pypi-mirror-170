...
class HiveApiAsync:
    ...
    def getAll(self):
        ...
        try:
            ...
            json_return.update({"parsed": resp.json(content_type=None)})
    ...
    def getCameraRecording(self, device, eventId):
        """Build and query alarm endpoint."""
        json_return = {}
    ...
    def setState(self, n_type, n_id, **kwargs):
        ...
        try:
            ...
            resp = self.request("post", url, data=jsc)
            json_return["original"] = resp.status
            json_return["parsed"] = resp.json(content_type=None)
