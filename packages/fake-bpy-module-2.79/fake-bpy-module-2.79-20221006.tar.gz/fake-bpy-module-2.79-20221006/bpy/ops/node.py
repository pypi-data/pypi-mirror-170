...
def add_and_link_node(override_context: typing.
                      ...
                      *,
                      settings: bpy.types.
                      bpy_prop_collection['bpy.types.NodeSetting'] = None,
    ...
    :type settings: bpy.types.bpy_prop_collection['bpy.types.NodeSetting']
...
def read_fullsamplelayers(override_context: typing.
                          Union[typing.Dict, 'bpy.types.Context'] = None,
                          execution_context: typing.Union[str, int] = None,
                          undo: bool = None):
