...
def play_rendered_anim(override_context: typing.
                       ...
                       execution_context: typing.Union[str, int] = None,
                       undo: bool = None):
    ''' Play back rendered frames/movies using an external player :file: startup/bl_operators/screen_play_rendered_anim.py\:76 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/screen_play_rendered_anim.py$76> _
