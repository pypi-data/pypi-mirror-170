...
def freestyle_add_edge_marks_to_keying_set(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Add the data paths to the Freestyle Edge Mark property of selected edges to the active keying set :file: startup/bl_operators/freestyle.py\:144 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/freestyle.py$144> _
...
def freestyle_add_face_marks_to_keying_set(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Add the data paths to the Freestyle Face Mark property of selected polygons to the active keying set :file: startup/bl_operators/freestyle.py\:175 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/freestyle.py$175> _
...
def render_layer_add(override_context: typing.
                     Union[typing.Dict, 'bpy.types.Context'] = None,
                     execution_context: typing.Union[str, int] = None,
                     undo: bool = None):
    ''' Add a render layer
...
def render_layer_remove(override_context: typing.
                        Union[typing.Dict, 'bpy.types.Context'] = None,
                        execution_context: typing.Union[str, int] = None,
                        undo: bool = None):
...
def units_length_preset_add(override_context: typing.
                            Union[typing.Dict, 'bpy.types.Context'] = None,
                            execution_context: typing.Union[str, int] = None,
                            undo: bool = None,
                            *,
