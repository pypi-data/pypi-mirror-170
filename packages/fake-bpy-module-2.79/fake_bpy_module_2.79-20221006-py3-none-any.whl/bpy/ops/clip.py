...
def constraint_to_fcurve(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Create F-Curves for object which will copy object's movement caused by this constraint :file: startup/bl_operators/clip.py\:508 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$508> _
...
def delete_proxy(override_context: typing.
                 ...
                 execution_context: typing.Union[str, int] = None,
                 undo: bool = None):
    ''' Delete movie clip proxy files from the hard drive :file: startup/bl_operators/clip.py\:351 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$351> _
...
def set_active_clip(override_context: typing.
                    ...
                    execution_context: typing.Union[str, int] = None,
                    undo: bool = None):
    ''' Undocumented :file: startup/bl_operators/clip.py\:215 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$215> _
...
def set_viewport_background(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: bool = None):
    ''' Set current movie clip as a camera background in 3D view-port (works only when a 3D view-port is visible) :file: startup/bl_operators/clip.py\:412 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$412> _
...
def setup_tracking_scene(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Prepare scene for compositing 3D objects into this footage :file: startup/bl_operators/clip.py\:976 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$976> _
...
def track_settings_as_default(override_context: typing.
                              ...
                              execution_context: typing.Union[str, int] = None,
                              undo: bool = None):
    ''' Copy tracking settings from active track to default settings :file: startup/bl_operators/clip.py\:1013 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$1013> _
...
def track_settings_to_track(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: bool = None):
    ''' Copy tracking settings from active track to selected tracks :file: startup/bl_operators/clip.py\:1061 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$1061> _
