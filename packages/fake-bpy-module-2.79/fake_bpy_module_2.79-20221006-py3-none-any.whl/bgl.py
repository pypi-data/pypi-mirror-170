...
def glAccum(op: typing.Union[typing.Set[str], typing.Set[int]], value: float):
    ''' Operate on the accumulation buffer.

    :param op: The accumulation buffer operation.
    :type op: typing.Union[typing.Set[str], typing.Set[int]]
...
def glAlphaFunc(func: typing.Union[typing.Set[str], typing.Set[int]],
                ref: float):
...
def glBegin(mode: typing.Union[typing.Set[str], typing.Set[int]]):
...
def glCallLists(n: int, type: typing.Union[typing.Set[str], typing.Set[int]],
                lists: 'Buffer'):
...
def glColorMaterial(face: typing.Union[typing.Set[str], typing.Set[int]],
...
def glDrawPixels(width: int, height: int,
...
def glGetClipPlane(plane: typing.Union[typing.Set[str], typing.Set[int]],
                   equation: 'Buffer'):
...
def glMatrixMode(mode: typing.Union[typing.Set[str], typing.Set[int]]):
...
def glNewList(list: int, mode: typing.Union[typing.Set[str], typing.Set[int]]):
    ''' Create or replace a display list
...
def glRenderMode(mode: typing.Union[typing.Set[str], typing.Set[int]]):
...
def glShadeModel(mode: typing.Union[typing.Set[str], typing.Set[int]]):
...
def gluLookAt(eyex: float, eyey: float, eyez: float, centerx: float,
              centery: float, centerz: float, upx: float, upy: float,
              upz: float):
...
def gluPickMatrix(x: float, y: float, width: float, height: float,
                  viewport: 'Buffer'):
...
def gluProject(objx: float, objy: float, objz: float, modelMatrix: 'Buffer',
               projMatrix: 'Buffer', viewport: 'Buffer', winx: 'Buffer',
               winy: 'Buffer', winz: 'Buffer'):
...
def gluUnProject(winx: float, winy: float, winz: float, modelMatrix: 'Buffer',
                 projMatrix: 'Buffer', viewport: 'Buffer', objx: 'Buffer',
                 objy: 'Buffer', objz: 'Buffer'):
    ''' Map object coordinates to window coordinates.
