...
no_prefix_origin_oc_json_ietf_val = {
  'config': {
    'name': 'default'
  },
  'protocols': {
...
json_val_one_leaf = {'enable-flow-control': True}
...
request_multiple_list = {
  'nodes': [
        ...
        },
        {
            ...
            'nodetype': 'leaf',
            'value': '10',
            'xpath': '/top:System/top:igmp-items/top:inst-items/top:dom-items/top:Dom-list[top:name="default"]/top:eventHist-items/top:EventHistory-list[top:type="vrf"]/top:size' # noqa
        },
  ...
  'nodes': [
        {
            ...
            'value': 'test1',
            'nodetype': 'leaf',
            'xpath': '/top:System/top:mrib-items/top:inst-items/top:dom-items/top:Dom-list[top:name="default"]/top:rpfselect-items/top:RpfSelect-list[top:vrfName="224.2.2.2/32"][top:srcPfx="224.1.1.1/32"]/prop' # noqa
        },
        {
            'datatype': '',
            'value': 'test2',
            'nodetype': 'leaf',
            'xpath': '/top:System/top:mrib-items/top:inst-items/top:dom-items/top:Dom-list[top:name="default"]/top:rpfselect-items/top:RpfSelect-list[top:vrfName="224.2.2.2/33"][top:srcPfx="224.1.1.2/33"]/prop' # noqa
        },
...
class TestGnmiTestRpc(unittest.TestCase):
    ...
    def test_set_oc_net_instance(self):
        ...
        for gmc in gmcs:
            ...
            self.assertEqual(gmc.json_val, no_prefix_origin_oc_json_ietf_val)
...
class TestGnmiTestShim(unittest.TestCase):
    ...
    def test_set_api(self):
        ...
        val = jdict['update'][0].pop('val')
        self.assertEqual(jdict, no_prefix_origin_oc_json_ietf)
        self.assertEqual(val['jsonIetfVal'], no_prefix_origin_oc_json_ietf_val)
