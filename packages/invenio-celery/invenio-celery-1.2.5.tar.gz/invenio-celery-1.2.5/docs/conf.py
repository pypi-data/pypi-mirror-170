...
html_theme_options = {
    ...
    "extra_nav_links": {
        ...
        "invenio-celery@PyPI": "https://pypi.python.org/pypi/invenio-celery/",
    },
}
...
htmlhelp_basename = "invenio-celery_namedoc"
...
man_pages = [
    (master_doc, "invenio-celery", "invenio-celery Documentation", [author], 1)
]
