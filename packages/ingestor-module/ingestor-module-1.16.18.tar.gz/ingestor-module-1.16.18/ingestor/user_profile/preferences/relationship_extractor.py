...
class RelationshipExtractor:
    ...
    def get_preference_relationships(
        ...
        for index in range(size):
            print("---Working on index ", index, " of ", size)

            customer_id, record_df = \
                self.get_preference_record_df(index)
