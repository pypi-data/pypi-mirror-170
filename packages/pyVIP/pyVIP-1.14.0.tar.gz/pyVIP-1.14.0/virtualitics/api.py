...
class VIP:
    ...
    def _send_request(self, payload, pagenum=None):
        ...
        while attempts_remaining > 0:
            try:
                ...
                if cur_result.plot is not None and task_response["SaveToLocalHistory"]:
                ...
                if cur_result.plot is not None and task_response["ReturnPlotMapping"]:
    ...
    def load_object(self, path=None, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, imgPath=None):
        """
        ...
        params["OBJPath"] = path
        params = self._add_export_to_params(export, background, imsize, autocrop, imgPath, [params], ignore_no_plot=True)
    ...
    def _add_data(self, data, task_type, replot=True, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        """
    ...
    def load_network(self, network, network_name=None, edge_weight_format='similarity', export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        """
    ...
    def _load_network_from_networkx(self, network, network_name=None, edge_weight_format="Similarity", export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        ...
        params = self._add_export_to_params(export, background, imsize, autocrop, path, [params], ignore_no_plot=True)
        params = self._add_plot_mapping_to_params(params, save_to_local_history)
        output = self._api_request(params=params, data=data_bytes)
    ...
    def _load_network_from_edgelist(self, edgelist, network_name=None, edge_weight_format="Similarity", export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        # TODO: add an impute method
    ...
    def filter(self, feature_name, min=None, max=None, include=None, exclude=None, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True, keep_missing_value_columns=True):
        """
    ...
    def remove_filter(self, feature_name, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        """
    ...
    def remove_all_filters(self, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        """
        :param export: Specify whether to export a capture of the plot. Can be None/False or "ortho", "front",
            "side" or "right", "top", or "perspective"
        :param background: Specify whether to export a plot capture with a light or dark theme, or the current color
    ...
    def get_screen(self, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        """
    ...
    def history(self, index=None, name=None, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        """
    ...
    def refresh_plot(self, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None):
        """
    ...
    def show(self, plot: vip_plot.VipPlot, display=True, save_to_local_history=True, export="ortho", background="light",
             imsize=(2048, 2048), autocrop=True, path=None):
        """
    ...
    def apply_suggested_mapping(self, result_index, mapping_index, method="smart_mapping", export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        """
    ...
    def clustering(self, num_clusters=None, features=None, exclude=None, keep_missing_value_columns=True, apply=True,
                   return_clusters_df=True, export="ortho", background="light", imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True):
        """
    ...
    def network_extractor(self, node_column, associative_columns, pivot_type="mean", export="ortho", background="light",
                          imsize=(2048, 2048), autocrop=True, path=None, save_to_local_history=True, bypass_warning=False, extraction_type='Categorical', standard_scale=True):
        """
    ...
    @staticmethod
    def _add_export_to_params(export, background, imsize, autocrop, path, params, ignore_no_plot=False):
        """
