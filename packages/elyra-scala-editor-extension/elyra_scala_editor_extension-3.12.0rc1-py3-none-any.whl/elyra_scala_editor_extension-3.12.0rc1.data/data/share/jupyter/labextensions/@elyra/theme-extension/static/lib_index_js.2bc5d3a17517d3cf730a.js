...
const extension = {
    ...
    activate: (app, translator, labShell, mainMenu, palette) => {
        ...
        commands.addCommand(CommandIDs.openHelp, {
            ...
            execute: (args) => {
                window.open('https://elyra.readthedocs.io/en/v3.12.0rc1/', '_blank');
            }
        });
        commands.addCommand(CommandIDs.releases, {
            label: "What's new in v3.12.0rc1",
            caption: "What's new in this release",
            icon: ui_components_1.whatsNewIcon,
            execute: (args) => {
                window.open('https://github.com/elyra-ai/elyra/releases/v3.12.0rc1/', '_blank');
            }
        });
        model.add({
...
//# sourceMappingURL=lib_index_js.2bc5d3a17517d3cf730a.js.map