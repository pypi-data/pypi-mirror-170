...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'frontegg', PLUGIN_VERSION, '--server', 'https://github.com/MaterializeInc/pulumi-frontegg/releases/download/v0.2.24/'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource frontegg {PLUGIN_VERSION}`
                """)
            else:
                raise
...
setup(name='pulumi_frontegg',
      ...
      url='https://github.com/MaterializeInc/pulumi-frontegg',
      project_urls={
