...
class Table:
    ...
    def batch_get_from_pks(self, pks:list) -> list:
        keys = [{
            self.__primary_key__: pk,
            self.__secondary_key__: self.pk2sk(pk)
        } for pk in pks]
            ...
            AttributeDefinitions = [
                {
                    ...
                    "AttributeName": self.__search_data_key__,
                    "AttributeType": "S"
                },{
                    "AttributeName": self.__search_data_num_key__,
                    "AttributeType": "N"
                }, {
                    "AttributeName": self.__search_data_bin_key__,
                    "AttributeType": "B"
                }
            ],
