...
from pegen4cp.generator import ForCPPythonParserGenerator
...
def build_python_generator(
    ...
    with open(grammar_file, "r") as file:
        gram_code: str = file.read()
    with open(output_file, "w") as file:
        gen: ParserGenerator = ForCPPythonParserGenerator(gram_code, grammar, file)  # TODO: skip_actions
