...
# Main package name
PACKAGE_NAME = "typer-router"

# Directory name of package
PACKAGE_DIRECTORY = "typer_router"

# Name of Repo
REPO_NAME = "typer-router"
...
PACKAGE_SHORT_DESCRIPTION = "Build Typer CLI Apps with File System-Based Routing"
