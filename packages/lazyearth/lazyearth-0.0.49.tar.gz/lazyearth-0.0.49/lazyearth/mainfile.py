...
class water:
        ...
        def apply_mask(array, mask, no_data_value=-9999, clear_nan=True):
            # print("My.Inside : waterdetect.Common.py : class DWutils: def apply_mask(array, mask, no_data_value=-9999, clear_nan=True):")
            if clear_nan:
        ...
        def calc_param_limits(parameter, no_data_value=-9999,min_param_value=5,max_param_value = 20):
            # print("My.Inside : waterquality.WaterQuality.py : class DWWaterQuality(DWWaterDetect): def calc_param_limits(self, parameter, no_data_value=-9999):")
        ...
        def gray2color_ramp(grey_array,min_value=0, max_value=20, colormap='viridis', limits=(0, 1)):
            # print("My.Inside : waterdetect.Common.py : class DWutils: def gray2color_ramp()")
            """
        ...
        def waterquality(self,watermask,waterquality_function=None,range=None,colormap=True,bright=5,title='',label=''):
            # Watermask
            ...
            parameter = self.apply_mask(parameter,~watermask,-9999)
            ...
            ax1 = fig.add_axes([0.05,0.50,2.60,0.35])
