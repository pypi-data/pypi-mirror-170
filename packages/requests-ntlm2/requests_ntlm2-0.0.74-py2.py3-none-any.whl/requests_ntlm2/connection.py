        ...
        if code == PROXY_AUTHENTICATION_REQUIRED:
            ...
            while True:
                ...
                if body_length is None and this_line_is_blank:
                    ...
                    if body_length is not None and content_length_header is not None and body_length >= content_length_header:
                        break
                    elif content_length_header is None:
                ...
                if line.decode("utf-8").startswith(match_string):
                    ...
                    line = line.decode("utf-8")
                    try:
                        content_length_header = int(line.replace(content_length_match_string, "").strip())
