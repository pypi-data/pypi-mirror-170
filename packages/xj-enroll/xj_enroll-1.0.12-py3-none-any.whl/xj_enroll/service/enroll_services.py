...
class EnrollServices:
    ...
    def enroll_list(params):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "id", "thread_id", "category_id", "classify_id", "enroll_category_value", "enroll_classify_value", "trading_relate", "region_code", "spend_time_start",
                "spend_time_end", "create_time_start", "create_time_end", "finish_time_start", "finish_time_end", "open_time_start", "open_time_end",
                "enroll_status_code", "bid_mode", "has_subitem"
            ],
            alias_dict={
        ...
        enroll_obj = Enroll.objects.filter(**params).annotate(enroll_category_value=F("category__value")).annotate(enroll_classify_value=F("classify__value")).values()
    ...
    def enroll_detail(enroll_id):
        enroll_obj = Enroll.objects.filter(id=enroll_id).annotate(enroll_category_value=F("category__value")).annotate(enroll_classify_value=F("classify__value"))
        if not enroll_obj:
            return None, None
