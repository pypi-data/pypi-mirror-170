...
class BaseLanguage(abc.ABC):
    ...
    @staticmethod
    @abc.abstractmethod
    def make_class_group(tree, parent,caller_file=None):
        """
        :param tree Tree:
        :param parent Group:
        :rtype: Group
...
class Group():
    ...
    def add_node(self, node, is_root=False, caller_file=None):
        print("model.py add_node def 542 caller_file: ", caller_file, "name: ", node.name())
        """
        Nodes are found after initialization. This is how they are added.
        :param node Node:
        :param is_root bool:
        """
        node.file_name_real = caller_file
