...
def deploy_xe_infra(device_list: DeviceDict, usecase: Automation) -> None:
    ...
    try:
        ...
        w8 = path.join(basedir_infr_files, "ddr_clips-1.1.6-py3-none-any.whl")
        ...
        for device in flow.active_devices.values():
            ...
            w8_file = device.scp_upload_from_file(
                w8, "bootflash:/guest-share/ddr/ddr_clips-1.1.6-py3-none-any.whl"
            ).wait()
    ...
    try:
        ...
        export_ins1 = flow.exec_wait(
                [
                    ...
                    "python3 -m pip install /bootflash/guest-share/ddr/ddr_clips-1.1.6-py3-none-any.whl --user",
