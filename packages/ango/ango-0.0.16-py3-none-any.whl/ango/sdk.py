...
class SDK:
    ...
    def upload_files(self, project_id, file_paths):
        ...
        Args:
            ...
            file_paths: list of absolute paths that files to be uploaded.
    ...
    def export(self, project_id):
        ...
        url = "%s/v2/export?project=%s&" \
              "labeledAt=true&reviewedAt=true&completion=true&duration=true&skip=true&reviewConf=true&format=json&" \
              "consensus=true&assetStatus=true&labelDuration=true&updateInfo=true&issues=true&mask=true&" \
              "segmentationPoints=true&annotationMetadata=true&benchmark=true&labelStatus=true&sendEmail=false" % (self.host, project_id)
        headers = {
            'apikey': self.api_key
        }
