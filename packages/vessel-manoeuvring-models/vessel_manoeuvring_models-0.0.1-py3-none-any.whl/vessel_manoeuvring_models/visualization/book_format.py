...
def test_installation():
    ...
    try:
        ...
        print(
            "Please install matplotlib before continuing. See chapter 0 for instructions."
        )
    ...
    if LooseVersion(v) < LooseVersion(min_version):
        print(
            "Minimum FilterPy version supported is {}. "
            "Please install a more recent version.\n"
            "   ex: pip install filterpy --upgrade".format(min_version)
        )
    ...
    if LooseVersion(v) < LooseVersion(min_version):
        print(
            "Minimum Matplotlib version supported is {}. "
    ...
    if v.major < 3 or (v.major == 3 and v.minor < 6):
        print(
            "You must use Python version 3.6 or later for the notebooks to work correctly"
        )
