...
import SuPyMode.Tools.Plots as Plots
...
class SuperSet(object):
    ...
    @property
    def FullxAxis(self):
        """Return full x-axis taking account for the symmetries of the solver"""
    ...
    def GetReport(self, ITR: list=[1], dpi: int=300, Filename :str='ReportTest', ModeOfInterest: list=None) -> None:
