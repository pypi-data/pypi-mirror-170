...
class SuPySolver(object):
    ...
    """Random modulation of the geometry refractive index. Helps to get rid of unwanted symmetries"""
    ...
    def InitBinding(self, Wavelength: float, nComputedMode: int, nSortedMode: int, Symmetries: dict) -> CppSolver: 
        ...
        Solver = CppSolver(Mesh          = self.Geometry._Mesh,
    ...
    @DebugFunction
    def AddModes(self, nSortedMode: int, Symmetries: dict, Sorting: str='index', nComputedMode: int=None) -> None:
