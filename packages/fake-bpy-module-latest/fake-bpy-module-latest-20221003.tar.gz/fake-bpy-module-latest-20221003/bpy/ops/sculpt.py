...
def cloth_filter(override_context: typing.
                 ...
                 undo: bool = None,
                 *,
                 area_normal_radius: float = 0.25,
                 strength: float = 1.0,
                 type: typing.Union[str, int] = 'GRAVITY',
...
def color_filter(
    ...
    :type fill_color: typing.Union[typing.List[float], typing.Tuple[float, float, float], 'mathutils.Vector']
    '''
...
def expand(override_context: typing.Union[typing.
           ...
           undo: bool = None,
           *,
           target: typing.Union[str, int] = 'MASK',
...
def face_set_box_gesture(override_context: typing.
                         Union[typing.Dict, 'bpy.types.Context'] = None,
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None,
                         *,
...
def face_set_edit(override_context: typing.
                  ...
                  undo: bool = None,
                  *,
                  mode: typing.Union[str, int] = 'GROW',
...
def face_sets_create(override_context: typing.
                     ...
                     undo: bool = None,
                     *,
                     mode: typing.Union[str, int] = 'MASKED'):
...
def face_sets_init(override_context: typing.
                   ...
                   undo: bool = None,
                   *,
                   mode: typing.Union[str, int] = 'LOOSE_PARTS',
                   threshold: float = 0.5):
...
def mask_by_color(override_context: typing.
                  Union[typing.Dict, 'bpy.types.Context'] = None,
                  execution_context: typing.Union[str, int] = None,
                  undo: bool = None,
                  *,
...
def mask_filter(override_context: typing.
                ...
                undo: bool = None,
                *,
                filter_type: typing.Union[str, int] = 'SMOOTH',
                iterations: int = 1,
...
def mask_from_cavity(override_context: typing.
                     ...
                     undo: bool = None,
                     *,
                     mix_mode: typing.Union[str, int] = 'MIX',
                     mix_factor: float = 1.0,
                     use_automask_settings: bool = False,
                     factor: float = 0.5,
                     blur_steps: int = 2,
    ...
    :param use_automask_settings: Use Automask Settings, Use default settings from Options panel in sculpt mode
    :type use_automask_settings: bool
    :param factor: Cavity Factor, The contrast of the cavity mask
    :type factor: float
    :param blur_steps: Cavity Blur, The number of times the cavity mask is blurred
    :type blur_steps: int
    :param use_curve: Use Curve
    :type use_curve: bool
...
def mask_init(override_context: typing.Union[typing.
              ...
              undo: bool = None,
              *,
              mode: typing.Union[str, int] = 'RANDOM_PER_VERTEX'):
...
def mesh_filter(override_context: typing.
                Union[typing.Dict, 'bpy.types.Context'] = None,
                execution_context: typing.Union[str, int] = None,
                undo: bool = None,
                *,
...
def project_line_gesture(override_context: typing.
                         Union[typing.Dict, 'bpy.types.Context'] = None,
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None,
                         *,
...
def set_pivot_position(override_context: typing.
                       ...
                       undo: bool = None,
                       *,
                       mode: typing.Union[str, int] = 'UNMASKED',
                       mouse_x: float = 0.0,
                       mouse_y: float = 0.0):
...
def trim_box_gesture(override_context: typing.
                     Union[typing.Dict, 'bpy.types.Context'] = None,
                     execution_context: typing.Union[str, int] = None,
                     undo: bool = None,
                     *,
