...
# -*- coding: utf-8 -*-
#
# jmv documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jmv', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'jmv.tex', 'jmv Documentation',
     'KaivnD', 'manual'),
]
