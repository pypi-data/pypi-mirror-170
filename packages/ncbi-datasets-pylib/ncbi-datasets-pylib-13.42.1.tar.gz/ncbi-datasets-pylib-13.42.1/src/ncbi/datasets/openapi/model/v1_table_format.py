...
class V1TableFormat(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """V1TableFormat - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "tsv", must be one of ["tsv", "csv", "jsonl", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "tsv", must be one of ["tsv", "csv", "jsonl", ]  # noqa: E501
