...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'Z\030ncbi/datasets/v2/reports\370\001\001\302\363\030\201\n\n\023Gene Product Report\022\021ProductDescriptor\032@<p>The downloaded gene package contains a gene product report in\032:<a href=\"https://jsonlines.readthedocs.io/\">JSON Lines</a>\032Rformat in the file:<br><br><em>ncbi_dataset/data/product_report.jsonl</em><br><br>\032pEach line of the gene product report file is a hierarchical <a href=\"https://www.json.org/json-en.html\">JSON</a>\032iobject that represents a single gene record. The schema of the gene record is defined in the tables below\032jwhere each row describes a single field in the report or a sub-structure, which is a collection of fields.\032EThe outermost structure of the report is <em>GeneDescriptor</em>.</p>\032Q<p>Table fields that include a <em>Table Field Mnemonic</em> can be used with the\032\221\001<a href=\"/datasets/docs/v2/reference-docs/command-line/dataformat/\">dataformat</a> command-line tool\'s <nobr><code>--fields</code></nobr> option.\032\223\001Refer to the <a href=\"/datasets/docs/v2/reference-docs/command-line/dataformat/\">dataformat</a> CLI tool reference to see how you can use this tool\032Ito transform gene product reports from JSON Lines to tabular formats.</p>\"\017LineageOrganism\"\010Organism*\221\001{{< readfile-code-block lang=\"json\" file=\"/docs_samples/dataformat-cli/gene-to-tsv.cli.output\" begin=\"START data-report\" end=\"END data-report\">}}'
  ...
  _GENETYPE._serialized_start=2984
  _GENETYPE._serialized_end=3168
  _RNATYPE._serialized_start=3170
  _RNATYPE._serialized_end=3219
  ...
  _PRODUCTDESCRIPTOR._serialized_end=2863
  _TRANSCRIPTTYPECOUNT._serialized_start=2865
  _TRANSCRIPTTYPECOUNT._serialized_end=2981
