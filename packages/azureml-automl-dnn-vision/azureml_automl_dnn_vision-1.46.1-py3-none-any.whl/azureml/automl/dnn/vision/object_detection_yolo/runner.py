...
from ..common.parameters import add_task_agnostic_train_parameters, get_task_agnostic_train_boolean_parameters
...
def _parse_argument_settings(automl_settings: Dict[str, Any]) -> Tuple[Dict[str, Any], List[str]]:
    ...
    boolean_parameters = get_task_agnostic_train_boolean_parameters()
    ...
    boolean_parameters.append(YoloLiterals.MULTI_SCALE)
    ...
    # This function parses the string and converts it to a boolean.
    utils.fix_boolean_settings(merged_dict, boolean_parameters)
