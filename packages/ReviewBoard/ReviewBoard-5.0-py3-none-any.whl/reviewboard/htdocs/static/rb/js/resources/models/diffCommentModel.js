...
RB.DiffComment = RB.BaseComment.extend({
  ...
  serializedAttrs: ['baseFileDiffID', 'beginLineNum', 'fileDiffID', 'interFileDiffID', 'numLines'].concat(RB.BaseComment.prototype.serializedAttrs),
  deserializedAttrs: ['beginLineNum', 'endLineNum'].concat(RB.BaseComment.prototype.deserializedAttrs),
  ...
  validate(attrs) {
    ...
    if (hasBeginLineNum && hasEndLineNum && attrs.beginLineNum > attrs.endLineNum) {
...
//# sourceMappingURL=diffCommentModel.js.map