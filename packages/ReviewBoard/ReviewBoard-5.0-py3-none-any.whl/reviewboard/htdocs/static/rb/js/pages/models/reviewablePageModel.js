...
RB.ReviewablePage = RB.Page.extend({
  ...
  initialize(attributes) {
    ...
    const fileAttachments = new Backbone.Collection(_.map(editorData.fileAttachments, editorData.mutableByUser ? attrs => reviewRequest.draft.createFileAttachment(attrs) : attrs => reviewRequest.createFileAttachment(attrs)), {
      model: RB.FileAttachment
    });
    this.reviewRequestEditor = new RB.ReviewRequestEditor(_.defaults({
...
//# sourceMappingURL=reviewablePageModel.js.map