  ...
  describe('Event handling', function () {
    describe('reviewReply changes', function () {
      ...
      it('Removes events from old reviewReply', function () {
        ...
        expect(editor._listeningTo.hasOwnProperty(reviewReply._listenId)).toBe(false);
      });
    });
  });
    ...
    describe('save', function () {
      function testBodySave(options, done) {
        ...
        editor.save().then(() => {
          ...
          expect(reviewReply.get(options.richTextAttr)).toBe(options.richText);
...
//# sourceMappingURL=reviewReplyEditorModelTests.js.map