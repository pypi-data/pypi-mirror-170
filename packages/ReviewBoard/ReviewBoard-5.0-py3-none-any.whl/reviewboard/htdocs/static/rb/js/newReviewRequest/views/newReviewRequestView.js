...
<input type="submit" class="primary large" id="files-only-create"
  ...
  RB.NewReviewRequestView = RB.PageView.extend({
    ...
    template: _.template(`<div class="rb-c-new-review-request">
 ...
 <div class="rb-c-new-review-request__repo-pane">
  ...
  <div class="rb-c-new-review-request__repo-detail">
   <div class="rb-c-new-review-request__main">
    ...
    events: {
      'click .rb-c-new-review-request__show-repositories': '_onShowRepositoriesClicked'
    },
    ...
    renderPage() {
      ...
      this._$newReviewRequestContainer = this.$pageContent.find('.rb-c-new-review-request');
      this._$repoPane = this.$pageContent.find('.rb-c-new-review-request__repo-pane');
      this._$repoDetailContainer = this._$repoPane.find('.rb-c-new-review-request__repo-detail');
      this._$repoSelectorContainer = this._$newReviewRequestContainer.find('.rb-c-sidebar');
      this._$content = this._$repoDetailContainer.find('.rb-c-new-review-request__main');
      this._$hint = this._$repoDetailContainer.find('.rb-c-new-review-request__hint');
      /*
      ...
      this.listenTo(this._repositorySelectionView, 'selected', repository => this.model.set('repository', repository));
      this.listenTo(this.model, 'change:repository', this._onRepositoryChanged);
    ...
    onMobileModeChanged(inMobileMode) {
      this._repositorySelectionView.$el.detach().appendTo(inMobileMode ? this._$repoSelectorContainer : this.$mainSidebar);
    },
    ...
    _onRepositoryChanged() {
      ...
      if (repository === null) {
         ...
         */
        this._$newReviewRequestContainer.removeClass('js-repository-selected');
         ...
         */
        this._$newReviewRequestContainer.addClass('js-repository-selected');
...
//# sourceMappingURL=newReviewRequestView.js.map