...
RB.Admin.WidgetView = Backbone.View.extend({
  ...
  addHeaderAction(options) {
    return this._buildAction(options).appendTo(this.$headerActions);
  },
  ...
  addFooterAction(options) {
    return this._buildAction(options).appendTo(this.$footerActions);
  },
  ...
  setReloading(reloading) {
    console.assert(this.canReload, 'This widget did not set canReload=true.');
  ...
  render() {
    ...
    this.$headerActions = this.$header.children('.rb-c-admin-widget__actions');
    this.$footerActions = this.$footer.children('.rb-c-admin-widget__actions');
  ...
  _buildAction(options) {
    ...
    const $action = $('<li class="rb-c-admin-widget__action">').addClass(`js-action-${options.id}`);
