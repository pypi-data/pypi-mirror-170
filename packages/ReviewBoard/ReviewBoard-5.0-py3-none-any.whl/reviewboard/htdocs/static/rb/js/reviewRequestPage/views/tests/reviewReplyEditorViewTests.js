...
suite('rb/reviewRequestPage/views/ReviewReplyEditorView', function () {
  ...
  beforeEach(function () {
    ...
    $container.append(view._$commentsList).append($('<a href="#" class="add_comment_link">New Comment</a>'));
  });
  describe('Construction', function () {
    it('Populate from draft comment', function () {
      ...
      expect(editor.get('timestamp').valueOf()).toBe(now.milliseconds(0).valueOf());
  ...
  describe('Event handling', function () {
    ...
    it('Comment published', function () {
      ...
      expect($floatingAnchor.hasClass('fa fa-link fa-flip-horizontal')).toBe(true);
    });
  });
  ...
  describe('Text rendering', function () {
    ...
    it('richText=false', function () {
      testRendering(false, '&lt;p&gt;&lt;strong&gt;Test&lt;/strong&gt; ' + '&amp;amp;lt;&lt;/p&gt;');
    });
  });
});

//# sourceMappingURL=reviewReplyEditorViewTests.js.map