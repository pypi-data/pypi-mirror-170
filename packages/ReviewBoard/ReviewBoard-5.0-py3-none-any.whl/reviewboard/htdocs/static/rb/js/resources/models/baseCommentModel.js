...
RB.BaseComment = RB.BaseResource.extend({
  ...
  serializedAttrs: ['forceTextType', 'includeTextTypes', 'issueOpened', 'issueStatus', 'richText', 'text'],
  deserializedAttrs: ['issueOpened', 'issueStatus', 'text', 'html'],
  serializers: {
  ...
  validate(attrs) {
    ...
    if (attrs.issueStatus && attrs.issueStatus !== RB.BaseComment.STATE_DROPPED && attrs.issueStatus !== RB.BaseComment.STATE_OPEN && attrs.issueStatus !== RB.BaseComment.STATE_RESOLVED && attrs.issueStatus !== RB.BaseComment.STATE_VERIFYING_DROPPED && attrs.issueStatus !== RB.BaseComment.STATE_VERIFYING_RESOLVED) {
   ...
   */
  isStateOpen(state) {
    return state === RB.BaseComment.STATE_OPEN || state === RB.BaseComment.STATE_VERIFYING_DROPPED || state === RB.BaseComment.STATE_VERIFYING_RESOLVED;
  },

  strings: {
    INVALID_ISSUE_STATUS: 'issueStatus must be one of STATE_DROPPED, ' + 'STATE_OPEN, STATE_RESOLVED, ' + 'STATE_VERIFYING_DROPPED, or ' + 'STATE_VERIFYING_RESOLVED'
  }
});

//# sourceMappingURL=baseCommentModel.js.map