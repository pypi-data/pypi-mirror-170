...
RB.ReviewDialogCommentHook = RB.ExtensionHook.extend({
   ...
   */
  setUpHook() {
    console.assert(this.get('viewType'), 'ReviewDialogCommentHook instance does not have a ' + '"viewType" attribute set.');
  }

});

//# sourceMappingURL=reviewDialogCommentHookModel.js.map