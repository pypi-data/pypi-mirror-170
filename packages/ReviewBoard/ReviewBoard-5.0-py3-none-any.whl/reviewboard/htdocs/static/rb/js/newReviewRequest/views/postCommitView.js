...
RB.PostCommitView = Backbone.View.extend({
 ...
 <p>
   ...
   */
  async _loadBranches() {
    var _this$_commitsView2, _this$_commitsView2$$;
    ...
    try {
      ...
      var _this$_commitsView, _this$_commitsView$$e;

      this._branchesView.$el.hide();

      (_this$_commitsView = this._commitsView) === null || _this$_commitsView === void 0 ? void 0 : (_this$_commitsView$$e = _this$_commitsView.$el) === null || _this$_commitsView$$e === void 0 ? void 0 : _this$_commitsView$$e.hide();
    ...
    (_this$_commitsView2 = this._commitsView) === null || _this$_commitsView2 === void 0 ? void 0 : (_this$_commitsView2$$ = _this$_commitsView2.$el) === null || _this$_commitsView2$$ === void 0 ? void 0 : _this$_commitsView2$$.hide();
  },
