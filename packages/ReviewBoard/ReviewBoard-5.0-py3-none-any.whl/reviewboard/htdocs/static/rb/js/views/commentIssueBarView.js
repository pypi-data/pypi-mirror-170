...
RB.CommentIssueBarView = Backbone.View.extend({
 ...
 <div class="issue-container">
  ...
  async _onFixedClicked() {
    const comment = this._manager.getComment(this.options.reviewID, this.options.commentID, this.options.commentType);
  ...
  _onIssueStatusUpdated(comment, oldIssueStatus, timestamp, commentType) {
    ...
    if (comment.id === options.commentID && commentType === options.commentType) {
