...
RB.AbstractReviewableView = Backbone.View.extend({
  ...
  createAndEditCommentBlock(options) {
    ...
    if (defaultCommentBlockFields.length === 0 && this.model.reviewableIDField) {
      console.log('Deprecation notice: Reviewable subclass is missing ' + 'defaultCommentBlockFields. Rename reviewableIDField ' + 'to defaultCommentBlockFields, and make it a list.');
...
//# sourceMappingURL=abstractReviewableView.js.map