...
RB.ReviewRequestActionHook = RB.ExtensionHook.extend({
   ...
   */
  setUpHook() {
    console.assert(this.get('callbacks'), 'ReviewRequestActionHook instance does not have a ' + '"callbacks" attribute set.');
  }

});

//# sourceMappingURL=reviewRequestActionHookModel.js.map