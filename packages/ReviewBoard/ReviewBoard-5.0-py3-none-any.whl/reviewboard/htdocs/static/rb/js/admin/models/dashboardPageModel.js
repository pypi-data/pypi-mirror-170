  ...
  loadWidgets(onWidgetLoaded) {
    ...
    for (let i = 0; i < widgetsData.length; i++) {
      ...
      try {
        ...
        const widgetModel = new ModelType(_.defaults({
          id: widgetInfo.id
        }, widgetInfo.modelAttrs), widgetInfo.modelOptions);
        ...
        console.error('Unable to render administration widget "%s": %s', widgetInfo.id, e);
      }
    }
  }
...
//# sourceMappingURL=dashboardPageModel.js.map