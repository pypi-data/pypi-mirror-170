  ...
  describe('Without commits', function () {
    ...
    describe('Reviewable Management', function () {
      ...
      it('Files reset', function () {
        ...
        expect($containers.find('.sidebyside')[0].id).toBe('file_container_101');
    ...
    describe('Page view/URL state', function () {
      ...
      describe('Initial URL', function () {
        it('Initial default load', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('1/#index_header', {
            replace: true,
            trigger: false
          });
        ...
        it('Initial load of first page explicit', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('1/?page=1#index_header', {
            replace: true,
            trigger: false
          });
          expect(page.loadDiffRevision).not.toHaveBeenCalled();
        ...
        it('Initial load of page > 1', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('1/?page=2#index_header', {
            replace: true,
            trigger: false
          });
          expect(page.loadDiffRevision).not.toHaveBeenCalled();
        ...
        it('Initial load of interdiff', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('2-3/?page=2#index_header', {
            replace: true,
            trigger: false
          });
          expect(page.loadDiffRevision).not.toHaveBeenCalled();
        ...
        it('Initial load with filename patterns', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('1/?filenames=*.js,src/*#index_header', {
            replace: true,
            trigger: false
          });
          expect(page.loadDiffRevision).not.toHaveBeenCalled();
      ...
      describe('_navigate', function () {
        ...
        it('With page == 1', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('1/?filenames=*.js%2Csrc%2F*', {
            trigger: true
          });
        ...
        it('With page > 1', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('1/?page=2&filenames=*.js%2Csrc%2F*', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: null,
        ...
        it('New revision on page > 1', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('2/?filenames=*.js%2Csrc%2F*', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: null,
        ...
        it('With updateURLOnly', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('2-3/?filenames=*.js%2Csrc%2F*', {
            replace: true,
            trigger: false
          });
          expect(page.loadDiffRevision).not.toHaveBeenCalled();
        ...
        it('With anchor', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('1/?filenames=*.js%2Csrc%2F*#test', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: null,
      ...
      describe('Revision selector', function () {
        ...
        it('New interdiff revision selected', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('2-5/', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: null,
      ...
      describe('Page selector', function () {
        ...
        it('With page > 1', function () {
          ...
          expect(router.navigate).toHaveBeenCalledWith('1/?page=2', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: null,
      ...
      it('Anchor selection', function () {
        ...
        expect(router.navigate).toHaveBeenCalledWith('1/#test', {
          replace: true,
          trigger: false
        });
        expect(page.loadDiffRevision).not.toHaveBeenCalled();
  ...
  describe('With commits', function () {
    ...
    describe('Render', function () {
      ...
      it('Subsequent render (without interdiff)', function () {
        pageView.render();
        spyOn($, 'ajax').and.callFake(makeAjaxFn('/api/review-requests/123/diff-context/?revision=2', {
          diff_context: {
            revision: {
              revision: 2,
              interdiff_revision: null,
      ...
      it('Subsequent render (with interdiff)', function () {
        ...
        spyOn($, 'ajax').and.callFake(makeAjaxFn('/api/review-requests/123/diff-context/' + '?revision=2&interdiff-revision=3', rspPayload));
        page.loadDiffRevision({
          revision: 2,
          interdiffRevision: 3
        });
      ...
      it('Initial render with base commit ID and tip commit ID', function () {
        page.revision.set({
          baseCommitID: 1,
          tipCommitID: 2
        });
    ...
    describe('Page view/URL state', function () {
      beforeEach(function () {
        ...
        spyOn(Backbone.history, 'matchRoot').and.returnValue(true);
        spyOn(pageView.router, 'navigate').and.callFake((url, options) => {
          if (!options || options.trigger !== false) {
            Backbone.history.loadUrl(url);
          }
        });
      ...
      describe('Initial URL', function () {
        it('With base-commit-id', function () {
          ...
          expect(pageView.router.navigate).toHaveBeenCalledWith('1/?base-commit-id=2#index_header', {
            replace: true,
            trigger: false
          });
          expect(page.loadDiffRevision).not.toHaveBeenCalled();
        ...
        it('With tip-commit-id', function () {
          ...
          expect(pageView.router.navigate).toHaveBeenCalledWith('1/?tip-commit-id=2#index_header', {
            replace: true,
            trigger: false
          });
          expect(page.loadDiffRevision).not.toHaveBeenCalled();
        ...
        it('With base-commit-id and tip-commit-id', function () {
          ...
          expect(pageView.router.navigate).toHaveBeenCalledWith('1/?base-commit-id=1&tip-commit-id=2#index_header', {
            replace: true,
            trigger: false
          });
          expect(page.loadDiffRevision).not.toHaveBeenCalled();
      ...
      describe('Commit range controls', function () {
        it('Selecting initial base commit ID', function () {
          ...
          spyOn($, 'ajax').and.callFake(makeAjaxFn('/api/review-requests/123/diff-context/' + '?revision=1&base-commit-id=1', {
            diff_context: {
              revision: {
                revision: 1,
                interdiff_revision: null,
          ...
          expect(pageView.router.navigate).toHaveBeenCalledWith('1/?base-commit-id=1', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: 1,
        ...
        it('Selecting initial tip commit ID', function () {
          ...
          expect($table.length).toBe(1);
          expect($rows.length).toBe(3);
          spyOn($, 'ajax').and.callFake(makeAjaxFn('/api/review-requests/123/diff-context/' + '?revision=1&tip-commit-id=2', {
            diff_context: {
              revision: {
                base_commit_id: null,
                interdiff_revision: null,
          ...
          expect(pageView.router.navigate).toHaveBeenCalledWith('1/?tip-commit-id=2', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: null,
        ...
        it('Selecting new tip commit ID', function () {
          ...
          expect($table.length).toBe(1);
          expect($rows.length).toBe(3);
          spyOn($, 'ajax').and.callFake(makeAjaxFn('/api/review-requests/123/diff-context/' + '?revision=1&tip-commit-id=1', {
            diff_context: {
              revision: {
                base_commit_id: null,
                interdiff_revision: null,
          ...
          expect(pageView.router.navigate).toHaveBeenCalledWith('1/?tip-commit-id=1', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: null,
        ...
        it('Selecting blank base commit ID', function () {
          ...
          expect($table.length).toBe(1);
          expect($rows.length).toBe(3);
          spyOn($, 'ajax').and.callFake(makeAjaxFn('/api/review-requests/123/diff-context/' + '?revision=1', {
            diff_context: {
              revision: {
                base_commit_id: null,
                interdiff_revision: null,
          ...
          expect(pageView.router.navigate).toHaveBeenCalledWith('1/', {
            trigger: true
          });
          expect(page.loadDiffRevision).toHaveBeenCalledWith({
            baseCommitID: null,
...
//# sourceMappingURL=diffViewerPageViewTests.js.map