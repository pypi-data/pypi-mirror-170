...
suite('rb/admin/views/relatedGroupSelectorView', function () {
  describe('Rendering', function () {
    it('when empty', function () {
      ...
      view.render();
      expect(view.$el.find('.related-object-selected li').length).toBe(0);
    });
  });
  describe('Rendering', function () {
    it('with inital options', function () {
      ...
      expect(view.$el.find('.related-object-selected li').length).toBe(2);
...
//# sourceMappingURL=relatedGroupSelectorViewTests.js.map