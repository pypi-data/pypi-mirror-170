...
RB.WebhookFormView = Backbone.View.extend({
  ...
  render() {
    ...
    this._$customContentRow.find('p.help').append('<br/>').append($('<a/>').attr('href', MANUAL_URL + 'admin/configuration/webhooks/' + '#custom-payloads').text(gettext("Custom payload reference")));
    /*
   ...
   */
  _onAllEventsToggled() {
    this._$eventCheckboxes.not(this._$allEventsCheckbox).prop('disabled', this._$allEventsCheckbox[0].checked);
  },
...
//# sourceMappingURL=webhookFormView.js.map