...
suite('rb/views/DiffFragmentQueueView', function () {
  ...
  describe('Diff fragment loading', function () {
    ...
    beforeEach(function () {
      ...
      $container4 = $('<div id="container1_126"/>').appendTo(window.$testsScratch);
    ...
    it('With Unicode content', function (done) {
      spyOn($, 'ajax').and.callFake(function (options) {
        ...
        if (url === `${URL_PREFIX}123,124,125/`) {
          ...
          const html1 = [60, 115, 112, 97, 110, 62, 195, 161, 195, 169, 195, 173, 195, 179, 195, 186, 32, 240, 159, 148, 165, 60, 47, 115, 112, 97, 110, 62];
          /* UTF-8 bytes for "<span>ÄËÏÖÜŸ 😱</span>" */

          const html2 = [60, 115, 112, 97, 110, 62, 195, 132, 195, 139, 195, 143, 195, 150, 195, 156, 197, 184, 32, 240, 159, 152, 177, 60, 47, 115, 112, 97, 110, 62];
          /* UTF-8 bytes for "<span>🔥😱</span>" */

          const html3 = [60, 115, 112, 97, 110, 62, 240, 159, 148, 165, 240, 159, 152, 177, 60, 47, 115, 112, 97, 110, 62];
          ...
          const html = [60, 115, 112, 97, 110, 62, 196, 128, 196, 146, 196, 170, 197, 140, 32, 240, 159, 145, 191, 60, 47, 115, 112, 97, 110, 62];
    ...
    it('With saved fragments', function (done) {
      ...
      $container1.html('<span>Comment 1</span>').data('diff-fragment-view', view1);
      const view2 = new RB.DiffFragmentView();
      $container2.html('<span>Comment 2</span>').data('diff-fragment-view', view2);
      const view3 = new RB.DiffFragmentView();
      $container3.html('<span>Comment 3</span>').data('diff-fragment-view', view3);
      /*
