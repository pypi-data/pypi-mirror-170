...
RB.Diff = RB.BaseResource.extend({
  ...
  serializedAttrs: ['basedir', 'diff', 'parentDiff'].concat(RB.BaseResource.prototype.serializedAttrs),
  ...
  getErrorString(rsp) {
    if (rsp.err.code === RB.APIErrors.REPO_FILE_NOT_FOUND) {
      return interpolate(gettext("The file \"%(file)s\" (revision %(revision)s) was not found in the repository"), {
        file: rsp.file,
...
//# sourceMappingURL=diffModel.js.map