...
(function () {
  ...
  RB.ReviewRequestPage.ReviewEntryView = ParentView.extend({
    ...
    render() {
      ...
      this.listenTo(this._reviewView, 'hasDraftChanged', hasDraft => this.$el.toggleClass('has-draft', hasDraft));
      this.listenTo(this._reviewView, 'openIssuesChanged', this._updateLabels);
    ...
    getReviewReplyEditorView(contextType, contextID) {
      return this._reviewView.getReviewReplyEditorView(contextType, contextID);
    },
     ...
     */
    _updateLabels() {
      this._updateLabel(this._$fixItLabel, this._reviewView.hasOpenIssues(), 'has-issues');

      this._updateLabel(this._$shipItLabel, this.model.get('review').get('shipIt'), 'ship-it');
    },
    ...
    async _revokeShipIt() {
      ...
      const confirmation = RB.ReviewRequestPage.ReviewEntryView.strings.revokeShipItConfirm;
...
//# sourceMappingURL=reviewEntryView.js.map