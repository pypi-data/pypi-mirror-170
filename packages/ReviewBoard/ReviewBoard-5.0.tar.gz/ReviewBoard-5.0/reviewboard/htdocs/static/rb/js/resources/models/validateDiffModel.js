...
RB.ValidateDiffModel = RB.Diff.extend({
  ...
  serializedAttrs: ['repository'].concat(RB.Diff.prototype.serializedAttrs),
   ...
   */
  url() {
    return SITE_ROOT + this.get('localSitePrefix') + 'api/validation/diffs/';
  },
...
//# sourceMappingURL=validateDiffModel.js.map