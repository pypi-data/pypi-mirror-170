...
RB.FileAttachmentComment = RB.BaseComment.extend({
  ...
  serializedAttrs: ['diffAgainstFileAttachmentID', 'fileAttachmentID'].concat(RB.BaseComment.prototype.serializedAttrs),
  deserializedAttrs: ['linkText', 'thumbnailHTML', 'reviewURL'].concat(RB.BaseComment.prototype.deserializedAttrs),
  ...
  parseResourceData(rsp) {
    const result = RB.BaseComment.prototype.parseResourceData.call(this, rsp);
    ...
    if (rsp.diff_against_file_attachment) {
      result.diffAgainstFileAttachment = new RB.FileAttachment(rsp.diff_against_file_attachment, {
        parse: true
      });
      result.diffAgainstFileAttachmentID = result.diffAgainstFileAttachment.id;
    }
...
//# sourceMappingURL=fileAttachmentCommentModel.js.map