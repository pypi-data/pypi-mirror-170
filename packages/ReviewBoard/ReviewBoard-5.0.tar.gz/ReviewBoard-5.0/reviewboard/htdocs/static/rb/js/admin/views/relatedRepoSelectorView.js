...
(function () {
  const optionTemplate = _.template(`<div>
 <span class="title"><%- name %></span>
  ...
  RB.RelatedRepoSelectorView = Djblets.RelatedObjectSelectorView.extend({
     ...
     */
    initialize(options) {
      Djblets.RelatedObjectSelectorView.prototype.initialize.call(this, _.defaults({
        selectizeOptions: {
          searchField: ['name'],
          sortField: [{
            field: 'name'
...
//# sourceMappingURL=relatedRepoSelectorView.js.map