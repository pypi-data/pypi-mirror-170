...
suite('rb/resources/models/ReviewReply', function () {
  ...
  describe('destroy', function () {
    let callbacks;
    beforeEach(function () {
      spyOn(Backbone.Model.prototype, 'destroy').and.callFake(options => options.success());
    ...
    describe('With isNew=false', function () {
      ...
      beforeEach(function () {
        ...
        spyOn(RB, 'apiCall').and.callFake(options => {
          ...
          const key = _.find(RB.ReviewReply.prototype.COMMENT_LINK_NAMES, name => options.url === links[name].href);
...
//# sourceMappingURL=reviewReplyModelTests.js.map