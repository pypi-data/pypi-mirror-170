...
<p><%= fileText %></p>`)({
  ...
  initialize(options) {
    ...
    this._script = $('<script />').attr('src', RB.SupportBannerView.supportURL + '?' + $.param({
  ...
  render(options) {
    ...
    this.$el.empty().html(options.html).attr('class', options.className);
    return this;
  },
...
//# sourceMappingURL=supportBannerView.js.map