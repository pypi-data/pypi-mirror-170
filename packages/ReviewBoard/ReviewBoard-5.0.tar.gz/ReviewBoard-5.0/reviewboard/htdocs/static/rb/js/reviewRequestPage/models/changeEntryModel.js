...
(function () {
  ...
  RB.ReviewRequestPage.ChangeEntry = parentModel.extend({
     ...
     */
    parse(attrs) {
      const commits = attrs.commits ? new RB.DiffCommitCollection(attrs.commits, {
        parse: true
      }) : null;
      return _.extend(parentModel.prototype.parse.call(this, attrs), {
        commits: commits
      });
    }
...
//# sourceMappingURL=changeEntryModel.js.map