...
suite('rb/utils/dataUtils', function () {
  ...
  it('readManyBlobsAsArrayBuffers', function (done) {
    ...
    RB.DataUtils.readManyBlobsAsArrayBuffers([blob1, blob2], (result1, result2) => {
  ...
  it('readManyBlobsAsStrings', function (done) {
    ...
    RB.DataUtils.readManyBlobsAsStrings([blob1, blob2], (result1, result2) => {
  ...
  it('buildBlob', function (done) {
    const blob = RB.DataUtils.buildBlob(['abc', [{
      type: 'uint8',
      values: [1, 2]
    }, {
      type: 'uint32',
