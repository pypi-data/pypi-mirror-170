...
suite('rb/pages/models/ReviewablePage', function () {
  describe('Construction', function () {
    it('Child objects created', function () {
      ...
      expect(page.commentIssueManager.get('reviewRequest')).toBe(reviewRequest);
      expect(page.reviewRequestEditor.get('commentIssueManager')).toBe(page.commentIssueManager);
      expect(page.reviewRequestEditor.get('reviewRequest')).toBe(reviewRequest);
...
//# sourceMappingURL=reviewablePageModelTests.js.map