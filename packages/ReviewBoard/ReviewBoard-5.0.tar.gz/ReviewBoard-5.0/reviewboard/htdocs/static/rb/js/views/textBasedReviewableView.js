...
RB.TextBasedReviewableView = RB.FileAttachmentReviewableView.extend({
   ...
   */
  initialize(options) {
    RB.FileAttachmentReviewableView.prototype.initialize.call(this, options);
   ...
   */
  renderContent() {
    this._$viewTabs = this.$('.text-review-ui-views li'); // Set up the source text table.
  ...
  _onViewChanged() {
    ...
    this._$viewTabs.removeClass('active').filter(`[data-view-mode=${viewMode}]`).addClass('active');
...
//# sourceMappingURL=textBasedReviewableView.js.map