...
suite('rb/ui/views/TextEditorView', function () {
  ...
  describe('Operations', function () {
    ...
    describe('show', function () {
      it('registers drop target if rich text', function () {
        ...
        view.show();
        expect(RB.DnDUploader.instance.registerDropTarget).toHaveBeenCalled();
      });
      it('does not register drop target if plain text', function () {
        ...
        view.show();
        expect(RB.DnDUploader.instance.registerDropTarget).not.toHaveBeenCalled();
      });
    });
    describe('hide', function () {
      it('disables drop target', function () {
        ...
        view.show();
        view.hide();
        expect(RB.DnDUploader.instance.unregisterDropTarget).toHaveBeenCalled();
      });
    });
  });
  describe('inlineEditor options', function () {
    ...
    function setupEditor(options) {
      $el = $('<textarea>').inlineEditor(RB.TextEditorView.getInlineEditorOptions(options));
    ...
    describe('Rich text checkbox', function () {
      function setChecked(checked) {
         ...
         */
        $markdownCheckbox.click().prop('checked', checked).trigger('change');
      }
...
//# sourceMappingURL=textEditorViewTests.js.map