...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5786
...
class FEPartAdvancedTimeSteppingAnalysisForModulation(_6933.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation):
    """FEPartAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2405.FEPart':
    ...
    @property
    def component_load_case(self) -> '_6813.FEPartLoadCase':
    ...
    @property
    def export(self) -> '_5697.HarmonicAnalysisFEExportOptions':
    ...
    @property
    def results(self) -> '_5786.FEPartHarmonicAnalysisResultsPropertyAccessor':
    ...
    @property
    def system_deflection_results(self) -> '_2703.FEPartSystemDeflection':
