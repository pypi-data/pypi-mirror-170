...
class CylindricalGearMicroGeometry(_1093.CylindricalGearMicroGeometryBase):
    ...
    def create_separate_micro_geometry_for_each_tooth(self):
        """ 'CreateSeparateMicroGeometryForEachTooth' is the original name of this method."""

        self.wrapped.CreateSeparateMicroGeometryForEachTooth()
