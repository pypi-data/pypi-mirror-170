/*! For license information please see a32d1064.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[878],{89194:(e,t,r)=>{r(10994),r(65660),r(70019);var i=r(9672),n=r(50856);(0,i.k)({_template:n.d`
    <style>
      :host {
        ...
        <div class="card-content">
          ...
          ${this._co2ConfigEntry?i.dy`<div class="row" .entry=${this._co2ConfigEntry}>
                <img
                  ...
                  src=${(0,u.X1)({domain:"co2signal",type:"icon",darkOptimized:null===(e=this.hass.themes)||void 0===e?void 0:e.darkMode})}
                />
                <span class="content">${this._co2ConfigEntry.title}</span>
                <a
                  href=${`/config/integrations#config_entry=${this._co2ConfigEntry.entry_id}`}
                >
                  <ha-icon-button .path=${x}></ha-icon-button>
                </a>
                <ha-icon-button
                ...
                <div class="row border-bottom">
                  <img
                    referrerpolicy="no-referrer"
                    src=${(0,u.X1)({domain:"co2signal",type:"icon",darkOptimized:null===(t=this.hass.themes)||void 0===t?void 0:t.darkMode})}
                  />
