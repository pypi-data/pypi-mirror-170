...
class Phonetic_Manipulation():
	...
	def __phone_sets__(self, phones: str) -> None:
		...
		self.low_front = self.low_front_unrounded_tense + self.low_front_rounded_tense
		...
		self.low_central = self.low_central_rounded_tense + self.low_central_unrounded_tense
		...
		self.low_back = self.low_back_rounded_tense + self.low_back_unrounded_tense
