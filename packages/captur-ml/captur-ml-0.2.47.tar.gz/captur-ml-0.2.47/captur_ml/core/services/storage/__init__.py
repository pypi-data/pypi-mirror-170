...
def check_bucket_exists(
    bucket_name: str, storage_client: Optional[storage.Client] = None
) -> bool:
...
def check_file_exists(
    bucket_name: str, file_name: str, storage_client: Optional[storage.Client] = None
) -> bool:
...
class GCS_Storage(object):
    ...
    def write_json(
        self, json_dict: Dict[Any, Any], bucket_name: str, destination_filename: str
    ):
        """Writes a JSON file to Google Cloud Storage.
    ...
    def read(
        self, bucket_name: str, origin_filename: str, read_mode: Literal["r", "b"] = "r"
    ) -> Union[bytes, str]:
        """Reads a file from Google Cloud Storage.
