...
setup(
    ...
    version = "0.0.75",                                         # The initial release version
    ...
    packages = find_namespace_packages(include = ["toolkit4life.*", "toolkit4life.db.*"]),   # List of all python modules to be installed
    classifiers = [
