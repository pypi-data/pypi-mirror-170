...
def csrf_scanner(url, secure = True, bot = False):
    ...
    while True:
        ...
        try:
            my_request = web_session.get(website_list[tracker], verify = True, headers = user_agent, timeout = (5, 30)).text
            status = web_session.get(website_list[tracker], verify = True, headers = user_agent, timeout = (5, 30)).status_code
        ...
        if len(my_request) <= 5000000:
            ...
            for i in href:
                ...
                if "http" not in result and result[0] != "/" and ".com" not in result and ".org" not in result and ".net" not in result:
        ...
        for i in web_list:
            ...
            try:
                result = web_session.get(i, verify = True, headers = user_agent, timeout = (5, 30)).text
...
def form_scanner(url, secure = True, parse = "forms"):
    ...
    try:
        result = web_session.get(url, verify = True, headers = user_agent, timeout = (5, 30)).text
...
def sql_injection_scanner(url, secure = True, bot = False):
    ...
    #malicious sql code
    boolean_sql = ['admin" or "1" = "1', "admin' or '1' = '1"]
    mal_sql = ["\"", "\'", ";", "*"]
            ...
            for forms in form_list:
                ...
                for i in my_forms:
                    ...
                    if name_regex and get_regex:
                        password_search = re.search("password", i)
                        ...
                        if password_search:
                            for boolean_mal in boolean_sql:
                                ...
                                get = web_session.get(my_url, verify = True, headers = user_agent, timeout = (5, 30))
                                get_check = web_session.get(my_url, params = mal_dict, verify = True, headers = user_agent, timeout = (5, 30))
                    ...
                    if name_regex and post_regex:
                        ...
                        if password_search:
                            for boolean_mal in boolean_sql:
                                ...
                                post = web_session.get(my_url, verify = True, headers = user_agent, timeout = (5, 30))
                                post_check = web_session.post(my_url, data = mal_dict, verify = True, headers = user_agent, timeout = (5, 30))
                ...
                for mal in mal_sql:
                    ...
                    for i in my_forms:
                        ...
                        if name_regex and get_regex:
                            ...
                            get_data = web_session.get(my_url, params = form_dict, verify = True, headers = user_agent, timeout = (5, 30)).text
                        ...
                        if name_regex and post_regex:
                            print(color + "checking form (" + mal + "): " + forms)
                            send_data = web_session.post(my_url, data = form_dict, verify = True, headers = user_agent, timeout = (5, 30)).text
                        ...
                        if name_regex and get_regex:
                            ...
                            if password_search:
                                for boolean_mal in boolean_sql:
                                    ...
                                    get = web_session.get(j, verify = True, headers = user_agent, timeout = (5, 30))
                                    get_check = web_session.get(j, params = mal_dict, verify = True, headers = user_agent, timeout = (5, 30))
                        ...
                        if name_regex and post_regex:
                            ...
                            if password_search:
                                for boolean_mal in boolean_sql:
                                    ...
                                    post = web_session.get(j, verify = True, headers = user_agent, timeout = (5, 30))
                                    post_check = web_session.post(j, data = mal_dict, verify = True, headers = user_agent, timeout = (5, 30))
                ...
                for forms in form_list:
                    for mal in mal_sql:
                        ...
                        for i in my_forms:
                            ...
                            if name_regex and get_regex:
                                print(color + "checking form (" + mal + "): " + forms)
                                get_data = web_session.get(j, params = form_dict, verify = True, headers = user_agent, timeout = (5, 30)).text
                            ...
                            if name_regex and post_regex:
                                print(color + "checking form (" + mal + "): " + forms)
                                send_data = web_session.post(j, data = form_dict, verify = True, headers = user_agent, timeout = (5, 30)).text
            ...
            for forms in form_list:
                ...
                for i in my_forms:
                    if forms in i and "get" in i:
                        get_data = web_session.get(my_url, params = mal_dict, verify = True, headers = user_agent, timeout = (5, 30)).text
                    ...
                    if forms in i and "post" in i:
                        send_data = web_session.post(my_url, data = mal_dict, verify = True, headers = user_agent, timeout = (5, 30)).text
        ...
        for links in my_result:
            ...
            try:
                ...
                for forms in form_list:
                    ...
                    for i in my_forms:
                        if forms in i and "get" in i:
                            get_data = web_session.get(links, params = mal_dict, verify = True, headers = user_agent, timeout = (5, 30)).text
                        ...
                        if forms in i and "post" in i:
                            send_data = web_session.post(links, data = mal_dict, verify = True, headers = user_agent, timeout = (5, 30)).text
