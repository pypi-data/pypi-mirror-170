...
def csrf_scanner(url, secure = True, bot = False):
    if secure == True:
        my_secure = "https://"
    ...
    while True:
        ...
        try:
            my_request = web_session.get(website_list[tracker], verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
            status = web_session.get(website_list[tracker], verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).status_code
        ...
        if len(my_request) <= 5000000:
            ...
            for i in href:
                ...
                if "http" not in result and result[0] != "/":
        ...
        for i in web_list:
            ...
            print(color + "checking: " + i)
                
            try:
                result = web_session.get(i, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
            ...
            for ii in forms:
                if "hidden" not in ii and "password" in ii:
                    print(True)
                    my_list.append(i)
...
def extract_metadata(image):
    ...
    for tagid in exifdata:
        ...
        clear()
        print(color + f"{tagname:25}: {value}")
...
def form_scanner(url, secure = True, parse = "forms"):
    ...
    try:
        result = web_session.get(url, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
...
def sql_injection_scanner(url, secure = True, bot = False):
    ...
    boolean_sql = ['admin" or "1" = "1', "admin' or '1' = '1", "support@" + str(email_mal) + '" or "1" = "1', "support@" + str(email_mal) + "' or '1' = '1"]
    mal_sql = ["\"", "\'", ";", "*"]
    ...
    if user_input == "1":
        for c in mal_sql:
            ...
            try:
                result = web_session.get(new_url, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
                        ...
                        if password_search:
                            for boolean_mal in boolean_sql:
                                try:
                                    ...
                                    get = web_session.get(my_url, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
                                    get_check = web_session.get(my_url, params = mal_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)

                                    if get.text != get_check.text:
                                        print(color + "true: " + url + " form: " + forms + " (boolean)")
                                        my_list.append(url + " form: " + forms + " (boolean)")
                        ...
                        if password_search:
                            for boolean_mal in boolean_sql:
                                try:
                                    ...
                                    post = web_session.get(my_url, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
                                    post_check = web_session.post(my_url, data = mal_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
                ...
                for mal in mal_sql:
                    ...
                    for i in my_forms:
                        ...
                        if name_regex and get_regex:
                            ...
                            get_data = web_session.get(my_url, params = form_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text

                            for ii in error_mesage:
                        ...
                        if name_regex and post_regex:
                            print(color + "checking form (" + mal + "): " + forms)
                            send_data = web_session.post(my_url, data = form_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
                            ...
                            if password_search:
                                for boolean_mal in boolean_sql:
                                    try:
                                        ...
                                        get = web_session.get(j, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
                                        get_check = web_session.get(j, params = mal_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)

                                        if get.text != get_check.text:
                                            print(color + "true: " + j + " form: " + forms + " (boolean)")
                                            my_list.append(j + " form: " + forms + " (boolean)")
                            ...
                            if password_search:
                                for boolean_mal in boolean_sql:
                                    try:
                                        ...
                                        post = web_session.get(j, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
                                        post_check = web_session.post(j, data = mal_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
                ...
                for forms in form_list:
                    for mal in mal_sql:
                        ...
                        for i in my_forms:
                            ...
                            if name_regex and get_regex:
                                print(color + "checking form (" + mal + "): " + forms)
                                get_data = web_session.get(j, params = form_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
                            ...
                            if name_regex and post_regex:
                                print(color + "checking form (" + mal + "): " + forms)
                                send_data = web_session.post(j, data = form_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
    ...
    if user_input == "3":
        ...
        for j in my_result:
            for c in mal_sql:
                ...
                try:
                    result = web_session.get(j, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
...
def xss_scanner(url, secure = True, bot = False):
    ...
    if user_input == "1":
        try:
            ...
            result = web_session.get(super_result[0] + "=" + mal_script, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
        ...
        try:
            ...
            result = web_session.get(my_url + mal_script, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
            ...
            for forms in form_list:
                ...
                for i in my_forms:
                    if forms in i and "get" in i:
                        get_data = web_session.get(my_url, params = mal_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
                    ...
                    if forms in i and "post" in i:
                        send_data = web_session.post(my_url, data = mal_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
    ...
    if user_input == "2":
        ...
        for links in my_result:
            ...
            try:
                ...
                result = web_session.get(links + mal_script, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False)
            ...
            try:
                ...
                for forms in form_list:
                    ...
                    for i in my_forms:
                        if forms in i and "get" in i:
                            get_data = web_session.get(links, params = mal_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
                        ...
                        if forms in i and "post" in i:
                            send_data = web_session.post(links, data = mal_dict, verify = False, headers = user_agent, timeout = (5, 30), allow_redirects = False).text
