...
*JobsApi* | [**delete_jobs_id**](docs/JobsApi.md#delete_jobs_id) | **DELETE** /jobs/{id} | Removes the job by given id
...
*ReindexApi* | [**post_reindex**](docs/ReindexApi.md#post_reindex) | **POST** /auxiliary/reindex | Creates a Reindex Job
*SegmentsApi* | [**delete_segments_id**](docs/SegmentsApi.md#delete_segments_id) | **DELETE** /segments/{id} | Removes the segment by given id
...
*SegmentsApi* | [**patch_segments_id**](docs/SegmentsApi.md#patch_segments_id) | **PATCH** /segments/{id} | Updates the provided fields for the Segment with the ID given
*SegmentsApi* | [**post_segments**](docs/SegmentsApi.md#post_segments) | **POST** /segments | Create new Segments
*SegmentsApi* | [**put_segments_id**](docs/SegmentsApi.md#put_segments_id) | **PUT** /segments/{id} | Updates Segment with the ID given
...
*WorkspaceInvitationsApi* | [**get_workspace_invitations**](docs/WorkspaceInvitationsApi.md#get_workspace_invitations) | **GET** /workspace-invitations | Retrieves a list of workspace invitations
*WorkspaceInvitationsApi* | [**get_workspace_invitations_id**](docs/WorkspaceInvitationsApi.md#get_workspace_invitations_id) | **GET** /workspace-invitations/{id} | Retrieves Workspace Invitation with given ID
*WorkspaceInvitationsApi* | [**post_workspace_invitations**](docs/WorkspaceInvitationsApi.md#post_workspace_invitations) | **POST** /workspace-invitations | Creates a new workspace invitation
*WorkspaceManagementApi* | [**post_workspace_management**](docs/WorkspaceManagementApi.md#post_workspace_management) | **POST** /workspace-management | Creates a new Workspace Management
*WorkspacesApi* | [**delete_workspaces_id**](docs/WorkspacesApi.md#delete_workspaces_id) | **DELETE** /workspaces/{id} | Deletes Workspace with the ID given
...
## Documentation For Models
 ...
 - [WorkspaceInvitationCreateRequest](docs/WorkspaceInvitationCreateRequest.md)
