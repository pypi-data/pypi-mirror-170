...
project_requirements = get_requires("sense2/requirements.txt")
dev_requirements = get_requires("sense2/requirements_dev.txt")
...
setup(
    ...
    description='Sense2 C/C++ package manager',
