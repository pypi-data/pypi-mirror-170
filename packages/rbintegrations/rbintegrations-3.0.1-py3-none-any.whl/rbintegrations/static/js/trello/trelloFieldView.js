...
(function () {
  ...
  var TrelloInlineEditorView = RB.InlineEditorView.extend({
    ...
    initialize: function initialize(options) {
      ...
      options = _.defaults(options, {
        ...
        setFieldValue: function setFieldValue(editor, value) {// This is a no-op, since we do this in the $.selectize call.
        }
      });
  ...
  RB.ReviewRequestFields.TrelloFieldView = RB.ReviewRequestFields.TextFieldView.extend({
    ...
    _renderValue: function _renderValue(cards) {
      ...
      this.$el.html("<ul>".concat(items.join(''), "</ul>"));
    },
    ...
    _buildAutoComplete: function _buildAutoComplete() {
      ...
      var url = "".concat(SITE_ROOT, "rbintegrations/trello/").concat(localSite, "card-search/").concat(reviewRequestId, "/");
