...
if os.environ.get('READTHEDOCS', False) == 'True':
    ...
    INSTALL_REQUIRES = ['smart_open', 'boto3', 'requests', 'pandas', 'zstandard', 'orjson', 'tethys-data-models']
...
setup(
    ...
    url='https://github.com/tethys-ts/s3tethys',  # Optional
