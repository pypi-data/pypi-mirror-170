...
def capture_loop():
    ...
    try:
        ...
        camera = Picamera2()
        camera.set_controls({"FrameRate": CAMERA_FRAMERATE})
        with camera:
            video_config = camera.create_video_configuration(main={"size": CAMERA_RES}, transform=transform)
