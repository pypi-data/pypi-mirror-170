...
"""
Note that most part of this file is copied from python official zipfile. I only make some small changes to it.
The offical one does not support UTF-8, so if there are some non-ascii characters in file name, they will become messy code.
I make these changes to enforce UTF-8 encoding.
I only change 2 lines (line 1371 and 1550 in initial file, line 1440 and 1619 in this file).
"""
...
Some software incorporated into Python is under different licenses. The licenses are
listed with code falling under that license. See Licenses and Acknowledgements for
Incorporated Software for an incomplete list of these licenses.
