...
# API Constants
API_URL = os.environ.get('SIEVE_API_URL', 'https://sieve-gateway-bs2etamm.uc.gateway.dev')
API_BASE = os.environ.get('SIEVE_API_BASE', 'v1')
DASHBOARD_URL = os.environ.get('SIEVE_DASHBOARD_URL', 'https://chicken-app.sievedata.com')
