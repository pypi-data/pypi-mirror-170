...
def kpis_cross_validation(list_path=[], n_splits=5,url_out=None,postfix=""):
    ...
    for i in range(n_splits):
       ...
       list_train_filtracion(filtracion_train)
       subcobertura_train = 1 - recall_train
       list_train_subcobertura(subcobertura_train)
       ...
       list_valid_filtracion(filtracion_valid)
       subcobertura_valid = 1 - recall_test
       list_valid_subcobertura(subcobertura_valid)
