    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cognito-identitypool-alpha==2.43.1.a0",
        "aws_prototyping_sdk.pdk_nag>=0.11.1, <0.12.0",
        "cdk-nag>=2.18.20, <3.0.0",
        "constructs>=10.1.113, <11.0.0",
        "jsii>=1.68.0, <2.0.0",
        "projen>=0.62.19, <0.63.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
    "classifiers": [
