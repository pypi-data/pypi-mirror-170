...
def fbx(filepath: str = "",
        ...
        colors_type: typing.Union[int, str] = 'SRGB',
    ...
    :type colors_type: typing.Union[int, str]
...
def gltf(filepath: str = "",
         ...
         use_active_collection_with_nested: bool = False,
         use_active_collection_without_nested: bool = False,
    ...
    :param use_active_collection_with_nested: Active Collection and nested Collections, Export objects in the active collection and nested collections only
    :type use_active_collection_with_nested: bool
    :param use_active_collection_without_nested: Active Collection, Export objects in the active collection only
    :type use_active_collection_without_nested: bool
