...
def cloth_filter(area_normal_radius: float = 0.25,
                 strength: float = 1.0,
                 type: typing.Union[int, str] = 'GRAVITY',
...
def color_filter(area_normal_radius: float = 0.25,
                 strength: float = 1.0,
                 type: typing.Union[int, str] = 'HUE',
...
def mask_from_cavity(mix_mode: typing.Union[int, str] = 'MIX',
...
def mesh_filter(area_normal_radius: float = 0.25,
                strength: float = 1.0,
