...
class Mega:
    ...
    def _process_file(self, file, shared_keys):
        if file['t'] == 0 or file['t'] == 1:
            ...
            #             break
            if file['h'] and file['k'].split(":")[0] in shared_keys.get('EXP', ()):
                shared_key = shared_keys['EXP'][file['k'].split(":")[0]]
                key = decrypt_key(base64_to_a32(file['k'].split(':')[-1]), shared_key)
    ...
    def _init_shared_keys(self, files, shared_keys):
        ...
        # print(base64_to_a32("F9rar0qS8G-FSi3jfENPCg"))
        # print(base64_to_a32(base64_url_encode(master_key_cipher.encrypt('lWVC0b7Q'.encode()+'lWVC0b7Q'.encode()))))
        # exit()
    ...
    def get_upload_link(self, file):
        ...
        if 'f' in file:
            ...
            return ('{}://{}'.format(self.schema, self.domain)+
                    '/#!{}!{}'.format(public_handle, decrypted_key))
        else:
    ...
    def get_folder_link(self, file):
        ...
        if 'h' in file and 'k' in file:
            ...
            return ('{}://{}'.format(self.schema, self.domain)+
                    '/#F!{}!{}'.format(public_handle, decrypted_key))
        else:
            raise ValidationError('File id and key must be present')
