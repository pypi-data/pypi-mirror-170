...
class AcSource:
    ...
    routes = {
        ...
        "lab_index":        f"{scheme}://{domains['lab']}",
        "lab_screening":    f"{scheme}://{domains['lab']}/screening-room",
        ...
        "video_mobile":     f"{scheme}://scan.acfun.cn/vd/",
        ...
        'moment_mobile':    f"{scheme}://{domains['mobile']}/communityCircle/moment/",
