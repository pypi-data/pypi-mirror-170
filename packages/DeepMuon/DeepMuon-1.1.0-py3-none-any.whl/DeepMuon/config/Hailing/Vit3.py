...
LastEditTime: 2022-09-28 16:54:33
...
'''
work_config=dict(work_dir='/home/dachuang2022/Yufeng/Hailing-Muon/work_dir/1TeV/Vit_MLP3',logfile='log.log')
'''
...
'''
hyperpara=dict(epochs=5000,batch_size=4000,inputshape=[1,3,10,10,40])
'''
