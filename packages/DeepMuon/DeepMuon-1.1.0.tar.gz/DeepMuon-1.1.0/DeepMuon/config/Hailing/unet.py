...
LastEditTime: 2022-10-05 01:05:58
...
'''
work_config=dict(work_dir='/home/dachuang2022/Yufeng/Hailing-Muon/work_dir/1TeV/UNET_MLP_3',logfile='log.log')
'''
## Specify the checkpoint configuration
'''
checkpoint_config=dict(load_from='/home/dachuang2022/Yufeng/Hailing-Muon/work_dir/1TeV/UNET_MLP_1/Best_Performance.pth',resume_from='',save_inter=100)
'''
