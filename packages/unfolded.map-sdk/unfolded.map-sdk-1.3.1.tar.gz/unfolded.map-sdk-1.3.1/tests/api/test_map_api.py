...
class TestSetViewLimits:
    ...
    def test_widget_message(self, mock_comm: MockComm):
        ...
        m.set_view_limits(view_limits, 0)
    ...
    def test_widget_message_kwargs(self, mock_comm: MockComm):
        m = SyncWidgetMap()
        view_limits = {"min_zoom": 3, "max_zoom": 8}
        m.set_view_limits(**view_limits, index=0)
...
class TestSetMapControlVisibility:
    ...
    def test_widget_message(self, mock_comm: MockComm):
        ...
        m.set_map_control_visibility(visibility)
...
class TestSetSplitMode:
    ...
    def test_widget_message(self, mock_comm: MockComm):
        ...
        m.set_split_mode("swipe", options)
...
class TestSetTheme:
    def test_widget_message(self, mock_comm: MockComm):
        ...
        m.set_theme(preset="light", background_color="blue")
...
class TestSetMapConfig:
    def test_widget_message(self, mock_comm: MockComm):
        ...
        m.set_map_config(config, options)
