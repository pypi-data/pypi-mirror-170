...
def sfacurv():
    ...
    p.parameter_add(Param(ptype="integer", keyword="rect2=",
                          description="Smoothness on 2st axis",
                          default=1))

    p.parameter_add(Param(ptype="integer", keyword="rect3=",
                          description="Smoothness on 3st axis",
                          default=1))
...
def sfbin():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/blog/2014/12/01/program-of-the-month-sfbin/",
             authors=rsf, executable=executable)
...
def sfcausint():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/blog/2013/12/01/program-of-the-month-sfcausint/",
             authors=rsf, executable=executable)
...
def sfclip():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/blog/2011/09/03/program-of-the-month-sfclip/",
             authors=rsf, executable=executable)
...
def sfcontour():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2011/12/03/programs-of-the-month-sfcontour/",
             authors=rsf, executable=executable)
...
def sfcostaper():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2014/04/02/program-of-the-month-sfcostaper/",
             authors=rsf, executable=executable)
...
def sfcut():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sfcut",
             authors=rsf, executable=executable)
...
def sfderiv():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/blog/2012/05/01/program-of-the-month-sfderiv/",
             authors=rsf, executable=executable)
...
def sfdip():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/blog/2012/06/02/program-of-the-month-sfdip/",
             authors=rsf, executable=executable)
...
def sfeikonal():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/blog/2014/06/11/program-of-the-month-sfeikonal/",
             authors=rsf, executable=executable)
...
def sffft3():
    ...
    par = Param(ptype="range", keyword="sign=",
                description="Transform signal")
    par.range([0,1],vinc=1,vdigits=0)
    p.parameter_add(par)
...
def sfgraph():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2011/08/09/program-of-the-month-sfgraph/",
             authors=rsf, executable=executable)
...
def sfgrey():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2015/03/04/program-of-the-month-sfgrey/",
             authors=rsf, executable=executable)
...
def sfhalfint():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2012/12/23/program-of-the-month-sfhalfint/",
             authors=rsf, executable=executable)
...
def sfin():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sfin",
             authors=rsf, executable=executable)
...
def sfkirmod():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2012/10/03/program-of-the-month-sfkirmod/",
             authors=rsf, executable=executable)
...
def sfmath():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sfmath",
             authors=rsf, executable=executable)
...
def sfnoise():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2011/07/03/program-of-the-month-sfnoise/",
             authors=rsf,
...
def sfpad():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sfpad",
             authors=rsf, executable=executable)
...
def sfput():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sfput",
             authors=rsf, executable=executable)
...
def sfscale():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sfscale",
             authors=rsf, executable=executable)
...
def sfslice():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/blog/2019/06/12/program-of-the-month-sfslice/",
             authors=rsf, executable=executable)
...
def sfsmooth():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2012/01/01/program-of-the-month-sfsmooth/",
             authors=rsf, executable=executable)
...
def sfspectra():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2012/03/18/program-of-the-month-sfspectra/",
             authors=rsf, executable=executable)
...
def sfspike():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sfspike",
             authors=rsf, executable=executable)
...
def sfstolt():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2014/08/03/program-of-the-month-sfstolt/",
             authors=rsf, executable=executable)
...
def sfpick():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/blog/2012/08/01/program-of-the-month-sfpick/",
             authors=rsf, executable=executable)
...
def sftransp():
    ...
    p = Prog(title=title,description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sftransp",
             authors=rsf, executable=executable)
...
def sfwindow():
    ...
    p = Prog(title=title, description=description,
             url="http://ahay.org/wiki/Guide_to_madagascar_programs#sfwindow",
             authors=rsf, executable=executable)
