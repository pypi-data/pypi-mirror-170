...
def autocomplete(override_context: typing.
                 ...
                 undo: bool = None):
    ''' Evaluate the namespace up until the cursor and give a list of options or complete the name if there is only one :file: startup/bl_operators/console.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/console.py> _:72
...
def banner(override_context: typing.Union[typing.
           ...
           execution_context: typing.Union[str, int] = None,
           undo: bool = None):
    ''' Print a message when the terminal initializes :file: startup/bl_operators/console.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/console.py> _:117
...
def copy_as_script(override_context: typing.
                   ...
                   execution_context: typing.Union[str, int] = None,
                   undo: bool = None):
    ''' Copy the console contents for use in a script :file: startup/bl_operators/console.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/console.py> _:94
