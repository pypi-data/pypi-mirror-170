...
def object_settings_copy(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Copy Rigid Body settings from active object to selected :file: startup/bl_operators/rigidbody.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/rigidbody.py> _:59
