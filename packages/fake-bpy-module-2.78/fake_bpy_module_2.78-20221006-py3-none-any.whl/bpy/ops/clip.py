...
def bundles_to_mesh(override_context: typing.
                    ...
                    execution_context: typing.Union[str, int] = None,
                    undo: bool = None):
    ''' Create vertex cloud using coordinates of reconstructed tracks :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:278
...
def constraint_to_fcurve(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Create F-Curves for object which will copy object's movement caused by this constraint :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:504
...
def delete_proxy(override_context: typing.
                 ...
                 execution_context: typing.Union[str, int] = None,
                 undo: bool = None):
    ''' Delete movie clip proxy files from the hard drive :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:347
...
def graph_select_border(override_context: typing.
                        Union[typing.Dict, 'bpy.types.Context'] = None,
                        execution_context: typing.Union[str, int] = None,
                        undo: bool = None,
                        *,
...
def set_active_clip(override_context: typing.
                    ...
                    execution_context: typing.Union[str, int] = None,
                    undo: bool = None):
    ''' Undocumented :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:212
...
def set_viewport_background(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: bool = None):
    ''' Set current movie clip as a camera background in 3D view-port (works only when a 3D view-port is visible) :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:408
...
def setup_tracking_scene(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Prepare scene for compositing 3D objects into this footage :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:972
...
def tools(override_context: typing.Union[typing.
                                         Dict, 'bpy.types.Context'] = None,
          execution_context: typing.Union[str, int] = None,
          undo: bool = None):
...
def track_settings_as_default(override_context: typing.
                              ...
                              execution_context: typing.Union[str, int] = None,
                              undo: bool = None):
    ''' Copy tracking settings from active track to default settings :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:1009
...
def track_settings_to_track(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: bool = None):
    ''' Copy tracking settings from active track to selected tracks :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:1057
...
def track_to_empty(override_context: typing.
                   ...
                   execution_context: typing.Union[str, int] = None,
                   undo: bool = None):
    ''' Create an Empty object which will be copying movement of active track :file: startup/bl_operators/clip.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/clip.py> _:254
