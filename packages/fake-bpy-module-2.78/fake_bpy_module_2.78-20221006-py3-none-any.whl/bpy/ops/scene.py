...
def freestyle_add_edge_marks_to_keying_set(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Add the data paths to the Freestyle Edge Mark property of selected edges to the active keying set :file: startup/bl_operators/freestyle.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/freestyle.py> _:104
...
def freestyle_add_face_marks_to_keying_set(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Add the data paths to the Freestyle Face Mark property of selected polygons to the active keying set :file: startup/bl_operators/freestyle.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/freestyle.py> _:135
