...
def beautify_fill(bm: 'bmesh.types.BMesh',
                  ...
                  use_restrict_tag: bool, method: int) -> typing.Dict:
...
def bisect_plane(
    ...
    :rtype: typing.Dict
    :return: - geom_cut : output new geometry from the cut **type** list of ( bmesh.types.BMVert , bmesh.types.BMEdge ) - geom : input and output geometry (result of cut) **type** list of ( bmesh.types.BMVert , bmesh.types.BMEdge , bmesh.types.BMFace )
    '''
...
def create_monkey(bm: 'bmesh.types.BMesh',
                  matrix: 'mathutils.Matrix') -> typing.Dict:
...
def extrude_face_region(
        bm: 'bmesh.types.BMesh',
        geom: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
        edges_exclude: typing.Set, use_keep_orig: bool,
        use_select_history: bool) -> typing.Dict:
...
def mirror(bm: 'bmesh.types.BMesh',
           ...
           mirror_u: bool, mirror_v: bool) -> typing.Dict:
...
def similar_edges(bm: 'bmesh.types.BMesh',
                  ...
                  thresh: float, compare: int) -> typing.Dict:
...
def spin(bm: 'bmesh.types.BMesh',
         ...
         steps: int, use_duplicate: bool) -> typing.Dict:
...
def subdivide_edges(bm: 'bmesh.types.BMesh',
                    edges: typing.List['bmesh.types.BMEdge'], smooth: float,
                    smooth_falloff: int, fractal: float, along_normal: float,
                    cuts: int, seed: int, custom_patterns: typing.Dict,
                    edge_percents: typing.Dict, quad_corner_type: int,
                    use_grid_fill: bool, use_single_edge: bool,
                    use_only_quads: bool, use_sphere: bool,
...
def symmetrize(bm: 'bmesh.types.BMesh',
               input: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
               direction: int, dist: float) -> typing.Dict:
...
def wireframe(bm: 'bmesh.types.BMesh',
    ...
    :param faces: input faces
    :type faces: typing.List['bmesh.types.BMFace']
    :param thickness: Undocumented. Undocumented.
    :type thickness: float
