...
def edge_loops_from_tessfaces(
        mesh: 'bpy.types.Mesh',
        tessfaces: typing.Optional['bpy.types.MeshTessFace'] = None,
        seams=()) -> typing.List:
    ...
    :type tessfaces: typing.Optional['bpy.types.MeshTessFace']
    :rtype: typing.List
...
def face_random_points(num_points,
                       tessfaces: 'bpy.types.MeshTessFace') -> typing.List:
