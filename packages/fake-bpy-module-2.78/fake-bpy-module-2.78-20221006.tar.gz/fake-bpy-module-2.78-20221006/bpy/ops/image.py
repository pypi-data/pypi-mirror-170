...
def project_apply(override_context: typing.
                  ...
                  execution_context: typing.Union[str, int] = None,
                  undo: bool = None):
    ''' Project edited image back onto the object :file: startup/bl_operators/image.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/image.py> _:230
...
def project_edit(override_context: typing.
                 ...
                 execution_context: typing.Union[str, int] = None,
                 undo: bool = None):
    ''' Edit a snapshot of the view-port in an external image editor :file: startup/bl_operators/image.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/image.py> _:159
...
def save_dirty(override_context: typing.
               ...
               execution_context: typing.Union[str, int] = None,
               undo: bool = None):
    ''' Save all modified textures :file: startup/bl_operators/image.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/image.py> _:124
