...
class GetHubFlowByIdResponse200FlowValueModulesItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_value(
            ...
            try:
                value_type_0: GetHubFlowByIdResponse200FlowValueModulesItemValueType0
                ...
                pass
            try:
                value_type_1: GetHubFlowByIdResponse200FlowValueModulesItemValueType1
                if not isinstance(data, dict):
                    raise TypeError()
                ...
                pass
            try:
                value_type_2: GetHubFlowByIdResponse200FlowValueModulesItemValueType2
                if not isinstance(data, dict):
                    raise TypeError()
            ...
            if not isinstance(data, dict):
                raise TypeError()
            value_type_3: GetHubFlowByIdResponse200FlowValueModulesItemValueType3
