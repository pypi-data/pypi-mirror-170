...
class DeleteCompletedJobResponse200RawFlowModulesItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_value(
            ...
            try:
                value_type_0: DeleteCompletedJobResponse200RawFlowModulesItemValueType0
                ...
                pass
            try:
                value_type_1: DeleteCompletedJobResponse200RawFlowModulesItemValueType1
                if not isinstance(data, dict):
                    raise TypeError()
                ...
                pass
            try:
                value_type_2: DeleteCompletedJobResponse200RawFlowModulesItemValueType2
                if not isinstance(data, dict):
                    raise TypeError()
            ...
            if not isinstance(data, dict):
                raise TypeError()
            value_type_3: DeleteCompletedJobResponse200RawFlowModulesItemValueType3
