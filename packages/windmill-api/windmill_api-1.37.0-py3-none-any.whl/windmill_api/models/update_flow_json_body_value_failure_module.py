...
class UpdateFlowJsonBodyValueFailureModule:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_value(
            ...
            try:
                value_type_0: UpdateFlowJsonBodyValueFailureModuleValueType0
                ...
                pass
            try:
                value_type_1: UpdateFlowJsonBodyValueFailureModuleValueType1
                if not isinstance(data, dict):
                    raise TypeError()
                ...
                pass
            try:
                value_type_2: UpdateFlowJsonBodyValueFailureModuleValueType2
                if not isinstance(data, dict):
                    raise TypeError()
            ...
            if not isinstance(data, dict):
                raise TypeError()
            value_type_3: UpdateFlowJsonBodyValueFailureModuleValueType3
