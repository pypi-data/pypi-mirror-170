...
from ..models.queued_job_raw_flow_failure_module_input_transforms import QueuedJobRawFlowFailureModuleInputTransforms
...
class QueuedJobRawFlowFailureModule:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        input_transforms = QueuedJobRawFlowFailureModuleInputTransforms.from_dict(d.pop("input_transforms"))
