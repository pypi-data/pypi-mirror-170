...
class ListQueueResponse200ItemRawFlowModulesItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_value(
            ...
            try:
                value_type_0: ListQueueResponse200ItemRawFlowModulesItemValueType0
                ...
                pass
            try:
                value_type_1: ListQueueResponse200ItemRawFlowModulesItemValueType1
                if not isinstance(data, dict):
                    raise TypeError()
                ...
                pass
            try:
                value_type_2: ListQueueResponse200ItemRawFlowModulesItemValueType2
                if not isinstance(data, dict):
                    raise TypeError()
            ...
            if not isinstance(data, dict):
                raise TypeError()
            value_type_3: ListQueueResponse200ItemRawFlowModulesItemValueType3
