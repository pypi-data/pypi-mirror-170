...
class RunFlowPreviewJsonBodyValueModulesItemValueType2:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_iterator(
            ...
            try:
                iterator_type_0: RunFlowPreviewJsonBodyValueModulesItemValueType2IteratorType0
            ...
            if not isinstance(data, dict):
                raise TypeError()
            iterator_type_1: RunFlowPreviewJsonBodyValueModulesItemValueType2IteratorType1
