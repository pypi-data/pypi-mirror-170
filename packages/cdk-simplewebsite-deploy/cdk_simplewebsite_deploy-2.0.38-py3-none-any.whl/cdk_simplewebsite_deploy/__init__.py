...
class BasicSiteConfiguration:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BasicSiteConfiguration.__init__)
...
class CloudfrontSiteConfiguration:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudfrontSiteConfiguration.__init__)
            check_type(argname="argument hosted_zone", value=hosted_zone, expected_type=type_hints["hosted_zone"])
            check_type(argname="argument index_doc", value=index_doc, expected_type=type_hints["index_doc"])
            check_type(argname="argument website_folder", value=website_folder, expected_type=type_hints["website_folder"])
...
class CreateBasicSite(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CreateBasicSite.__init__)
...
class CreateCloudfrontSite(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CreateCloudfrontSite.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
