...
class ResNetBlock(nn.Module):
    ...
    Can also take in some context tensor
...
class UNet(nn.Module):
    """A image to image mapping network which halves the spacial dimension
    with each block while doubling the number of channels, before building
