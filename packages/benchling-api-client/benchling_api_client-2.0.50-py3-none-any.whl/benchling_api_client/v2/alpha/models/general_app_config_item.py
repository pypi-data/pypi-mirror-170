...
from ..models.general_app_config_item_type import GeneralAppConfigItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="GeneralAppConfigItem")


@attr.s(auto_attribs=True, repr=False)
class GeneralAppConfigItem:
    """  """

    _type: Union[Unset, GeneralAppConfigItemType] = UNSET
    ...
    def __repr__(self):
        ...
        return "GeneralAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_type() -> Union[Unset, GeneralAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = GeneralAppConfigItemType(_type)
                except ValueError:
                    type = GeneralAppConfigItemType.of_unknown(_type)

            return type

        type = get_type() if "type" in d else cast(Union[Unset, GeneralAppConfigItemType], UNSET)
        ...
        general_app_config_item.additional_properties = d
        return general_app_config_item
    ...
    @property
    def type(self) -> GeneralAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: GeneralAppConfigItemType) -> None:
        self._type = value
