...
class CanvasCreate:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for blocks_item_data in self._blocks:
            ...
            elif isinstance(blocks_item_data, SearchDropdownUiBlock):
                blocks_item = blocks_item_data.to_dict()
                ...
                def _parse_blocks_item(
                    ...
                    if discriminator_value is not None:
                        ...
                        if discriminator_value == "DROPDOWN":
                            blocks_item = DropdownUiBlock.from_dict(data)
                        ...
                        if discriminator_value == "SEARCH_DROPDOWN":
                            blocks_item = SearchDropdownUiBlock.from_dict(data)
                        ...
                        if discriminator_value == "SELECTOR_INPUT":
                            blocks_item = SelectorInputUiBlock.from_dict(data)
