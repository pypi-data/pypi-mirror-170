...
class SceneEngineClient(object):
    ...
    def index_recording(self,
        ...
        ----------
        path:
            The path containing recording data which includes bucket  e.g. bucket/a/b or bucket
        recording_name:
            The name of the recording to ingest.
            This will be used as session name.
        session_set_id:
