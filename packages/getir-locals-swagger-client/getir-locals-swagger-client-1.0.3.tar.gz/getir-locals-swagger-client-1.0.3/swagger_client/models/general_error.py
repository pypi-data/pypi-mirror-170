...
class GeneralError(object):
    ...
    """
    swagger_types = {
        'meta': 'GeneralErrorWrapper',
        'body': 'list[FieldValidation]'
    }
    ...
    def __init__(self, meta=None, body=None):  # noqa: E501
    ...
    @property
    def meta(self):
        """Gets the meta of this GeneralError.  # noqa: E501


        :return: The meta of this GeneralError.  # noqa: E501
        :rtype: GeneralErrorWrapper
        """
        return self._meta

    @meta.setter
    def meta(self, meta):
        """Sets the meta of this GeneralError.


        :param meta: The meta of this GeneralError.  # noqa: E501
        :type: GeneralErrorWrapper
        """
    ...
    @property
    def body(self):
        """Gets the body of this GeneralError.  # noqa: E501


        :return: The body of this GeneralError.  # noqa: E501
        :rtype: list[FieldValidation]
        """
        return self._body

    @body.setter
    def body(self, body):
        """Sets the body of this GeneralError.


        :param body: The body of this GeneralError.  # noqa: E501
        :type: list[FieldValidation]
        """
