...
class ProductBatchVendorRequest(object):
    ...
    """
    swagger_types = {
        'products': 'list[ProductVendorRequest]'
    }
    ...
    def __init__(self, products=None):  # noqa: E501
        """ProductBatchVendorRequest - a model defined in Swagger"""  # noqa: E501
        self._products = None
    ...
    @property
    def products(self):
        """Gets the products of this ProductBatchVendorRequest.  # noqa: E501


        :return: The products of this ProductBatchVendorRequest.  # noqa: E501
        :rtype: list[ProductVendorRequest]
        """
        return self._products

    @products.setter
    def products(self, products):
        """Sets the products of this ProductBatchVendorRequest.


        :param products: The products of this ProductBatchVendorRequest.  # noqa: E501
        :type: list[ProductVendorRequest]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductBatchVendorRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductBatchVendorRequest):
            return False
