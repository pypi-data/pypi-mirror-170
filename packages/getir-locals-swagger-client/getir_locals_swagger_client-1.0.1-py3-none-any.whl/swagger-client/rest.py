...
try:
    ...
    raise ImportError('Swagger python swagger-client requires urllib3.')
...
class RESTClientObject(object):
    ...
    def __init__(self, configuration, pools_size=4, maxsize=None):
        ...
        # Custom SSL certificates and swagger-client certificates: http://urllib3.readthedocs.io/en/latest/advanced-usage.html  # noqa: E501
