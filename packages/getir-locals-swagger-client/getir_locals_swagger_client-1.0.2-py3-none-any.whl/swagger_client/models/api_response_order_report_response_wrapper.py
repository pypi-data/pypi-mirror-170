...
class ApiResponseOrderReportResponseWrapper(object):
    ...
    """
    swagger_types = {
        'data': 'ApiResponseOrderReportResponse'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """ApiResponseOrderReportResponseWrapper - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this ApiResponseOrderReportResponseWrapper.  # noqa: E501


        :return: The data of this ApiResponseOrderReportResponseWrapper.  # noqa: E501
        :rtype: ApiResponseOrderReportResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ApiResponseOrderReportResponseWrapper.


        :param data: The data of this ApiResponseOrderReportResponseWrapper.  # noqa: E501
        :type: ApiResponseOrderReportResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiResponseOrderReportResponseWrapper, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiResponseOrderReportResponseWrapper):
            return False
