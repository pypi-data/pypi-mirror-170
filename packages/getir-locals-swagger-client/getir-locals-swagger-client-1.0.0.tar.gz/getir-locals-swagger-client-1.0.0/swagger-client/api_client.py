...
class ApiClient(object):
    """Generic API swagger-client for Swagger swagger-client library builds.

    Swagger generic API swagger-client. This swagger-client handles the swagger-client-
    ...
    :param configuration: .Configuration object for this swagger-client
    ...
    @property
    def user_agent(self):
        """User agent for this API swagger-client"""
