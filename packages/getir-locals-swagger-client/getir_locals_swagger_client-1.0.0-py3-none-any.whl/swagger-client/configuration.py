...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://locals-integration-api-gateway.artisandev.getirapi.com"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("swagger-client")
        ...
        # swagger-client certificate file
        self.cert_file = None
        # swagger-client key file
        self.key_file = None
    ...
    def auth_settings(self):
        """Gets Auth Settings dict for api swagger-client.
