...
class toolkit(object):
    ...
    def select(self, selection: "std::string const &") -> "bool":
        return _verovio.toolkit_select(self, selection)
    ...
    def renderData(self, data: "std::string const &", jsonOptions: "std::string const &") -> "std::string":
        return _verovio.toolkit_renderData(self, data, jsonOptions)
