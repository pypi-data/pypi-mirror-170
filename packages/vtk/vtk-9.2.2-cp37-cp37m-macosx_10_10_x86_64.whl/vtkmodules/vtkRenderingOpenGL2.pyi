...
class vtkOpenGLRenderWindow(vtkmodules.vtkRenderingCore.vtkRenderWindow):
    ...
    def GetColorBufferSizes(self, rgba:[int, ...]) -> int: ...
    ...
    @overload
    def GetZbufferData(self, x1:int, y1:int, x2:int, y2:int, z:[float, ...]) -> int: ...
    @overload
    ...
    def ReleaseRGBAPixelData(self, data:[float, ...]) -> None: ...
    ...
    @overload
    def SetPixelData(self, x:int, y:int, x2:int, y2:int, data:[int, ...], front:int, right:int) -> int: ...
    @overload
    def SetPixelData(self, x:int, y:int, x2:int, y2:int, data:vtkUnsignedCharArray, front:int, right:int) -> int: ...
    @overload
    def SetRGBACharPixelData(self, x:int, y:int, x2:int, y2:int, data:[int, ...], front:int, blend:int=0, right:int=0) -> int: ...
    @overload
    def SetRGBACharPixelData(self, x:int, y:int, x2:int, y2:int, data:vtkUnsignedCharArray, front:int, blend:int=0, right:int=0) -> int: ...
    @overload
    def SetRGBAPixelData(self, x:int, y:int, x2:int, y2:int, data:[float, ...], front:int, blend:int=0, right:int=0) -> int: ...
    @overload
    ...
    @overload
    def SetZbufferData(self, x1:int, y1:int, x2:int, y2:int, buffer:[float, ...]) -> int: ...
    @overload
...
class vtkCocoaRenderWindow(vtkOpenGLRenderWindow):
    ...
    @overload
    def SetPosition(self, a:[int, int]) -> None: ...
...
class vtkOpenGLPolyDataMapper(vtkmodules.vtkRenderingCore.vtkPolyDataMapper):
    ...
    def ProcessSelectorPixelBuffers(self, sel:vtkHardwareSelector, pixeloffsets:[int, ...], prop:vtkProp) -> None: ...
    def ReleaseGraphicsResources(self, __a:vtkWindow) -> None: ...
...
class vtkCompositePolyDataMapper2(vtkOpenGLPolyDataMapper):
    ...
    @overload
    def SetBlockColor(self, index:int, color:(float, float, float)) -> None: ...
    @overload
...
class vtkDataTransferHelper(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetCPUExtent(self) -> (int, int, int, int, int, int): ...
    def GetCPUExtentIsValid(self) -> bool: ...
    def GetContext(self) -> vtkRenderWindow: ...
    def GetExtentIsValid(self, extent:[int, ...]) -> bool: ...
    def GetGPUExtent(self) -> (int, int, int, int, int, int): ...
    ...
    def GetTextureExtent(self) -> (int, int, int, int, int, int): ...
    ...
    @overload
    def SetCPUExtent(self, _arg:(int, int, int, int, int, int)) -> None: ...
    ...
    @overload
    def SetGPUExtent(self, _arg:(int, int, int, int, int, int)) -> None: ...
    ...
    @overload
    def SetTextureExtent(self, _arg:(int, int, int, int, int, int)) -> None: ...
    def Upload(self, components:int=0, componentList:[int, ...]=...) -> bool: ...
...
class vtkGenericOpenGLRenderWindow(vtkOpenGLRenderWindow):
    ...
    @overload
    def SetScreenSize(self, _arg:(int, int)) -> None: ...
...
class vtkOpenGLFluidMapper(vtkmodules.vtkRenderingCore.vtkAbstractVolumeMapper):
    ...
    def GetAttenuationColor(self) -> (float, float, float): ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOpaqueColor(self) -> (float, float, float): ...
    ...
    @overload
    def SetAttenuationColor(self, _arg:(float, float, float)) -> None: ...
    ...
    @overload
    def SetOpaqueColor(self, _arg:(float, float, float)) -> None: ...
...
class vtkOpenGLFramebufferObject(vtkmodules.vtkRenderingCore.vtkFrameBufferObjectBase):
    ...
    @overload
    def ActivateDrawBuffers(self, ids:[int, ...], n:int) -> None: ...
    ...
    @staticmethod
    def Blit(srcExt:(int, int, int, int), destExt:(int, int, int, int), bits:int, mapping:int) -> int: ...
    def CheckFrameBufferStatus(self, mode:int) -> int: ...
    def DeactivateDrawBuffers(self) -> None: ...
    def DeactivateReadBuffer(self) -> None: ...
    @overload
    def Download(self, extent:[int, int, int, int], vtkType:int, nComps:int, oglType:int, oglFormat:int) -> vtkPixelBufferObject: ...
    @overload
    @staticmethod
    def Download(extent:[int, int, int, int], vtkType:int, nComps:int, oglType:int, oglFormat:int, pbo:vtkPixelBufferObject) -> None: ...
    def DownloadColor1(self, extent:[int, int, int, int], vtkType:int, channel:int) -> vtkPixelBufferObject: ...
    def DownloadColor3(self, extent:[int, int, int, int], vtkType:int) -> vtkPixelBufferObject: ...
    def DownloadColor4(self, extent:[int, int, int, int], vtkType:int) -> vtkPixelBufferObject: ...
    def DownloadDepth(self, extent:[int, int, int, int], vtkType:int) -> vtkPixelBufferObject: ...
...
class vtkOpenGLGL2PSHelper(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def DrawImage(self, image:vtkImageData, pos:[float, float, float]) -> None: ...
...
class vtkOpenGLGlyph3DHelper(vtkOpenGLPolyDataMapper):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GlyphRender(self, ren:vtkRenderer, actor:vtkActor, numPts:int, colors:[int, ...], matrices:[float, ...], normalMatrices:[float, ...], pickIds:[int, ...], pointMTime:int, culling:bool) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkOpenGLIndexBufferObject(vtkOpenGLBufferObject):
    @staticmethod
    def AppendEdgeFlagIndexBuffer(indexArray:[int, ...], cells:vtkCellArray, vertexOffset:int, edgeflags:vtkDataArray) -> None: ...
    @staticmethod
    def AppendLineIndexBuffer(indexArray:[int, ...], cells:vtkCellArray, vertexOffset:int) -> None: ...
    @staticmethod
    def AppendPointIndexBuffer(indexArray:[int, ...], cells:vtkCellArray, vertexOffset:int) -> None: ...
    @staticmethod
    def AppendStripIndexBuffer(indexArray:[int, ...], cells:vtkCellArray, vertexOffset:int, wireframeTriStrips:bool) -> None: ...
    @staticmethod
    def AppendTriangleLineIndexBuffer(indexArray:[int, ...], cells:vtkCellArray, vertexOffset:int) -> None: ...
...
class vtkOpenGLRenderUtilities(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def RenderQuad(verts:[float, ...], tcoords:[float, ...], program:vtkShaderProgram, vao:vtkOpenGLVertexArrayObject) -> None: ...
    @staticmethod
...
class vtkOpenGLState(vtkmodules.vtkCommonCore.vtkObject):
    def ActivateTexture(self, __a:vtkTextureObject) -> None: ...
    def DeactivateTexture(self, __a:vtkTextureObject) -> None: ...
    def GetBlendFuncState(self, __a:[int, ...]) -> None: ...
    ...
    def vtkDrawBuffers(self, n:int, __b:[int, ...], __c:vtkOpenGLFramebufferObject) -> None: ...
    ...
    def vtkglDrawBuffers(self, n:int, __b:[int, ...]) -> None: ...
    def vtkglEnable(self, cap:int) -> None: ...
    def vtkglGetBooleanv(self, pname:int, params:[int, ...]) -> None: ...
    def vtkglGetDoublev(self, pname:int, params:[float, ...]) -> None: ...
    def vtkglGetFloatv(self, pname:int, params:[float, ...]) -> None: ...
    def vtkglGetIntegerv(self, pname:int, params:[int, ...]) -> None: ...
...
class vtkPixelBufferObject(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Download2D(self, type:int, data:Pointer, dims:[int, int], numcomps:int, increments:[int, int]) -> bool: ...
    def Download3D(self, type:int, data:Pointer, dims:[int, int, int], numcomps:int, increments:[int, int, int]) -> bool: ...
    ...
    def Upload2D(self, type:int, data:Pointer, dims:[int, int], comps:int, increments:[int, int]) -> bool: ...
    def Upload3D(self, type:int, data:Pointer, dims:[int, int, int], comps:int, increments:[int, int, int], components:int, componentList:[int, ...]) -> bool: ...
...
class vtkShaderProgram(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def SetUniform1fv(self, name:str, count:int, f:(float, ...)) -> bool: ...
    def SetUniform1iv(self, name:str, count:int, f:(int, ...)) -> bool: ...
    def SetUniform2f(self, name:str, v:(float, float)) -> bool: ...
    def SetUniform2fv(self, name:str, count:int, f:(float, ...)) -> bool: ...
    def SetUniform2i(self, name:str, v:(int, int)) -> bool: ...
    def SetUniform3f(self, name:str, v:(float, float, float)) -> bool: ...
    def SetUniform3fv(self, name:str, count:int, f:(float, ...)) -> bool: ...
    def SetUniform3uc(self, name:str, v:(int, int, int)) -> bool: ...
    def SetUniform4f(self, name:str, v:(float, float, float, float)) -> bool: ...
    def SetUniform4fv(self, name:str, count:int, f:(float, ...)) -> bool: ...
    def SetUniform4uc(self, name:str, v:(int, int, int, int)) -> bool: ...
    ...
    def SetUniformMatrix3x3(self, name:str, v:[float, ...]) -> bool: ...
    def SetUniformMatrix4x4(self, name:str, v:[float, ...]) -> bool: ...
    def SetUniformMatrix4x4v(self, name:str, count:int, v:[float, ...]) -> bool: ...
...
class vtkShadowMapPass(vtkOpenGLRenderPass):
    ...
    def GetShadowMapTextureUnits(self) -> (int, ...): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def ShadowMapTransforms(self) -> (float, ...): ...
...
class vtkTextureObject(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def CopyToFrameBuffer(self, tcoords:[float, ...], verts:[float, ...], program:vtkShaderProgram, vao:vtkOpenGLVertexArrayObject) -> None: ...
