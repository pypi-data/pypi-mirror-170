...
class _User():
    ...
    def Info(self, id):
        ...
        if "data" not in el:
            ...
            bar = requests.get(f"https://friends.roblox.com/v1/users/{id}/friends/count")
            bar = json.loads(bar.text)
            ag = requests.get(f"https://friends.roblox.com/v1/users/{id}/followers/count")
            ag = json.loads(ag.text)
            qux = requests.get(f"https://friends.roblox.com/v1/users/{id}/followings/count")
