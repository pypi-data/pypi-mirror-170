...
def smartner(nl, language="en", online=True, datasets=None, dataframe=None, response_type="deanonymize", token="",
             use_ner=True, use_cache=False, use_redis=False, cache_mode="standard", model_version=None,
