...
setup(
    ...
    description="An Evidentiq Platform client library",  # Optional
    ...
    # project.
    author="Evidentiq",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="info@evidentiq.com",  # Optional
    ...
    install_requires=['requests[security]~=2.28', 'boto3~=1.24', 'enforce-typing~=1.0', 'sentinels~=1.0', 'frozendict~=2.3', 'http-constants~=0.5', 'hyperlink~=21.0'],  # Optional
