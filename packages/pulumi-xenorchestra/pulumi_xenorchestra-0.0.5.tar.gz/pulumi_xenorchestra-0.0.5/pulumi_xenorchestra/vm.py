...
class VmArgs:
    def __init__(__self__, *,
                 ...
                 cpu_cap: Optional[pulumi.Input[float]] = None,
                 cpu_weight: Optional[pulumi.Input[float]] = None,
                 ...
                 videoram: Optional[pulumi.Input[float]] = None,
                 wait_for_ip: Optional[pulumi.Input[bool]] = None):
        """
        The set of arguments for constructing a Vm resource.
        :param pulumi.Input[int] cpus: The number of CPUs the VM will have. Updates to this field will cause a stop and start of the VM if the new CPU value is greater than the max CPU value. This can be determined with the following command:
        :param pulumi.Input[Sequence[pulumi.Input['VmDiskArgs']]] disks: The disk the VM will have access to.
        :param pulumi.Input[float] memory_max: The amount of memory in bytes the VM will have. Updates to this field will cause a stop and start of the VM if the new `memory_max` value is greater than the dynamic memory max. This can be determined with the following command:
        :param pulumi.Input[str] name_label: The name for the disk.
        :param pulumi.Input[Sequence[pulumi.Input['VmNetworkArgs']]] networks: The network the VM will use
        :param pulumi.Input[str] template: The ID of the VM template to create the new VM from.
        :param pulumi.Input[str] affinity_host: The preferred host you would like the VM to run on. If changed on an existing VM it will require a reboot for the VM to be rescheduled.
        :param pulumi.Input[bool] auto_poweron: If the VM will automatically turn on. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] blocked_operations: List of operations on a VM that are not permitted. Examples include: clean_reboot, clean_shutdown, hard_reboot, hard_shutdown, pause, shutdown, suspend, destroy. This can be used to prevent a VM from being destroyed. The entire list can be found here
        ...
        :param pulumi.Input[str] cloud_config: The content of the cloud-init config to use
        :param pulumi.Input[str] cloud_network_config: The content of the cloud-init network configuration for the VM (uses [version 1](https://cloudinit.readthedocs.io/en/latest/topics/network-config-format-v1.html))
        :param pulumi.Input[bool] exp_nested_hvm: Boolean parameter that allows a VM to use nested virtualization.
        :param pulumi.Input[str] high_availability: The restart priority for the VM. Possible values are `best-effort`, `restart` and empty string (no restarts on failure. Defaults to empty string.
        :param pulumi.Input[str] hvm_boot_firmware: The firmware to use for the VM. Possible values are `bios` and `uefi`. Defaults to empty string.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: List of labels (strings) that are used to identify and organize resources. These are equivalent to Xenserver [tags](https://docs.citrix.com/en-us/xencenter/7-1/resources-tagging.html).
        :param pulumi.Input[str] vga: The video adapter the VM should use. Possible values include std and cirrus.
        :param pulumi.Input[float] videoram: The videoram option the VM should use. Possible values include 1, 2, 4, 8, 16
        """
    ...
    def memory_max(self) -> pulumi.Input[float]:
        """
        The amount of memory in bytes the VM will have. Updates to this field will cause a stop and start of the VM if the new `memory_max` value is greater than the dynamic memory max. This can be determined with the following command:
        """
    ...
    def cloud_config(self) -> Optional[pulumi.Input[str]]:
        """
        The content of the cloud-init config to use
        """
    ...
    def cpu_cap(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "cpu_cap")

    @cpu_cap.setter
    def cpu_cap(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "cpu_cap", value)

    @property
    @pulumi.getter(name="cpuWeight")
    def cpu_weight(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "cpu_weight")

    @cpu_weight.setter
    def cpu_weight(self, value: Optional[pulumi.Input[float]]):
    ...
    def hvm_boot_firmware(self) -> Optional[pulumi.Input[str]]:
        """
        The firmware to use for the VM. Possible values are `bios` and `uefi`. Defaults to empty string.
        """
    ...
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        List of labels (strings) that are used to identify and organize resources. These are equivalent to Xenserver [tags](https://docs.citrix.com/en-us/xencenter/7-1/resources-tagging.html).
        """
    ...
    @property
    @pulumi.getter
    def videoram(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @videoram.setter
    def videoram(self, value: Optional[pulumi.Input[float]]):
...
class Vm(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_poweron: Optional[pulumi.Input[bool]] = None,
                 blocked_operations: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 cdrom: Optional[pulumi.Input[pulumi.InputType['VmCdromArgs']]] = None,
                 cloud_config: Optional[pulumi.Input[str]] = None,
                 cloud_network_config: Optional[pulumi.Input[str]] = None,
                 core_os: Optional[pulumi.Input[bool]] = None,
                 cpu_cap: Optional[pulumi.Input[float]] = None,
                 cpu_weight: Optional[pulumi.Input[float]] = None,
                 cpus: Optional[pulumi.Input[int]] = None,
                 disks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VmDiskArgs']]]]] = None,
                 exp_nested_hvm: Optional[pulumi.Input[bool]] = None,
                 high_availability: Optional[pulumi.Input[str]] = None,
                 host: Optional[pulumi.Input[str]] = None,
                 hvm_boot_firmware: Optional[pulumi.Input[str]] = None,
                 ...
                 name_description: Optional[pulumi.Input[str]] = None,
                 name_label: Optional[pulumi.Input[str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VmNetworkArgs']]]]] = None,
                 resource_set: Optional[pulumi.Input[str]] = None,
                 start_delay: Optional[pulumi.Input[int]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 template: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[bool] auto_poweron: If the VM will automatically turn on. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] blocked_operations: List of operations on a VM that are not permitted. Examples include: clean_reboot, clean_shutdown, hard_reboot, hard_shutdown, pause, shutdown, suspend, destroy. This can be used to prevent a VM from being destroyed. The entire list can be found here
        :param pulumi.Input[pulumi.InputType['VmCdromArgs']] cdrom: The ISO that should be attached to VM. This allows you to create a VM from a diskless template (any templates available from `xe template-list`) and install the OS from the following ISO.
        :param pulumi.Input[str] cloud_config: The content of the cloud-init config to use
        :param pulumi.Input[str] cloud_network_config: The content of the cloud-init network configuration for the VM (uses [version 1](https://cloudinit.readthedocs.io/en/latest/topics/network-config-format-v1.html))
        :param pulumi.Input[int] cpus: The number of CPUs the VM will have. Updates to this field will cause a stop and start of the VM if the new CPU value is greater than the max CPU value. This can be determined with the following command:
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VmDiskArgs']]]] disks: The disk the VM will have access to.
        :param pulumi.Input[bool] exp_nested_hvm: Boolean parameter that allows a VM to use nested virtualization.
        :param pulumi.Input[str] high_availability: The restart priority for the VM. Possible values are `best-effort`, `restart` and empty string (no restarts on failure. Defaults to empty string.
        :param pulumi.Input[str] hvm_boot_firmware: The firmware to use for the VM. Possible values are `bios` and `uefi`. Defaults to empty string.
        :param pulumi.Input[str] installation_method: This cannot be used with `cdrom`. Possible values are `network` which allows a VM to boot via PXE.
        ...
        :param pulumi.Input[str] name_description: A description for the disk.
        :param pulumi.Input[str] name_label: The name for the disk.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VmNetworkArgs']]]] networks: The network the VM will use
        :param pulumi.Input[int] start_delay: Number of seconds the VM should be delayed from starting
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: List of labels (strings) that are used to identify and organize resources. These are equivalent to Xenserver [tags](https://docs.citrix.com/en-us/xencenter/7-1/resources-tagging.html).
        :param pulumi.Input[str] template: The ID of the VM template to create the new VM from.
        :param pulumi.Input[str] vga: The video adapter the VM should use. Possible values include std and cirrus.
    ...
    def get(resource_name: str,
            ...
            vga: Optional[pulumi.Input[str]] = None,
            videoram: Optional[pulumi.Input[float]] = None,
            wait_for_ip: Optional[pulumi.Input[bool]] = None) -> 'Vm':
        """
    ...
    @property
    @pulumi.getter(name="cpuCap")
    def cpu_cap(self) -> pulumi.Output[Optional[float]]:
        return pulumi.get(self, "cpu_cap")

    @property
    @pulumi.getter(name="cpuWeight")
    def cpu_weight(self) -> pulumi.Output[Optional[float]]:
        return pulumi.get(self, "cpu_weight")
    ...
    @property
    @pulumi.getter
    def videoram(self) -> pulumi.Output[Optional[float]]:
        """
        The videoram option the VM should use. Possible values include 1, 2, 4, 8, 16
        """
        return pulumi.get(self, "videoram")
