...
class Humanloop(Consumer):
    ...
    def generate_old(self, request: Body(type=ModelGenerate)) -> ModelGenerateResponse:
    ...
    def delete_metric(self, project_id: int, metric_id: str) -> MetricResponse:
        """Delete a specific metric."""

    @json
    @returns.json
    @get("/v1/projects/{project}/experiments")
    def get_experiments(self, project: int) -> List[ExperimentResponse]:
        """Get an array of experiments associated to your project"""

    @json
    @returns.json
    @post("/v1/projects/{project}/experiments")
    def create_experiment(
        self, project: int, experiment: Body(type=CreateExperimentRequest)
    ) -> ExperimentResponse:
    ...
    def update_project(
        self, project: str, update: Body(type=UpdateProjectRequest)
    ) -> ProjectResponse:
        """Update the specified project"""

    @returns.json
    @delete("/v1/projects/{project}/active-model-config")
    def remove_project_active_model_config(self, project: str) -> ProjectResponse:
        """Remove the project's active model config, if set."""

    @returns.json
    @delete("/v1/projects/{project}/active-experiment")
    def remove_project_active_experiment(self, project: str) -> ProjectResponse:
        """Remove the project's active experiment, if set."""

    @json
    @returns.json
    @post("/v1/generate")
    def generate(self, request: Body(type=GenerateRequest)) -> ModelGenerateResponse:
    ...
    def get_model_config(
        self, project: Query() = None, experiment_id: Query() = None
