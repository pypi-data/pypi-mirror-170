...
class HasArguments(object):
    ...
    def saveArguments(self, arguments, results):
        return {
            ...
            for argument, result in zip(arguments, results) if result.value is not None
        }
...
class HasEventHooks(object):
    def __init__(self):
        super().__init__()
        self.eventHooks = {}

    def addEventHook(self, topic: str, handler):
        self.eventHooks[topic] = handler
