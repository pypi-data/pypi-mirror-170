...
class ReservationsApi(object):
    ...
    def reservations_actionable_list(
        ...
        **kwargs
        ...
        Returns all reservations that are queued, holding resources or recently expired  # noqa: E501
    ...
    def reservations_active_list(
        ...
        **kwargs
        ...
        Returns all reservations that currently hold resources for the user           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
