"""
CLI tool for deploying prefect flows
"""
import asyncio
import importlib
...
DEFAULT_VALUES = {
    ...
    "storage.files": lambda flow, context: {
        os.path.join(os.getcwd(), "odp"): "/opt/prefect/odp/",
    ...
    "storage.python_dependencies": lambda flow, context: [
        context["pyproject"]["attrs"],
        context["pyproject"]["azure_common"],
        context["pyproject"]["azure_identity"],
        context["pyproject"]["azure_keyvault"],
        context["pyproject"]["azure_keyvault_secrets"],
        context["pyproject"]["azure_storage_blob"],
        context["pyproject"]["azure_storage_common"],
        context["pyproject"]["dask"],
        context["pyproject"]["dask_gateway"],
        context["pyproject"]["distributed"],
        context["pyproject"]["prometheus_client"],
        context["pyproject"]["pykube_ng"],
        context["pyproject"]["redis"],
        context["pyproject"]["retry"],
    ],
}
