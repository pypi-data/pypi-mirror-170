...
{'': ['*'],
 ...
 'fast_tmp_cli': ['tpl/project/*',
                  'tpl/project/{{cookiecutter.project_slug}}/static/*',
                  'tpl/project/{{cookiecutter.project_slug}}/static/css/*',
                  'tpl/project/{{cookiecutter.project_slug}}/static/img/*',
                  'tpl/project/{{cookiecutter.project_slug}}/static/js/*',
                  'tpl/static/*',
                  'tpl/static/static/*']}
