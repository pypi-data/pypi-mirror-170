...
class CloudtrailApi:
    ...
    def get_channel(self, context: RequestContext, channel: ChannelArn) -> GetChannelResponse:
        ...
        :param channel: The Amazon Resource Name (ARN) of the CloudTrail service-linked channel.
    ...
    def list_imports(
        ...
        :param destination: The destination event data store.
    ...
    def start_import(
        ...
        :param destinations: The destination event data store.
