...
class TransferApi:
    ...
    def delete_agreement(
        ...
        :param server_id: The server ID associated with the agreement that you are deleting.
        :raises ServiceUnavailableException:
        :raises InternalServiceError:
        :raises InvalidRequestException:
        :raises ResourceNotFoundException:
    ...
    def delete_certificate(self, context: RequestContext, certificate_id: CertificateId) -> None:
        ...
        :param certificate_id: The ID of the certificate object that you are deleting.
        :raises ServiceUnavailableException:
        :raises InternalServiceError:
        :raises InvalidRequestException:
        :raises ResourceNotFoundException:
    ...
    def delete_host_key(
        ...
        :param server_id: Provide the ID of the server that contains the host key that you are
        deleting.
        :param host_key_id: The ID of the host key that you are deleting.
        :raises ServiceUnavailableException:
        :raises InternalServiceError:
        :raises InvalidRequestException:
        :raises ResourceNotFoundException:
    ...
    def delete_profile(self, context: RequestContext, profile_id: ProfileId) -> None:
        ...
        :param profile_id: The ID of the profile that you are deleting.
        :raises ServiceUnavailableException:
        :raises InternalServiceError:
        :raises InvalidRequestException:
        :raises ResourceNotFoundException:
    ...
    def describe_agreement(
        ...
        :param agreement_id: A unique identifier for the agreement.
        :param server_id: The server ID that's associated with the agreement.
    ...
    def describe_host_key(
        ...
        :param server_id: Provide the ID of the server that contains the host key that you want
        described.
        :param host_key_id: Provide the ID of the host key that you want described.
    ...
    def import_host_key(
        ...
        :param description: Enter a text description to identify this host key.
    ...
    def list_host_keys(
        ...
        :param server_id: Provide the ID of the server that contains the host keys that you want
        to view.
    ...
    def update_host_key(
        ...
        :param server_id: Provide the ID of the server that contains the host key that you are
        updating.
        :param host_key_id: Provide the ID of the host key that you are updating.
        :param description: Provide an updated description for the host key.
