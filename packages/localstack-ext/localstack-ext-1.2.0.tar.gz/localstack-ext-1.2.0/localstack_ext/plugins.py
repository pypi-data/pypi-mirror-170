...
@hooks.on_infra_start(should_load=api_key_configured,priority=1000)
def patch_account_id_resolver():from localstack_ext.aws.accounts import _patch_account_id_resolver as A;A()
@hooks.on_infra_start(should_load=api_key_configured,priority=900)
def patch_get_account_id_from_access_key_id():from localstack_ext.aws.accounts import _patch_get_account_id_from_access_key_id as A;A()
