...
@pro_aws_provider()
def acm():B='acm';from localstack.services.moto import MotoFallbackDispatcher as C;from localstack_ext.services.acm.provider import AcmProProvider as D;A=D();return Service(B,listener=AwsApiListener(B,C(A)),backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider()
def apigatewayv2():from localstack_ext.services.apigateway.provider_v2_asf import AsfApiGatewayV2Provider as B;A=B();C=AwsApiListener(_A,A);return Service(_A,listener=C,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def application_autoscaling():from localstack_ext.services.applicationautoscaling.provider import ApplicationAutoscalingProvider as B;A=B();return Service(_G,listener=AwsApiListener(_G,MotoFallbackDispatcher(A)),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider(api=_S)
def cognito_identity():from localstack_ext.services.cognito_identity.provider import CognitoIdentityAWSApiListener as B;A=B();return Service(_S,listener=A,lifecycle_hook=A.provider,backend_state_lifecycle=A.provider)
@pro_aws_provider(api=_H)
def cognito_idp():from localstack_ext.services.cognito_idp.provider import CognitoIdpProvider as B;A=B();return Service(_H,listener=AwsApiListener(_H,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider()
def fis():B='fis';from localstack_ext.services.fis.provider import FisProvider as C;A=C();return Service(B,listener=AwsApiListener(B,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def iot_data():from localstack_ext.services.iot_data.provider import IotDataProvider as B;A=B();C=AwsApiListener(_I,MotoFallbackDispatcher(A));return Service(_I,listener=C,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def kinesis_legacy():from localstack.services.kinesis import kinesis_listener as B,kinesis_starter as A;from localstack_ext.services.kinesis.provider import KinesisDummyProvider as C;return Service(_C,listener=B.UPDATE_KINESIS,start=A.start_kinesis,check=A.check_kinesis,backend_state_lifecycle=C(_C))
@pro_aws_provider()
def kinesis():from localstack_ext.services.kinesis.provider import KinesisProvider as B;A=B();C=AwsApiListener(_C,HttpFallbackDispatcher(A,A.get_forward_url));return Service(_C,listener=C,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider()
def logs():B='logs';from localstack_ext.services.logs.provider import LogsProvider as C;A=C();D=AwsApiListener(B,MotoFallbackDispatcher(A));return Service(B,listener=D,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def mediastore_data():from localstack_ext.services.mediastore.provider import MediaStoreDataProvider as B;A=B();return Service(_J,listener=AwsApiListener(_J,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider()
def organizations():B='organizations';from localstack_ext.services.organizations.provider import OrganizationsProvider as C;A=C();D=AwsApiListener(B,MotoFallbackDispatcher(A));return Service(B,listener=D,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def qldb_session():from localstack_ext.services.qldb.provider import QldbSessionProvider as B;A=B();return Service(_K,listener=AwsApiListener(_K,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def rds_data():from localstack_ext.services.rds_data.provider import RdsDataProvider as A;B=A();return Service(_L,listener=AwsApiListener(_L,B))
@pro_aws_provider()
...
def redshift_data():from localstack_ext.services.redshift.provider import RedshiftDataProvider as A;B=A();C=AwsApiListener(_M,B);return Service(_M,listener=C)
@pro_aws_provider()
...
def sagemaker_runtime():from localstack_ext.services.sagemaker.provider import SageMakerRuntimeProvider as A;B=A();C=AwsApiListener(_N,B);return Service(_N,listener=C)
@pro_aws_provider()
...
def timestream_write():from localstack_ext.services.timestream.provider import TimestreamWriteProvider as B;A=B();return Service(_O,listener=AwsApiListener(_O,A),backend_state_lifecycle=A)
@pro_aws_provider(api=_P)
def timestream_query():from localstack_ext.services.timestream.provider import TimestreamQueryProvider as B;A=B();return Service(_P,listener=AwsApiListener(_P,A),backend_state_lifecycle=A)
@pro_aws_provider()
...
def apigateway_legacy():from localstack_ext.services.apigateway.apigateway_extended import ApigatewayExtApiListener as B,ApigatewayExtProvider as C;A=C();D=B(_D,MotoFallbackDispatcher(A));return Service(_D,listener=D,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
def apigateway():from localstack_ext.services.apigateway.apigateway_extended_asf import AsfApigatewayExtProvider as B;A=B();C=AwsApiListener(_D,MotoFallbackDispatcher(A));return Service(_D,listener=C,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider(api=_Q)
def awslambda():from localstack.services.awslambda import lambda_starter as A;from localstack_ext.services.awslambda.lambda_extended import patch_lambda as B;from localstack_ext.services.awslambda.persistence import LambdaPersistenceLifeCycle as C;B();return Service(_Q,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,backend_state_lifecycle=C(_Q))
@pro_aws_provider(api=_R)
def cloudwatch():from localstack_ext.services.cloudwatch.provider import CloudwatchProvider as B;A=B();return Service(_R,listener=AwsApiListener(_R,MotoFallbackDispatcher(A)),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider()
def mq():from localstack_ext.services.mq.provider import MQProvider as B;A=B();return Service('mq',listener=AwsApiListener('mq',MotoFallbackDispatcher(A)),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
def iam():B='iam';from localstack_ext.services.iam.provider import IamProviderExt as C;A=C();return Service(B,listener=AwsApiListener(B,MotoFallbackDispatcher(A)),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider()
def sns():B='sns';from localstack_ext.services.sns.provider import SnsProviderExt as C;A=C();return Service(B,listener=AwsApiListener(B,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
def sqs():from localstack.services import edge;from localstack.services.sqs import query_api as B;from localstack_ext.services.sqs.provider import SqsProvider as C;B.register(edge.ROUTER);A=C();return Service(_F,listener=AwsApiListener(_F,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider(api=_F,name=_E)
def sqs_legacy():from localstack.services.sqs.legacy import sqs_listener as B,sqs_starter as A;from localstack_ext.services.sqs.legacy.sqs_extended import patch_sqs as C;C();return Service(_F,listener=B.UPDATE_SQS,start=A.start_sqs,check=A.check_sqs)
@pro_aws_provider()
def stepfunctions():B='stepfunctions';from localstack_ext.services.stepfunctions.provider import StepFunctionsExtProvider as C,patch_stepfunctions as D;D();A=C();E=AwsApiListener(B,HttpFallbackDispatcher(A,A.get_forward_url));return Service(B,listener=E,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
