...
from pravo_api.api.links_getter.models import DocInfo
from pravo_api.api.utils.my_logger import Log, get_struct_logger
...
class MetaInfoGetter:
    ...
    def get_doc_meta_info(self, doc_id) -> Dict[str, Union[str, None]]:
        try:
            ...
            return {'doc_id': doc_id, 'tags': tags, 'author': author, 'date': date, 'region': self.configs.REGION}
