# Copyright (C) 2017 The python-litecoinlib developers
#
...
from litecoin.segwit_addr import encode, decode
import litecoin
...
class CBech32Data(bytes):
    ...
    def __new__(cls, s):
        """from bech32 addr to """
        witver, data = decode(litecoin.params.BECH32_HRP, s)
    ...
    def __str__(self):
        """Convert to string"""
        return encode(litecoin.params.BECH32_HRP, self.witver, self)
