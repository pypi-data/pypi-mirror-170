...
class CBloomFilter(litecoin.core.serialize.Serializable):
    ...
    def insert(self, elem):
        ...
        """
        if isinstance(elem, litecoin.core.COutPoint):
            elem = elem.serialize()
    ...
    def stream_deserialize(cls, f):
        vData = bytearray(litecoin.core.serialize.BytesSerializer.stream_deserialize(f))
        (nHashFuncs,
         nTweak,
         nFlags) = CBloomFilter.__struct.unpack(litecoin.core.ser_read(f, CBloomFilter.__struct.size))
    ...
    def stream_serialize(self, f):
        litecoin.core.serialize.BytesSerializer.stream_serialize(self.vData, f)
