...
class Whitelist:
    ...
    def save(self):
        self.contacts = [contact.dict() for contact in sorted(self.contacts, key=lambda contact: contact.name.lower())]
        storage.save_json(self.whitelist_path, self.contacts)
