...
class iFDO:
    ...
    def __init__(self, dir:miqtd.Dir, handle_prefix='20.500.12085/ee277578-a911-484d-a515-9c781d79aa91',provenance = None,verbose=True,startEmpty=False,writeTmpProvFile=True,iFDOfile=None):
        """ Creates an iFOD object. Requires a valid directory containing image data and a handle prefix if it's not the Geomar one. Loads directory's iFDO file if it exists already.
        ...
        if not iFDOfile is None:
            ...
            if not os.path.exists(file):
                raise miqtc.IfdoException("iFDO file not found: " + file)
        else:
            file = self.dir.to(self.dir.dt.products)+self.constructiFDOfileName(self.dir.event(),self.dir.sensor())
    ...
    def writeiFDOfile(self):
        ...
        iFDO_path = self.dir.to(self.dir.dt.products)+ self.constructiFDOfileName(event,sensor)
    ...
    @staticmethod
    def constructiFDOfileName(event:str,sensor:str): #,dataType:str):
        #return event + '_'+ sensor + '_' + dataType + '_iFDO.yaml'
