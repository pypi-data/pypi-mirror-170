...
# gopy build -output /project/build/lib.linux-x86_64-cpython-39/feast/embedded_go/lib -vm /opt/python/cp39-cp39/bin/python --build-tags cgo,ccalloc --dynamic-link=True -no-make github.com/feast-dev/feast/go/embedded
