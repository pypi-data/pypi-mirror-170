...
extern char* embedded_OnlineFeatureService_CheckForInstantiationError(long long int _handle);
...
extern char* embedded_OnlineFeatureService_StartHttpServer(long long int _handle, char* host, long long int port);
extern char* embedded_OnlineFeatureService_StartHttpServerWithLoggingDefaultOpts(long long int _handle, char* host, long long int port, PyObject* writeLoggedFeaturesCallback);
extern char* embedded_OnlineFeatureService_StartHttpServerWithLogging(long long int _handle, char* host, long long int port, PyObject* writeLoggedFeaturesCallback, long long int loggingOpts);
extern void embedded_OnlineFeatureService_StopHttpServer(long long int _handle, char goRun);
extern void embedded_OnlineFeatureService_StopGrpcServer(long long int _handle, char goRun);
