...
# gopy build -output /Users/runner/work/feast/feast/build/lib.macosx-10.9-x86_64-cpython-38/feast/embedded_go/lib -vm /private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/cibw-run-hi2k2wqn/cp38-macosx_x86_64/build/venv/bin/python --build-tags cgo,ccalloc --dynamic-link=True -no-make github.com/feast-dev/feast/go/embedded
...
add_checked_function(mod, 'embedded_OnlineFeatureService_CheckForInstantiationError', retval('char*'), [param('int64_t', '_handle')])
...
add_checked_function(mod, 'embedded_OnlineFeatureService_StartHttpServer', retval('char*'), [param('int64_t', '_handle'), param('char*', 'host'), param('int64_t', 'port')])
add_checked_function(mod, 'embedded_OnlineFeatureService_StartHttpServerWithLoggingDefaultOpts', retval('char*'), [param('int64_t', '_handle'), param('char*', 'host'), param('int64_t', 'port'), param('PyObject*', 'writeLoggedFeaturesCallback', transfer_ownership=False)])
add_checked_function(mod, 'embedded_OnlineFeatureService_StartHttpServerWithLogging', retval('char*'), [param('int64_t', '_handle'), param('char*', 'host'), param('int64_t', 'port'), param('PyObject*', 'writeLoggedFeaturesCallback', transfer_ownership=False), param('int64_t', 'loggingOpts')])
add_checked_function(mod, 'embedded_OnlineFeatureService_StopHttpServer', None, [param('int64_t', '_handle'), param('bool', 'goRun')])
add_checked_function(mod, 'embedded_OnlineFeatureService_StopGrpcServer', None, [param('int64_t', '_handle'), param('bool', 'goRun')])
