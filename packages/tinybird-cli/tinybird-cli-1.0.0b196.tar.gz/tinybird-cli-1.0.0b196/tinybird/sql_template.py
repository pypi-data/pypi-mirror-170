...
def day_diff(d0, d1, default=None):
    ...
    try:
        ...
        raise SQLTemplateException(
            'invalid date format, it must be ISO format date YYYY-MM-DD, e.g. 2018-09-26', documentation='/cli/advanced-templates.html#day_diff')
...
def get_template_and_variables(sql: str):
    """
...
def render_sql_template(sql: str, variables: dict = None, test_mode: bool = False) -> Tuple[str, dict]:
    """
    ...
    t, template_variables = get_template_and_variables(sql)
