...
def _parse(reader, template, in_block=None, in_loop=None):
    ...
    while True:
        ...
        while True:
            ...
            if (curly + 2 < reader.remaining() and  # noqa: W504
...
VALID_FUNCTION_NAMES = {'Boolean', 'DateTime', 'Date',
                        'Float32', 'Float64', 'Int8', 'Int16', 'Int32', 'Int64', 'Int128', 'Int256',
                        'UInt8', 'UInt16', 'UInt32', 'UInt64', 'UInt128', 'UInt256', 'String', 'Array',
                        'defined', 'column', 'columns', 'day_diff', 'split_to_array',
                        'enumerate_with_last', 'symbol', 'sql_and', 'cache_ttl', 'error', 'custom_error',
                        'sql_unescape', 'max_threads', 'Int', 'table', 'TABLE',
                        'len', 'list', 'min', 'max',
                        'Integer',
                        'int', 'float'}
