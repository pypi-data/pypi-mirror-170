...
from saysynth import MidiTrack, controller
from saysynth.cli.options import (adsr_opts, group_options, phoneme_opts,
                                  randomize_velocity_opt, say_opts,
                                  segment_opts, show_volume_opts, start_opts,
                                  text_opt, velocity_emphasis_opt,
                                  volume_range_opt)
