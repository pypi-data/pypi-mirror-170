"""
The `saysynth.cli` module contains submodules containing the logic for
all `saysynth` subcommands, inlcuding any shared `options`.
"""
...
main = SaySynthCLI(help="Generate music with the `say` command.")
