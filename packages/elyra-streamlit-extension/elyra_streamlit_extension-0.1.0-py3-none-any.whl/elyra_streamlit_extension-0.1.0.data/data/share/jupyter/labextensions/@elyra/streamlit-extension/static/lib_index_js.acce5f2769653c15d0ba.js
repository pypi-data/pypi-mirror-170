"use strict";
(self["webpackChunk_elyra_streamlit_extension"] = self["webpackChunk_elyra_streamlit_extension"] || []).push([["lib_index_js"],{
...
const getStreamlitApp = async (file) => {
    return await (0,_handler__WEBPACK_IMPORTED_MODULE_7__.requestAPI)('app', {
        method: 'POST',
...
const plugin = {
    ...
    activate: (app, editorTracker, factory, restorer) => {
        ...
        app.commands.addCommand(_utils__WEBPACK_IMPORTED_MODULE_6__.CommandIDs.openFromEditor, {
            ...
            isVisible: () => {
                const widget = editorTracker.currentWidget;
                return (widget && path__WEBPACK_IMPORTED_MODULE_5___default().extname(widget.context.path) === '.py') || false;
            },
            icon: _utils__WEBPACK_IMPORTED_MODULE_6__.streamlitIcon,
            label: 'Run in Streamlit'
        });
        ...
        app.docRegistry.addWidgetExtension('Python Editor', new _button__WEBPACK_IMPORTED_MODULE_8__.StreamlitButtonExtension(app.commands));
...
const streamlitIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
    name: 'streamlit:icon',
    svgstr: _style_streamlit_mark_color_svg__WEBPACK_IMPORTED_MODULE_1__["default"]
});
...
//# sourceMappingURL=lib_index_js.acce5f2769653c15d0ba.js.map