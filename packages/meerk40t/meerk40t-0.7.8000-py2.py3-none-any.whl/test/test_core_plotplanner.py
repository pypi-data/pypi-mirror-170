...
class TestPlotplanner(unittest.TestCase):
    ...
    def test_plotplanner_constant_xy_end(self):
        ...
        for q in range(100):
            plan = PlotPlanner(LaserSettings(power=1000))
            settings = LaserSettings(power=1000)
            settings.constant_move_x = bool(random.randint(0, 1))
            settings.constant_move_y = bool(random.randint(0, 1))
            goal_x = None
            goal_y = None
            for i in range(10):
            ...
            if last_x != goal_x:
                print(settings.constant_move_x)
                print(settings.constant_move_y)
    ...
    def test_plotplanner_static_issue(self):
        ...
        settings = LaserSettings(power=1000)
        settings.constant_move_x = True
        settings.constant_move_y = False
        lines = (
            ((41, 45), (14, 43)),
            ((32, 67), (32, 61)),
        )
