...
def bundles_to_mesh(override_context: typing.
                    ...
                    execution_context: typing.Union[str, int] = None,
                    undo: bool = None):
    ''' Create vertex cloud using coordinates of reconstructed tracks :file: startup/bl_operators/clip.py\:287 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$287> _
...
def constraint_to_fcurve(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Create F-Curves for object which will copy object's movement caused by this constraint :file: startup/bl_operators/clip.py\:514 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$514> _
...
def delete_proxy(override_context: typing.
                 ...
                 execution_context: typing.Union[str, int] = None,
                 undo: bool = None):
    ''' Delete movie clip proxy files from the hard drive :file: startup/bl_operators/clip.py\:357 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$357> _
...
def set_active_clip(override_context: typing.
                    ...
                    execution_context: typing.Union[str, int] = None,
                    undo: bool = None):
    ''' Undocumented contribute <https://developer.blender.org/T51061> :file: startup/bl_operators/clip.py\:216 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$216> _
...
def set_viewport_background(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: bool = None):
    ''' Set current movie clip as a camera background in 3D view-port (works only when a 3D view-port is visible) :file: startup/bl_operators/clip.py\:418 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$418> _
...
def setup_tracking_scene(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Prepare scene for compositing 3D objects into this footage :file: startup/bl_operators/clip.py\:968 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$968> _
...
def track_settings_to_track(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: bool = None):
    ''' Copy tracking settings from active track to selected tracks :file: startup/bl_operators/clip.py\:1047 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$1047> _
...
def track_to_empty(override_context: typing.
                   ...
                   execution_context: typing.Union[str, int] = None,
                   undo: bool = None):
    ''' Create an Empty object which will be copying movement of active track :file: startup/bl_operators/clip.py\:263 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$263> _
