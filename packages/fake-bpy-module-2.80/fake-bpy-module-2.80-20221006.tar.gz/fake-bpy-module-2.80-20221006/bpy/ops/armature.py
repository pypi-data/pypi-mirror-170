...
def autoside_names(override_context: typing.
                   ...
                   undo: bool = None,
                   *,
                   type: typing.Union[str, int] = 'XAXIS'):
...
def calculate_roll(override_context: typing.
                   ...
                   undo: bool = None,
                   *,
                   type: typing.Union[str, int] = 'POS_X',
...
def merge(override_context: typing.Union[typing.
          ...
          undo: bool = None,
          *,
          type: typing.Union[str, int] = 'WITHIN_CHAIN'):
...
def parent_set(override_context: typing.
               ...
               undo: bool = None,
               *,
               type: typing.Union[str, int] = 'CONNECTED'):
...
def select_similar(override_context: typing.
                   ...
                   undo: bool = None,
                   *,
                   type: typing.Union[str, int] = 'LENGTH',
                   threshold: float = 0.1):
