...
def anim_transforms_to_deltas(override_context: typing.
                              ...
                              execution_context: typing.Union[str, int] = None,
                              undo: bool = None):
    ''' Convert object animation for normal transforms to delta transforms :file: startup/bl_operators/object.py\:779 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$779> _
...
def hide_render_clear_all(override_context: typing.
                          ...
                          execution_context: typing.Union[str, int] = None,
                          undo: bool = None):
    ''' Reveal all render objects by setting the hide render flag :file: startup/bl_operators/object.py\:688 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$688> _
...
def instance_offset_from_cursor(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Set offset used for collection instances based on cursor position :file: startup/bl_operators/object.py\:868 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$868> _
...
def isolate_type_render(override_context: typing.
                        ...
                        execution_context: typing.Union[str, int] = None,
                        undo: bool = None):
    ''' Hide unselected render objects of same type as active by setting the hide render flag :file: startup/bl_operators/object.py\:668 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$668> _
...
def join_uvs(override_context: typing.Union[typing.
             ...
             execution_context: typing.Union[str, int] = None,
             undo: bool = None):
    ''' Transfer UV Maps from active to selected objects (needs matching geometry) :file: startup/bl_operators/object.py\:582 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$582> _
...
def make_dupli_face(override_context: typing.
                    ...
                    execution_context: typing.Union[str, int] = None,
                    undo: bool = None):
    ''' Convert objects into instanced faces :file: startup/bl_operators/object.py\:656 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$656> _
...
def mode_set_or_submode(override_context: typing.
                        Union[typing.Dict, 'bpy.types.Context'] = None,
                        execution_context: typing.Union[str, int] = None,
                        undo: bool = None,
                        *,
