...
def brush_select(override_context: typing.
    ...
    :param gpencil_tool: gpencil_tool * DRAW Draw, The brush is of type used for drawing strokes. * FILL Fill, The brush is of type used for filling areas. * ERASE Erase, The brush is used for erasing strokes.
...
def weight_sample_group(override_context: typing.
                        ...
                        undo: bool = None,
                        *,
                        group: typing.Union[str, int] = 'DEFAULT'):
