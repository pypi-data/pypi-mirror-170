    ...
    def __init__(self, sharedDataPeriod, tag, value=None):    
        ...
        if value is None: #Read dataset tag
            ...
            if not tag in dataset.index:                
                if (not sharedDataPeriod.default_startDate is None) \
                    & (not sharedDataPeriod.default_collections is None):
                    self.startDate = sharedDataPeriod.default_startDate
                    self.collections = sharedDataPeriod.default_collections.split(',')
                else:
