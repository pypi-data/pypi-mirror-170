...
class Pipeline(object):
    ...
    def set_input_data(
        ...
        call = self._kb.functions.create_datafile_call(name)
        self._dataset = call
    ...
    def set_input_features(
        self, name, feature_columns=None, group_columns=None, label_column=None
    ):
    ...
    def set_input_capture(self, names, group_columns=None):
        """Use a data file that has been uploaded as your data source.
