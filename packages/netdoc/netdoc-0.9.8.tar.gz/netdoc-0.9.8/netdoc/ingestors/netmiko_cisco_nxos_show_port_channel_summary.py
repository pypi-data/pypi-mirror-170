...
def ingest(log, force=False):
    ...
    for item in log.parsed_output:
        # Parsing
        # https://github.com/networktocode/ntc-templates/tree/master/tests/cisco_nxos/show_port-channel_summary
        device_o = log.discoverable.device
        bundle_name = item['bundle_iface']
        physical_interfaces = item['phys_iface']
