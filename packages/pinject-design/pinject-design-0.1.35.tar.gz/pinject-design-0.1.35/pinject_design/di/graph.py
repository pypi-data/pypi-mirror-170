...
class ExtendedObjectGraph:
    ...
    def _provide(self, target: Union[str, Type[T], Injected[T], Callable,Designed[T]]) -> Union[object, T]:
        """
    ...
    def child_session(self, overrides: "Design"=None) -> "ExtendedObjectGraph":
        """
