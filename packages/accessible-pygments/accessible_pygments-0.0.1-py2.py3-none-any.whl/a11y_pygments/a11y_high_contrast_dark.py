...
class A11yHighContrastDarkStyle(Style):
    """
    ...
    styles = {
        ...
        Comment:                   highlight_color, # class: 'c'
        ...
        Keyword.Type:              highlight_color, # class: 'kt'
        ...
        Name.Attribute:            highlight_color, # class: 'na'
        Name.Builtin:              highlight_color, # class: 'nb'
        Name.Builtin.Pseudo:       highlight_color, # class: 'bp'
        ...
        Number:                    highlight_color, # class: 'm'
        ...
        Literal:                   highlight_color, # class: 'l'
        # Literal.Date:              "",            # class: 'ld'

        String:                    highlight_color, # class: 's'
        ...
        String.Symbol:             highlight_color, # class: 'ss'
