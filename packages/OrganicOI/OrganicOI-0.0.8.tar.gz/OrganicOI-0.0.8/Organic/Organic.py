...
effect:
    ...
    def save_image_from_noise(self, noise, name='image.pdf'):
        ...
        self.plot_image(img, name=name+'00.pdf')
        self.plot_image(img[::-1,:], name=name+'10.pdf')
        self.plot_image(img[:,::-1], name=name+'01.pdf')
        self.plot_image(img[::-1,::-1], name=name+'11.pdf')
    ...
    def saveImages(self, image, losses):
        ...
        # save image
        self.imagetofits(median[0,:,:,0], ftot[id], fdatabest, frglbest, name=os.path.join(os.getcwd(),self.dir,'BestImage.fits'))
