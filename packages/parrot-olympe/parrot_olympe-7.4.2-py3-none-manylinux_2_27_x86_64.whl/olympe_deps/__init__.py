...
vmeta_quat_rotate_vector = _libraries['libvideo-metadata.so'].vmeta_quat_rotate_vector
vmeta_quat_rotate_vector.restype = None
vmeta_quat_rotate_vector.argtypes = [POINTER_T(struct_vmeta_quaternion), POINTER_T(struct_vmeta_xyz)]
vmeta_wrapto_d = _libraries['libvideo-metadata.so'].vmeta_wrapto_d
vmeta_wrapto_d.restype = ctypes.c_double
vmeta_wrapto_d.argtypes = [ctypes.c_double, ctypes.c_double]
vmeta_geo_to_ned = _libraries['libvideo-metadata.so'].vmeta_geo_to_ned
vmeta_geo_to_ned.restype = None
vmeta_geo_to_ned.argtypes = [POINTER_T(struct_vmeta_location), POINTER_T(struct_vmeta_location), POINTER_T(struct_vmeta_xyz)]
vmeta_location_horiz_distance = _libraries['libvideo-metadata.so'].vmeta_location_horiz_distance
vmeta_location_horiz_distance.restype = ctypes.c_int32
vmeta_location_horiz_distance.argtypes = [POINTER_T(struct_vmeta_location), POINTER_T(struct_vmeta_location), POINTER_T(ctypes.c_float)]
vmeta_location_delta = _libraries['libvideo-metadata.so'].vmeta_location_delta
vmeta_location_delta.restype = ctypes.c_int32
vmeta_location_delta.argtypes = [POINTER_T(struct_vmeta_location), POINTER_T(struct_vmeta_location), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_double), POINTER_T(ctypes.c_double), POINTER_T(struct_vmeta_xyz)]
...
vmeta_frame_ltic = _libraries['libvideo-metadata.so'].vmeta_frame_ltic
vmeta_frame_ltic.restype = ctypes.c_int32
vmeta_frame_ltic.argtypes = [POINTER_T(struct_vmeta_session), POINTER_T(struct_vmeta_frame), ctypes.c_float, POINTER_T(struct_vmeta_location), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_float)]
...
arsdk_device_type__enumvalues = {
    ...
    2335: 'ARSDK_DEVICE_TYPE_ANAFI_3',
    2336: 'ARSDK_DEVICE_TYPE_ANAFI_3_USA',
...
ARSDK_DEVICE_TYPE_ANAFI_3 = 2335
ARSDK_DEVICE_TYPE_ANAFI_3_USA = 2336
...
__all__ = \
    ...
    'ARSDK_DEVICE_TYPE_ANAFI_3', 'ARSDK_DEVICE_TYPE_ANAFI_3_USA',
    ...
    'MP4_VIDEO_CODEC_UNKNOWN', 'MUX_ARSDK_CHANNEL_ID_BACKEND',
    'MUX_ARSDK_CHANNEL_ID_DISCOVERY', 'MUX_ARSDK_CHANNEL_ID_RTP',
    ...
    'VDEF_TRANSFER_FUNCTION_UNKNOWN', 'VMETA_API_VERSION',
    'VMETA_AUTOMATION_ANIM_BOOMERANG', 'VMETA_AUTOMATION_ANIM_CANDLE',
    ...
    'VMETA_CAMERA_MODEL_TYPE_UNKNOWN', 'VMETA_CAMERA_TYPE_DISPARITY',
    ...
    'VMETA_STRM_SDP_KEY_MODEL', 'VMETA_STRM_SDP_KEY_MODEL_ID',
    'VMETA_STRM_SDP_KEY_PERSPECTIVE_DISTORTION',
    'VMETA_STRM_SDP_KEY_PICTURE_FOV', 'VMETA_STRM_SDP_KEY_RUN_DATE',
    'VMETA_STRM_SDP_KEY_RUN_ID', 'VMETA_STRM_SDP_KEY_SERIAL_NUMBER',
    ...
    'VMETA__TRACKING_STATE__TS_TRACKING', 'Vmeta__Animation',
    'Vmeta__Animation__enumvalues', 'Vmeta__FlyingState',
    'Vmeta__FlyingState__enumvalues', 'Vmeta__PilotingMode',
    'Vmeta__PilotingMode__enumvalues',
    ...
    '_MBUF_ANCILLARY_DATA_H_', '_MBUF_CODED_VIDEO_FRAME_H_',
    '_MBUF_MEM_GENERIC_H_', '_MBUF_MEM_H_',
    '_MBUF_RAW_VIDEO_FRAME_H_', '_PDRAW_DEFS_H_', '_PDRAW_H_',
    '_STDINT_H', '_VDEFS_H_', '_VMETA_FRAME_H_',
    ...
    'mux_channel_alloc_queue', 'mux_channel_cb_t',
    'mux_channel_close', 'mux_channel_event', 'mux_channel_open',
    'mux_decode', 'mux_encode', 'mux_get_loop',
    ...
    'pdraw_media_type_str', 'pdraw_muxer_add_media',
    'pdraw_muxer_destroy', 'pdraw_muxer_new', 'pdraw_new',
    'pdraw_pipeline_mode', 'pdraw_pipeline_mode_str',
    ...
    'size_t', 'ssize_t', 'struct_ProtobufCFieldDescriptor',
    ...
    'struct_pdraw_cbs', 'struct_pdraw_coded_video_info',
    ...
    'struct_vdef_rect', 'struct_vmeta_buffer',
    'struct_vmeta_camera_model', 'struct_vmeta_camera_model_0_0',
    ...
    'struct_vmeta_xy', 'struct_vmeta_xyz', 'time_t', 'uint16_t',
    ...
    'vmeta_camera_model_type_to_str', 'vmeta_camera_type',
    'vmeta_camera_type_from_str', 'vmeta_camera_type_to_str',
    'vmeta_dynamic_range', 'vmeta_dynamic_range_from_str',
    'vmeta_dynamic_range_to_str', 'vmeta_euler_to_quat',
    ...
    'vmeta_frame_ltic', 'vmeta_frame_new',
    'vmeta_frame_piloting_mode_proto_to_vmeta',
    ...
    'vmeta_frame_write', 'vmeta_geo_to_ned', 'vmeta_location_delta',
    'vmeta_location_horiz_distance', 'vmeta_piloting_mode',
    'vmeta_piloting_mode_str', 'vmeta_quat_rotate_vector',
    'vmeta_quat_to_euler', 'vmeta_record_type',
    ...
    'vmeta_video_stop_reason_to_str', 'vmeta_wrapto_d']
