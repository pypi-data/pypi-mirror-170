...
class QPdfBookmarkModel(QtCore.QAbstractItemModel):
    ...
    def documentChanged(self, document: 'QPdfDocument') -> None: ...
...
class QPdfDocument(QtCore.QObject):
    ...
    def pageModelChanged(self) -> None: ...
    def pageCountChanged(self, pageCount: int) -> None: ...
    def statusChanged(self, status: 'QPdfDocument.Status') -> None: ...
...
class QPdfPageNavigator(QtCore.QObject):
    ...
    def jumped(self, current: QPdfLink) -> None: ...
    def forwardAvailableChanged(self, available: bool) -> None: ...
    def backAvailableChanged(self, available: bool) -> None: ...
    def currentZoomChanged(self, zoom: float) -> None: ...
    def currentLocationChanged(self, location: QtCore.QPointF) -> None: ...
    def currentPageChanged(self, page: int) -> None: ...
    def back(self) -> None: ...
...
class QPdfPageRenderer(QtCore.QObject):
    ...
    def renderModeChanged(self, renderMode: 'QPdfPageRenderer.RenderMode') -> None: ...
    def documentChanged(self, document: QPdfDocument) -> None: ...
...
class QPdfSearchModel(QtCore.QAbstractListModel):
    ...
    def searchStringChanged(self) -> None: ...
