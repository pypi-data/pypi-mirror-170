...
class CubicWebRequestBase(RequestSessionBase):
...
_CubicWebRequestBase = class_renamed(
    "_CubicWebRequestBase", CubicWebRequestBase, version="3.38"
)
ConnectionCubicWebRequestBase = class_renamed(
    "ConnectionCubicWebRequestBase", CubicWebRequestBase, version="3.38"
)
