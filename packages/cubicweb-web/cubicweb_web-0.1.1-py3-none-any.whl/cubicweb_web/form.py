...
from cubicweb_web import httpcache, formfields, controller, formwidgets as fwdgs
...
class metafieldsform(type):
    ...
    def __new__(mcs, name, bases, classdict):
        ...
        clsfields = (
            item for item in classdict.items() if isinstance(item[1], formfields.Field)
        )
...
class Form(AppObject, metaclass=metafieldsform):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if mainform:
            ...
            self.add_hidden("__form_id", formid)
    ...
    def _process_kwargs(self, kwargs):
        ...
        for key, val in kwargs.items():
            if key in controller.NAV_FORM_PARAMETERS:
                ...
                hiddens.append(("__redirectpath", val))
    ...
    def set_message(self, submitmsg):
        ...
        self.add_hidden("_cwmsgid", cwmsgid)
