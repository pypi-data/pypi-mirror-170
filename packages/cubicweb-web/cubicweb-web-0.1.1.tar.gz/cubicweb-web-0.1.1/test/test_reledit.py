...
class ClickAndEditFormTC(ReleditMixinTC, CubicWebTC):
    def setup_database(self):
        ...
        with self.admin_access.client_cnx() as cnx:
            ...
            self.create_user(
                cnx, login="edith", password="edith", groups=("validators", "users")
            )
    ...
    def editable_fields(self):
        return {
            "title": f"""<div id="title-subject-%(eid)s-reledit" onmouseout="jQuery('#title-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#title-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="title-subject-%(eid)s-value" class="editableFieldValue">cubicweb-world-domination</div><div id="title-subject-%(eid)s" class="editableField invisible"><div id="title-subject-%(eid)s-update" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;base&#39;, %(eid)s, &#39;title&#39;, &#39;subject&#39;, &#39;title-subject-%(eid)s&#39;, false, &#39;&#39;, &#39;edit_rtype&#39;);" title="click to edit this field"><img title="click to edit this field" src="{BASE_URL}data/pen_icon.png" alt="click to edit this field"/></div></div></div>""",
            "long_desc": f"""<div id="long_desc-subject-%(eid)s-reledit" onmouseout="jQuery('#long_desc-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#long_desc-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="long_desc-subject-%(eid)s-value" class="editableFieldValue">&lt;not specified&gt;</div><div id="long_desc-subject-%(eid)s" class="editableField invisible"><div id="long_desc-subject-%(eid)s-add" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;edition&#39;, %(eid)s, &#39;long_desc&#39;, &#39;subject&#39;, &#39;long_desc-subject-%(eid)s&#39;, false, &#39;autolimited&#39;, &#39;add&#39;);" title="click to add a value"><img title="click to add a value" src="{BASE_URL}data/plus.png" alt="click to add a value"/></div></div></div>""",
            "manager": f"""<div id="manager-subject-%(eid)s-reledit" onmouseout="jQuery('#manager-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#manager-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="manager-subject-%(eid)s-value" class="editableFieldValue">&lt;not specified&gt;</div><div id="manager-subject-%(eid)s" class="editableField invisible"><div id="manager-subject-%(eid)s-update" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;base&#39;, %(eid)s, &#39;manager&#39;, &#39;subject&#39;, &#39;manager-subject-%(eid)s&#39;, false, &#39;autolimited&#39;, &#39;edit_rtype&#39;);" title="click to edit this field"><img title="click to edit this field" src="{BASE_URL}data/pen_icon.png" alt="click to edit this field"/></div></div></div>""",
            "composite_card11_2ttypes": """&lt;not specified&gt;""",
            "concerns": """&lt;not specified&gt;""",
        }

    def _test_fields(self, fields, login="admin"):
        with self.new_access(login).web_request() as req:
            proj = req.entity_from_eid(self.proj)
            for rschema, ttypes, role in proj.e_schema.relation_definitions(
                includefinal=True
            ):
                if rschema not in fields:
                    continue
                rtype = rschema.type
                proj_view = proj.view("reledit", rtype=rtype, role=role)
                if proj_view:
                    self.assertMultiLineEqual(
                        fields[rtype] % {"eid": self.proj}, proj_view, rtype
                    )

    def test_admins_edit_permissions(self):
        """managers can edit all fields"""
        fields = self.editable_fields.copy()
        self._test_fields(fields, login="admin")

    def test_validators_edit_permissions(self):
        """validators can edit all relations"""
        fields = self.editable_fields.copy()
        self._test_fields(fields, login="edith")

    def test_contributors_edit_permissions(self):
        """contributors can edit all but `manager` relation as they don't update
        permissions on Personne
        """
        fields = self.editable_fields.copy()
    ...
    def test_default_forms(self):
        ...
        doreledit = {
            "title": f"""<div id="title-subject-%(eid)s-reledit" onmouseout="jQuery('#title-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#title-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="title-subject-%(eid)s-value" class="editableFieldValue">cubicweb-world-domination</div><form action="{BASE_URL}validateform?__onsuccess=window.parent.cw.reledit.onSuccess" method="post" enctype="application/x-www-form-urlencoded" id="title-subject-%(eid)s-form" onsubmit="return freezeFormButtons(&#39;title-subject-%(eid)s-form&#39;);" class="releditForm" target="eformframe">
<fieldset>
<input name="__form_id" type="hidden" value="base" />
<input name="__errorurl" type="hidden" value="{BASE_URL}view?rql=Blop&amp;vid=blop#title-subject-%(eid)s-form" />
...
<tr>
<td><button class="validateButton" type="submit" value="button_ok"><img alt="OK_ICON" src="{BASE_URL}data/ok.png" />button_ok</button></td>
<td><button class="validateButton" onclick="cw.reledit.cleanupAfterCancel(&#39;title-subject-%(eid)s&#39;)" type="button" value="button_cancel"><img alt="CANCEL_ICON" src="{BASE_URL}data/cancel.png" />button_cancel</button></td>
</tr></table>
</fieldset>
<iframe width="0px" height="0px" src="javascript: void(0);" name="eformframe" id="eformframe"></iframe>
</form><div id="title-subject-%(eid)s" class="editableField invisible"><div id="title-subject-%(eid)s-update" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;base&#39;, %(eid)s, &#39;title&#39;, &#39;subject&#39;, &#39;title-subject-%(eid)s&#39;, false, &#39;&#39;);" title="click to edit this field"><img title="click to edit this field" src="{BASE_URL}data/pen_icon.png" alt="click to edit this field"/></div></div></div>""",
            "long_desc": f"""<div id="long_desc-subject-%(eid)s-reledit" onmouseout="jQuery('#long_desc-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#long_desc-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="long_desc-subject-%(eid)s-value" class="editableFieldValue">&lt;not specified&gt;</div><form action="{BASE_URL}validateform?__onsuccess=window.parent.cw.reledit.onSuccess" method="post" enctype="application/x-www-form-urlencoded" id="long_desc-subject-%(eid)s-form" onsubmit="return freezeFormButtons(&#39;long_desc-subject-%(eid)s-form&#39;);" class="releditForm" target="eformframe">
<fieldset>
<input name="__form_id" type="invisible" value="edition" />
<input name="__errorurl" type="invisible" value="{BASE_URL}view?rql=Blop&amp;vid=blop#long_desc-subject-%(eid)s-form" />
...
<tr>
<td><button class="validateButton" type="submit" value="button_ok"><img alt="OK_ICON" src="{BASE_URL}data/ok.png" />button_ok</button></td>
<td><button class="validateButton" onclick="cw.reledit.cleanupAfterCancel(&#39;long_desc-subject-%(eid)s&#39;)" type="button" value="button_cancel"><img alt="CANCEL_ICON" src="{BASE_URL}data/cancel.png" />button_cancel</button></td>
</tr></table>
</fieldset>
<iframe width="0px" height="0px" src="javascript: void(0);" name="eformframe" id="eformframe"></iframe>
</form><div id="long_desc-subject-%(eid)s" class="editableField invisible"><div id="long_desc-subject-%(eid)s-add" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;edition&#39;, %(eid)s, &#39;long_desc&#39;, &#39;subject&#39;, &#39;long_desc-subject-%(eid)s&#39;, false, &#39;autolimited&#39;);" title="click to add a value"><img title="click to add a value" src="{BASE_URL}data/plus.png" alt="click to add a value"/></div></div></div>""",
            "manager": f"""<div id="manager-subject-%(eid)s-reledit" onmouseout="jQuery('#manager-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#manager-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="manager-subject-%(eid)s-value" class="editableFieldValue">&lt;not specified&gt;</div><form action="{BASE_URL}validateform?__onsuccess=window.parent.cw.reledit.onSuccess" method="post" enctype="application/x-www-form-urlencoded" id="manager-subject-%(eid)s-form" onsubmit="return freezeFormButtons(&#39;manager-subject-%(eid)s-form&#39;);" class="releditForm" target="eformframe">
<fieldset>
<input name="__form_id" type="hidden" value="base" />
<input name="__errorurl" type="hidden" value="{BASE_URL}view?rql=Blop&amp;vid=blop#manager-subject-%(eid)s-form" />
...
<tr>
<td><button class="validateButton" type="submit" value="button_ok"><img alt="OK_ICON" src="{BASE_URL}data/ok.png" />button_ok</button></td>
<td><button class="validateButton" onclick="cw.reledit.cleanupAfterCancel(&#39;manager-subject-%(eid)s&#39;)" type="button" value="button_cancel"><img alt="CANCEL_ICON" src="{BASE_URL}data/cancel.png" />button_cancel</button></td>
</tr></table>
</fieldset>
<iframe width="0px" height="0px" src="javascript: void(0);" name="eformframe" id="eformframe"></iframe>
</form><div id="manager-subject-%(eid)s" class="editableField invisible"><div id="manager-subject-%(eid)s-update" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;base&#39;, %(eid)s, &#39;manager&#39;, &#39;subject&#39;, &#39;manager-subject-%(eid)s&#39;, false, &#39;autolimited&#39;);" title="click to edit this field"><img title="click to edit this field" src="{BASE_URL}data/pen_icon.png" alt="click to edit this field"/></div></div></div>""",
            "composite_card11_2ttypes": """&lt;not specified&gt;""",
            "concerns": """&lt;not specified&gt;""",
        }
        for rschema, ttypes, role in self.proj.e_schema.relation_definitions(
            includefinal=True
        ):
            ...
            rtype = rschema.type
            self.assertMultiLineEqual(
                doreledit[rtype] % {"eid": self.proj.eid, "toto": self.toto.eid},
                self.proj.view(
                    "doreledit",
                    rtype=rtype,
                    role=role,
...
class ClickAndEditFormUICFGTC(ReleditMixinTC, CubicWebTC):
    def setup_database(self):
        ...
        with self.admin_access.client_cnx() as cnx:
            ...
            cnx.execute(
                "SET P manager T WHERE P eid %(p)s, T eid %(t)s",
                {"p": self.proj, "t": self.toto},
            )
            cnx.commit()

    def test_with_uicfg(self):
        old_rctl = reledit_ctrl._tagdefs.copy()
        reledit_ctrl.tag_attribute(
            ("Project", "title"),
            {"novalue_label": "<title is required>", "reload": True},
        )
        reledit_ctrl.tag_subject_of(
            ("Project", "long_desc", "*"),
            {
                "reload": True,
                "edit_target": "rtype",
                "novalue_label": "<long_desc is required>",
            },
        )
        reledit_ctrl.tag_subject_of(
            ("Project", "manager", "*"), {"edit_target": "related"}
        )
        reledit_ctrl.tag_subject_of(
            ("Project", "composite_card11_2ttypes", "*"), {"edit_target": "related"}
        )
        reledit_ctrl.tag_object_of(
            ("Ticket", "concerns", "Project"), {"edit_target": "rtype"}
        )
        reledit = {
            "title": f"""<div id="title-subject-%(eid)s-reledit" onmouseout="jQuery('#title-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#title-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="title-subject-%(eid)s-value" class="editableFieldValue">cubicweb-world-domination</div><div id="title-subject-%(eid)s" class="editableField invisible"><div id="title-subject-%(eid)s-update" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;base&#39;, %(eid)s, &#39;title&#39;, &#39;subject&#39;, &#39;title-subject-%(eid)s&#39;, true, &#39;&#39;, &#39;edit_rtype&#39;);" title="click to edit this field"><img title="click to edit this field" src="{BASE_URL}data/pen_icon.png" alt="click to edit this field"/></div></div></div>""",
            "long_desc": f"""<div id="long_desc-subject-%(eid)s-reledit" onmouseout="jQuery('#long_desc-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#long_desc-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="long_desc-subject-%(eid)s-value" class="editableFieldValue">&lt;long_desc is required&gt;</div><div id="long_desc-subject-%(eid)s" class="editableField invisible"><div id="long_desc-subject-%(eid)s-update" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;base&#39;, %(eid)s, &#39;long_desc&#39;, &#39;subject&#39;, &#39;long_desc-subject-%(eid)s&#39;, true, &#39;autolimited&#39;, &#39;edit_rtype&#39;);" title="click to edit this field"><img title="click to edit this field" src="{BASE_URL}data/pen_icon.png" alt="click to edit this field"/></div></div></div>""",
            "manager": f"""<div id="manager-subject-%(eid)s-reledit" onmouseout="jQuery('#manager-subject-%(eid)s').addClass('invisible')" onmouseover="jQuery('#manager-subject-%(eid)s').removeClass('invisible')" class="releditField"><div id="manager-subject-%(eid)s-value" class="editableFieldValue"><a href="{BASE_URL}personne/%(toto)s" title="">Toto</a></div><div id="manager-subject-%(eid)s" class="editableField invisible"><div id="manager-subject-%(eid)s-update" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;edition&#39;, %(eid)s, &#39;manager&#39;, &#39;subject&#39;, &#39;manager-subject-%(eid)s&#39;, false, &#39;autolimited&#39;, &#39;edit_related&#39;);" title="click to edit this field"><img title="click to edit this field" src="{BASE_URL}data/pen_icon.png" alt="click to edit this field"/></div><div id="manager-subject-%(eid)s-delete" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;deleteconf&#39;, %(eid)s, &#39;manager&#39;, &#39;subject&#39;, &#39;manager-subject-%(eid)s&#39;, false, &#39;autolimited&#39;, &#39;delete&#39;);" title="click to delete this value"><img title="click to delete this value" src="{BASE_URL}data/cancel.png" alt="click to delete this value"/></div></div></div>""",
            "composite_card11_2ttypes": """&lt;not specified&gt;""",
            "concerns": f"""<div id="concerns-object-%(eid)s-reledit" onmouseout="jQuery('#concerns-object-%(eid)s').addClass('invisible')" onmouseover="jQuery('#concerns-object-%(eid)s').removeClass('invisible')" class="releditField"><div id="concerns-object-%(eid)s-value" class="editableFieldValue"><a href="{BASE_URL}ticket/%(tick)s" title="">write the code</a></div><div id="concerns-object-%(eid)s" class="editableField invisible"><div id="concerns-object-%(eid)s-update" class="editableField" onclick="cw.reledit.loadInlineEditionForm(&#39;base&#39;, %(eid)s, &#39;concerns&#39;, &#39;object&#39;, &#39;concerns-object-%(eid)s&#39;, false, &#39;autolimited&#39;, &#39;edit_rtype&#39;);" title="click to edit this field"><img title="click to edit this field" src="{BASE_URL}data/pen_icon.png" alt="click to edit this field"/></div></div></div>""",
        }
